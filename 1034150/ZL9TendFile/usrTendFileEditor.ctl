...
Begin VB.UserControl usrTendFileEditor 
   ...
   Begin VB.PictureBox picCloumn 
      ...
      Begin VB.CommandButton cmdFilterCancel 
         Height          =   315
         Left            =   3000
         Picture         =   "usrTendFileEditor.ctx":1CB4
         Style           =   1  'Graphical
         TabIndex        =   31
         ToolTipText     =   "取消"
         Top             =   2310
   ...
   Begin VB.PictureBox picBiref 
      ...
      Begin VB.CommandButton cmdCancel 
         Height          =   315
         Left            =   4290
         Picture         =   "usrTendFileEditor.ctx":223E
         Style           =   1  'Graphical
         TabIndex        =   53
         ToolTipText     =   "取消"
         Top             =   2850
      ...
      Begin VB.CommandButton cmdOk 
         Height          =   315
         Left            =   3750
         Picture         =   "usrTendFileEditor.ctx":27C8
         Style           =   1  'Graphical
         TabIndex        =   52
         ToolTipText     =   "确认"
         Top             =   2850
      ...
      Begin MSComctlLib.ImageList imgTrueFalse 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            NumListImages   =   2
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "usrTendFileEditor.ctx":2D52
               Key             =   "T"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "usrTendFileEditor.ctx":32EC
               Key             =   "F"
            EndProperty
         EndProperty
      End
   ...
   Begin VB.PictureBox picMain 
      ...
      Begin VB.ListBox lstSelect 
         ...
         Height          =   930
         Index           =   2
         ItemData        =   "usrTendFileEditor.ctx":3886
         Left            =   7470
         List            =   "usrTendFileEditor.ctx":3899
         TabIndex        =   84
         Top             =   390
         Visible         =   0   'False
         Width           =   855
      ...
      Begin VB.PictureBox picInfo 
         ...
         Begin VB.PictureBox picImg 
            ...
            Height          =   225
            Left            =   840
            Picture         =   "usrTendFileEditor.ctx":38BD
            ScaleHeight     =   225
            ScaleWidth      =   285
            TabIndex        =   82
            Top             =   45
      ...
      Begin VB.PictureBox PicLst 
         ...
         Begin VB.ListBox lstSelect 
            ...
            Height          =   1470
            Index           =   0
            ItemData        =   "usrTendFileEditor.ctx":A10F
            Left            =   -10
            List            =   "usrTendFileEditor.ctx":A125
            TabIndex        =   5
            Top             =   825
            Visible         =   0   'False
            Width           =   1215
      ...
      Begin VB.PictureBox picSign 
         ...
         Begin VB.Image imgSign 
            Height          =   240
            Left            =   -30
            Picture         =   "usrTendFileEditor.ctx":A15D
            Tag             =   "240"
            Top             =   -30
            Width           =   240
         End
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsfHead 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"usrTendFileEditor.ctx":109AF
         ScrollTrack     =   -1  'True
         ScrollBars      =   0
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VB.PictureBox picDoubleChoose 
         ...
         Begin VB.PictureBox picChooseRight 
            ...
            Begin VB.ComboBox cboChoose 
               ...
               Height          =   300
               Index           =   1
               ItemData        =   "usrTendFileEditor.ctx":10A11
               Left            =   -30
               List            =   "usrTendFileEditor.ctx":10A21
               Style           =   2  'Dropdown List
               TabIndex        =   60
               Top             =   -30
               Width           =   1605
         ...
         Begin VB.PictureBox picChooseLeft 
            ...
            Begin VB.ComboBox cboChoose 
               ...
               Height          =   300
               Index           =   0
               ItemData        =   "usrTendFileEditor.ctx":10A33
               Left            =   -30
               List            =   "usrTendFileEditor.ctx":10A43
               Style           =   2  'Dropdown List
               TabIndex        =   58
               Top             =   -30
               Width           =   1605
      ...
      Begin VB.CommandButton cmdWord 
         ...
         Height          =   255
         Left            =   6120
         Picture         =   "usrTendFileEditor.ctx":10A55
         Style           =   1  'Graphical
         TabIndex        =   23
         TabStop         =   0   'False
         Top             =   1290
      ...
      Begin VB.ListBox lstSelect 
         ...
         Height          =   2340
         Index           =   1
         ItemData        =   "usrTendFileEditor.ctx":10D97
         Left            =   6675
         List            =   "usrTendFileEditor.ctx":10DAD
         Style           =   1  'Checkbox
         TabIndex        =   6
         Top             =   1590
         Visible         =   0   'False
      ...
      Begin VSFlex8Ctl.VSFlexGrid VsfData 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"usrTendFileEditor.ctx":10DE5
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsTest 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"usrTendFileEditor.ctx":10E47
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
...
Private mstrMangeVerify As String           '当前操作员的管理职务
...
Private mlngCollectValue As Long            '汇总值,用来分辨是否汇总
...
Private Sub DrawCollectCell(ByVal hDC As Long, ByVal ROW As Long, ByVal COL As Long, ByVal Left As Long, ByVal Top As Long, ByVal Right As Long, ByVal Bottom As Long)
    ...
    Case 1  '上下划横线(起始行画上横线，结束行画下横线)
        ...
        End If
    Case 2  '汇总项下双横线
        If InStr(1, "|" & VsfData.TextMatrix(ROW, mlngCollectValue) & ";", "|" & COL - (cHideCols + VsfData.FixedCols - 1) & ";") <> 0 Then   'And Val(VsfData.TextMatrix(ROW, COL)) <> 0 Then
            '画线
...
Private Sub BoundItems(ByVal intCol As Integer)
    ...
    gstrSQL = "" & _
        ...
        "     WHERE A.项目序号 =B.项目序号(+) AND A.项目性质=2 And NVL(A.应用场合,0)<>1) A," & vbNewLine & _
...
'                    End If
        ...
        mstrSQL中 = UCase(mstrSQL中 & ",MAX(签名级别) AS 签名级别,MAX(签名信息) AS 签名信息,MAX(交班签名人) AS 交班签名人,MAX(记录ID) AS 记录ID,MAX(行数) AS 行数,MAX(实际行数) AS 实际行数,Max(开始页号) AS 开始页号,Max(开始行号) AS 开始行号,MAX(汇总类别) AS 汇总类别,MAX(汇总文本) AS 汇总文本,MAX(汇总标记) AS 汇总标记,MAX(汇总日期) AS 汇总日期,MAX(开始时点) AS 开始时点,MAX(结束时点) AS 结束时点,f_List2str(Cast(Collect(汇总值) As t_Strlist), '|') 汇总值")
        mstrSQL内 = UCase(mstrSQL内 & ",l.签名级别,l.签名人 AS 签名信息,l.交班签名人,C.记录ID,P.行数||'' AS 行数,DECODE(SIGN(P.结束页号-P.开始页号),1,DECODE(SIGN([5]-P.开始页号),1, P.结束行号,P.行数-P.结束行号 ),P.行数) AS 实际行数,P.开始页号,P.开始行号,NVL(L.汇总类别,0) AS 汇总类别,L.汇总文本,L.汇总标记,to_char(L.发生时间,'yyyy-MM-dd hh24:mi:ss')||'' AS 汇总日期,L.开始时点,L.结束时点," & str汇总值)
        mstrSQL列 = UCase(mstrSQL列 & ",签名级别,签名信息,交班签名人,记录ID,行数,实际行数,开始页号,开始行号,汇总类别,汇总文本,汇总标记,汇总日期,开始时点,结束时点,汇总值")
...
'        If mblnCorrelative = False Then mstrColCorrelative = ""
        ...
        mlngCollectValue = mlngCollectEnd + 1
...
Public Function SignMe(Optional ByVal bln审签 As Boolean = False, Optional ByVal blnExchange As Boolean = False) As Boolean
    ...
    With rsTemp
        Do While Not .EOF
            str行错误 = ""
            blnSign = SignName(Format(!发生时间, "yyyy-MM-dd HH:mm:ss"), strSignTime, bln审签, str状态, str行错误, blnExchange)
            If str行错误 <> "" Then
...
Public Sub UnSignMe(Optional ByVal bln审签 As Boolean = False)
    ...
    If Not IsNull(rsTemp!记录时间) Then
        gstrSQL = "" & _
                  " SELECT  A.项目ID AS 证书ID,B.发生时间,B.ID,B.签名人" & vbNewLine & _
                  " FROM 病人护理明细 A,病人护理数据 B" & vbNewLine & _
                  " WHERE A.记录ID=B.ID AND B.文件ID=[1] And A.记录人=[2] And A.记录时间=[3] " & _
                  " AND A.记录类型=" & IIf(bln审签, 15, 5)
        Call SQLDIY(gstrSQL)
        Set rsTemp = zlDatabase.OpenSQLRecord(gstrSQL, "提取所有数据准备取消签名或审签", mlng文件ID, gstrUserName, CDate(rsTemp!记录时间))
    Else
        gstrSQL = "" & _
                  " SELECT  A.项目ID AS 证书ID,B.发生时间,B.ID,B.签名人" & vbNewLine & _
                  " FROM 病人护理明细 A,病人护理数据 B" & vbNewLine & _
                  ...
                  " AND A.记录类型=" & IIf(bln审签, 15, 5)
        Call SQLDIY(gstrSQL)
        Set rsTemp = zlDatabase.OpenSQLRecord(gstrSQL, "提取所有数据准备取消签名或审签", mlng文件ID, gstrUserName, CStr(rsTemp!项目名称))
    End If
...
Private Function CheckFlip() As Boolean
    ...
    mintType = -1
    If mblnVerify = True Then CheckFlip = True: Exit Function
...
Private Function SaveData() As Boolean
    ...
    Dim strSQL() As String, strSQLTime() As String
...
Private Sub cbsThis_Update(ByVal Control As XtremeCommandBars.ICommandBarControl)
    ...
    Case conMenu_Edit_Import '入量导入
        Control.Enabled = Control.Visible And Not mblnArchive And Not mblnVerify And mblnEditable And mblnShow And mstrColImCorrelative <> ""
    Case conMenu_View_Jump
            ...
            If FormatValue(VsfData.TextMatrix(lngRow, mlngRowCount)) Like "*|1" Then
                ...
                'If Val(VsfData.TextMatrix(lngRow, mlngCollectType)) = 0 Then    '汇总行不允许编辑
                    ...
                    If blnSel Then
                        ...
                        End If
                        '43588:刘鹏飞,2012-09-13,添加记录单审签模式
                        If IIf(mintSignMode = 0, mintVerify < intLevel Or InStr(1, mstrMangeVerify, "护士长") > 0 And (InStr(1, VsfData.TextMatrix(lngRow, mlngSigner), "/") = 0), InStr(1, VsfData.TextMatrix(lngRow, mlngSigner), "/") = 0 And mintVerify <> 未定义) And intLevel <> 未定义 Then
                        ...
                        For lngCurRow = lngStart + lngRowCount To VsfData.Rows - 1
                            ...
                            If lngCurRow > lngNextGroupRow Then
                                ...
                                If blnSel = True Then
                                    ...
                                    End If
                                    '43588:刘鹏飞,2012-09-13,添加记录单审签模式
                                    If Not (IIf(mintSignMode = 0, mintVerify < intLevel Or InStr(1, mstrMangeVerify, "护士长") > 0 And InStr(1, VsfData.TextMatrix(lngCurRow, mlngSigner), "/") = 0, InStr(1, VsfData.TextMatrix(lngCurRow, mlngSigner), "/") = 0 And mintVerify <> 未定义) And intLevel <> 未定义) And blnTrue = True Then
...
Private Sub cmdOK_Click()
    ...
    VsfData.TextMatrix(lngStart, mlngCollectValue) = str汇总
    ...
    If lngMaxMutilRows > 0 Then
        ...
        For lngRow = lngStart To lngStart + lngMaxMutilRows - 1
            ...
            VsfData.TextMatrix(lngRow, mlngCollectValue) = VsfData.TextMatrix(lngStart, mlngCollectValue)
        Next lngRow
    End If
...
Private Sub VsfData_EnterCell()
    ...
    If mblnVerify Then  '必须放在mblnShow判断语句的上面
        If VsfData.COL = mlngYear Then Exit Sub
...
Private Sub vsfdata_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    ElseIf KeyCode = vbKeySpace And mblnVerify Then
        ...
        If mintSignMode = 0 And mintVerify >= intLevel And Not (InStr(1, mstrMangeVerify, "护士长") > 0 And InStr(1, VsfData.TextMatrix(lngStart, mlngSigner), "/") = 0) Then
        ...
        If lngDemo > 1 Then '寻找起始行
            ...
            If InStr(1, VsfData.TextMatrix(lngStart, mlngSigner), "/") <> 0 And mintSignMode = 1 Then
                ...
                Exit Sub
            End If
            If mintVerify >= intLevel And mintSignMode = 0 And Not (InStr(1, mstrMangeVerify, "护士长") > 0 And InStr(1, VsfData.TextMatrix(lngStart, mlngSigner), "/") = 0) Then
        ...
        For lngRow = lngStart + lngRowCount To VsfData.Rows - 1
            ...
            If lngRow > lngNextGroupRow Then
                ...
                If InStr(1, VsfData.TextMatrix(lngRow, mlngSigner), "/") <> 0 And mintSignMode = 1 Then
                    ...
                    Exit Sub
                End If
                If mintVerify >= intLevel And mintSignMode = 0 And Not (InStr(1, mstrMangeVerify, "护士长") > 0 And InStr(1, VsfData.TextMatrix(lngRow, mlngSigner), "/") = 0) Then
...
Private Sub txtDnInput_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = vbKeyDown And IsCanves(Val(txtDnInput.Tag)) Then
        lstSelect(2).Visible = True
        lstSelect(2).Tag = 3
        Call LstChoose(txtDnInput.Text)
        lstSelect(2).SetFocus
    End If
End Sub
...
'从医嘱导入入量，导入的入量当分组数据处理
    ...
    '返回记录集内容包含:key,名称,用量
    Set rsImpAmount = frmImportOrder.ShowMe(Me, mlng文件ID, mlng病人ID, mlng主页ID, mint婴儿, strImportOrders, strDate)
