...
Private mlngCollectValue As Long            '汇总值,判断汇总项目是否汇总
...
Private Sub DrawCollectCell(ByVal hDC As Long, ByVal ROW As Long, ByVal COL As Long, ByVal Left As Long, ByVal Top As Long, ByVal Right As Long, ByVal Bottom As Long)
    ...
    Case 2  '汇总项下双横线
        If InStr(1, "|" & mstrColCollect & ";", "|" & COL - (cHideCols + VsfData.FixedCols - 1) & ";") <> 0 And Replace(VsfData.TextMatrix(ROW, COL), " ", "") <> "" Then 'And Val(VsfData.TextMatrix(ROW, COL)) <> 0 Then
            '画线
