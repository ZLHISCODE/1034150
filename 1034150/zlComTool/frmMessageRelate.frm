...
Begin VB.Form frmMessageRelate 
   ...
   Begin RichTextLib.RichTextBox rtfContent 
      ...
      ReadOnly        =   -1  'True
      ScrollBars      =   3
      TextRTF         =   $"frmMessageRelate.frx":6852
   End
   ...
   Begin MSComctlLib.ImageList ils16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMessageRelate.frx":68EF
            Key             =   "New"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMessageRelate.frx":6A49
            Key             =   "Read"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMessageRelate.frx":6BA3
            Key             =   "NewReply"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMessageRelate.frx":6CFD
            Key             =   "ReadReply"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMessageRelate.frx":6E57
            Key             =   "High"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMessageRelate.frx":6FB1
            Key             =   "Low"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMessageRelate.frx":710B
            Key             =   "Script"
         EndProperty
      EndProperty
   End
...
'功能:装入相关消息到lvwMain
    ...
    'Get_Mail_List(消息类型,用户,显示已读,会话ID)
...
'功能:把消息的内容装入到RichText中
    ...
    rsTemp.CursorLocation = adUseClient
    Set rsTemp = zlDatabase.OpenCursor(Me.Caption, "zltools", "b_ComFunc.Get_Zlmessage", Val(Mid(lvwMain.SelectedItem.Key, 3)))
