...
Begin VB.Form frmSystemPara 
   ...
   Begin VB.Frame fraMain 
      ...
      Begin VB.Frame fra 
         ...
         Begin VB.ComboBox cmb 
            Height          =   300
            Index           =   17
            ItemData        =   "frmSystemPara.frx":0010
            Left            =   1605
            List            =   "frmSystemPara.frx":0012
            Style           =   2  'Dropdown List
            TabIndex        =   227
            Top             =   872
            Width           =   1780
         ...
         Begin VB.ComboBox cmb 
            Height          =   300
            Index           =   9
            ItemData        =   "frmSystemPara.frx":0014
            Left            =   1605
            List            =   "frmSystemPara.frx":0016
            Style           =   2  'Dropdown List
            TabIndex        =   27
            Top             =   546
            Width           =   1780
      ...
      Begin VB.Frame fra 
         ...
         Begin VB.CheckBox chk 
            ...
            Width           =   2895
         End
         Begin MSComCtl2.DTPicker dtpRegistOpenTime 
            Height          =   315
            Left            =   1740
            TabIndex        =   13
            Top             =   3660
         ...
         End
         Begin VB.CheckBox chk 
            Caption         =   $"frmSystemPara.frx":0018
            Height          =   195
            Index           =   31
            Left            =   165
            TabIndex        =   25
   ...
   Begin VB.Frame fraMain 
      ...
      Begin VB.Frame frmOther 
         ...
         Begin TabDlg.SSTab stbOther 
            ...
            TabHeight       =   520
            TabCaption(0)   =   "手术"
            TabPicture(0)   =   "frmSystemPara.frx":0036
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "frmOPS"
            Tab(0).Control(0).Enabled=   0   'False
            Tab(0).ControlCount=   1
            TabCaption(1)   =   "抗菌药"
            TabPicture(1)   =   "frmSystemPara.frx":0052
            Tab(1).ControlEnabled=   0   'False
            Tab(1).Control(0)=   "fraKSSStrict"
            Tab(1).ControlCount=   1
            TabCaption(2)   =   "输血"
            TabPicture(2)   =   "frmSystemPara.frx":006E
            Tab(2).ControlEnabled=   0   'False
            Tab(2).Control(0)=   "fraEnableBlood"
            Tab(2).Control(1)=   "fraBlood"
            Tab(2).ControlCount=   2
            TabCaption(3)   =   "医嘱超量"
            TabPicture(3)   =   "frmSystemPara.frx":008A
            Tab(3).ControlEnabled=   0   'False
            Tab(3).Control(0)=   "fraCLKS"
            Tab(3).ControlCount=   1
            TabCaption(4)   =   "申请单"
            TabPicture(4)   =   "frmSystemPara.frx":00A6
            Tab(4).ControlEnabled=   0   'False
            Tab(4).Control(0)=   "Label18"
            Tab(4).Control(1)=   "frmApply(0)"
            Tab(4).Control(2)=   "frmApply(1)"
            Tab(4).Control(3)=   "chk(103)"
            Tab(4).Control(4)=   "chk(104)"
            Tab(4).ControlCount=   5
            Begin VB.Frame fraEnableBlood 
               Height          =   1380
               Left            =   -74925
               TabIndex        =   417
               Top             =   1020
            ...
            Begin VB.Frame fraCLKS 
               ...
               Begin VSFlex8Ctl.VSFlexGrid vsUnWriteDept 
                  ...
                  FormatString    =   $"frmSystemPara.frx":00C2
                  ScrollTrack     =   0   'False
                  ScrollBars      =   3
                  ScrollTips      =   0   'False
                  MergeCells      =   0
      ...
      Begin VB.Frame fra 
         ...
         Begin VB.CheckBox chk 
            ...
            Left            =   2880
            TabIndex        =   422
            ToolTipText     =   "用于自由录入的医嘱也可以登记执行情况"
            Top             =   2040
            Width           =   1785
         End
         Begin VB.CheckBox chk 
         ...
         Begin TabDlg.SSTab SendPriceType 
            ...
            TabMaxWidth     =   882
            TabCaption(0)   =   "门诊"
            TabPicture(0)   =   "frmSystemPara.frx":0178
            Tab(0).ControlEnabled=   0   'False
            Tab(0).Control(0)=   "lst(4)"
            Tab(0).ControlCount=   1
            TabCaption(1)   =   "住院"
            TabPicture(1)   =   "frmSystemPara.frx":0194
            ...
            Begin VB.ListBox lst 
               ...
               IMEMode         =   3  'DISABLE
               Index           =   4
               ItemData        =   "frmSystemPara.frx":01B0
               Left            =   -74925
               List            =   "frmSystemPara.frx":01B2
               Style           =   1  'Checkbox
               TabIndex        =   270
               Top             =   360
               Width           =   5475
            ...
            Begin VB.ListBox lst 
               ...
               IMEMode         =   3  'DISABLE
               Index           =   2
               ItemData        =   "frmSystemPara.frx":01B4
               Left            =   75
               List            =   "frmSystemPara.frx":01B6
               Style           =   1  'Checkbox
               TabIndex        =   269
               Top             =   360
               Width           =   5475
      ...
      Begin VB.Frame fraCheckDrug 
         ...
         Begin VB.ComboBox cmb 
            ...
            Height          =   300
            Index           =   27
            ItemData        =   "frmSystemPara.frx":01B8
            Left            =   1260
            List            =   "frmSystemPara.frx":01BA
            Style           =   2  'Dropdown List
            TabIndex        =   306
            Top             =   1320
            Width           =   1770
         ...
         Begin VB.ComboBox cmb 
            Height          =   300
            Index           =   20
            ItemData        =   "frmSystemPara.frx":01BC
            Left            =   1260
            List            =   "frmSystemPara.frx":01BE
            Style           =   2  'Dropdown List
            TabIndex        =   259
            Top             =   37
            Width           =   1410
      ...
      Begin VB.Frame fra 
         ...
         Begin VB.ComboBox cmb 
            Height          =   300
            Index           =   16
            ItemData        =   "frmSystemPara.frx":01C0
            Left            =   3480
            List            =   "frmSystemPara.frx":01C2
            Style           =   2  'Dropdown List
            TabIndex        =   84
         ...
         Begin VB.ComboBox cmb 
            Height          =   300
            Index           =   8
            ItemData        =   "frmSystemPara.frx":01C4
            Left            =   720
            List            =   "frmSystemPara.frx":01C6
            Style           =   2  'Dropdown List
            TabIndex        =   83
            ToolTipText     =   "影响范围：入出院，医生工作站"
            Top             =   540
         ...
         Begin VB.ComboBox cmb 
            Height          =   300
            Index           =   1
            ItemData        =   "frmSystemPara.frx":01C8
            Left            =   720
            List            =   "frmSystemPara.frx":01CA
            Style           =   2  'Dropdown List
            TabIndex        =   82
      ...
      Begin VB.Frame fra 
         ...
         End
         Begin VB.CheckBox chk 
            Caption         =   $"frmSystemPara.frx":01CC
            Height          =   255
            Index           =   79
            Left            =   240
            TabIndex        =   258
         ...
         Begin VB.ComboBox cmb 
            Height          =   300
            Index           =   10
            ItemData        =   "frmSystemPara.frx":01F0
            Left            =   1020
            List            =   "frmSystemPara.frx":01F2
            Style           =   2  'Dropdown List
            TabIndex        =   64
            Top             =   255
            Width           =   1740
   ...
   Begin VB.Frame fraMain 
      ...
      Begin VB.ComboBox cmb 
         Height          =   300
         Index           =   11
         ItemData        =   "frmSystemPara.frx":01F4
         Left            =   960
         List            =   "frmSystemPara.frx":01F6
         Style           =   2  'Dropdown List
         TabIndex        =   277
         Top             =   97
         Width           =   3540
      ...
      Begin TabDlg.SSTab sstSign 
         ...
         TabPicture(0)   =   "frmSystemPara.frx":01F8
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "vsDept(0)"
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "住院医生医嘱,病历"
         TabPicture(1)   =   "frmSystemPara.frx":0214
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "vsDept(1)"
         Tab(1).ControlCount=   1
         TabCaption(2)   =   "住院护士医嘱"
         TabPicture(2)   =   "frmSystemPara.frx":0230
         Tab(2).ControlEnabled=   0   'False
         Tab(2).Control(0)=   "vsDept(2)"
         Tab(2).ControlCount=   1
         TabCaption(3)   =   "医技医嘱,报告"
         TabPicture(3)   =   "frmSystemPara.frx":024C
         Tab(3).ControlEnabled=   0   'False
         Tab(3).Control(0)=   "vsDept(3)"
         Tab(3).ControlCount=   1
         TabCaption(4)   =   "护理记录,护理病历"
         TabPicture(4)   =   "frmSystemPara.frx":0268
         Tab(4).ControlEnabled=   0   'False
         Tab(4).Control(0)=   "vsDept(4)"
         Tab(4).ControlCount=   1
         TabCaption(5)   =   "药品发药"
         TabPicture(5)   =   "frmSystemPara.frx":0284
         Tab(5).ControlEnabled=   0   'False
         Tab(5).Control(0)=   "vsDept(5)"
         Tab(5).ControlCount=   1
         TabCaption(6)   =   "LIS"
         TabPicture(6)   =   "frmSystemPara.frx":02A0
         Tab(6).ControlEnabled=   0   'False
         Tab(6).Control(0)=   "vsDept(6)"
         Tab(6).ControlCount=   1
         TabCaption(7)   =   "PACS"
         TabPicture(7)   =   "frmSystemPara.frx":02BC
         Tab(7).ControlEnabled=   0   'False
         Tab(7).Control(0)=   "vsDept(7)"
         Tab(7).ControlCount=   1
         TabCaption(8)   =   "血库"
         TabPicture(8)   =   "frmSystemPara.frx":02D8
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsDept 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"frmSystemPara.frx":02F4
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsDept 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"frmSystemPara.frx":0387
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsDept 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"frmSystemPara.frx":041A
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsDept 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"frmSystemPara.frx":04AD
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsDept 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"frmSystemPara.frx":0540
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsDept 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"frmSystemPara.frx":05D3
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsDept 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"frmSystemPara.frx":0666
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsDept 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"frmSystemPara.frx":06F9
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsDept 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"frmSystemPara.frx":078C
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
   ...
   Begin VB.Frame fraMain 
      ...
      Begin VB.ComboBox cmb 
         Height          =   300
         Index           =   25
         ItemData        =   "frmSystemPara.frx":081F
         Left            =   7830
         List            =   "frmSystemPara.frx":0821
         Style           =   2  'Dropdown List
         TabIndex        =   91
         Top             =   3750
         Width           =   1815
      ...
      Begin VB.CommandButton cmdOneCard 
         ...
         Index           =   0
         Left            =   5040
         Picture         =   "frmSystemPara.frx":0823
         Style           =   1  'Graphical
         TabIndex        =   236
         ToolTipText     =   "增加一种前缀"
         Top             =   7605
      ...
      Begin VB.CommandButton cmdOneCard 
         ...
         Index           =   1
         Left            =   5400
         Picture         =   "frmSystemPara.frx":0DAD
         Style           =   1  'Graphical
         TabIndex        =   235
         ToolTipText     =   "修改当前前缀"
         Top             =   7605
      ...
      Begin VB.CommandButton cmdOneCard 
         ...
         Index           =   2
         Left            =   5760
         Picture         =   "frmSystemPara.frx":1337
         Style           =   1  'Graphical
         TabIndex        =   234
         ToolTipText     =   "删除当前前缀"
         Top             =   7605
   ...
   Begin VB.Frame fraMain 
      ...
      Begin VB.Image Image1 
         Height          =   480
         Left            =   480
         Picture         =   "frmSystemPara.frx":18C1
         Top             =   90
         Width           =   480
      End
      ...
      Begin MSComctlLib.ImageList ils16 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmSystemPara.frx":1F42
               Key             =   "Limit"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmSystemPara.frx":2394
               Key             =   "bm"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmSystemPara.frx":292E
               Key             =   "社区"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmSystemPara.frx":2EC8
               Key             =   "UnCheck"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmSystemPara.frx":3462
               Key             =   "AllCheck"
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Frame fraMain 
      ...
      Begin VB.Label Label1 
         BackStyle       =   0  'Transparent
         Caption         =   $"frmSystemPara.frx":39FC
         Height          =   555
         Left            =   135
         TabIndex        =   188
         Top             =   7215
   ...
   Begin VB.Frame fraMain 
      ...
      Begin TabDlg.SSTab sstabDigit 
         ...
         EndProperty
         TabCaption(0)   =   "  录入精度"
         TabPicture(0)   =   "frmSystemPara.frx":3ADD
         Tab(0).ControlEnabled=   -1  'True
         ...
         Begin VB.Label Label23 
            Caption         =   $"frmSystemPara.frx":3AF9
            BeginProperty Font 
               Name            =   "宋体"
               Size            =   10.5
               Charset         =   134
   ...
   Begin VB.Frame fraMain 
      ...
      Begin VB.Frame fra门诊结帐 
         ...
         Begin VB.ComboBox cmb 
            Height          =   300
            Index           =   21
            ItemData        =   "frmSystemPara.frx":3B82
            Left            =   1920
            List            =   "frmSystemPara.frx":3B84
            Style           =   2  'Dropdown List
            TabIndex        =   406
         ...
         Begin VB.ComboBox cmb 
            Height          =   300
            Index           =   24
            ItemData        =   "frmSystemPara.frx":3B86
            Left            =   1920
            List            =   "frmSystemPara.frx":3B88
            Style           =   2  'Dropdown List
            TabIndex        =   405
      ...
      Begin VB.Frame FraChangeDept 
         ...
         Begin VB.ComboBox cmb 
            Height          =   300
            Index           =   29
            ItemData        =   "frmSystemPara.frx":3B8A
            Left            =   1905
            List            =   "frmSystemPara.frx":3B8C
            Style           =   2  'Dropdown List
            TabIndex        =   116
            Top             =   570
            Width           =   2205
         ...
         Begin VB.ComboBox cmb 
            Height          =   300
            Index           =   28
            ItemData        =   "frmSystemPara.frx":3B8E
            Left            =   1905
            List            =   "frmSystemPara.frx":3B90
            Style           =   2  'Dropdown List
            TabIndex        =   115
            Top             =   195
            Width           =   2205
      ...
      Begin VB.ComboBox cboPatiVerfy 
         Height          =   300
         ItemData        =   "frmSystemPara.frx":3B92
         Left            =   5925
         List            =   "frmSystemPara.frx":3B94
         Style           =   2  'Dropdown List
         TabIndex        =   125
         Top             =   3960
         Width           =   3660
      ...
      Begin VB.Frame fra出院检查副 
         ...
         Begin VB.ComboBox cmb 
            Height          =   300
            Index           =   6
            ItemData        =   "frmSystemPara.frx":3B96
            Left            =   1080
            List            =   "frmSystemPara.frx":3B98
            Style           =   2  'Dropdown List
            TabIndex        =   121
            ToolTipText     =   "在病人结帐以及病人入出管理中出院时检查"
            Top             =   675
         ...
         Begin VB.ComboBox cmb 
            Height          =   300
            Index           =   19
            ItemData        =   "frmSystemPara.frx":3B9A
            Left            =   1080
            List            =   "frmSystemPara.frx":3B9C
            Style           =   2  'Dropdown List
            TabIndex        =   120
            ToolTipText     =   "在病人入出管理中转科时检查"
            Top             =   315
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsUnCheckItem 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"frmSystemPara.frx":3B9E
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.Frame fra出院检查 
         ...
         Begin VB.ComboBox cmb 
            Height          =   300
            Index           =   23
            ItemData        =   "frmSystemPara.frx":3BDC
            Left            =   1080
            List            =   "frmSystemPara.frx":3BDE
            Style           =   2  'Dropdown List
            TabIndex        =   118
            ToolTipText     =   "在病人入出管理中转科时检查"
            Top             =   240
         ...
         Begin VB.ComboBox cmb 
            Height          =   300
            Index           =   22
            ItemData        =   "frmSystemPara.frx":3BE0
            Left            =   1080
            List            =   "frmSystemPara.frx":3BE2
            Style           =   2  'Dropdown List
            TabIndex        =   119
            ToolTipText     =   "在病人结帐以及病人入出管理中出院时检查"
            Top             =   600
      ...
      Begin VB.Frame fra结帐 
         ...
         Begin VB.ComboBox cmb 
            Height          =   300
            Index           =   5
            ItemData        =   "frmSystemPara.frx":3BE4
            Left            =   1410
            List            =   "frmSystemPara.frx":3BE6
            Style           =   2  'Dropdown List
            TabIndex        =   113
            Top             =   270
            Width           =   2715
...
'    chk_时价药品取上次售价 = 73
    ...
    chk_申请单启用环节住院检验 = 101
    chk_申请单启用环节住院输血 = 100
    chk_启用申请单后必须使用申请单下达医嘱门诊 = 103
    chk_启用申请单后必须使用申请单下达医嘱住院 = 104
    chk_诊断手术名称自由调整 = 98
    chk_路径变异原因从字典表中选取 = 99
    chk_身份证号码加密显示 = 105
    chk_同一身份证对应一个建档病人 = 110
    chk_专家号挂号限制 = 178
    chk_专家号预约限制 = 179
    chk_启用医学影像信息系统专业版接口 = 106
    chk_新开医嘱签名时一组医嘱签名一次 = 108
    
    chk_刷卡消费须定位到密码框 = 180
    chk_门诊费用转住院预交票据打印控制 = 111
...
Private Enum constCmb
    ...
    cmb_出院时未发药项目检查 = 22
    cmb_转科时未发药项目检查 = 23
    cmb_门诊结帐未执行诊疗项目检查 = 24
    cmb_门诊费用转住院预交发票格式 = 25
    cmd_中药配方 = 26
    cmd_过敏输入来源 = 27
    cmd_转科时未审核销帐单据 = 28
    cmd_出院时超期护理数据 = 29
...
Private mblnLoad As Boolean, mblnNotChange As Boolean
Private mintColumn As Integer, mblnInstantActive As Boolean
...
Private Sub cmdInstantActive_Click()
    ...
    Call zlDatabase.SetPara("挂号排班模式", strValue, glngSys)
...
Private Sub chkRA_Click(Index As Integer)
    If Me.Visible = False Then Exit Sub

    Select Case Index
    Case Val("0-门诊处方审查")
        If chkRA(Index).Value = 0 Then
            '检查最近未审查的记录
        ...
        txtRA(Val("0-离岗时长")).Enabled = chkRA(Index).Value = 1
        optOpporunity(1).Enabled = chkRA(Index).Value = 1
        optOpporunity(2).Enabled = chkRA(Index).Value = 1
        
        If chkRA(Index).Value = 0 Then chkRA(Val("1-提醒门诊医生")).Value = 0
        chkRA(Val("1-提醒门诊医生")).Enabled = chkRA(Index).Value = 1
    Case Val("2-住院药嘱审查")
        If chkRA(Index).Value = 0 Then
            '检查最近未审查的记录
        ...
        If chkRA(Index).Value = 0 Then chkRA(Val("3-提醒住院医生")).Value = 0
        chkRA(Val("3-提醒住院医生")).Enabled = chkRA(Index).Value = 1
    End Select
End Sub

Private Sub chkRA_KeyPress(Index As Integer, KeyAscii As Integer)
    If KeyAscii = vbKeyReturn Then zlCommFun.PressKey vbKeyTab
End Sub
...
Private Sub InitEnv()
    ...
    cmb(cmb_药品出库优先算法).AddItem "2-按批号最近先出"
    ...
    cmb(cmb_合理用药接口).AddItem "4-广州保进"
    cmb(cmb_合理用药接口).AddItem "5-杭州逸曜"
    ...
    cmb(cmb_门诊结帐未发药品检查).AddItem "0-不检查"
    cmb(cmb_门诊结帐未发药品检查).AddItem "1-检查并提示"
    cmb(cmb_门诊结帐未发药品检查).AddItem "2-检查并禁止"
    cmb(cmb_门诊结帐未发药品检查).ListIndex = 0
    
    cmb(cmb_门诊结帐未执行诊疗项目检查).AddItem "0-不检查"
    cmb(cmb_门诊结帐未执行诊疗项目检查).AddItem "1-检查并提示"
    cmb(cmb_门诊结帐未执行诊疗项目检查).AddItem "2-检查并禁止"
    cmb(cmb_门诊结帐未执行诊疗项目检查).ListIndex = 0
    ...
    If Not mobjESign Is Nothing Then
        ...
        For i = LBound(arrTemp) To UBound(arrTemp)
            cmb(cmb_电子签名认证中心).AddItem arrTemp(i)
        Next
        If cmb(cmb_电子签名认证中心).ListCount > 0 Then cmb(cmb_电子签名认证中心).ListIndex = 0
    End If
    ...
    Call OpenRecordset(rsTmp, Me.Caption)
    cmb(cmb_输血采集诊疗检验类型).Clear
    i = 0
    Do While Not rsTmp.EOF
        cmb(cmb_输血采集诊疗检验类型).AddItem rsTmp!编码 & "-" & rsTmp!名称
        If Val("" & rsTmp!缺省标志) = 1 Then
            cmb(cmb_输血采集诊疗检验类型).ListIndex = cmb(cmb_输血采集诊疗检验类型).NewIndex
        End If
        If "" & rsTmp!名称 = "血常规" Then i = cmb(cmb_输血采集诊疗检验类型).NewIndex
        rsTmp.MoveNext
    Loop
    If cmb(cmb_输血采集诊疗检验类型).ListIndex = -1 And cmb(cmb_输血采集诊疗检验类型).ListCount > 0 Then
        cmb(cmb_输血采集诊疗检验类型).ListIndex = i
    End If
    cmb(cmb_输血采集诊疗检验类型).Tag = cmb(cmb_输血采集诊疗检验类型).ListIndex
    zlControl.CboSetWidth cmb(cmb_输血采集诊疗检验类型).hwnd, 2000
    Exit Sub
ErrHandle:
    If ErrCenter() = 1 Then
        Resume
...
'系统参数表
    ...
    Do Until rsTemp.EOF
        ...
        Case 265
            cmb(cmb_门诊结帐未发药品检查).ListIndex = zlCommFun.Nvl(rsTemp("参数值"), 0)
        Case 266
            cmb(cmb_门诊结帐未执行诊疗项目检查).ListIndex = zlCommFun.Nvl(rsTemp("参数值"), 0)
        Case 23    '已结帐单据操作
        ...
        Case 26    '电子签名使用场合
            ...
            If Len(Nvl(rsTemp!参数值)) > 7 Then
                chk(chk_电子签名控制_血库).Value = Val(Mid(Nvl(rsTemp!参数值), 8, 1))
            Else
                chk(chk_电子签名控制_血库).Value = 0
            End If
        Case 27    '住院药嘱发送产生领药号
...
'            chk(chk_时价药品取上次售价).Value = zlCommFun.Nvl(rsTemp("参数值"), 0)
        Case 186  '输血和皮试医嘱执行后需要核对
            strTemp = zlCommFun.Nvl(rsTemp("参数值"), "00")
            chk(chk_输血核对).Value = Mid(strTemp, 1, 1)
            chk(chk_皮试核对).Value = Mid(strTemp, 2, 1)
        Case 187
        ...
        Case 220    '允许修改n天内登记的医嘱执行记录
            ...
            End If
        Case 221
            If Val(zlCommFun.Nvl(rsTemp("参数值"), 0)) = -1 Then
                opt结存方式(0).Value = True
                opt结存方式(0).Enabled = True
                fra自动结存方式.Enabled = False
            ElseIf Val(zlCommFun.Nvl(rsTemp("参数值"), 0)) = 0 Then
                opt结存方式(1).Enabled = True
                fra自动结存方式.Enabled = True
        ...
        Case 228
            ...
            If Not mobjPass Is Nothing Then
                cmdSet.Visible = mobjPass.SetEnabled(cmb(cmb_合理用药接口).ListIndex, strTemp)
            End If
        Case 230
        ...
        Case 236
            chk(chk_启用血库管理系统).Value = IIF(Val(zlCommFun.Nvl(rsTemp!参数值)) = 1, 1, 0)
            strTemp = "Select 1 From zlSystems Where 编号=[1]"
            Set rsTmp = zlDatabase.OpenSQLRecord(strTemp, Me.Caption, 2200)
'            chk(chk_启用血库管理系统).Visible = Not rsTmp.EOF
            fraEnableBlood.Visible = Not rsTmp.EOF
        Case 238
            strTemp = zlCommFun.Nvl(rsTemp("参数值"), "11|11|11")
            Call Set申请单启用环节(strTemp)
        Case 239
            chk(chk_新开医嘱签名时一组医嘱签名一次).Value = IIF(Val(zlCommFun.Nvl(rsTemp!参数值)) = 1, 1, 0)
        Case 240
            chk(chk_医嘱用药天数反算).Value = Val(zlCommFun.Nvl(rsTemp("参数值"), 0))
        Case 241    '处方审查管理
            strTemp = zlCommFun.Nvl(rsTemp!参数值, "0")
            Select Case Val(strTemp)
            Case 1      '门诊启用，住院不启用
                chkRA(Val("0-门诊处方审查")).Value = 1
                chkRA(Val("2-住院药嘱审查")).Value = 0
                chkRA(Val("3-提醒住院医生")).Enabled = False
            Case 2      '门诊不启用，住院启用
                chkRA(Val("0-门诊处方审查")).Value = 0
                chkRA(Val("2-住院药嘱审查")).Value = 1
                chkRA(Val("1-提醒门诊医生")).Enabled = True
                optOpporunity(1).Enabled = False
                optOpporunity(2).Enabled = False
                txtRA(Val("0-离岗时长")).Enabled = False
            Case 3      '门诊、住院都启用
                chkRA(Val("0-门诊处方审查")).Value = 1
                chkRA(Val("2-住院药嘱审查")).Value = 1
            Case Else   '门诊、住院都不启用
                ...
                chkRA(Val("2-住院药嘱审查")).Value = 0
                chkRA(Val("3-提醒住院医生")).Enabled = False
                chkRA(Val("1-提醒门诊医生")).Enabled = False
                optOpporunity(1).Enabled = False
                optOpporunity(2).Enabled = False
                txtRA(Val("0-离岗时长")).Enabled = False
            End Select
        Case 242    '门诊审方时机
            strTemp = zlCommFun.Nvl(rsTemp!参数值, "1")
            If Val(strTemp) = 1 Then
                optOpporunity(1).Value = True
                fraOpporunity.Tag = "1"
            Else
                If Val(zlCommFun.Nvl(rsTemp!参数值)) = 2 Then
            ...
            End If
        Case 243    '门诊药师离岗时长
            txtRA(Val("0-门诊药师离岗时长")).Text = Trim(zlCommFun.Nvl(rsTemp!参数值))
        Case 245    '提醒门诊医生不合格医嘱
            chkRA(1).Value = IIF(Val(zlCommFun.Nvl(rsTemp!参数值)) = 0, 0, 1)
        Case 246    '提醒住院医生不合格医嘱
            chkRA(3).Value = IIF(Val(zlCommFun.Nvl(rsTemp!参数值)) = 0, 0, 1)
        Case 247
            chk(chk_身份证号码加密显示).Value = Val(zlCommFun.Nvl(rsTemp("参数值"), 0))
        Case 251
            chk(chk_病人地址结构化录入).Value = IIF(Val(zlCommFun.Nvl(rsTemp("参数值"), 0)) = 0, 0, 1)
        Case 252
            chk(chk_乡镇地址结构化录入).Value = IIF(Val(zlCommFun.Nvl(rsTemp("参数值"), 0)) = 0, 0, 1)
        Case 253
            chk(chk_外院医生必须先建档).Value = IIF(Val(zlCommFun.Nvl(rsTemp("参数值"), 0)) = 0, 0, 1)
        Case 254
            chk(chk_主刀医师达到手术等级无需审核).Value = IIF(Val(zlCommFun.Nvl(rsTemp!参数值)) = 1, 1, 0)
        Case 255
            chk(chk_启用医学影像信息系统专业版接口).Value = IIF(Val(zlCommFun.Nvl(rsTemp("参数值"), 0)) = 0, 0, 1)
        Case 257
            chk(chk_诊断手术名称自由调整).Value = IIF(Val(zlCommFun.Nvl(rsTemp!参数值)) = 1, 1, 0)
        Case 259
            chk(chk_路径变异原因从字典表中选取).Value = IIF(Val(zlCommFun.Nvl(rsTemp!参数值)) = 1, 1, 0)
        Case 260
            strTemp = zlCommFun.Nvl(rsTemp("参数值"), "11")
            chk(chk_启用申请单后必须使用申请单下达医嘱门诊).Value = Mid(strTemp, 1, 1)
            chk(chk_启用申请单后必须使用申请单下达医嘱住院).Value = Mid(strTemp, 2, 1)
        Case 263
            strTemp = zlCommFun.Nvl(rsTemp("参数值"), 0)
            txt(chk_专家号挂号限制).Text = Val(strTemp)
            chk(chk_专家号挂号限制).Value = IIF(Val(strTemp) <> 0, 1, 0)
            If chk(chk_专家号挂号限制).Value = 1 Then
                txt(chk_专家号挂号限制).Enabled = True
            Else
                txt(chk_专家号挂号限制).Enabled = False
                txt(chk_专家号挂号限制).Text = ""
            End If
        Case 264
            strTemp = zlCommFun.Nvl(rsTemp("参数值"), 0)
            txt(chk_专家号预约限制).Text = Val(strTemp)
            chk(chk_专家号预约限制).Value = IIF(Val(strTemp) <> 0, 1, 0)
            If chk(chk_专家号预约限制).Value = 1 Then
                txt(chk_专家号预约限制).Enabled = True
            Else
                txt(chk_专家号预约限制).Enabled = False
                txt(chk_专家号预约限制).Text = ""
            End If
        Case 256    '挂号排班模式
            If Val(Split(rsTemp!参数值 & "|", "|")(0)) = 0 Then
                mblnNotChange = True
                optRegistPlanMode(0).Value = 1
                optRegistPlanMode(1).Value = 0
                mblnNotChange = False
                dtpRegistPlanMode.Enabled = False
                strSQL = "Select Max(发生时间) As 最大时间 From 病人挂号记录 Where 记录状态 =1 And 发生时间 >= [1] And 发生时间 Is Not Null And 出诊记录Id Is Null"
                Set rsCheck = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, zlDatabase.Currentdate)
                If IsNull(rsCheck!最大时间) Then
                    dtpRegistPlanMode.Value = zlDatabase.Currentdate
                Else
                    dtpRegistPlanMode.Value = CDate(rsCheck!最大时间)
                End If
            Else
                mblnNotChange = True
                optRegistPlanMode(0).Value = 0
                ...
                If Split(rsTemp!参数值 & "|", "|")(1) = "" Then
                    ...
                    End If
                Else
                    dtpRegistPlanMode.Value = CDate(Split(rsTemp!参数值 & "|", "|")(1))
                End If
            End If
            ...
            End If
        Case 270
            chk(chk_预约排队按时点显示).Value = Val(zlCommFun.Nvl(rsTemp("参数值"), 0))
        Case 272
            chk(chk_用血医嘱发送后才能发血).Value = IIF(Val(zlCommFun.Nvl(rsTemp("参数值"), 0)) = 0, 0, 1)
        Case 273
            Call zlControl.CboLocate(cmb(cmb_输血采集诊疗检验类型), zlCommFun.Nvl(rsTemp("参数值")))
        Case 276
            chk(chk_刷卡消费须定位到密码框).Value = Val(zlCommFun.Nvl(rsTemp("参数值"), 0))
        Case 277 '号源开放时间
            dtpRegistOpenTime.Value = Format(zlCommFun.Nvl(rsTemp!参数值, rsTemp!缺省值), "HH:mm:ss")
        Case 279
            chk(chk_同一身份证对应一个建档病人).Value = Val(zlCommFun.Nvl(rsTemp("参数值"), 0))
        Case 283
            chk(chk_门诊费用转住院预交票据打印控制).Value = Val(zlCommFun.Nvl(rsTemp("参数值"), 0))
        Case 284
            i = Val(zlCommFun.Nvl(rsTemp("参数值"), 0))
            If i >= 0 And i < cmb(cmb_门诊费用转住院预交发票格式).ListCount Then
                cmb(cmb_门诊费用转住院预交发票格式).ListIndex = i
            End If
        Case 286
            chk(chk_输血申请不显示血液库存).Value = IIF(Val(zlCommFun.Nvl(rsTemp("参数值"), 0)) = 0, 0, 1)
        Case 288
            chk(chk_叮嘱发送执行).Value = IIF(Val(zlCommFun.Nvl(rsTemp("参数值"), 0)) = 0, 0, 1)
        Case 293
            chk(chk_下达用血申请时确定发血信息).Value = IIF(Val(zlCommFun.Nvl(rsTemp("参数值"), 0)) = 0, 0, 1)
        End Select
        rsTemp.MoveNext
    Loop
    ...
    Call LoadSign
    optInExseCharge(Val(zlDatabase.GetPara("记帐报警包含所有住院划价费用", glngSys, 1150, "0", Array(optInExseCharge, lblInExseCharge), True))).Value = True
    chk(chk_备货卫材输入条码).Value = Val(zlDatabase.GetPara("备货卫材只能输内部条码", glngSys, 1257, 0, chk(chk_备货卫材输入条码), True))
...
'                        .TextMatrix(.Rows - 1, 1) = "其他"
    ...
    gstrSQL = "" & vbCrLf & _
            "   SELECT b.id,nvl(b.编码,'') 编码,nvl(b.名称,'') 名称,a.服务对象,a.工作性质" & vbCrLf & _
            "          FROM 部门性质说明 A, 部门表 B" & vbCrLf & _
            " WHERE B.ID=A.部门ID AND A.工作性质 IN ('制剂室', '中药房', '西药房', '成药房') And (B.撤档时间=to_date('3000-01-01','yyyy-mm-dd') or B.撤档时间 is null)  order by 编码"
    Call zlDatabase.OpenRecordset(rsTemp, gstrSQL, Me.Caption)
    Bill药房配药控制.Rows = 1
    Do Until rsTemp.EOF
        With Bill药房配药控制
...
'        End With
    ...
    If Val(txtRA(0).Text) < 5 Or Val(txtRA(0).Text) > 99 Then
        MsgBox "门诊药师审方离岗时长范围（5-99）！", vbInformation, gstrSysName
        txtRA(0).Text = 10
        Call ShowTab(18)
        Exit Function
    End If
    If optOpporunity(1).Value = False And optOpporunity(2).Value = False And chkRA(0).Value = 1 Then
        MsgBox "请选择门诊药师审方的介入时机！", vbInformation, gstrSysName
        optOpporunity(1).SetFocus
        Call ShowTab(18)
        Exit Function
    End If
...
Private Function Save数据() As Boolean
    ...
    '保存“影像信息系统”启用控制
    If chk(chk_启用医学影像信息系统专业版接口).Value = 1 Then Call SaveRisEnable
...
'    strTemp = strTemp & "54," & chk(chk_时价药品入库).Value & ","
    ...
    strTemp = strTemp & "265," & (cmb(cmb_门诊结帐未发药品检查).ListIndex) & ","
    strTemp = strTemp & "266," & (cmb(cmb_门诊结帐未执行诊疗项目检查).ListIndex) & ","
    ...
    strTemp = strTemp & "26," & chk(chk_电子签名控制_门诊).Value & chk(chk_电子签名控制_住院).Value & chk(chk_电子签名控制_医技).Value & chk(chk_电子签名控制_护理).Value & chk(chk_电子签名控制_药品).Value & chk(chk_电子签名控制_lis).Value & chk(chk_电子签名控制_pacs).Value & chk(chk_电子签名控制_血库).Value & ","
    ...
    strTemp = strTemp & "251," & chk(chk_病人地址结构化录入).Value & ","
    strTemp = strTemp & "252," & chk(chk_乡镇地址结构化录入).Value & ","
    strTemp = strTemp & "253," & chk(chk_外院医生必须先建档).Value & ","
...
'    strTemp = strTemp & "183," & chk(chk_时价药品取上次售价).Value & ","
    strTemp = strTemp & "186," & chk(chk_输血核对).Value & chk(chk_皮试核对).Value & ","
    ...
    strTemp = strTemp & "254," & chk(chk_主刀医师达到手术等级无需审核).Value & ","
    ...
    '启用大通合理用药接口才保存
    strTemp = strTemp & "225," & IIF(cmb(cmb_合理用药接口).ListIndex = 2 Or cmb(cmb_合理用药接口).ListIndex = 4, chk(chk_启用接口调用日志).Value, 0) & ","
    ...
    If InStr(",1,2,", "," & cmb(cmb_合理用药接口).ListIndex & ",") > 0 Then
    ...
    strTemp = strTemp & "236," & chk(chk_启用血库管理系统).Value & ","
    strTemp = strTemp & "238," & Get申请单启用环节 & ","
    strTemp = strTemp & "239," & chk(chk_新开医嘱签名时一组医嘱签名一次).Value & ","
    strTemp = strTemp & "240," & chk(chk_医嘱用药天数反算).Value & ","
    
    strTemp = strTemp & "241," & GetRA_Switch() & ","
    strTemp = strTemp & "242," & IIF(optOpporunity(1).Value, "1", "2") & ","
    strTemp = strTemp & "243," & Trim(txtRA(Val("0-离岗时长")).Text) & ","
    strTemp = strTemp & "245," & chkRA(Val("1-门诊提醒")).Value & ","
    strTemp = strTemp & "246," & chkRA(Val("3-住院提醒")).Value & ","
    
    strTemp = strTemp & "247," & chk(chk_身份证号码加密显示).Value & ","
    strTemp = strTemp & "255," & chk(chk_启用医学影像信息系统专业版接口).Value & ","
    strTemp = strTemp & "257," & chk(chk_诊断手术名称自由调整).Value & ","
    strTemp = strTemp & "259," & chk(chk_路径变异原因从字典表中选取).Value & ","
    strTemp = strTemp & "260," & chk(chk_启用申请单后必须使用申请单下达医嘱门诊).Value & chk(chk_启用申请单后必须使用申请单下达医嘱住院).Value & ","
    strTemp = strTemp & "263," & IIF(chk(chk_专家号挂号限制).Value = 0, 0, Val(txt(chk_专家号挂号限制).Text)) & ","
    strTemp = strTemp & "264," & IIF(chk(chk_专家号预约限制).Value = 0, 0, Val(txt(chk_专家号预约限制).Text)) & ","
    If optRegistPlanMode(0).Value = True Then
        strTemp = strTemp & "256," & "0" & ","
    Else
        strTemp = strTemp & "256," & "1|" & Format(dtpRegistPlanMode.Value, "yyyy-mm-dd hh:mm:ss") & ","
    End If
    strTemp = strTemp & "270," & chk(chk_预约排队按时点显示).Value & ","
    strTemp = strTemp & "272," & chk(chk_用血医嘱发送后才能发血).Value & ","
    strTemp = strTemp & "273," & zlCommFun.GetNeedName(cmb(cmb_输血采集诊疗检验类型).List(cmb(cmb_输血采集诊疗检验类型).ListIndex), "-") & ","
    strTemp = strTemp & "286," & chk(chk_输血申请不显示血液库存).Value & ","
    strTemp = strTemp & "276," & chk(chk_刷卡消费须定位到密码框).Value & ","
    strTemp = strTemp & "277," & Format(dtpRegistOpenTime.Value, "HH:mm:ss") & "," '号源开放时间
    strTemp = strTemp & "279," & chk(chk_同一身份证对应一个建档病人).Value & ","
    strTemp = strTemp & "283," & chk(chk_门诊费用转住院预交票据打印控制).Value & ","
    strTemp = strTemp & "284," & cmb(cmb_门诊费用转住院预交发票格式).ListIndex & ","
    strTemp = strTemp & "288," & chk(chk_叮嘱发送执行).Value & ","
    strTemp = strTemp & "293," & chk(chk_下达用血申请时确定发血信息).Value & ","
    gstrSQL = "zl_Parameters_Update_Batch(" & glngSys & ",'" & strTemp & "')"
    Call zlDatabase.ExecuteProcedure(gstrSQL, Me.Caption)
    
    If optInExseCharge(0).Value = True Then
        zlDatabase.SetPara "记帐报警包含所有住院划价费用", 0, glngSys, 1150, True
    Else
        zlDatabase.SetPara "记帐报警包含所有住院划价费用", 1, glngSys, 1150, True
    End If
    
    zlDatabase.SetPara "备货卫材只能输内部条码", chk(chk_备货卫材输入条码).Value, glngSys, 1257, True
...
'            fra(10).Enabled = (chk(chk_加收工本费).Value = 1)
        ...
        Case Index = chk_药品填单时下可用库存
            ...
            End If
        Case Index = chk_记帐报警包含划价费用
            If Val(IIF(chk(Index).Value = 1, 1, 0)) = 1 Then
        ...
        Case Index = chk_电子签名控制_门诊 Or Index = chk_电子签名控制_住院 _
                ...
                Or Index = chk_电子签名控制_lis Or Index = chk_电子签名控制_pacs Or Index = chk_电子签名控制_血库
            ...
            If cmb(cmb_电子签名认证中心).ListIndex <> 0 Then
                If chk(chk_电子签名控制_门诊).Value = 0 And chk(chk_电子签名控制_住院).Value = 0 _
                    ...
                    And chk(chk_电子签名控制_lis).Value = 0 And chk(chk_电子签名控制_pacs).Value = 0 And chk(chk_电子签名控制_血库).Value = 0 Then
                        ...
                        ElseIf Index = chk_电子签名控制_pacs Then
                            chk(chk_电子签名控制_血库).Value = 1
                        ElseIf Index = chk_电子签名控制_血库 Then
            ...
            ElseIf Index = chk_电子签名控制_血库 Then
                sstSign.TabVisible(sst_血库) = chk(chk_电子签名控制_血库).Value = 1
            End If
       ...
       Case Index = chk_项目执行前必须收费或审核
        ...
        Case Index = chk启用手术分级管理
            If chk(Index).Value = 1 Then
                ...
                chk(chk_主刀医师达到手术等级无需审核).Enabled = True
            Else
                chk(chk_手术授权管理).Value = 0
                chk(chk_手术授权管理).Enabled = False
                chk(chk_主刀医师达到手术等级无需审核).Value = 0
                chk(chk_主刀医师达到手术等级无需审核).Enabled = False
            End If
        Case Index = chk_输血分级管理
            ...
            End If
        Case Index = chk_启用血库管理系统
            If chk(Index).Value = 1 Then
                chk(chk_用血医嘱发送后才能发血).Value = 0
                chk(chk_用血医嘱发送后才能发血).Enabled = True
                chk(chk_输血申请不显示血液库存).Value = 0
                chk(chk_输血申请不显示血液库存).Enabled = True
                chk(chk_下达用血申请时确定发血信息).Value = 0
                chk(chk_下达用血申请时确定发血信息).Enabled = True
                lbl(61).Enabled = True
                cmb(cmb_输血采集诊疗检验类型).Enabled = True
                If Val(cmb(cmb_输血采集诊疗检验类型).Tag) >= 0 And Val(cmb(cmb_输血采集诊疗检验类型).Tag) < cmb(cmb_输血采集诊疗检验类型).ListCount Then
                    cmb(cmb_输血采集诊疗检验类型).ListIndex = Val(cmb(cmb_输血采集诊疗检验类型).Tag)
                End If
            Else
                chk(chk_用血医嘱发送后才能发血).Value = 0
                chk(chk_用血医嘱发送后才能发血).Enabled = False
                chk(chk_输血申请不显示血液库存).Value = 0
                chk(chk_输血申请不显示血液库存).Enabled = False
                chk(chk_下达用血申请时确定发血信息).Value = 0
                chk(chk_下达用血申请时确定发血信息).Enabled = False
                lbl(56).Enabled = False
                cmb(cmb_输血采集诊疗检验类型).Enabled = False
                cmb(cmb_输血采集诊疗检验类型).ListIndex = -1
            End If
        ...
        Case Index = chk_病人地址结构化录入
            chk(chk_乡镇地址结构化录入).Enabled = chk(chk_病人地址结构化录入).Value = 1
            If Not chk(chk_乡镇地址结构化录入).Enabled Then chk(chk_乡镇地址结构化录入).Value = 0
        Case Index = chk_专家号挂号限制
            txt(chk_专家号挂号限制).Enabled = chk(Index).Value = 1
        Case Index = chk_专家号预约限制
            txt(chk_专家号预约限制).Enabled = chk(Index).Value = 1
        Case Index = chk_启用医学影像信息系统专业版接口
            vsfRISEnables.Enabled = chk(chk_启用医学影像信息系统专业版接口).Value = 1
...
Private Sub dtpRegistPlanMode_Validate(Cancel As Boolean)
    ...
    If Not rsTmp.EOF Then
        MsgBox "启用日期之后存在计划排班模式的挂号或者预约记录,请重新设置启用日期!", vbInformation, gstrSysName
        Cancel = True
        Exit Sub
    End If
End Sub
...
Private Sub optRegistPlanMode_Click(Index As Integer)
    ...
    If optRegistPlanMode(0).Value = 1 Or optRegistPlanMode(0).Value = True Then
        ...
        dtpRegistPlanMode.Enabled = False
    Else
        If MsgBox("即将挂号方式切换为临床出诊排班模式,为了保证系统的正常运行,切换前请确认已经正确产生了临床出诊记录,是否继续?", vbInformation + vbYesNo + vbDefaultButton2, gstrSysName) = vbNo Then
            mblnNotChange = True
            optRegistPlanMode(0).Value = 1
            mblnNotChange = False
            Exit Sub
...
Private Sub cmb_Click(Index As Integer)
    ...
    If Index = cmb_电子签名认证中心 Then
        If cmb(Index).ListIndex = 0 Then
            ...
            chk(chk_电子签名控制_血库).Enabled = False
        ...
        Else
            ...
            chk(chk_电子签名控制_血库).Enabled = True
        ...
        If cmb(Index).ListIndex <> 0 Then
            If Not mobjESign Is Nothing Then
                cmd(cmd_电子签名设置).Visible = mobjESign.SetEnabled(Val(cmb(Index).List(cmb(Index).ListIndex)))
            End If
        End If
    ElseIf Index = cmb_合理用药接口 Then
        '美康时可见
        lblPassVer.Visible = InStr(",1,2,", "," & cmb(Index).ListIndex & ",") > 0
        optPASSVer(0).Visible = InStr(",1,2,", "," & cmb(Index).ListIndex & ",") > 0
        optPASSVer(1).Visible = InStr(",1,2,", "," & cmb(Index).ListIndex & ",") > 0
        optPASSVer(1).Enabled = True
        ...
        If cmb(Index).ListIndex = 0 Then    '未启用接口
            ...
            chk(chk_启用接口调用日志).Visible = False  '大通\药卫士时可见
        ...
        Else
            ...
            chk(chk_启用接口调用日志).Visible = (cmb(Index).ListIndex = 2) Or (cmb(Index).ListIndex = 4)
            
            If cmb(Index).ListIndex = 2 Then   '大通
                optPASSVer(0).Caption = "CS版"
                optPASSVer(1).Caption = "BS版"
                chk(chk_禁止下达超极量药品医嘱).Enabled = optPASSVer(0).Value
            Else
                chk(chk_禁止下达超极量药品医嘱).Enabled = False
                chk(chk_禁止下达超极量药品医嘱).Value = 0
            End If
            ...
            If Not mobjPass Is Nothing Then
                ...
                cmdSet.Visible = mobjPass.SetEnabled(cmb(Index).ListIndex, strValue)
            End If
        End If
    ElseIf Index = cmb_输血采集诊疗检验类型 Then
        If cmb(cmb_输血采集诊疗检验类型).ListIndex <> -1 Then
            cmb(cmb_输血采集诊疗检验类型).Tag = cmb(cmb_输血采集诊疗检验类型).ListIndex
        End If
    End If
End Sub
...
Private Sub optPASSVer_Click(Index As Integer)
    Dim strValue As String
    chk(chk_允许使用系统设置).Visible = Index = 0 And cmb(cmb_合理用药接口).ListIndex = 1
    chk(chk_禁止下达超极量药品医嘱).Enabled = Index = 0 And cmb(cmb_合理用药接口).ListIndex = 2
    strValue = IIF(optPASSVer(0).Value, "3.0", "4.0")
    cmdSet.Visible = mobjPass.SetEnabled(cmb(cmb_合理用药接口).ListIndex, strValue)
End Sub
...
Private Sub txtRA_GotFocus(Index As Integer)
    Call zlControl.TxtSelAll(txtRA(Index))
End Sub

Private Sub txtRA_KeyPress(Index As Integer, KeyAscii As Integer)
    If KeyAscii = vbKeyReturn Then
        KeyAscii = 0
        Call zlCommFun.PressKey(vbKeyTab)
...
Private Sub txtRA_Validate(Index As Integer, Cancel As Boolean)
    If Val(txtRA(Index).Text) < 5 Or Val(txtRA(Index).Text) > 99 Then
        MsgBox "门诊药师审方离岗时长范围（5-99）！", vbInformation, gstrSysName
        txtRA(Index).Text = 10
    End If
End Sub
        ...
        With vsfRisDepts
            If .MouseCol = col_Ris科室选择 And .MouseRow = 0 Then
                If .ColData(col_Ris科室选择) = RIS_Checked Then
                    .Cell(flexcpPicture, 0, col_Ris科室选择) = ils16.ListImages("UnCheck").Picture
                    .ColData(col_Ris科室选择) = ""
                Else
                    .Cell(flexcpPicture, 0, col_Ris科室选择) = ils16.ListImages("AllCheck").Picture
...
Private Sub vsfRISEnables_AfterEdit(ByVal Row As Long, ByVal Col As Long)
    ...
    If Me.Visible And vsfRISEnables.Tag = "" Then
        vsfRISEnables.Tag = "已修改"
        mblnChange = True
    End If
...
'功能：从界面获取参数值
    ...
    chk(chk_申请单启用环节门诊输血).Value & chk(chk_申请单启用环节住院输血).Value
    Get申请单启用环节 = strTmp
End Function
...
Private Function GetRA_Switch() As String
'功能：获取有关处方审查管理开关值
'参数：
'返回：0-门诊和住院都不启用；1-门诊启用，住院不启用；2-门诊不启用，住院启用；3-门诊和住院都启用

    If chkRA(Val("0-门诊处方审查")).Value = 1 And chkRA(Val("2-住院药嘱审查")).Value = 1 Then
        GetRA_Switch = "3"
    ElseIf chkRA(Val("0-门诊处方审查")).Value = 0 And chkRA(Val("2-住院药嘱审查")).Value = 1 Then
        GetRA_Switch = "2"
    ElseIf chkRA(Val("0-门诊处方审查")).Value = 1 And chkRA(Val("2-住院药嘱审查")).Value = 0 Then
        GetRA_Switch = "1"
    Else
        GetRA_Switch = "0"
    End If
...
'    Set rsTemp = zlDatabase.OpenSQLRecord(strSQL, "提取影像检查类别")
    strSQL = "select 编码, 名称 from 诊疗检查类型"
    Set rsTemp = zlDatabase.OpenSQLRecord(strSQL, "提取诊疗检查类型")
    ...
    With vsfRISEnables
        ...
        .ColWidth(col_RIS启用科室) = 2100
        .ColWidth(col_RIS启用预约科室全) = 650
        .ColWidth(col_RIS启用预约科室) = 2050
...
'            .RowData(i * 3 + 3) = Nvl(rsTemp!编码)
            .RowData(i * 3 + 1) = rsTemp!名称
            .RowData(i * 3 + 2) = rsTemp!名称
            .RowData(i * 3 + 3) = rsTemp!名称
...
'-----------------------------------------------------------
    ...
    With vsfGrid
        '判断启用RIS和检查类型是否被选中
        strModality = .TextMatrix(iRow, col_RIS启用检查类型)
        ...
        If .Tag = "已修改" Then
            ...
            For i = 1 To .Rows - 1
                ...
                If .Cell(flexcpChecked, i, col_RIS启用检查类型) = 1 Then
                    strModality = .TextMatrix(i, col_RIS启用检查类型)
                    '选择了场合，才保存
