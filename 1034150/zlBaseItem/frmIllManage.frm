...
Private Const mstr疾病 As String = "编码,1200,0,1;附码,1200,0,0;名称,2440,0,2;拼音码,1000,0,0;五笔码,1000,0,0;性别限制,800,0,0;手术类型,800,0,0;统计码,800,0,0;提醒疗效,800,0,0;分娩信息,800,0,0;适用范围,1000,0,0;说明,3000,0,0;建档时间,1400,0,0;撤档时间,1400,0,0"
...
Private Sub mnuEditModify_Click()
    ...
    Else
        ...
        If nodTemp Is Nothing Then
            ...
            frmIllItemEdit.疾病编辑 tvwMain_S.Visible, "无", "", mstr编码类别, cmbType.Text, Mid(lvwMain.SelectedItem.Key, 2)
        Else
            
            frmIllItemEdit.疾病编辑 tvwMain_S.Visible, nodTemp.Text, Mid(nodTemp.Key, 2), mstr编码类别, cmbType.Text, Mid(lvwMain.SelectedItem.Key, 2)
        End If
    End If
End Sub
...
Private Sub mnuEditDisease_Click()
    ...
    If nodTemp Is Nothing Then
        ...
        frmIllItemEdit.疾病编辑 tvwMain_S.Visible, "无", "", mstr编码类别, cmbType.Text
    Else
        ...
        frmIllItemEdit.疾病编辑 tvwMain_S.Visible, nodTemp.Text, Mid(nodTemp.Key, 2), mstr编码类别, cmbType.Text
    End If
End Sub
...
'功能:更新ListView中的数据
    ...
    "          to_char(A.撤档时间,'yyyy-mm-dd') as 撤档时间,Decode(Nvl(适用范围,0),0,'全院',1,'门诊',2,'住院') As 适用范围 " & _
    "   From 疾病编码目录 A  " & _
