...
Begin VB.Form frmPIVAMain 
   ...
   Begin VB.PictureBox picDept 
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsfDept 
         ...
         FormatString    =   $"frmPIVAMain.frx":6DDC
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.PictureBox picDept 
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsfDept 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"frmPIVAMain.frx":6E6A
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.PictureBox picDetailList 
      ...
      Begin VB.Frame fraMedis 
         ...
         Begin VB.Image ImgResult 
            DragIcon        =   "frmPIVAMain.frx":8520
            Height          =   240
            Index           =   4
            Left            =   9360
            Picture         =   "frmPIVAMain.frx":ED72
            Top             =   240
            Visible         =   0   'False
            Width           =   240
         End
         Begin VB.Image ImgResult 
            DragIcon        =   "frmPIVAMain.frx":155C4
            Height          =   240
            Index           =   3
            Left            =   8310
            Picture         =   "frmPIVAMain.frx":1BE16
            Top             =   240
            Visible         =   0   'False
            Width           =   240
         End
         Begin VB.Image ImgResult 
            DragIcon        =   "frmPIVAMain.frx":22668
            Height          =   240
            Index           =   2
            Left            =   7260
            Picture         =   "frmPIVAMain.frx":28EBA
            Top             =   240
            Visible         =   0   'False
            Width           =   240
         End
         Begin VB.Image ImgResult 
            DragIcon        =   "frmPIVAMain.frx":2F70C
            Height          =   240
            Index           =   1
            Left            =   6210
            Picture         =   "frmPIVAMain.frx":35F5E
            Top             =   240
            Visible         =   0   'False
            Width           =   240
         End
         Begin VB.Image ImgResult 
            DragIcon        =   "frmPIVAMain.frx":3C7B0
            Height          =   240
            Index           =   0
            Left            =   5160
            Picture         =   "frmPIVAMain.frx":43002
            Top             =   240
            Visible         =   0   'False
            Width           =   240
         End
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsfTrans 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"frmPIVAMain.frx":500A6
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsfSumDrug 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"frmPIVAMain.frx":50DA4
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsfMedis 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"frmPIVAMain.frx":50F64
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VSFlex8Ctl.VSFlexGrid VSFLook 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"frmPIVAMain.frx":513DB
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsfColSel 
         ...
         FormatString    =   $"frmPIVAMain.frx":51639
         ScrollTrack     =   -1  'True
         ScrollBars      =   2
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.PictureBox picCondition 
      ...
      Begin VB.PictureBox picMsg 
         ...
         Height          =   2055
         Left            =   120
         MouseIcon       =   "frmPIVAMain.frx":51687
         ScaleHeight     =   2055
         ScaleWidth      =   2895
         TabIndex        =   39
         Tag             =   "0"
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsfMsg 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"frmPIVAMain.frx":51CD3
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
   ...
   Begin VSFlex8Ctl.VSFlexGrid vsfPrint 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"frmPIVAMain.frx":52684
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin MSComctlLib.ImageList ImgList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPIVAMain.frx":52712
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPIVAMain.frx":58F74
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPIVAMain.frx":5F7D6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPIVAMain.frx":66038
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPIVAMain.frx":6C89A
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPIVAMain.frx":730FC
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPIVAMain.frx":7995E
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPIVAMain.frx":801C0
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin XtremeDockingPane.DockingPane dkpMain 
      Bindings        =   "frmPIVAMain.frx":86A22
      Left            =   6480
      Top             =   240
      _Version        =   589884
      _ExtentX        =   450
...
Private mlngNum As Long      '当前明细界面的数量
...
'    int瓶签自动打印 As Integer          '0-不自动打印;1-摆药后自动打印;2-配药后自动打印
    ...
    intNum As Integer
    str常用药品 As String
    blnTwoCode As Boolean               '扫描两次自动发送
...
'        .Cols = MINTCOLS
        ...
        VsfGridColFormat vsfTrans, mIntCol作废类型, "作废类型", 1200, flexAlignLeftCenter, "作废类型"
    ...
    If strRows = "" Then
        strRows = mstrUnVisble & "审;摆药单号;摆药人;摆药时间;配药人;配药时间;发送人;发送时间;销帐申请人;销帐申请时间;销帐审核人;销帐审核时间;作废类型;"
    End If
    ...
    '初始环节为摆药环节
    Call InitColSelList(mstrUnVisble & "审;摆药单号;摆药人;摆药时间;配药人;配药时间;发送人;发送时间;销帐申请人;销帐申请时间;销帐审核人;销帐审核时间;作废类型;")
End Sub
        ...
        ElseIf mParams.strSort <> "" Then
            For intCol = 0 To .Cols - 1
                For intSortCount = 0 To UBound(Split(mParams.strSort, ","))
                    If .ColKey(intCol) = Split(mParams.strSort, ",")(intSortCount) Then
...
'            "          from (select A.瓶签号,C.no,C.药品id,F.名称,row_number() over(partition by A.瓶签号 order by m.序号) 序号" & vbNewLine & _
'            "                  from 输液配药记录 A," & vbNewLine & _
'            "                       输液配药内容 B," & vbNewLine & _
'            "                       药品收发记录 C," & vbNewLine & _
'            "                       药品特性     D," & vbNewLine & _
'            "                       药品规格     E," & vbNewLine & _
'            "                       收费项目目录 F," & vbNewLine & _
'            "                       病人医嘱记录 M," & vbNewLine & _
'            "                       住院费用记录 N" & vbNewLine & _
'            "                 where A.执行时间 between [1] and [2]" & vbNewLine & _
'            "                   and A.Id = B.记录ID and B.收发id = C.id and C.药品id = E.药品id" & vbNewLine & _
'            "                   And d.溶媒 <> 1 And A.操作状态 = 1 And A.部门id = [3]" & vbNewLine & _
'            "                   and E.药名id = D.药名id and M.相关id = A.医嘱id" & vbNewLine & _
'            "                   and m.id = N.医嘱序号 and C.费用ID = N.id and E.药品id = F.ID)" & vbNewLine & _
'            "         where 序号 = 1" & vbNewLine & _
'            "         group by 药品id, 名称 " & vbNewLine & _
'            " order by 数量 desc)" & vbNewLine & _
'            " where rownum<4"
    ...
    gstrSQL = "Select 药品id, 名称, 数量" & vbNewLine & _
        ...
        "                    c.费用id = n.Id And e.药品id = f.Id And 操作状态 = 1)" & vbNewLine & _
        "       Group By 药品id, 名称" & vbNewLine & _
        "       Order By 数量 Desc) "
    ...
    Do While (Not rstemp.EOF And intRow < 3)
        If intRow < 3 Then
            intRow = intRow + 1
...
Private Sub zlGetMediNumNew()
    ...
    If mParams.str常用药品 = "" Then Exit Sub
    mblnFilter = True
...
'参数：KeyAscii=在KeyPress事件中调用的参数
    ...
    Else
        If Format((sngNow - sngInputBegin) / Len(strText), "0.000") <= 0.1 Then blnScaner = True
    End If
...
Private Sub GetParams()
    ...
    With mParams
        ...
        .bln审核划价单 = (gtype_UserSysParms.P81_执行后自动审核划价单 = 1)
...
'        Me.lblFindItem.Caption = GetSetting("ZLSOFT", "私有模块\" & gstrDbUser & "\界面设置\" & App.ProductName & "\" & Me.Name, "查找方式", "床号")
...
Private Sub BillPrint_Send(Optional ByVal blnByBat As Boolean)
    '打印发送单
    Dim strDate As String
...
Private Sub ResizeConditionArea()
    ...
    With picTime
        If cbo时间范围.ListIndex = 3 Then
            .Height = Dtp结束时间.Top + Dtp结束时间.Height
        Else
            .Height = cbo时间范围.Top + cbo时间范围.Height
        End If
    End With
...
Private Sub GetTransCount(ByVal dateStart As Date, ByVal dateEnd As Date)
    ...
    With mrsDeptTrans
        ...
        Set rsTmp = PIVA_GetTransCount(mcondition.lngCenterID, dateStart, dateEnd, mParams.bln审核, mParams.bln处方审查, mParams.intCheck)
        If Not rsTmp Is Nothing Then
            Do While Not rsTmp.EOF
                If rsTmp!类型 = "00" And mParams.intCheck = 1 Then
                    If lng病区id <> rsTmp!病区ID Then
                        lng病区id = rsTmp!病区ID
                        .AddNew
                        !选择 = 0
                        !类型 = rsTmp!类型
    ...
    With mrsWorkBatch
        ...
        Do While Not .EOF
            If !正常 = 1 Then
                ...
                mstr打包 = mstr打包 & "," & !批次 & "#," & NVL(!打包, 0)
                    
                mstr批次 = IIf(mstr批次 = "", "", mstr批次 & "/") & !批次 & "#" & _
                    "|" & "配药时间" & !配药时间 & _
                    "|" & "给药时间" & !给药时间 & "," & IIf(NVL(!颜色) = "", 0, !颜色)
            Else
                mParams.strBatchList = IIf(mParams.strBatchList = "", "", mParams.strBatchList & "|") & NVL(!批次, 1) & "#" & vbTab & "（备用批次）"
                mstr批次 = IIf(mstr批次 = "", "", mstr批次 & "/") & NVL(!批次, 1) & "#|（备用批次）" & "," & IIf(NVL(!颜色) = "", 0, !颜色)
                mstr打包 = IIf(mstr打包 = "", "", mstr打包 & ",") & NVL(!批次, 1) & "#,0"
            End If
...
Private Sub IniTransRec()
    ...
    With mrsTrans
        ...
        .Fields.Append "单量", adDouble, 18, adFldIsNullable
        ...
        .Fields.Append "排序单量", adDouble, 18, adFldIsNullable
...
Private Sub LoadTrans(ByVal lng库房ID As Long, ByVal str病区id As String, ByVal strStartTime As String, _
    ByVal strEndTime As String, ByVal strStep As String, ByVal intPack As Integer, ByVal intSend As Integer)
...
'    Set rsTrans = Piva_GetTrans(lng库房ID, str病区id, CDate(strStartTime), CDate(strEndTime), strStep, intPack, intSend, mParams.bln审核)
    ...
    For i = 0 To UBound(Split(str病区id, ","))
    
        
        Set rsTrans = Piva_GetTrans(lng库房ID, CLng(Split(str病区id, ",")(i)), CDate(strStartTime), CDate(strEndTime), strStep, intPack, intSend, mParams.bln审核, mParams.bln处方审查)
...
Private Sub SetLastBatch(ByRef rsTrans As ADODB.Recordset)
    ...
    '参数设置为保持则退出
    If mParams.blnLastBatch = False Then Exit Sub
    ...
    With rsTrans
        ...
        Do While Not .EOF
            If InStr(1, str病人ids, !病人ID) = 0 Then
                str病人ids = IIf(str病人ids = "", "", str病人ids & ",") & !病人ID
            End If
    ...
    '按病人为单位以此判断本次发送是否有变化(根据本次发送的医嘱ID和上次发送的医嘱ID是否一致判断)
    For i = 0 To UBound(Split(str病人ids, ","))
        lng病人ID = Split(str病人ids, ",")(i)
        gstrSQL = "Select a.医嘱id, a.发送号 From 输液配药记录 A, 病人医嘱记录 B Where a.医嘱id = b.Id And b.病人id = [1] "
        Set rsData = zlDatabase.OpenSQLRecord(gstrSQL, "SetLastBatch", lng病人ID)
...
Private Sub cboMedi_Click()
    If mblnFilter = True Then Exit Sub
    Call Filter
End Sub

Private Sub cboType_Click()
    Call LoadVsfMedi(mstr上次病区ID, False)
...
Private Sub chkResult_Click(Index As Integer)
    Call LoadVsfMedi(mstr上次病区ID, True)
End Sub
...
Private Sub Set批次(ByRef rstemp As Recordset, ByVal lng病人ID As Long, ByVal str批次 As String, ByVal str执行时间 As String)
    Dim lng容量 As Long
    Dim lng总量 As Long
    Dim lngRow As Long
...
Private Sub DelTransRec()
    ...
    End With
End Sub
Private Sub RefreshDeptList(ByVal Index As Long)
    If mblnActive = True Then vsfDept(Index).SetFocus
    mlng已扫描 = 0
    '清除输液单明细列表
...
'    End If
    ...
    If str病区id = "" Then Exit Sub
    
    If Not mParams.blnFilter Then
        Call zlGetMediNum(CDate(mcondition.strTransStartTime), CDate(mcondition.strTransEndTime), "", 1)
    End If
    ...
    Else
        ...
        '重新取所选病区对应的输液单明细
        Call LoadTrans(mcondition.lngCenterID, str病区id, mcondition.strTransStartTime, mcondition.strTransEndTime, mcondition.strTransStep, Val(vsfTrans.Tag), Val(fraDetailCtr.Tag))
'         '在状态栏显示所选的病区和输液单数量
'        Call GetCount
'        mrsTrans.Filter = ""
'        '显示输液单卡片
        ...
        Select Case lngType
            ...
            Case conMenu_Oper_Bag_All
                ...
                With Me.vsfTrans
                    ...
                    For lngRow = 1 To .rows - 1
                        If lng配药id <> Val(.TextMatrix(.Row, .ColIndex("配药id"))) Then
                            lng配药id = Val(.TextMatrix(.Row, .ColIndex("配药id")))
                            If InStr("|" & str打包id, "|" & .TextMatrix(lngRow, .ColIndex("配药ID"))) < 1 Then
                                str打包id = IIf(str打包id = "", "", str打包id & "|") & .TextMatrix(lngRow, .ColIndex("配药ID")) & ",2"
                            End If
                            ...
                            If mcondition.strTransStep = M_STR_CALSS_DOSAGE And .TextMatrix(.Row, .ColIndex("是否打包")) > 0 Then
                                mintCountPack = mintCountPack + IIf(IIf(IsNull(mrsTrans!摆药时间), "", Format(mrsTrans!摆药时间, "YYYY-MM-DD HH:MM:SS")) <= IIf(IsNull(mrsTrans!打包时间), "", Format(mrsTrans!打包时间, "YYYY-MM-DD HH:MM:SS")), 0, 1)
                            Else
                                If IIf(IsNull(mrsTrans!摆药时间), "", Format(mrsTrans!摆药时间, "YYYY-MM-DD HH:MM:SS")) <= IIf(IsNull(mrsTrans!打包时间), "", Format(mrsTrans!打包时间, "YYYY-MM-DD HH:MM:SS")) Then
                                    mintCountPack = mintCountPack - 1
...
'    If Not cbrControl Is Nothing Then cbrControl.Visible = (Val(cmdNext.Tag) = mType.输液单 And mcondition.strTransStep = M_STR_CALSS_PREPARE)
    ...
    If Not cbrMenu Is Nothing Then cbrMenu.Visible = (mcondition.strTransStep = M_STR_CALSS_PREPARE)
    If Not cbrControl Is Nothing Then cbrControl.Visible = (mcondition.strTransStep = M_STR_CALSS_PREPARE)
...
Private Sub ShowComment(ByVal intTab As Integer, ByVal strStep As String)
    ...
    If intTab = mDetailType.输液单列表 Then
        ...
        ElseIf strStep = M_STR_CALSS_SEND Then
            If mParams.blnTwoCode = True Then lblCount.Visible = True
...
Private Sub ShowSumDrug()
    ...
    With vsfSumDrug
        ...
        If chkDept.Value = 1 And chkPack.Value = 1 Then
            mrsTrans.Sort = "病区,是否打包,药品名称,批次,收发ID"
            
            Do While Not mrsTrans.EOF
                If strCurr <> mrsTrans!病区 & mrsTrans!是否打包 & mrsTrans!药品名称 & mrsTrans!批次 Then
                    lngRow = lngRow + 1
                    .rows = .rows + 1
                    
                    strCurr = mrsTrans!病区 & mrsTrans!是否打包 & mrsTrans!药品名称 & mrsTrans!批次
                    dblSum = NVL(mrsTrans!数量, 0)
                    ...
                    .TextMatrix(lngRow, .ColIndex("规格")) = NVL(mrsTrans!规格)
                ...
                Else
                    dblSum = dblSum + NVL(mrsTrans!数量, 0)
                    .TextMatrix(lngRow, .ColIndex("数量")) = FormatEx(dblSum, 2) & mrsTrans!单位
        ...
        ElseIf chkDept.Value = 1 Then
            mrsTrans.Sort = "病区,药品名称,批次,收发ID"
            
            Do While Not mrsTrans.EOF
                If strCurr <> mrsTrans!病区 & mrsTrans!药品名称 & mrsTrans!批次 Then
                    lngRow = lngRow + 1
                    .rows = .rows + 1
                    
                    strCurr = mrsTrans!病区 & mrsTrans!药品名称 & mrsTrans!批次
                    dblSum = NVL(mrsTrans!数量, 0)
        ...
        ElseIf chkPack.Value = 1 Then
            mrsTrans.Sort = "是否打包,药品名称,批次,收发ID"
            
            Do While Not mrsTrans.EOF
                If strCurr <> mrsTrans!是否打包 & mrsTrans!药品名称 & mrsTrans!批次 Then
                    lngRow = lngRow + 1
                    .rows = .rows + 1
                    
                    strCurr = mrsTrans!是否打包 & mrsTrans!药品名称 & mrsTrans!批次
                    dblSum = NVL(mrsTrans!数量, 0)
            ...
            Loop
        Else
            mrsTrans.Sort = "药品名称,批次,收发ID"
            
            Do While Not mrsTrans.EOF
                If strCurr <> mrsTrans!药品名称 & mrsTrans!批次 Then
                    lngRow = lngRow + 1
                    .rows = .rows + 1
                    
                    strCurr = mrsTrans!药品名称 & mrsTrans!批次
                    dblSum = NVL(mrsTrans!数量, 0)
...
'    vsfDrug.rows = 2
'
    dteCur = zlDatabase.Currentdate
    If mrsTrans Is Nothing Then Exit Function
    If mrsTrans.RecordCount = 0 Then Exit Function
    mrsTrans.MoveFirst
'    If Val(vsfTrans.Tag) = 1 And mParams.blnByMedi = True Then
'        Call MediSort
'    ElseIf Me.cboMedi.Text <> "<全部>" Then
'        Call MediSort
'    Else
...
'    End If
    ...
    dateCurrent = zlDatabase.Currentdate
...
'            If lng药品id = mrsTrans!药品id And mrsTrans!溶媒 <> 1 And lng配药id = mrsTrans!配药id And .TextMatrix(lngRow - 1, .ColIndex("数量")) <> "00" Then
'                .TextMatrix(lngRow - 1, .ColIndex("数量")) = (Val(Mid(.TextMatrix(lngRow - 1, .ColIndex("数量")), 1, InStr(1, .TextMatrix(lngRow - 1, .ColIndex("数量")), mrsTrans!单位) - 1)) + FormatEx(mrsTrans!数量, 2)) & mrsTrans!单位
'                .rows = .rows - 1
'            Else
                lng药品id = mrsTrans!药品id
                ...
                .TextMatrix(lngRow, .ColIndex("配药批次")) = IIf(NVL(mrsTrans!配药批次) = "", " ", NVL(mrsTrans!配药批次))
                ...
                .TextMatrix(lngRow, .ColIndex("床号")) = IIf(NVL(mrsTrans!床号) = "", "<空>", mrsTrans!床号 & "床")
                ...
                .TextMatrix(lngRow, .ColIndex("执行频次")) = NVL(mrsTrans!执行频次)
                ...
                .TextMatrix(lngRow, .ColIndex("优先级")) = Val(NVL(mrsTrans!优先级))
                .TextMatrix(lngRow, .ColIndex("是否锁定")) = NVL(mrsTrans!是否锁定, 0)
                ...
                .TextMatrix(lngRow, .ColIndex("摆药单号")) = IIf(NVL(mrsTrans!摆药单号) = "", " ", mrsTrans!摆药单号)
                ...
                .TextMatrix(lngRow, .ColIndex("NO")) = NVL(mrsTrans!NO)
                .TextMatrix(lngRow, .ColIndex("单据")) = mrsTrans!单据
                .TextMatrix(lngRow, .ColIndex("药品id")) = mrsTrans!药品id
                
                If mrsTrans!是否皮试 = 1 Then
                    .TextMatrix(lngRow, .ColIndex("皮")) = Get皮试结果(Val(mrsTrans!病人ID), Val(mrsTrans!药名ID), dateCurrent, CDate(mrsTrans!开嘱时间))
                End If
                
                .Cell(flexcpPicture, lngRow, .ColIndex("医嘱"), lngRow, .ColIndex("医嘱")) = IIf(Format(NVL(mrsTrans!药师审核时间), "YYYY-MM-dd") = Format(dteCur, "YYYY-MM-dd"), Me.ImgList.ListImages(2).Picture, Me.ImgList.ListImages(1).Picture)
...
'                    If mrsTrans!审查结果 > -1 And mrsTrans!审查结果 < 5 Then
'                        .Cell(flexcpPicture, lngRow, .ColIndex("审查结果"), lngRow, .ColIndex("审查结果")) = frmPublic.imgPass.ListImages(Val(mrsTrans!审查结果) + 1).Picture
'                        .Cell(flexcpPictureAlignment, lngRow, .ColIndex("审查结果"), lngRow, .ColIndex("审查结果")) = flexPicAlignCenterCenter
'                    End If
'                ElseIf mParams.intShowPass = 3 Then
'                    If mrsTrans!审查结果 = 1 Then
'                        .Cell(flexcpPicture, lngRow, .ColIndex("审查结果"), lngRow, .ColIndex("审查结果")) = frmPublic.imgPass.ListImages(3).Picture
'                    ElseIf mrsTrans!审查结果 = 2 Then
'                        .Cell(flexcpPicture, lngRow, .ColIndex("审查结果"), lngRow, .ColIndex("审查结果")) = frmPublic.imgPass.ListImages(2).Picture
'                    ElseIf mrsTrans!审查结果 = 3 Then
'                        .Cell(flexcpPicture, lngRow, .ColIndex("审查结果"), lngRow, .ColIndex("审查结果")) = frmPublic.imgPass.ListImages(1).Picture
'                    End If
'                    .Cell(flexcpPictureAlignment, lngRow, .ColIndex("审查结果"), lngRow, .ColIndex("审查结果")) = flexPicAlignCenterCenter
'                End If
                ...
                .TextMatrix(lngRow, .ColIndex("警告")) = Val(mrsTrans!审查结果)
...
'        .Cell(flexcpForeColor, 0, .ColIndex("选择"), .Rows - 1, .ColIndex("选择")) = vbBlue
        ...
        For lngRow = 1 To .rows - 1
            If Val(.TextMatrix(lngRow, .ColIndex("配药ID"))) > 0 Then
                '更新打印标志图标
                If Val(.TextMatrix(lngRow, .ColIndex("打印标志"))) > 0 Then
                    .Row = lngRow
                    .Col = .ColIndex("打印")
...
Private Sub Filter()
    ...
    If Not mrsTrans Is Nothing Then mrsTrans.Filter = ""
...
'            Call SetBeach
        ...
        Case mconMenu_File_PIVA_BillPrintTotal
            '打印发送单
            Call BillPrint_Send
        Case mconMenu_File_PIVA_BillPrintTotalByBat
            Call BillPrint_Send(True)
...
'            Call DeleteLabel(Control.Id)
        Case conMenu_Oper_Look
            ...
            If Not mobjCISJOB Is Nothing Then
                If Val(Me.vsfMedis.TextMatrix(vsfMedis.Row, vsfMedis.ColIndex("病人id"))) = 0 Or Val(Me.vsfMedis.TextMatrix(vsfMedis.Row, vsfMedis.ColIndex("主页id"))) = 0 Then
                    MsgBox "请选择需要查看的医嘱！", vbInformation + vbOKOnly
                    Exit Sub
                End If
...
'        Case mconMenu_PASS_Item + 10
'            Call AdviceCheckWarn(9, "0000000", 21, 1, mlng医嘱id)
'        '功能：执行专项PASS命令
...
Private Sub zlSubPrint(ByVal bytMode As Byte)
    ...
    ObjAppRow.Add "打印时间:" & Format(zlDatabase.Currentdate, "yyyy-MM-dd HH:MM:SS")
                ...
                For lngPrintCol = 0 To .Cols - 1
                    If .ColKey(lngPrintCol) = vsfObj.ColKey(lngCol) Then
                        ...
                        If .ColKey(lngPrintCol) = "打印" And lngRow > 0 Then
                            If vsfObj.TextMatrix(lngRow, vsfObj.ColIndex("打印标志")) > 0 Then
                                .TextMatrix(lngRow, lngPrintCol) = "√"
                            Else
                                .TextMatrix(lngRow, lngPrintCol) = ""
                            End If
            ...
            With mrsTrans
                ...
                Do While Not .EOF
                    ...
                    If mcondition.strTransStep = M_STR_CALSS_DOSAGE Or mcondition.strTransStep = M_STR_CALSS_SEND Then
                        If IsOutPatient(mstrPrivs, Val(mrsTrans!单据), CStr(mrsTrans!NO), 2, 2, mrsTrans!病人ID, mrsTrans!主页id, 3) = False Then Exit Sub
                        If IsReceiptBalance_Charge(1, mstrPrivs, Val(mrsTrans!单据), CStr(mrsTrans!NO), Val(mrsTrans!费用序号), 2, 2, 3) = False Then Exit Sub
                    ElseIf mcondition.strTransStep = M_STR_CALSS_SEND Then
                        If IsOutPatient(mstrPrivs, Val(mrsTrans!单据), CStr(mrsTrans!NO), 2, 2, mrsTrans!病人ID, mrsTrans!主页id, 4) = False Then Exit Sub
                        If IsReceiptBalance_Charge(1, mstrPrivs, Val(mrsTrans!单据), CStr(mrsTrans!NO), Val(mrsTrans!费用序号), 2, 2, 4) = False Then Exit Sub
                    End If
        ...
        Else
            With Me.VSFLook
                For intRow = 1 To .rows - 1
                    If lng配药id <> Val(.TextMatrix(intRow, .ColIndex("配药id"))) Then
...
Private Sub PIVAWork_Prepare(ByVal intType As Integer)
    ...
    Do While Not mrsTrans.EOF
        If IsOutPatient(mstrPrivs, Val(mrsTrans!单据), CStr(mrsTrans!NO), 2, 2, mrsTrans!病人ID, mrsTrans!主页id, 2) = False Then Exit Sub
        If IsReceiptBalance_Charge(1, mstrPrivs, Val(mrsTrans!单据), CStr(mrsTrans!NO), Val(mrsTrans!费用序号), 2, 2, 2) = False Then Exit Sub
...
'    blnBeginTrans = False
    ...
    With mrsTrans
        ...
        Do While Not .EOF
            If lng病人ID <> 0 And lng病人ID <> !病人ID Then
...
'    Call ShowSumDrug
    ...
    '刷新
    If lng配药id = 0 Then Call RefreshDeptList(Me.tabDeptList.Selected.Index)
    If lng配药id = 0 Then Call RefreshDetailList(Me.tabDeptList.Selected.Index)
    If lng配药id <> 0 Then
        mrsTrans.Filter = ""
        mrsTrans.Filter = "配药id=" & lng配药id
        Do While Not mrsTrans.EOF
...
Private Sub PIVAWork_ReturnVerify()
    ...
    strCurrent = Format(zlDatabase.Currentdate(), "yyyy-MM-dd HH:mm:ss")
...
'        If MsgBox("是否发送？", vbQuestion + vbYesNo + vbDefaultButton2, gstrSysName) = vbNo Then Exit Sub
...
'    Call ShowSumDrug
    ...
    If blnAutoPrint Then
        If Me.cboBatch.ListIndex > 0 Then
...
Private Sub Form_Load()
    ...
    mdateToday = zlDatabase.Currentdate
    ...
    mcondition.lngCenterID = mParams.lng配置中心
    '定义不显示的列
    mstrUnVisble = "当前行;标志;是否锁定;NO;单据;剂量单位;用法;药品id;核查人;核查时间;打印标志;配药id;是否打包;原批次;抗菌药物;主页id;病人ID;警告;溶媒;背景号;"
...
'    SaveSetting "ZLSOFT", "私有模块\" & gstrDbUser & "\界面设置\" & App.ProductName & "\" & Me.Name, "查找方式", Me.lblFindItem.Caption
...
'        Set cbrControlMain = .Add(xtpControlButton, mconMenu_File_PIVA_BillPrint, "单据打印(&B)")
        ...
        Set cbrControlMain = .Add(xtpControlButton, mconMenu_File_PIVA_BillPrintTotalByBat, "按发送时间打印发送清单(&T)")
...
'        Set cbrControlMain = .Add(xtpControlButton, mconMenu_Edit_PIVA_PASS, "过敏史/病生状态(&G)")
'        cbrControlMain.BeginGroup = True
...
'        cbrControlMain.BeginGroup = True
'        cbrControlMain.Visible = (mParams.intShowPass = 1 And IsInString(gstrprivs, "合理用药监测", ";"))
        If Not gobjPass Is Nothing Then Call gobjPass.zlPassCommandBarAdd_YF(mlngMode, cbrToolBar.Controls, mconMenu_Edit_PIVA_PASS, mconMenu_Edit_PIVA_PASS)
        ...
        With vsfColSel
            ...
            Else
                ...
                If .Top + .Height > Me.ScaleHeight - vsfTrans.Top Then
                    .Height = Me.ScaleHeight - .Top - vsfTrans.Top - 800
                    .Width = 1750
                Else
                    .Width = 1470
                End If
...
'        .Height = picDetailList.Height - .Top
    ...
    If fraH.Tag = "1" Then
        ...
        VSFLook.Top = picDetailList.Height - VSFLook.Height
        VSFLook.Left = 0
...
'        txtLog.Height = VSFLook.Height - CmdSave.Height - 50
    ...
    If fraH.Top < vsfTrans.Top + vsfTrans.Height + 50 Then
        fraH.Top = vsfTrans.Top + vsfTrans.Height + 50
        VSFLook.Top = fraH.Top + fraH.Height
        VSFLook.Height = picDetailList.Height - fraH.Top - fraH.Height
    End If
    
    If fraH.Top < vsfMedis.Top + vsfMedis.Height + 50 Then
        fraH.Top = vsfMedis.Top + vsfMedis.Height + 50
        txtLog.Top = fraH.Top + fraH.Height
        txtLog.Height = picDetailList.Height - fraH.Top - fraH.Height - CmdSave.Height - 50
        txtLog.ZOrder
    End If
End Sub
...
Private Sub picHelp_Resize()
    Me.lblCount.Left = picHelp.Width - picFind.Width + 200
End Sub


Private Sub InitTabDeptList()
...
Private Sub tabWork_SelectedChanged(ByVal Item As XtremeSuiteControls.ITabControlItem)
    ...
    If mcondition.strTransStep = M_STR_CALSS_PREPARE Then
        strUnvisble = mstrUnVisble & "审;摆药人;摆药时间;配药人;配药时间;发送人;发送时间;销帐申请人;销帐申请时间;销帐审核人;销帐审核时间;作废类型;"
    ElseIf mcondition.strTransStep = M_STR_CALSS_DOSAGE Then
        strUnvisble = mstrUnVisble & "审;配药人;配药时间;发送人;发送时间;销帐申请人;销帐申请时间;销帐审核人;销帐审核时间;作废类型;"
    ElseIf mcondition.strTransStep = M_STR_CALSS_SEND Then
        strUnvisble = mstrUnVisble & "审;摆药人;摆药时间;发送人;发送时间;销帐申请人;销帐申请时间;销帐审核人;销帐审核时间;作废类型;"
    ElseIf mcondition.strTransStep = M_STR_CALSS_VERIFY Then
        strUnvisble = mstrUnVisble & "选择;摆药人;摆药时间;配药人;配药时间;发送人;发送时间;销帐审核人;销帐审核时间;作废类型;"
    End If
...
'        Next
    ...
    If mcondition.strTransStep = M_STR_CALSS_INVALID Then
        strUnvisble = mstrUnVisble & "审;摆药人;摆药时间;配药人;配药时间;发送人;发送时间;销帐申请人;销帐申请时间;"
    ElseIf mcondition.strTransStep = M_STR_CALSS_SENDED Then
        strUnvisble = mstrUnVisble & "审;摆药人;摆药时间;配药人;配药时间;销帐申请人;销帐申请时间;销帐审核人;销帐审核时间;作废类型;"
    ElseIf mcondition.strTransStep = M_STR_CALSS_DEVICERETURN Then
        strUnvisble = mstrUnVisble & "审;摆药单号;医嘱发送时间;摆药人;摆药时间;配药人;配药时间;发送人;发送时间;销帐申请人;销帐申请时间;销帐审核人;销帐审核时间;作废类型;"
    Else
        strUnvisble = mstrUnVisble & "审;摆药人;摆药时间;配药人;配药时间;发送人;发送时间;销帐申请人;销帐申请时间;销帐审核人;销帐审核时间;作废类型;"
    End If
    ...
    If blnDoIt = True Then
        If mcondition.strTransStep = M_STR_CALSS_AUDIT _
            ...
            With vsfMedis
                ...
                If lblFindItem.Caption = "床号" Then
                    StrFind = txtFindItem.Text & "床"
                Else
        ...
        Else
            With vsfTrans
                ...
                If lngRow > 0 Then
                    ...
                    mstr瓶签号 = txtFindItem.Text
                    If Me.lblFindItem.Caption = "瓶签号" Then
                        If Val(.TextMatrix(lngRow, .ColIndex("选择"))) <> -1 Then
                            For intCol = lngRow To .rows - 1
                                If Val(.TextMatrix(intCol, .ColIndex("配药ID"))) = Val(.TextMatrix(lngRow, .ColIndex("配药ID"))) Then
                                    .TextMatrix(intCol, .ColIndex("选择")) = -1
                                End If
                            Next
                    ...
                    If mParams.blnTwoCode = True And lblFindItem.Caption = "瓶签号" And blnScaner Then
...
'
'                '列宽为空或者隐藏的列设置为不勾选
                If (vsfTrans.ColWidth(i) = 0 Or vsfTrans.ColHidden(i)) Then
...
'Private Sub vsfDrug_AfterRowColChange(ByVal OldRow As Long, ByVal OldCol As Long, ByVal NewRow As Long, ByVal NewCol As Long)
'    With vsfDrug
'        If NewRow >= .FixedRows - 1 And NewCol >= .FixedCols - 1 Then
'            .ForeColorSel = .Cell(flexcpForeColor, NewRow, 1)
'            .Col = 0
...
'Private Sub vsfDrug_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
'    Dim objPopup As CommandBarPopup
...
'    'PASS系统弹出菜单
'    If Button = 2 Then
'        If mParams.blnShowPass = True And vsfDrug.MouseCol = vsfDrug.ColIndex("审查结果") Then
'            If vsfDrug.TextMatrix(vsfDrug.MouseRow, vsfDrug.ColIndex("NO")) = "" Then Exit Sub
'            int单据 = Val(vsfDrug.TextMatrix(vsfDrug.MouseRow, vsfDrug.ColIndex("单据")))
'            strNo = vsfDrug.TextMatrix(vsfDrug.MouseRow, vsfDrug.ColIndex("NO"))
'
'            '检查Pass状态
'            If AdviceCheckWarn(int单据, strNo, 0, vsfDrug.MouseRow) >= 0 Then
...
'      单药警告：应在用药审查过之后进行调用(有警告值)
    ...
    If lng医嘱id = 0 Then
        ...
        lng主页ID = rsTmp!主页id
    Else
        strSQL = "select A.病人id,A.相关id,A.主页id,A.收费细目id,A.开嘱医生,A.单次用量,A.频率次数,A.频率间隔,A.间隔单位,A.医嘱期效,A.开始执行时间 开始时间,A.执行终止时间 结束时间,C.名称 用法,D.名称 药品名称,D.计算单位 from 病人医嘱记录 A,病人医嘱记录 B,诊疗项目目录 C,收费细目 D where A.相关id=B.id and B.诊疗项目id=C.id and A.收费细目id=d.id and A.id=[1]"
    ...
    If lngPatiID <> mlngPassPati Then
        If str挂号单 <> "" Then               '门诊病人
            ...
            Call PassSetPatientInfo(lngPatiID, rsTmp!就诊次数, rsTmp!姓名, NVL(rsTmp!性别), Format(rsTmp!出生日期, "yyyy-MM-dd"), "", "", _
        ...
        Else                                    '住院病人
            ...
            Call PassSetPatientInfo(lngPatiID, lng主页ID, rsTmp!姓名, NVL(rsTmp!性别), Format(rsTmp!出生日期, "yyyy-MM-dd"), "", "", _
...
'        If mcondition.strTransStep = M_STR_CALSS_AUDIT Then
'            If .TextMatrix(.Row, .ColIndex("已审核")) = 0 Then
'                .Cell(flexcpForeColor, mintBeginRow, 1, mintEndRow, .Cols - 1) = vbBlack
'
'            Else
'                .Cell(flexcpForeColor, mintBeginRow, 1, mintEndRow, .Cols - 1) = &HFF0000
'                .ForeColorSel = &HFF0000
'            End If
'        End If
        
        strDiag = RecipeSendWork_GetDiagnosis(2, Val(.TextMatrix(.Row, .ColIndex("病人id"))), Val(.TextMatrix(.Row, .ColIndex("主页id"))), 2)
        txtDia.Text = ""
        If strDiag <> "" Then
            strDiag = strDiag & "|"
...
Private Sub vsfMedis_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Button = 2 Then
        ...
        If IsInString(gstrprivs, "合理用药监测", ";") And vsfMedis.MouseCol = vsfMedis.ColIndex("警") Then
            '检查Pass状态
'            mlng医嘱id = Val(vsfMedis.TextMatrix(vsfMedis.MouseRow, vsfMedis.ColIndex("医嘱id")))
'            If AdviceCheckWarn(9, "000000", 0, vsfMedis.MouseRow, Val(vsfMedis.TextMatrix(vsfMedis.MouseRow, vsfMedis.ColIndex("医嘱id")))) >= 0 Then
'
'                Set objPopup = Me.cbsMain.ActiveMenuBar.FindControl(xtpControlPopup, mconMenu_PASS)
'                If Not objPopup Is Nothing Then
'                    objPopup.CommandBar.ShowPopup
...
'                If Not objPopup Is Nothing Then objPopup.Visible = True
'            End If
...
Private Sub vsfMsg_DblClick()
    ...
    With Me.vsfMsg
        ...
        For i = 1 To Me.vsfDept(Me.tabDeptList.Selected.Index).rows - 1
            If vsfDept(Me.tabDeptList.Selected.Index).TextMatrix(i, vsfDept(Me.tabDeptList.Selected.Index).ColIndex("病区id")) = .TextMatrix(.Row, .ColIndex("病人病区id")) Then
                vsfDept(Me.tabDeptList.Selected.Index).TextMatrix(i, vsfDept(Me.tabDeptList.Selected.Index).ColIndex("选择")) = -1
                Call vsfDept_AfterEdit(Me.tabDeptList.Selected.Index, i, .ColIndex("选择"))
            End If
        Next
        ...
        Select Case .Col
            Case .ColIndex("打包")
                ...
                Do While Not mrsTrans.EOF
                    ...
                    mrsTrans!打包时间 = IIf(.TextMatrix(.Row, .ColIndex("是否打包")) = 0, "", zlDatabase.Currentdate)
                    mrsTrans.Update
                    mrsTrans.MoveNext
                Loop
            ...
            Case .ColIndex("审查结果")
                If IsInString(gstrprivs, "合理用药监测", ";") Then
                    Call gobjPass.zlPassQueryCheckResult_YF(mlngMode, .TextMatrix(.Row, .ColIndex("住院号")), "2")
                End If
            Case .ColIndex("审")
                If .TextMatrix(.Row, .ColIndex("标志")) = "0" Then
                    For lngRow = 1 To .rows - 1
...
'        .Cell(flexcpBackColor, mintBeginRow, 1, mintEndRow, .Cols - 1) = &HFFE8D0
        ...
        If mcondition.strTransStep = M_STR_CALSS_PREPARE Then
            '获取数据
            Set rstemp = PIVA_已摆药输液单(mcondition.lngCenterID, CDate(.TextMatrix(.Row, .ColIndex("执行时间"))), Val(.TextMatrix(.Row, .ColIndex("病人id"))))
            ...
            With Me.VSFLook
                ...
                Do While Not rstemp.EOF
                    ...
                    .TextMatrix(intRow, .ColIndex("批次")) = IIf(NVL(rstemp!配药批次) = "", "", NVL(rstemp!配药批次) & "#")
                    ...
                    .TextMatrix(intRow, .ColIndex("摆药单号")) = NVL(rstemp!摆药单号)
...
Private Sub vsfTrans_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Button = 2 Then
        ...
        If IsInString(gstrprivs, "合理用药监测", ";") And vsfTrans.MouseCol = vsfTrans.ColIndex("审查结果") Then
            'PASS系统弹出菜单
...
'            Set objPopup = Me.cbsMain.ActiveMenuBar.FindControl(xtpControlPopup, mconMenu_PASS)
'
'            Call gobjPass.zlPASSPopupCommandBars_YF(mlngMode, objPopup, mconMenu_PASS, lngPatiID, lng主页ID, str挂号单, str审查结果, lng医嘱id)
        Else
            '右键操作菜单
            With vsfTrans
...
End Sub
Private Function InitMedi(ByVal rsMedi As Recordset, ByVal str配药类型 As String) As Recordset
    Dim rstemp As Recordset
    Dim lng医嘱号 As Long
    Dim lng医嘱id As Long
...
Private Sub LoadVsfMedi(ByVal str病区id As String, Optional ByVal blnFilter As Boolean)
    Dim rstemp As Recordset
    Dim i As Long
    Dim lng医嘱id As Long
    Dim j As Integer
    ...
    If Not blnFilter Then
        Set rstemp = Piva_GetMedi(mcondition.lngCenterID, str病区id, intType, mcondition.strTransStartTime, mcondition.strTransEndTime, mParams.intCheck)
        
        Call InitMedi(rstemp, str配药类型)
    End If
    ...
    With Me.vsfMedis
        ...
        Do While Not mrsMedi.EOF
            ...
            Else
                ...
                .MergeCol(.ColIndex("期效")) = True
                .MergeCol(.ColIndex("给药途径")) = True
            End If
            ...
            .TextMatrix(i, .ColIndex("姓名")) = NVL(mrsMedi!姓名)
            .TextMatrix(i, .ColIndex("性别")) = NVL(mrsMedi!性别)
            .TextMatrix(i, .ColIndex("年龄")) = NVL(mrsMedi!年龄)
            .TextMatrix(i, .ColIndex("床号")) = IIf(NVL(mrsMedi!床号) = "", "<空>", mrsMedi!床号 & "床")
            .TextMatrix(i, .ColIndex("住院号")) = NVL(mrsMedi!住院号, " ")
            .TextMatrix(i, .ColIndex("名字")) = NVL(mrsMedi!姓名, " ")
            .TextMatrix(i, .ColIndex("病区ID")) = NVL(mrsMedi!病人病区ID, " ")
            .TextMatrix(i, .ColIndex("科室ID")) = NVL(mrsMedi!病人科室id, " ")
            .TextMatrix(i, .ColIndex("科室")) = NVL(mrsMedi!科室)
            .TextMatrix(i, .ColIndex("开单医生")) = NVL(mrsMedi!开单医生)
            .TextMatrix(i, .ColIndex("药品名称")) = NVL(mrsMedi!药品名称) & "，" & NVL(mrsMedi!规格)
            .TextMatrix(i, .ColIndex("药师审核原因")) = NVL(mrsMedi!药师审核原因)
            .TextMatrix(i, .ColIndex("警告")) = NVL(mrsMedi!审查结果)
            .TextMatrix(i, .ColIndex("药品id")) = Val(mrsMedi!药品id)
            .TextMatrix(i, .ColIndex("药名")) = NVL(mrsMedi!药品名称)
            .TextMatrix(i, .ColIndex("配药类型")) = NVL(mrsMedi!配药类型)
            ...
            If mrsMedi!是否皮试 = 1 Then
                .TextMatrix(i, .ColIndex("皮")) = Get皮试结果(Val(mrsMedi!病人ID), Val(mrsMedi!药名ID), dateCurrent, mrsMedi!开嘱时间)
            End If
            
            .TextMatrix(i, .ColIndex("规格")) = NVL(mrsMedi!规格)
            .TextMatrix(i, .ColIndex("单量")) = Format(NVL(mrsMedi!单量), "#####0.00000;-#####0.00000; ;")
            .TextMatrix(i, .ColIndex("单位")) = NVL(mrsMedi!单位)
            .TextMatrix(i, .ColIndex("频率")) = NVL(mrsMedi!频次)
            .TextMatrix(i, .ColIndex("执行时间")) = NVL(mrsMedi!执行时间)
    ...
    With mrsSendMsg
        ...
        For i = 1 To .RecordCount
            ...
            Call objDrugXML.AppendNode("patient_clinic")
                ...
                Call objDrugXML.AppendData("clinic_bed", IIf(!床号 = "<空>", "", Replace(NVL(!床号, ""), "床", "")))
