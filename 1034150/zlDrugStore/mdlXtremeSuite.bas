...
Public Const mconMenu_File_PIVA_BillPrintTotalByBat = 158         '按批次打印发药清单
...
Public Const mconMenu_View_Expand_TheMenu = 793       '显示拓展菜单(&G)
Public Const mconMenu_View_Expand_TheMenu_Picture = 794         '显示药品图片(&N)
Public Const mconMenu_View_Expand_TheMenu_Text = 795            '显示用药说明(&S)
