...
Begin VB.Form Frm部门发药参数设置 
   ...
   Begin TabDlg.SSTab tabShow 
      ...
      Tab(1).Control(0)=   "lbl发药清单"
      Tab(1).Control(1)=   "lbl退药清单"
      Tab(1).Control(2)=   "lblName"
      Tab(1).Control(3)=   "Chk是否自动缺药检查"
      Tab(1).Control(4)=   "Frame3"
      Tab(1).Control(5)=   "chk药品储备"
      Tab(1).Control(6)=   "fra设备定义"
      Tab(1).Control(7)=   "cbo发药清单"
      Tab(1).Control(8)=   "cbo退药清单"
      Tab(1).Control(9)=   "frm高危药品发放"
      Tab(1).Control(10)=   "cboName"
      ...
      Tab(5).Control(0)=   "lbl票据"
      Tab(5).Control(1)=   "cbo票据设置"
      Tab(5).Control(2)=   "cmd打印设置"
