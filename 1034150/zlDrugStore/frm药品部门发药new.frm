...
Begin VB.Form frm部门发药管理New 
   ...
   Begin MSComctlLib.ImageList imgPacker 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm药品部门发药new.frx":113F2
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm药品部门发药new.frx":1198C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm药品部门发药new.frx":11F26
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin MSComctlLib.ImageList imgTvw 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   4
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm药品部门发药new.frx":124C0
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm药品部门发药new.frx":12A5A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm药品部门发药new.frx":12FF4
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm药品部门发药new.frx":1358E
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imgLvwSel 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   4
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm药品部门发药new.frx":13B28
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm药品部门发药new.frx":13E42
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm药品部门发药new.frx":1415C
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm药品部门发药new.frx":144AE
            Key             =   "Up"
         EndProperty
      EndProperty
   End
   ...
   Begin MSComctlLib.StatusBar stbThis 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   3175
            MinWidth        =   3175
            Picture         =   "frm药品部门发药new.frx":14800
            Text            =   "中联软件"
            TextSave        =   "中联软件"
            Key             =   "ZLFLAG"
   ...
   Begin XtremeDockingPane.DockingPane dkpMain 
      Bindings        =   "frm药品部门发药new.frx":15094
      Left            =   4440
      Top             =   360
      _Version        =   589884
      _ExtentX        =   450
...
Private Sub DrugStoreWork_PrintBill()
    ...
    If GetSetting("ZLSOFT", "私有模块\zl9Report\LocalSet\ZL1_BILL_1342", "AllFormat") <> "" Then
...
Private Sub PackerTransDetail_DYEY(ByVal rsData As ADODB.Recordset)
    ...
    With rsData
        ...
        lng当前部门 = !领药部门ID
        str部门 = !领药部门编码 & ";" & mstr药房编码 & ";" & str分包设备编号 & IIf(gstrUnitName = GCST_UNIT_YQMY, ";" & CStr(mcur汇总发药号), "")
        Do While Not .EOF
        ...
        Do While Not .EOF
            ...
            If rsTmp.RecordCount > 0 Then
                ...
                With mrsApplyforcredit
                    ...
                    !批号 = rsData!批号
                    !数量 = rsData!数量
                    !销帐申请数量 = zlStr.FormatEx(rsTmp!销帐申请数量 / rsData!包装, 5) & rsData!单位
                    !姓名 = rsData!姓名
                    !性别 = rsData!性别
                    !年龄 = rsData!年龄
                    !领药部门 = rsData!领药部门
...
'                    blnBeginTrans = True
'                    Call zldatabase.ExecuteProcedure(gstrSQL, Me.Caption & "-按病人发药")
'
...
'                    End If
'                Else
                    strID批次串 = IIf(strID批次串 = "", !收发Id & "," & NVL(!批次, 0), strID批次串 & "|" & !收发Id & "," & NVL(!批次, 0))
                    strID串 = IIf(strID串 = "", !收发Id, strID串 & "," & !收发Id)
                    If InStr(1, strInputID, !医嘱id & ",3|") < 1 And NVL(!医嘱id, 0) <> 0 And Not (!类别 = "E" And !执行分类 = 1 And mblnIs配置中心) Then
                        strInputID = strInputID & !医嘱id & ",3|"
                    End If
'                End If
            Else
                '如果病人ID不同则提交事务
...
'                    Call zldatabase.ExecuteProcedure(gstrSQL, "首次执行医嘱审核")
                ...
                If gblnESign部门发药 = True And gblnESignUserStoped = False Then
                    ...
                    gstrSQL = Signature(rsSign, StrCurDate, str配药人, lng病人ID)
...
'            Call Signature(rsData, StrCurDate, str配药人)
'        End If
    End If
    If ErrCenter = 1 Then
        Resume
...
Private Function Signature(ByVal rsData As Recordset, ByVal StrCurDate As String, ByVal str配药人 As String, ByVal lng病人ID As Long) As String
    Dim str签名记录 As String
    Dim strSQL As String
    ...
    If gblnESign部门发药 = True And gblnESignUserStoped = False Then
        If rsData.RecordCount > 0 Then
            If GetSignatureRecoredGather(EsignTache.send, rsData, mcondition.lng药房ID, str配药人, gstrUserName, StrCurDate, str签名记录) = False Then
                Exit Function
            End If
            
            If str签名记录 <> "" Then
                strSQL = "Select 药品签名记录_Id.Nextval 签名id From Dual"
                Set rsTemp = zldatabase.OpenSQLRecord(strSQL, "获取签名id")
                
                lng签名id = Val(rsTemp!签名ID)
...
'                For lngRow = 0 To UBound(Split(str收发ID, ","))
'                    If Len(strTemp & "," & Split(str收发ID, ",")(lngRow)) >= 4000 Then
'                        strSQL = "Zl_药品签名记录_Insert(" & str签名记录 & "'" & str收发ID & "'," & lng签名id & ")"
'
'                        ReDim Preserve arrSql(UBound(arrSql) + 1)
'                        arrSql(UBound(arrSql)) = strSQL
'
'                        strTemp = Split(str收发ID, ",")(lngRow)
'                    Else
'                        strTemp = IIf(strTemp = "", Split(str收发ID, ",")(lngRow), strTemp & "," & Split(str收发ID, ",")(lngRow))
'                    End If
'
'                    If lngRow = UBound(Split(str收发ID, ",")) And str签名记录 <> "" Then
'                        strSQL = "Zl_药品签名记录_Insert(" & str签名记录 & "'" & strTemp & "'," & lng签名id & ")"
'
'                        ReDim Preserve arrSql(UBound(arrSql) + 1)
'                        arrSql(UBound(arrSql)) = strSQL
'                    End If
...
'                    If InStr(TxtInput.Text, "-") > 0 Then
'                        .str床号 = Mid(Trim(TxtInput.Text), 1, InStr(TxtInput.Text, "-") - 1)
'                    Else
'                        .str床号 = Trim(TxtInput.Text)
'                    End If
                Case mInputType.NO
                    If InStr(txtInput.Text, "-") > 0 Then
                ...
                If mParams.blnOnlyShowDept = False Then
                    ...
                    Do While Not rsData.EOF
                        ...
                        If ((str当前NO <> rsData!NO) Or (str当前NO = rsData!NO And str当前病人姓名 <> rsData!姓名)) Then
                            ...
                            strType = IIf(NVL(rsData!医嘱序号, 0) = 0, IIf(rsData!门诊标志 = 1 Or rsData!门诊标志 = 4, "门诊记帐单", IIf(rsData!单据 = 9, "住院记帐单", "住院记帐表")), IIf(IsNull(rsData!扣率) = True, "住院记帐单", IIf(rsData!扣率 Like "0*", "长嘱", IIf(rsData!扣率 Like "1*", "临嘱", "记帐表"))))
...
Private Sub InitSendRec()
    ...
    With mrsSendData
        ...
        .Fields.Append "间隔单位", adLongVarChar, 20, adFldIsNullable
        .Fields.Append "执行时间方案", adLongVarChar, 50, adFldIsNullable
        .Fields.Append "频率次数", adDouble, 18, adFldIsNullable
        .Fields.Append "发送数次", adDouble, 18, adFldIsNullable
...
Private Sub LoadCustomSet()
    ...
    mParams.int输入模式 = Val(GetSetting("ZLSOFT", "私有模块\" & gstrDbUser & "\界面设置\" & App.ProductName & "\" & Me.Name, "输入模式", 0))
    If mParams.int输入模式 < 0 Then
        mParams.int输入模式 = 0
    End If
...
Private Sub RefreshChargeOffDetail()
    ...
    gstrSQL = gstrSQL & " Group By C.单据, C.NO, C.序号, C.药品id " & _
    ...
    Do While Not rsTemp.EOF
        With mrsChargeOff
            ...
            !费用ID = rsTemp!费用ID
            !记录性质 = rsTemp!记录性质
            !批次 = IIf(IsNull(rsTemp!批次), 0, rsTemp!批次)
            !审核标志 = 0
            !执行标志 = 0
...
Private Sub InitReturnRec()
    ...
    With mrsReturnData
        ...
        .Fields.Append "销帐申请", adDouble, 1, adFldIsNullable         '适用于参数[有销帐申请时不能进行退药操作],当参数启用时，此字段才接受对应的值
...
Private Function LoadSendRecord(ByVal rsData As ADODB.Recordset) As Boolean
    ...
    With rsData
        Do While Not .EOF
            ...
            mrsSendData!类型 = IIf(NVL(!医嘱序号, 0) = 0, IIf(!门诊标志 = 1 Or !门诊标志 = 4, "门诊记帐单", IIf(!单据 = 9, "住院记帐单", "住院记帐表")), IIf(IsNull(!扣率) = True, "住院记帐单", IIf(!扣率 Like "0*", "长嘱", IIf(!扣率 Like "1*", "临嘱", "记帐表"))))
            ...
            mrsSendData!抗生素 = !抗生素
            mrsSendData!用药目的 = NVL(!用药目的)
            mrsSendData!用药理由 = !用药理由
            mrsSendData!用药次数 = IIf(Val(NVL(!发送数次)) < 0, 0, Val(NVL(!发送数次)))
            ...
            mrsSendData!数量 = FormatEx(IIf(IsNull(!数量), 1, !数量) / !包装, 5) & !单位
            mrsSendData!单价 = FormatEx(!单价 * !包装, 5)
...
'            mrsSendData!金额 = Format(!金额, "#####0.00;-#####0.00; ;")
            mrsSendData!金额 = !金额
            mrsSendData!单量 = IIf(IsNull(!单量), "", FormatEx(!单量, 5) & NVL(!计算单位) & "(" & FormatEx(!单量 / !剂量系数 / !包装, 5) & !单位 & ")")
            mrsSendData!原始单量 = IIf(IsNull(!单量), "", FormatEx(!单量, 5) & NVL(!计算单位))
            mrsSendData!频次 = IIf(IsNull(!频次), "", !频次)
            mrsSendData!间隔单位 = IIf(IsNull(!间隔单位), "", !间隔单位)
            mrsSendData!执行时间方案 = IIf(IsNull(!执行时间方案), "", !执行时间方案)
            mrsSendData!频率次数 = IIf(IsNull(!执行时间方案), 0, !频率次数)
            mrsSendData!发送数次 = IIf(IsNull(!执行时间方案), 0, !发送数次)
            mrsSendData!实际数量 = FormatEx(Val(IIf(IsNull(!数量), 1, !数量)) * (Val(IIf(IsNull(!付), 1, !付))) / !包装, 5)
            mrsSendData!单量单位 = NVL(!计算单位)
            ...
            mrsSendData!留存数量 = FormatEx(IIf(IsNull(!留存数量), 0, !留存数量) / !包装, 5)
...
Private Function LoadReturnRecord(ByVal rsData As ADODB.Recordset) As Boolean
    ...
    With rsData
        Do While Not .EOF
            ...
            mrsReturnData!类型 = IIf(NVL(!医嘱序号, 0) = 0, IIf(!门诊标志 = 1 Or !门诊标志 = 4, "门诊记帐单", IIf(!单据 = 9, "住院记帐单", "住院记帐表")), IIf(IsNull(!扣率) = True, "住院记帐单", IIf(!扣率 Like "0*", "长嘱", IIf(!扣率 Like "1*", "临嘱", "记帐表"))))
            ...
            mrsReturnData!数量 = FormatEx(IIf(IsNull(!数量), 1, !数量) / !包装, 5) & !单位
'            If !可操作 <> 1 Then
'                mrsReturnData!已退数 = FormatEx(IIf(IsNull(!已退数量), 1, !已退数量) / !包装, 5)
'                mrsReturnData!准退数 = FormatEx(IIf(IsNull(!准退数), 1, !准退数) / !包装, 5)
'                mrsReturnData!退药数 = FormatEx(IIf(IsNull(!准退数), 1, !准退数) / !包装, 5)
'            Else
                dblSumSended = GetSumSended(!单据, !NO, !药品ID, !序号)
                mrsReturnData!已退数 = FormatEx((Val(IIf(IsNull(!数量), 1, !数量)) * (Val(IIf(IsNull(!付), 1, !付))) - dblSumSended) / !包装, 5)
                mrsReturnData!准退数 = FormatEx(dblSumSended / !包装, 5)
                mrsReturnData!退药数 = FormatEx(dblSumSended / !包装, 5)
'            End If
            mrsReturnData!包装 = !包装
            mrsReturnData!单位 = !单位
            mrsReturnData!单价 = FormatEx(!单价 * !包装, 5)
            mrsReturnData!金额 = !金额
            mrsReturnData!单量 = IIf(IsNull(!单量), "", FormatEx(!单量, 5) & NVL(!计算单位) & "(" & FormatEx(!单量 / !剂量系数 / !包装, 5) & !单位 & ")")
            mrsReturnData!单量单位 = NVL(!计算单位)
            ...
            If mParams.bln有销帐申请时不能进行退药操作 Then
                mrsReturnData!销帐申请 = !销帐申请
            End If
...
Private Sub SaveCustomSet()
    ...
    SaveSetting "ZLSOFT", "私有模块\" & gstrDbUser & "\界面设置\" & App.ProductName & "\" & Me.Name, "输入模式", mParams.int输入模式
...
Private Sub RefreshSendDept()
    ...
    gstrSQL = gstrSQL & IIf(mblnIs配置中心 And mParams.intCheck = 1, ",病人医嘱记录 F", "")
    ...
    gstrSQL = gstrSQL & " Where A.对方部门id = H.ID" & IIf(mParams.strSourceDep = "", "", " And A.对方部门id=E.Column_Value ") & _
        ...
        IIf(mblnIs配置中心 And mParams.intCheck = 1, "And F.id(+)=C.医嘱序号 And (F.id is null or (F.id is not null and F.药师审核标志=1)) ", "") & _
    ...
    ElseIf mcondition.lng病人ID <> -1 Or (Val(lblPatiInputType.Tag) = mInputType.IC卡 And Me.txtInput.Text <> "") Then
        gstrSQL = gstrSQL & " And C.病人ID = [9] "
    ...
    If mParams.blnShowReject = True Then
        ...
        strTmpSql = " (Select A.单据, A.NO, A.病人id, A.主页id, A.姓名, Nvl(B.优先级, 0) 优先级, A.对方部门id, A.库房id, A.发药窗口, A.填制日期, A.已收费, Null As 配药人," & _
                ...
                " From 住院费用记录 A, 药品收发记录 B, 病人信息 C " & _
                 IIf(mblnIs配置中心 And mParams.intCheck = 1, ",病人医嘱记录 F", "") & _
                " Where A.ID = B.费用id + 0 And B.单据 In (9, 10) And B.审核日期 Is Null And B.摘要 = '拒发' And " & _
                IIf(mblnIs配置中心 And mParams.intCheck = 1, " F.id(+)=A.医嘱序号 And (F.id is null or (F.id is not null and F.药师审核标志=1)) And ", "") & _
...
Private Sub RefreshSendDetail()
    ...
    strSqlTmp = "SELECT DISTINCT S.ID As 收发ID,to_char(s.效期,'yyyy-mm-dd') 效期,S.记录状态,S.药品ID,S.费用id,NVL(N.已收费,0) 已收费,P.名称 科室,S.配药人,C.开单人 开单医生,C.操作员姓名 审核人,S.单据,S.扣率, " & _
             ...
             " C.医嘱序号,I.计算单位,NVL(S.产地,NVL(X.产地,'')) 产地,nvl(M.审查结果,-1) 审查结果,M.皮试结果,Nvl(M.开嘱时间,C.登记时间) As 开嘱时间,decode(m.用药目的,1,'预防',2,'治疗',3,'预防和治疗','') 用药目的,m.用药理由,D.药名ID,nvl(C.医嘱序号,-1) 医嘱id," & IIf(mParams.bln药品储备 = True, "L.", "'' ") & "库房货位," & _
             " M.相关ID,M.药师审核标志,C.病人科室ID As 科室ID,C.序号 费用序号," & IIf(mParams.bln药品储备 = True, "Decode(Sign(Nvl(K.库存数量, 0) - Nvl(L.下限, 0)), -1, 0, 1) ", "0 ") & " 库存下限, Z.名称 As 英文名, Decode(Nvl(c.婴儿费,0), 0, Q.年龄, Ceil(Sysdate - U.出生时间) || '天') 年龄,Q.病人类型,W.颜色,N.领药号, " & _
             IIf(mParams.int药品名称显示 = 0 Or mParams.int药品名称显示 = 2, "NVL(E.名称,'')", "Decode(E.名称,Null,'',X.名称)") & " As 其它名, " & _
             "'['||X.编码||']'||" & IIf(mParams.int药品名称显示 = 1, "NVL(E.名称,X.名称)", "X.名称") & " As 品名,nvl(N.名称,'') 配方名称," & _
             "X.编码" & " As 药品编码," & IIf(mParams.int药品名称显示 = 1, "NVL(E.名称,X.名称)", "X.名称") & " As 药品名称,s.入出类别id,s.入出系数,s.填制人,s.填制日期,s.配药日期,Nvl(t.是否皮试,0) As 是否皮试,F.执行分类,F.类别,D.剂量系数, m.医生嘱托, m.间隔单位, m.执行时间方案, m.频率次数 "
'    '测试分组（相关ID设为1）
...
'             "X.编码" & " As 药品编码," & IIf(mParams.int药品名称显示 = 1, "NVL(E.名称,X.名称)", "X.名称") & " As 药品名称,s.入出类别id,s.入出系数,s.填制人,s.填制日期,s.配药日期"
    ...
    '''from
    strSqlTmp = strSqlTmp & " FROM 药品收发记录 S,住院费用记录 C,病人医嘱记录 M,病人医嘱记录 G,未发药品记录 N,收费项目别名 E,收费项目目录 X,诊疗项目目录 I,诊疗项目目录 N,诊疗项目目录 F," & _
    ...
    strSqlTmp = strSqlTmp & " WHERE S.NO=N.NO AND S.单据=N.单据 AND NVL(S.库房ID,[1])+0=NVL(N.库房ID,[1]) AND S.费用ID=C.ID And S.药品ID=D.药品ID And c.病人id = u.病人id(+) And c.婴儿费 = u.序号(+) And C.主页id=U.主页id(+) " & _
            ...
            " AND C.病人科室ID=P.id And d.药品ID=X.ID and D.药名ID=T.药名ID AND D.药名ID=I.ID and C.医嘱序号=M.ID(+) and M.相关id=G.id(+) and G.配方id=N.id(+) and G.诊疗项目id=F.id(+) " & _
...
Private Sub RefreshReturnDetail()
    ...
    gstrSQL = " SELECT /*+rule*/ DISTINCT S.ID As 收发ID,S.单据,S.药品ID,S.NO,S.序号,S.扣率,H.ID As 领药部门ID,P.名称 科室,C.门诊标志,C.标识号,C.病人ID,C.床号,Decode(Nvl(c.婴儿费,0), 0, Nvl(W.姓名, C.姓名), U.婴儿姓名) 姓名,Decode(Nvl(c.婴儿费,0), 0, Nvl(W.性别, C.性别), U.婴儿性别) 性别," & _
             ...
             " NVL(S.产地,NVL(X.产地,'')) 产地,nvl(M.审查结果,-1) 审查结果,nvl(C.医嘱序号,-1) 医嘱id,S.领药人," & IIf(mParams.bln药品储备 = True, "L.", "'' ") & "库房货位, " & _
             " M.相关ID,c.序号 费用序号,Z.名称 As 英文名,0 As 转出, S.发药号,D.剂量系数,m.医生嘱托 " & IIf(mParams.bln有销帐申请时不能进行退药操作, " , Decode(e.状态, 0, 1, 0) As 销帐申请 ", "") & _
             " FROM "
    gstrSQL = gstrSQL & _
    ...
    gstrSQL = gstrSQL & _
             ...
             "          ) S,"
    gstrSQL = gstrSQL & "" & _
             "      住院费用记录 C,部门表 P,药品规格 D,收费项目目录 X,收费项目别名 A,药品特性 T,诊疗项目目录 I,病人医嘱记录 M,病人医嘱发送 Q,病人信息 R,病案主页 W," & IIf(mParams.bln药品储备 = True, "药品储备限额 L,", "") & "诊疗项目别名 Z,部门表 H, 病人新生儿记录 U " & IIf(mParams.bln有销帐申请时不能进行退药操作, " , (Select 费用id, 状态 From 病人费用销帐 Where 状态 = 0) E ", "")
     
     
    '''where
    gstrSQL = gstrSQL & " WHERE S.药品ID=D.药品ID And C.病人id=W.病人id And C.主页id=W.主页id AND D.药名ID=T.药名ID AND d.药品ID=x.ID AND C.病人科室ID+0=P.ID AND D.药名ID=I.ID and C.医嘱序号=M.ID(+)  and C.医嘱序号=Q.医嘱id(+) And c.No = q.No(+) And c.病人id = u.病人id(+) And c.婴儿费 = u.序号(+) And C.主页id=U.主页id(+) " & _
             " And D.药名id = Z.诊疗项目id(+) And Z.性质(+) = 2 " & IIf(mParams.bln药品储备 = True, " And S.药品ID=L.药品ID(+) And Nvl(S.库房ID,[1])=L.库房ID(+) ", "") & _
             " AND D.药品ID=A.收费细目ID(+) AND A.性质(+)=3 And C.病人id = R.病人id " & _
             " AND S.费用ID=C.ID And S.单据 IN(9,10) " & _
             " AND S.审核人 IS NOT NULL And s.对方部门id + 0 = h.Id " & IIf(mParams.bln有销帐申请时不能进行退药操作, " And s.费用id = e.费用id(+) ", "")
    ...
    Dim strSQL As String
    '判断是否存在部分数据已转出
    blnMoved = zldatabase.DateMoved(mcondition.str开始时间)
    If blnMoved Then
...
'        .Add FSHIFT, VK_DELETE, mconMenu_Edit_Delete
    ...
    With cbrMenuBar.CommandBar.Controls
        Set cbrControlMain = .Add(xtpControlButton, mconMenu_Input_Dept_HosNumber, "住院号(&0)")
        cbrControlMain.Parameter = "住|住院号|0|||||"
        cbrControlMain.Checked = True
        Set cbrControlMain = .Add(xtpControlButton, mconMenu_Input_Dept_Name, "姓名(&1)")
        cbrControlMain.Parameter = "姓|姓名|0|||||"
        Set cbrControlMain = .Add(xtpControlButton, mconMenu_Input_Dept_BedNumber, "床号(&2)")
        cbrControlMain.Parameter = "床|床号|0||||||"
        Set cbrControlMain = .Add(xtpControlButton, mconMenu_Input_Dept_NO, "单据号(&3)")
        cbrControlMain.Parameter = "单|单据号|0||||||"
        Set cbrControlMain = .Add(xtpControlButton, mconMenu_Input_Dept_Ident, "病人ID(&4)")
        cbrControlMain.Parameter = "病|病人ID|0||||||"
        Set cbrControlMain = .Add(xtpControlButton, mconMenu_Input_Dept_ReceiveNO, "领药号(&5)")
        cbrControlMain.Parameter = "领|领药号|0||||||"
        Set cbrControlMain = .Add(xtpControlButton, mconMenu_Input_Dept_BatchSendNO, "汇总发药号(&6)")
        cbrControlMain.Parameter = "发|发药号|0||||||"
        Set cbrControlMain = .Add(xtpControlButton, mconMenu_Input_Dept_Dept, "领药部门(&7)")
        cbrControlMain.Parameter = "部|领药部门|0||||||"
        Set cbrControlMain = .Add(xtpControlButton, mconMenu_Input_Dept_ICCard, "IC卡(&8)")
        ...
        If mstrCardType <> "" Then
            ...
            For intCount = 0 To UBound(Split(mstrCardType, ";"))
                ...
                '去除重复加载的类型
                If InStr(";住院号;姓名;床号;单据号;病人ID;领药号;汇总发药号;领药部门;IC卡;", ";" & strCardName & ";") = 0 Then
...
'    If gtype_UserSysParms.P222_药房自动化发药接口 = 0 Then
'        '未启动时不显示包装机图标
'        Me.stbThis.Panels(5).Visible = False
'    Else
'        '根据连接状态显示不同的发药机图标
'        If gtype_UserSysParms.P222_药房自动化发药接口 = 1 And gobjPackerZY Is Nothing Then
'            '正常传送时
...
Private Sub UpdateDeptListRecord(ByVal intType As Integer)
    ...
    With tvwList(intType)
        If mParams.blnOnlyShowDept = False Then
            '如果是显示详细信息，则按实际勾选的NO号标记
            For i = 1 To .Nodes.count
                If Mid(.Nodes(i).Key, 1, 1) = "N" Then
                    mrsDeptList.Filter = "NO='" & Split(.Nodes(i).Tag, "|")(0) & "' and 病人id=" & Val(Split(.Nodes(i).Tag, "|")(1)) & " and 病人姓名='" & Split(.Nodes(i).Tag, "|")(2) & "'"
                    Do While Not mrsDeptList.EOF
                        mrsDeptList!执行状态 = IIf(.Nodes(i).Checked = True, 1, 0)
                        mrsDeptList.Update
            ...
            Next
        Else
            '如果仅显示部门名称，则按实际勾选的部门标记
            For i = 1 To .Nodes.count
                If Mid(.Nodes(i).Key, 1, 1) = "D" Then
                    mrsDeptList.Filter = "科室ID=" & Mid(.Nodes(i).Key, 3) & ""
                    Do While Not mrsDeptList.EOF
                        mrsDeptList!执行状态 = IIf(.Nodes(i).Checked = True, 1, 0)
                        mrsDeptList.Update
...
Private Sub cbsMain_Execute(ByVal Control As XtremeCommandBars.ICommandBarControl)
    ...
    Select Case Control.Id
        ...
        Case mconMenu_Edit_Dept_Hot_IC
            If lblPatiInputType.Tag = mInputType.IC卡 Then
                Call cmdIC_Click
            End If
        Case Else
...
Private Sub SetInputPopupCheck(ByVal Control As XtremeCommandBars.ICommandBarControl)
    ...
    If Not cbrMenuBar Is Nothing Then
        ...
        If Split(Control.Caption, "(")(0) = "领药部门" Then
        ...
        mParams.int输入模式 = Val(lblPatiInputType.Tag)
        txtInput.Text = ""
...
Private Sub cmdIC_Click()
    ...
    If Val(lblPatiInputType.Tag) = mInputType.IC卡 Then
...
Private Sub cmdRefresh_Click()
    ...
    Call UpdateDeptListRecord(IIf(tbcDetail.Selected.Index = 4, mDeptType.退药, mDeptType.发药))
...
Private Sub Form_Load()
    ...
    mblnIs配置中心 = Is配置中心(mParams.lng药房ID)
    Call Cbo发药药房_Click
...
Private Sub lblPatiInputType_MouseUp(Button As Integer, Shift As Integer, x As Single, y As Single)
    ...
    If Button = 1 Then
        ...
        If Not objPopup Is Nothing Then
            ...
            cbrControl.Enabled = tbcDetail.Selected.Index <> mListType.退药
...
Private Sub picConMain_Resize()
    ...
    With cmdIC
        .Visible = (Val(Split(txtInput.Tag, "|")(gCardFormat.刷卡标志)) = 1)
        .Top = txtInput.Top
        .Left = picConMain.Width - .Width - 80
        
        If Val(Split(txtInput.Tag, "|")(gCardFormat.刷卡标志)) = 1 Then
...
'    On Error GoTo errHandle
    ...
    If mcur汇总发药号 > 0 Then
        stbThis.Panels(2).Text = "上次发药号：" & mcur汇总发药号 & ""
    End If
...
Private Sub TimerReturn_Timer()
    ...
    Me.stbThis.Panels(3).Text = "未处理的销帐数据" & rsTemp!数量 & "条"
...
Private Function CheckCorrelation(ByVal intType As Integer, ByVal rsSendData As ADODB.Recordset) As Boolean
    ...
    With rsSendData
        ...
        Do While Not .EOF
            ...
            If Not IsOutPatient(mstrPrivs, lng单据, strNo, 2, 2) Then Exit Function
            .MoveNext
        Loop
    End With
    ...
    If UBound(arrSql) >= 0 And gblnESign部门发药 = True And gblnESignUserStoped = False Then
        With rsReturnData
            ...
            Do While Not .EOF
                ...
                If GetSignatureRecored(EsignTache.returnStep, !单据, !NO, mcondition.lng药房ID, str签名记录, rsTemp!Id) = False Then
                    If blnBeginTrans = True Then gcnOracle.RollbackTrans
                    Exit Sub
                End If
...
Private Sub txtInput_KeyPress(KeyAscii As Integer)
    ...
    If Val(lblPatiInputType.Tag) = mInputType.住院号 Or Val(lblPatiInputType.Tag) = mInputType.病人ID Then
        If KeyAscii >= Asc("0") And KeyAscii <= Asc("9") Or KeyAscii = vbKeyEscape Or KeyAscii = vbKeyBack Then Exit Sub
        KeyAscii = 0
    ElseIf Val(lblPatiInputType.Tag) = mInputType.姓名 Then
        '姓名类别
...
'            txtInput.Tag = Mid(Split(strDeptInfo, "|")(1), 1, InStr(Split(strDeptInfo, "|")(1), ",") - 1)
    ...
    If Val(lblPatiInputType.Tag) <> mInputType.领药部门 Then
        mblnInput = True
    End If
...
Private Function GetPatiInfo(ByVal intType As Integer, ByVal strInfo As String) As String
    ...
    ElseIf intType > 8 Then
        ...
        If Not mobjSquareCard Is Nothing Then
            '通过卡ID和卡号查找病人ID
            Call mobjSquareCard.zlGetPatiID(Split(Split(mstrCardType, ";")(intType - 9), "|")(3), txtInput.Text, True, lng病人ID)
        End If
