...
'PACS工作站菜单
Public Const conMenu_Manage_PacsCritical = 8343                     '危急情况
Public Const conMenu_Manage_PacsCriticalReg = 8344                '危急患者登记
Public Const conMenu_Manage_PacsCriticalManage = 8345         '危急患者管理
...
Public Const conMenu_Manage_SetXWParam = 8227             '新网PACS参数
...
Public Const conMenu_Manage_Disease = 8237              '传染病
Public Const conMenu_Manage_DiseaseRegist = 8238        '传染病登记
Public Const conMenu_Manage_DiseaseQuery = 8239         '传染病查询
Public Const conMenu_Manage_PacsPlugLevel2 = 8240        '插件配置_2级菜单
Public Const conMenu_Manage_PacsPlugIn = 8235           'Pacs第三方功能挂接
Public Const conMenu_Manage_PacsPlugCfg = 8236          '插件配置
Public Const conMenu_Manage_LookMecRecord = 8243         '病案查阅
Public Const conMenu_Manage_SendAudit = 8244         '发送审核
Public Const conMenu_Tool_Valid = 8245                  '图像校对工具
...
Public Const conMenu_PacsReport_FontSetDefault = 8360        '字号默认
Public Const conMenu_PacsReport_FontSet14 = 8361        '字号14
Public Const conMenu_PacsReport_FontSet16 = 8362        '字号16
Public Const conMenu_PacsReport_FontSet22 = 8363        '字号22
Public Const conMenu_PacsReport_FontSet28 = 8364        '字号28
Public Const conMenu_PacsReport_FontSet36 = 8365        '字号36
Public Const conMenu_PacsReport_FontSet42 = 8366       '字号42
Public Const conMenu_PacsReport_FontSetUser = 8367       '字号自定义
...
Public Const conMenu_Cap_SendToAdvice = 8143    '发送到检查
Public Const conMenu_Cap_SendToAfter = 8144     '发送到后台
...
Public Const conMenu_PatholMaterial_LAB = 3984           '病理打印
...
Public Const conMenu_PatholProRep_Report = 4117                    '报告打印
