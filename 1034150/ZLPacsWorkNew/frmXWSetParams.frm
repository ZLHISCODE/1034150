...
'------------------------------------------------
    ...
    txtDBServerPswd = GetDecryptionPassW(zlDatabase.GetPara("XW数据库服务器密码", glngSys, G_LNG_XWPACSVIEW_MODULE, ""))
    ...
    txtDelImagePswd = GetDecryptionPassW(zlDatabase.GetPara("XW删除图像密码", glngSys, G_LNG_XWPACSVIEW_MODULE, ""))
    
    txtSendImageUser = zlDatabase.GetPara("XW发送图像用户名", glngSys, G_LNG_XWPACSVIEW_MODULE, "")
    txtSendImagePswd = GetDecryptionPassW(zlDatabase.GetPara("XW发送图像密码", glngSys, G_LNG_XWPACSVIEW_MODULE, ""))
    
    txtDVDBurnUser = zlDatabase.GetPara("XW光盘刻录用户名", glngSys, G_LNG_XWPACSVIEW_MODULE, "")
    txtDVDBurnPswd = GetDecryptionPassW(zlDatabase.GetPara("XW光盘刻录密码", glngSys, G_LNG_XWPACSVIEW_MODULE, ""))
...
'------------------------------------------------
    ...
    Call zlDatabase.SetPara("XW数据库服务器密码", GetEncryptionPassW(txtDBServerPswd.Text), glngSys, G_LNG_XWPACSVIEW_MODULE)
    ...
    Call zlDatabase.SetPara("XW删除图像密码", GetEncryptionPassW(txtDelImagePswd.Text), glngSys, G_LNG_XWPACSVIEW_MODULE)
    
    Call zlDatabase.SetPara("XW发送图像用户名", txtSendImageUser.Text, glngSys, G_LNG_XWPACSVIEW_MODULE)
    Call zlDatabase.SetPara("XW发送图像密码", GetEncryptionPassW(txtSendImagePswd.Text), glngSys, G_LNG_XWPACSVIEW_MODULE)
    
    Call zlDatabase.SetPara("XW光盘刻录用户名", txtDVDBurnUser.Text, glngSys, G_LNG_XWPACSVIEW_MODULE)
    Call zlDatabase.SetPara("XW光盘刻录密码", GetEncryptionPassW(txtDVDBurnPswd.Text), glngSys, G_LNG_XWPACSVIEW_MODULE)
