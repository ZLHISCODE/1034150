...
Begin VB.Form frmPacsInterfaceCfg 
   ...
   Begin VB.PictureBox picAppCfg 
      ...
      Begin VB.Frame fraAppInfo 
         ...
         Begin VB.ComboBox cboClasses 
            Height          =   300
            ItemData        =   "frmPacsInterfaceCfg.frx":6881
            Left            =   5220
            List            =   "frmPacsInterfaceCfg.frx":6883
            Style           =   2  'Dropdown List
            TabIndex        =   10
            Top             =   720
            Width           =   2355
   ...
   Begin MSComctlLib.StatusBar stbThis 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   4154
            MinWidth        =   4154
            Picture         =   "frmPacsInterfaceCfg.frx":6885
            Text            =   "中联软件"
            TextSave        =   "中联软件"
            Key             =   "ZLFLAG"
   ...
   Begin XtremeDockingPane.DockingPane dkpMain 
      Bindings        =   "frmPacsInterfaceCfg.frx":7119
      Left            =   2100
      Top             =   1140
      _Version        =   589884
      _ExtentX        =   450
...
Private Sub picAppCfg_Resize()
    ...
    vsfAppfunPara.Left = 120
    vsfAppfunPara.Top = 300
    vsfAppfunPara.Width = fraFuncParas.Width - vsfAppfunPara.Left * 2
    If cboType.ItemData(cboType.ListIndex) = mExecuteType.动态创建 Then
