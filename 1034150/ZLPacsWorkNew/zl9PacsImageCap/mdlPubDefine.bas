...
Public Const conMenu_Cap_DelCache = 8143        '删除缓存
Public Const conMenu_Cap_RefreshCache = 8145
Public Const conMenu_Cap_ImgImport = 8146
Public Const conMenu_Cap_ImgExport = 8147
Public Const conMenu_Cap_ReUpLoad = 8148        '重新上传
Public Const conMenu_Cap_SplitPage = 8149
Public Const conMenu_Cap_ReDownLoad = 8150      '重新下载
Public Const conMenu_Cap_ImageProcess = 8152     '图像处理
