...
Private Sub cmdOK_Click()
    ...
    Else
        ...
        strInfo = CheckPWDComplex(cnOracle, strPassword, strToolTip)
        ...
        If gobjRegister.UpdateUserPassword(cnOracle, mstrUserName, strPassword, blnTransPassword, strError) Then
            ...
            If blnTransPassword Then
                ...
                Call ExecuteProcedure("Zlpassword_Update('" & UCase(mstrUserName) & "','" & Sm4EncryptEcb(UCase(strPassword), GetGeneralAccountKey(G_PASSWORD_KEY)) & "')", Me.Caption)
...
Private Sub Form_Load()
    ...
    HookDefend txtOldPWD.hwnd
    HookDefend txtNewPWD.hwnd
    HookDefend txtComfirmPwd.hwnd
End Sub
