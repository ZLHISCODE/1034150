...
Private Function SaveBalance(objCard As Card, ByRef strNo As String, ByRef Curdate As Date, str病历原因 As String) As Long
    ...
    If bln医保结算校对 Then
        ...
        bln医保结算校对 = frmMedicareReckoning.ShowMe(Me, _
            ...
            intInsure, mstrDec, gBytMoney, cur缴款, "" & mrsInfo!医保号, mbytMCMode, str住院次数, mint预交类别, mblnThreeDepositAfter, IIf(mblnShowThree, lblDelMoney.Caption, ""), mrsCardType, mobjPayCards, objCard, mstrPrivs)
