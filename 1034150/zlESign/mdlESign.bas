        ...
        If mUserInfo.strUserID = udtUser.strUserID And (mUserInfo.strName = udtUser.strName Or mUserInfo.strSignName = udtUser.strName) Then
            ...
            '验证客户端证书有效期剩余天数
                ...
                If (intDay > 0) Then
                    ...
                    If MsgBox(strTmp, vbYesNo + vbInformation + vbDefaultButton2, gstrSysName) = vbYes Then
                        blnTip = True
                    Else
                        blnDo = False
                    End If
                ElseIf (intDay <= 0) Then
                    ...
                    If MsgBox(strTmp, vbYesNo + vbQuestion + vbDefaultButton1, gstrSysName) = vbYes Then
                        blnTip = True
                    Else
                        blnDo = False
                    End If
                ...
                If blnTip Then
                    ...
                    If MsgBox(strTmp, vbOKCancel + vbInformation + vbDefaultButton1, "注册信息") = vbOK Then
                        blnDo = True
                    Else
                        blnDo = False
                    End If
