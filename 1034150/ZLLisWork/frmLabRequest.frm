...
Object = "{AF9744ED-CAFC-4877-8437-2C20C14CEA4E}#3.13#0"; "zlIDKind.ocx"
...
Private Function OpenSelect(ByVal strText As String, Optional ByVal blnWhere As Boolean = False) As Byte
    ...
    Dim strSQLbak As String
    Dim strSQL As String, intPatProperty As Integer, rsPatProperty As New ADODB.Recordset    '门诊留观病人
    On Error GoTo ErrHand
...
'        mintFocusItem = FocusItem.医嘱内容
    ...
    For i = 1 To vsf2.Rows - 1
        ...
        End If
    Next
    If vsf2.Row >= 0 And vsf2.Col >= 0 Then
    ...
    For mlngLoop = 1 To vsf2.Rows - 1
        ...
        Do While Not rsTmp.EOF
            If Not IsNull(rsTmp(0)) Then
                ...
                Set rsSample = zlDatabase.OpenSQLRecord(gstrSql, Me.Caption, rsTmp(0))
                If rsSample.RecordCount = 1 Then
...
'返回：本次录入是否有效
    ...
    blnOk = frmAdviceEditEx.ShowMe(Me, Me.vsf2.hWnd, t_Pati, 2, 4, 0, 1, PatientType, , , , 0, strExtData)
    On Error GoTo errH
