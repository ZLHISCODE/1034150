...
Begin VB.Form frmLabSampling 
   ...
   Begin VB.PictureBox picBarCodeWork 
      ...
      Begin VB.Frame fraBarCode 
         ...
         Begin VB.Frame Frame2 
            ...
            Begin VB.CommandButton cmdBarcodePrint 
               ...
               Height          =   345
               Left            =   6600
               Picture         =   "frmLabSampling.frx":058A
               TabIndex        =   45
               Top             =   1245
               Width           =   1185
            End
            Begin VB.CommandButton cmdComplete 
               ...
               Height          =   345
               Left            =   6600
               Picture         =   "frmLabSampling.frx":06D4
               TabIndex        =   44
               Top             =   855
               Width           =   1185
            End
            Begin VB.CommandButton cmdBakBillPrint 
               ...
               Height          =   345
               Left            =   6600
               Picture         =   "frmLabSampling.frx":081E
               TabIndex        =   43
               Top             =   1650
               Width           =   1185
            End
      ...
      Begin VB.Frame FraPatientInfo 
         ...
         Begin VB.ComboBox cbo开单科室 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "frmLabSampling.frx":0968
            Left            =   900
            List            =   "frmLabSampling.frx":096A
            TabIndex        =   25
            Top             =   960
            Width           =   1635
         End
         ...
         Begin VB.ComboBox cboAge 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "frmLabSampling.frx":096C
            Left            =   4770
            List            =   "frmLabSampling.frx":097F
         ...
         Begin VB.ComboBox cbo性别 
            ...
            Height          =   330
            IMEMode         =   3  'DISABLE
            ItemData        =   "frmLabSampling.frx":099B
            Left            =   3210
            List            =   "frmLabSampling.frx":099D
            Style           =   2  'Dropdown List
            TabIndex        =   18
            Top             =   210
            Width           =   675
   ...
   Begin MSComctlLib.ImageList ImgList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLabSampling.frx":099F
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLabSampling.frx":0A0B
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLabSampling.frx":0FA5
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLabSampling.frx":153F
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLabSampling.frx":1AD9
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.StatusBar stbThis 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   2355
            MinWidth        =   882
            Picture         =   "frmLabSampling.frx":2073
            Text            =   "中联软件"
            TextSave        =   "中联软件"
            Key             =   "ZLFLAG"
   ...
   Begin XtremeDockingPane.DockingPane dkpMan 
      Bindings        =   "frmLabSampling.frx":2907
      Left            =   8880
      Top             =   60
      _Version        =   589884
      _ExtentX        =   450
...
'        Set Control = .Add(xtpControlButton, conMenu_Manage_Plan, "登记")
...
Private Sub cbrthis_Update(ByVal Control As XtremeCommandBars.ICommandBarControl)
    ...
    If intCount > 0 Then
        ...
        If DateDiff("n", mstrOldTime, Now) >= 1 Then
            ...
            Set PopupItem = .AddItem(45, 60, 300, 200, "你有" & intCount & "个拒收标本，请查收！")
...
Private Sub cmdNewBarcode_Click()
    ...
    '        MsgBox "确认费用不成功！", gstrSysName
        ...
        WriterBarCode 1, IIf(chkComPlete.Value = 1, True, False), _
                         ...
                         IIf(chkBackBill.Value = 1 And chkComPlete.Value = 1, True, False)
...
Private Sub RefreshPatientData()
    ...
    Dim strBloodType As String                   '输血医嘱检验类型
    Dim strBooldSql As String                    '输血医嘱查询sql
    On Error GoTo errH
    ...
    strSQL = "Select /*+ RULE */ 病人ID,病人来源,病人姓名,病人科室,性别,年龄,就诊卡号,标识号,当前床号,主页ID,Sum(decode(状态,'已完成',1,'执行中',1,0)) As 已执行," & vbNewLine & _
    ...
    Else
        ...
        End If
    End If
    strBooldSql = GetBooldPatientDataSql
    strSQL = strSQL & " union all " & strBooldSql
    ...
    Else
        If UBound(varFilter) >= mFilter.检验类型 Then
            str检验类型 = varFilter(mFilter.检验类型) & ",9,"
        End If
...
Private Function GetBooldPatientDataSql() As String
    ...
    strBloodSQL = strBloodSQL & "Select    distinct a.病人id,decode(a.病人来源,1,'门诊',2,'住院',3,'院外',4,'体检') as 病人来源, " & vbCrLf & _
                ...
                " Where A.ID = H.相关ID And H.id = B.医嘱id And A.病人id = C.病人id And A.病人科室id = E.ID And A.诊疗项目id+0 = f.ID  " & vbCrLf & _
                "      And h.诊疗项目ID = k.id and a.id = j.医嘱id(+)  " & vbCrLf & _
                " And A.挂号单 = G.No(+) and a.病人id = g.病人id(+)  and a.病人id = g.病人id(+)  and (g.病人ID is null or (g.记录状态 =1 and g.记录性质 =1) ) And f.类别 = 'K'  and  k.操作类型='9' and a.病人id = l.病人ID(+) and a.主页ID = l.主页ID(+) and b.执行部门id + 0 = [1] " & vbCrLf & _
                " And A.ID = M.医嘱ID And k.试管编码 is not null and a.病人ID = S.病人ID(+) and a.主页ID = s.主页ID(+) " & IIf(Me.rptPlist.Tag = "", "and a.开始执行时间 < to_date('" & Format(NowDate, "yyyy-mm-dd 23:59:59") & "','yyyy-mm-dd hh24:mi:ss')", "")
    ...
    If Me.rptPlist.Tag <> "" Then
        ...
        If varFilter(mFilter.标本) <> "所有标本" Then
            strBloodSQL = strBloodSQL & " And decode(f.类别, 'K',[6],H.标本部位)= [6] "
        End If
        
        If varFilter(mFilter.采集方式) <> 0 Then
            strBloodSQL = strBloodSQL & " And decode(f.类别,'K',K.id,f.ID)=[7]"
        End If
    ...
    If Me.rptPlist.Tag <> "" Or strTmp <> "" Then
        ...
        If UBound(varFilter) >= mFilter.标本 Then
            If Trim(varFilter(mFilter.标本)) <> "" Then
                ...
                strSQL = strSQL & " And decode(a.类别, '输血',[5],a.标本)= [5] "
            End If
        End If

        If UBound(varFilter) >= mFilter.采集方式 Then
            If Trim(varFilter(mFilter.采集方式)) <> "所有方式" And Trim(varFilter(mFilter.采集方式)) <> "" And varFilter(mFilter.采集方式) <> 0 Then
                strSQL = strSQL & " and a.采集项目ID = [6] "
            End If
        End If
...
Private Function RefreshAdviceData(lngPatientID As Long, intState As Integer, intPatientType As Integer, Optional blOnlyWhere As Boolean = False, Optional intPatientPage As Integer) As Boolean
    ...
    Dim blnFL As Boolean                            '是否分类显示,存在输血医嘱时,分类显示
    Dim strBooldSql As String                       's输血医嘱查询sql
    Dim strErr As String
    blnFL = False
    ...
    If Me.rptPlist.Tag <> "" Or strTmp <> "" Then
        If varFilter(mFilter.标本) <> "所有标本" Then
            strSQL = strSQL & " And a.标本= [5] "
        End If
        
        If varFilter(mFilter.采集方式) <> 0 Then
            If Trim(varFilter(mFilter.采集方式)) <> "所有方式" And Trim(varFilter(mFilter.采集方式)) <> "" Then
                strSQL = strSQL & " and a.采集项目ID = [6] "
            End If
        End If
...
'        End If
    ...
    If strTmp <> "" Or rptPlist.Tag <> "" Then
        Set rsTmp = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, lngPatientID, mlngDeptID, CDate(Format(strDateBegin, "yyyy-mm-dd 00:00:00")), _
                CDate(Format(strDateEnd, "yyyy-mm-dd 23:59:59")), CStr(varFilter(mFilter.标本)), CLng(varFilter(mFilter.采集方式)), zlCommFun.GetFullNO(strNO), txtGoto, _
                intPatientPage)
    Else
        Set rsTmp = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, lngPatientID, mlngDeptID, CDate(Format(strDateBegin, "yyyy-mm-dd 00:00:00")), _
...
'                Record(mAcol.选择).Checked = True
                ...
                If Nvl(rsTmp("相关ID")) <> "" And Nvl(rsTmp("审核时间")) = "" And Val(Nvl(rsTmp("执行状态"))) = 1 Then
                    If Not mobjLisInsideComm Is Nothing Then
                        Record(mAcol.审核时间).Value = mobjLisInsideComm.GetNewTime(Val(Nvl(rsTmp("相关ID"))), strErr)
                        If strErr <> "" Then
...
Private Sub WriterBarCode(Mode As Integer, Optional WriterUser As Boolean = False, _
                          Optional PrintBarCode As Boolean = False, Optional PrintBackBill As Boolean = False)
    '功能                       写入和条码
    ...
    Dim blnPrint As Boolean                        '外挂打印条码
    ReDim astrSQL(0)
    ...
    If ((Mode = 0 Or Mode = 1) And WriterUser = True) Or Mode = 3 Or Mode = 2 Then
        Call WriterBarCodeToLIS(rsNumber, IIf(Mode = 2, 2, 3))
    End If
    ...
    If PrintBarCode = True Then
        ...
        If blnPrint = True Then
            ...
            Do Until rsNumber.EOF
                ...
                "所在科室 = " & IIf(txtPatientDept <> "", txtPatientDept, "无"), _
...
'                    MsgBox IDKind.GetKindIndex("就诊卡")
                    ...
                    ElseIf blnCard Or IDKind.IDKind = IDKind.GetKindIndex("就诊卡") Then
                        strSQL = "select 病人ID from 病人信息 where 就诊卡号 = [1] "
...
'                        strSQL = strSQL & " or 就诊卡号 = [1] "
                        ...
                        strSQL = "Select Distinct a.病人id" & vbNewLine & _
                            ...
                            "Where a.病人id = b.病人id And b.Id = c.医嘱id And c.发送时间 Between To_Date('" & strDateBegin & "', 'yyyy-mm-dd hh24:mi:ss') And" & vbNewLine & _
...
Private Function FindPatient(strFind As String) As Boolean
    ...
    For intLoop = 0 To 2
        For Each Row In Me.rptPlist.Rows '门诊号、住院号、病人id、姓名、就诊卡号、条码
            If (strFind = "*" & Row.Record(mPcol.标识号).Value And "门诊" = Row.Record(mPcol.来源).Value) Or _
                (IDKind.IDKind = IDKind.GetKindIndex("门诊号") And strFind = Row.Record(mPcol.标识号).Value And "门诊" = Row.Record(mPcol.来源).Value) Or _
                (strFind = "+" & Row.Record(mPcol.标识号).Value And "住院" = Row.Record(mPcol.来源).Value) Or _
                strFind = "-" & Row.Record(mPcol.病人ID).Value Or Row.Record(mPcol.病人姓名).Value Like strFind & "*" Or _
                strFind = Row.Record(mPcol.就诊卡).Value Or InStr(1, "," & Row.Record(mPcol.条码).Value & ",", "," & strFind & ",") > 0 Then
...
'返回：本次录入是否有效
    ...
    blnOk = frmAdviceEditEx.ShowMe(Me, Me.txt医嘱内容.hWnd, t_Pati, 0, 4, 0, 1, PatientType, , , , 0, strExtData)
    On Error GoTo errH
    ...
    Select Case intMode
        ...
        Case 1                              '生成
            ...
            If rsNumber.EOF = False Then
                '当诊疗项目相同时新增一个条码
                blnNew = True
            ElseIf InStr(RowRecord.Item(mAcol.试管名称).Value, "T") > 0 Then
                '当试管为特殊试管时,都生成新的条码
                blnNew = True
            Else
