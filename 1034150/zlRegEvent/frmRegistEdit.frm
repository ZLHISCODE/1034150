...
Begin VB.Form frmRegistEdit 
   ...
   Begin MSComctlLib.StatusBar stbThis 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   2355
            MinWidth        =   882
            Picture         =   "frmRegistEdit.frx":014A
            Text            =   "中联软件"
            TextSave        =   "中联软件"
            Key             =   "ZLFLAG"
   ...
   Begin VB.PictureBox picReg 
      ...
      Begin VB.CommandButton cmdPatiPic 
         Height          =   375
         Left            =   6120
         Picture         =   "frmRegistEdit.frx":09DE
         Style           =   1  'Graphical
         TabIndex        =   62
      ...
      Begin VB.PictureBox pic备注 
         ...
         Begin VB.CommandButton cmdRemark 
            Height          =   315
            Left            =   2805
            Picture         =   "frmRegistEdit.frx":7230
            Style           =   1  'Graphical
            TabIndex        =   99
            TabStop         =   0   'False
            Top             =   30
      ...
      Begin VB.PictureBox picPati 
         ...
         Begin VB.CommandButton cmdMore 
            ...
            Height          =   360
            Left            =   4335
            Picture         =   "frmRegistEdit.frx":7326
            Style           =   1  'Graphical
            TabIndex        =   85
            TabStop         =   0   'False
         ...
         Begin VB.CommandButton cmdLookup 
            ...
            Height          =   360
            Left            =   3600
            Picture         =   "frmRegistEdit.frx":78B0
            Style           =   1  'Graphical
            TabIndex        =   7
            TabStop         =   0   'False
         ...
         Begin VB.CommandButton cmdCard 
            ...
            Height          =   360
            Left            =   3975
            Picture         =   "frmRegistEdit.frx":79FA
            Style           =   1  'Graphical
            TabIndex        =   84
            TabStop         =   0   'False
         ...
         Begin VB.CommandButton cmdComminuty 
            ...
            Height          =   360
            Left            =   4695
            Picture         =   "frmRegistEdit.frx":7F84
            Style           =   1  'Graphical
            TabIndex        =   83
            TabStop         =   0   'False
         ...
         Begin zlIDKind.IDKindNew IDKind 
            ...
            _ExtentY        =   661
            Appearance      =   2
            IDKindStr       =   $"frmRegistEdit.frx":850E
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "宋体"
               Size            =   12
               Charset         =   134
   ...
   Begin VB.PictureBox picleft 
      ...
      Begin VSFlex8Ctl.VSFlexGrid mshPlan 
         ...
         EndProperty
         MousePointer    =   0
         MouseIcon       =   "frmRegistEdit.frx":85BB
         BackColor       =   -2147483643
         ForeColor       =   -2147483640
         BackColorFixed  =   -2147483633
         ForeColorFixed  =   -2147483630
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"frmRegistEdit.frx":8B95
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frmRegistEdit"
...
Private mblnChange As Boolean, mbln退号原因 As Boolean
...
Private mblnUnChange As Boolean, mstrCardPrivs As String
Private mblnFirst As Boolean, mstr原摘要 As String
    ...
    If Not mobjCommunity Is Nothing Then
        If mobjCommunity.Identify(glngSys, mlngModul, mint社区, mstr社区号, colInfo, lng病人ID) Then
            ...
            With mobjfrmPatiInfo
                ...
                If strTmp <> "" Then .cbo职业.ListIndex = GetCboIndex(.cbo职业, strTmp, , True)
...
'            cboNO.Text = ""        '挂号单
    ...
    chk病历费.Enabled = False
    '75893
    If mbytMode = 1 Or mbytMode = 0 Then
        chk病历费.Value = IIf(zlDatabase.GetPara("默认购买病历", glngSys, mlngModul, 0) = "1", 1, 0)
    Else
        chk病历费.Value = 0
    End If
    chk病历费.Enabled = mbln病历费
...
Private Sub CopyInfoTofrmPatiInfo()
    With mobjfrmPatiInfo
        ...
        '问题号:40005
        If Not mrsInfo Is Nothing Then
            .txt联系人身份证.Text = SetNullValue(mrsInfo!联系人身份证号)
            .txt联系人姓名.Text = SetNullValue(mrsInfo!联系人姓名)
            .txt联系人电话.Text = SetNullValue(mrsInfo!联系人电话)
            .txt联系人关系.Text = SetNullValue(mrsInfo!联系人关系)
            .txtBirthLocation.Text = SetNullValue(mrsInfo!出生地点)
            '73609:李南春，2014-8-1，病人信息保存
            .txt户口地址邮编.Text = SetNullValue(mrsInfo!户口地址邮编)
        End If
    End With
End Sub
...
Private Sub SetmobjfrmPatiInfo()
    ...
    With mobjfrmPatiInfo
        ...
        .cbo职业.ListIndex = GetCboIndex(.cbo职业, Nvl(mrsInfo!职业), , True)
   ...
   ' Call zlInitParaSet  '初始化本地参数
    ...
    Else
        ...
        If mbytMode = 2 Then
            glngMinH = 10950
            glngMaxH = 10950
            picReg.Height = picReg.Height - 250
        Else
            glngMinH = 10850
            glngMaxH = 10850
            picReg.Height = picReg.Height - 350
        End If
    End If
    ...
    If mbytInState = 1 Or mbytInState = 2 Or mbytInState = 3 Then  '查阅时,不能更改窗体大小:25623
        Call zlSetWindowsBroldStyle(Me)
        Call Form_Resize
    End If
    RaisEffect picReg, -1
    RaisEffect picCode, -1
    RaisEffect picPati, -1
    RaisEffect picMoney, -1
    RaisEffect picTotal, -1
...
Private Sub Form_Resize()
   ...
   End If
    ...
    picReg.Top = Me.ScaleTop + (Me.ScaleHeight - picReg.Height) / 2
...
Private Sub LoadUnitReg(ByVal str号别 As String)
 '加载挂号合作单位控制信息
    ...
    If mViewMode = v_专家号 Or mViewMode = v_专家号分时段 Then
        ...
        strSQL = strSQL & vbCrLf & "                          Nvl(e.失效时间, To_Date('3000-01-01', 'yyyy-mm-dd')))"
        strSQL = strSQL & vbCrLf & " Union All"
        ...
        strSQL = strSQL & vbCrLf & "                          Nvl(a.失效时间, To_Date('3000-01-01', 'yyyy-mm-dd'))) d"
        ...
        strSQL = strSQL & vbCrLf & "             Nvl(b.失效时间, To_Date('3000-01-01', 'yyyy-mm-dd')) And"
        strSQL = strSQL & vbCrLf & "             Decode(To_Char([2], 'D'), '1', '周日', '2', '周一', '3', '周二', '4', '周三', '5', '周四', '6', '周五', '7',"
    ...
    Else
        ...
        ElseIf Not mrsSNState Is Nothing Then
            ...
            If mrsSNState.RecordCount > 0 Then
                ...
                End If
            Else
                If blnHave And lngLocateSnX = mshSN.Row And lngLocateSnY = mshSN.Col Then Exit Sub
...
Private Sub zlInusreIdentify()
    ...
    If strAdvance <> "" Then
     ...
     End If
    Call ShowMedicareInfo(Not mRegistFeeMode = EM_RG_记帐): Call ShowDeposit(False)
...
Public Sub txtPatient_Validate(Cancel As Boolean)
    ...
    If txtPatient.Text <> "" Then
        ...
        If mblnCard Or (IsCardType(IDKind, "IC卡号") _
            Or (gCurSendCard.lng卡类别ID = lng卡类别ID And lng卡类别ID > 0)) And Not blnTmp Then
            mblnCard = False
            mbln发卡 = True '问题号:56599
            If mrsInfo Is Nothing Then
...
'---------------------------------------------------------------------------------------------------------------------------------------------
    ...
    If mCurSendCard.bln严格控制 = True Then
        '89572:李南春,2015/10/26,挂号发卡获取票据领用ID
...
Private Sub GetPatient(objCard As zlIDKind.Card, ByVal strInput As String, ByVal blnCard As Boolean, Optional blnInputIDCard As Boolean = False, Optional ByRef Cancel As Boolean)
    ...
    Dim bln医保号 As Boolean, blnReload As Boolean
            ...
            Case "姓名", "姓名或就诊卡"
                ...
                If Not blnSame Then
                    ...
                    Else
                         '问题号:50485
                        strPati = _
                            " Select distinct 1 as 排序ID,A.病人ID as ID,A.病人ID,A.姓名,A.性别,A.年龄,A.门诊号,A.出生日期,A.身份证号,A.家庭地址,A.工作单位,decode(b.卡号,Null,Null,'√') As 是否有医疗卡" & _
...
'功能：显示/隐藏医保个人帐户支付信息
    ...
    If Not blnShow Then
        ...
        txt个帐支付.Text = "0.00"
    End If
    If mblnStation And mblnStationPrice Then
        txt个帐支付.Visible = False
        lbl个帐支付.Visible = False
    End If
End Sub
...
Private Sub InitFace()
    ...
    If mbytInState = 0 Then
        ...
        cbo医生.Enabled = False
        If mblnStation Then
            cbo费别.Enabled = InStr(1, mstrStationPrivs, ";允许修改费别;") > 0 And gbln费别 And mbytMode <> 2
        Else
...
'        lbl门诊号.Left = cbo付款方式.Left + cbo付款方式.Width + 50
'        txt门诊号.Left = lbl门诊号.Left + lbl门诊号.Width + 50
'        txt门诊号.Width = picPati.Left + picPati.Width - txt门诊号.Left - 200
        ...
        If Not (Me.mbytInState = 1 And (mbytMode = 3 Or mbytMode = 4)) Then
            ...
            cmdCancel.Top = picReg.Top + picReg.Height - cmdCancel.Height - 100
...
Private Function zlCheck限约或限号数(ByVal str号别 As String) As Boolean
    ...
    If mbytMode = 1 Or (chkBooking.Visible And chkBooking.Value = 1) Then
      ...
      strSQL = _
        ...
        "           Where A.审核时间 Is Not Null And ([2] Between A.生效时间 And A.失效时间) And A.ID = B.计划id(+) And" & _
        ...
        "                      Nvl(失效时间, To_Date('3000-01-01', 'YYYY-MM-DD')) And 安排id=a.安排id)) P," & _
        "   挂号安排 C, 病人挂号汇总 D" & _
    ...
    Case 1:  '预约
         If lng限号数 - lng已挂数 - lng已约数 - lng合作单位数量 > 0 Then
            ...
            '----------------------------------------------
             ...
             If lng已约数 + lng合作单位数量 >= lng限约数 Then
                If InStr(mstrPrivs, ";加号;") > 0 Then  '需要提示:
                     If MsgBox("该号别该天已达到限约数" & lng限约数 & IIf(lng合作单位数量 > 0, "(其中包含挂号合作单位分配数量[" & lng合作单位数量 & "])", "") & " ，你是否继续预约?", vbQuestion + vbYesNo + vbDefaultButton2, gstrSysName) = vbNo Then
                        txt号别 = "": If txt号别.Enabled And txt号别.Visible Then txt号别.SetFocus
                        Exit Function
                    End If
                    mbln加号 = True
                Else
...
'blnCache:仅当输入号别未达到最大长度时才缓存,主要是考虑限号时刻在变
    ...
    If Not blnCache Then
        ...
        str挂号安排 = "" & _
            ...
            "                  And a.ID = B.安排id(+) And Trunc(Sysdate)+Nvl(Decode(A.预约天数,0,1,A.预约天数)," & IIf(gint预约天数 = 0, 1, gint预约天数) & ") >= [5] And Decode(To_Char([5], 'D'), '1', '周日', '2', '周一', '3', '周二', '4', '周三', '5', '周四', '6', '周五', '7', '周六', Null) = B.限制项目(+)" & vbNewLine
      ...
      End If
       ' a.停用日期 Is Null And
        ...
        If InStr(mstrPrivs, ";挂免费号;") = 0 And mbytMode = 0 Then
            strZero = "" & _
            "   And Not Exists ( Select 1 From 收费价目 B,挂号安排 A  Where A.项目ID=B.收费细目ID And A.项目ID=C.ID Group by A.项目ID Having Nvl(Sum(B.现价),0)=0)"
        End If
        ...
        If mblnStation And mstrRoom <> "" Then
            ...
            "               And   Not Exists(Select 1 From 挂号安排计划 where 安排ID=A.id And ([5] BETWEEN 生效时间  and 失效时间)  And 审核时间 is not NULL  ) " & _
            ...
            "             Where A.安排ID=J.ID And A.审核时间 Is Not Null And ([5] Between  A.生效时间  And A.失效时间)" & _
            "                       And A.生效时间 =( Select Max(生效时间) from 挂号安排计划  " & _
            "                                                      Where 审核时间 Is not NULL And 安排ID=a.安排ID " & _
            "                                                                 And  [5] Between Nvl(生效时间, To_Date('1900-01-01', 'YYYY-MM-DD')) And  Nvl(失效时间, To_Date('3000-01-01', 'YYYY-MM-DD')) " & _
            "                                                       ) " & _
           ...
           strSQL = str挂号安排 & vbCrLf & _
            ...
            "          And P.ID=D.号表ID(+) " & IIf(chkShowAll.Value = 1, "", "And (Nvl(P.分诊方式,0)=0 Or (P.分诊方式>0 And D.门诊诊室=[3]))") & strWhere & _
        ...
        Else
            ...
            If mbytMode = 1 Or (mbytMode = 0 And chkBooking.Visible And chkBooking.Value = 1) Or (mbytMode = 2 Or mblnReadBooking) Then '预约挂号,需要加入计划部分
                ...
                "                      Nvl(失效时间, To_Date('3000-01-01', 'YYYY-MM-DD')) And 安排id = a.安排id)" & _
                "                  " & IIf(chkShowAll.Value = 1, "", " And Decode(To_Char([5], 'D'), '1', a.周日, '2', a.周一, '3', a.周二, '4', a.周三, '5', a.周四, '6', a.周五, '7',a.周六, Null) Is Not Null")
             
                strState = strState & " Union " & _
                "   Select A.安排ID,B.已挂数,B.已约数" & _
                "   From (" & str挂号安排计划 & ") A,病人挂号汇总 B,挂号安排 C" & _
                "   Where A.安排ID=C.ID And C.科室ID = B.科室ID And A.项目ID = B.项目ID" & _
                "               And Nvl(A.医生ID,0)=Nvl(B.医生ID,0) " & _
                "               And Nvl(A.医生姓名,'医生')=Nvl(B.医生姓名,'医生') " & _
                "               And (A.号码=B.号码 or B.号码 is Null )  And B.日期=[6]"
    ...
    If txtPatientPrint.Visible Then
        ...
        If txtPatient.Text <> txtPatientPrint.Text Or mstr年龄 & mstr年龄单位 <> str年龄 Or mstr性别 <> str性别 Then
            If zlExistOperationData(Val(txtPatientPrint.Tag), cboNO.Tag) Then
                ...
                txt年龄.Text = mstr年龄
                If mstr年龄单位 <> "" Then cbo年龄单位.ListIndex = GetCboIndex(cbo年龄单位, mstr年龄单位, True): cbo年龄单位.Visible = True: txt年龄.Width = 600
                str年龄 = Trim(txt年龄.Text): str性别 = NeedName(cbo性别.Text)
                If IsNumeric(str年龄) Then str年龄 = str年龄 & cbo年龄单位.Text
...
Private Function zlExcuteDelRegistered() As Boolean
    ...
    Dim curChkMoney As Currency, strBackNote As String
    ...
    Dim dblCheckMoney As Double, str退款操作员 As String
    ...
    If Not bln记帐 Then
        ...
        '卡类别ID,卡号,是否消费卡(1-是;0-否),交易流水号,交易说明,结帐ID,卡结帐ID
        '问题:51527
        If mCurCardPay.lng医疗卡类别ID = 0 Then
            dblThreeMoney = 0
        Else
            If cllBillBalance Is Nothing Then
                MsgBox "未能正确读取原结算卡信息，不能退号！", vbInformation, gstrSysName
                Exit Function
            End If
            If mCurCardPay.lng医疗卡类别ID <> Val(cllBillBalance(1)(0)) Then
                MsgBox "指定退费结算卡与原结算卡不一致，不能退号！", vbInformation, gstrSysName
                Exit Function
            End If
            For i = 1 To mshMoney.Rows - 1
                dblCheckMoney = Val(mshMoney.TextMatrix(i, 2)) + dblCheckMoney
            Next
            If dblCheckMoney <> 0 And dblThreeMoney = 0 Then
                MsgBox "结算卡退费金额与单据金额不一致，不能退号！", vbInformation, gstrSysName
                Exit Function
            End If
        End If
            ...
            If str操作 <> "" Then
                 Select Case str操作
                    ...
                    Case "取消绑定"
                        ...
                        strSQLCard = strSQLCard & "" & Nvl(mrsInfo!病人ID, 0) & ","
            ...
            Else
                ...
                If Not objCard Is Nothing Then
                    If mCurCardPay.lng医疗卡类别ID <> 0 And mCurCardPay.bln消费卡 = False And objCard.是否全退 Then
                        ...
                        If intMsgReturn = vbNo Then cboNO.Text = "": cboNO.SetFocus: Exit Function
                    Else
    ...
    '如果退费涉及预交款,则需要刷卡验证
    If Val(txt预交支付.Text) <> 0 And gbln消费验证 Then
        If mrsBill.RecordCount <> 0 Then mrsBill.MoveFirst
        If Not zlDatabase.PatiIdentify(Me, glngSys, Nvl(mrsBill!病人ID, 0), Val(txt预交支付.Text), mlngModul, 1, IDKind.GetCurCard.接口序号) Then Exit Function
    End If
    ...
    If str退款操作员 <> "" Then strBackNote = str退款操作员 & "强制退现:" & objCard.名称 & "," & Format(dblTotal, "0.00") & "元"
    ...
    strSQL = strSQL & IIf(str退款操作员 = "", "", strBackNote) & "',"
    ...
    '三方交易
    '退费
    If mCurCardPay.lng医疗卡类别ID <> 0 And bln记帐 = False Then
...
'        End If
'    End If
    If mbytMode <> 1 And mblnStation And Not mblnStationPrice And cbo结算方式.Visible Then
        If cbo结算方式.Text = "" And Not blnPrice Then
            If GetRegistMoney - Val(txt个帐支付.Text) - Val(txt预交支付.Text) > 0 Then
                MsgBox "不能确定挂号费用的结算方式，不能挂号！", vbInformation, gstrSysName
    ...
    If Val(txt缴款.Text) <> 0 And txt缴款.Enabled And txt缴款.Visible Then
        If Val(txt缴款.Text) < mcur应缴 + GetRegistMoney - Val(txt个帐支付.Text) - Val(txt预交支付.Text) Then
            ...
            Call SelAll(txt缴款): txt缴款.SetFocus: Exit Function
        End If
    End If
    ...
    If Val(txt预交支付.Text) <> 0 And gbln消费验证 Then
       '
        If Not zlDatabase.PatiIdentify(Me, glngSys, mrsInfo!病人ID, Val(txt预交支付.Text), mlngModul, 1, IDKind.GetCurCard.接口序号) Then Exit Function
    End If
...
'---------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Dim bytType As Byte, str费别 As String, str年龄 As String, blnCodePrint As Boolean
    ...
    Dim blnSlipPrint As Boolean, blnNoDoc As Boolean, strDebug As String
    ...
    Dim objICCard As Object, rsCheck As ADODB.Recordset
    ...
    Dim str时点 As String, blnEnterPrint As Boolean
    ...
    Else
        ...
        Else
            If mblnStation Then
                blnPrice = mblnStationPrice And txtPatient.Text <> "" And mbytMode = 0 And fraBookingDate.Visible = False And mstrNoIn = "" And mshPlan.TextMatrix(mshPlan.Row, mshPlan.ColIndex("病案")) <> ""
            Else
                blnPrice = gblnPrice And txtPatient.Text <> "" And mbytMode = 0 And fraBookingDate.Visible = False And mstrNoIn = "" And mshPlan.TextMatrix(mshPlan.Row, mshPlan.ColIndex("病案")) <> ""
            End If
        End If
        ...
        If mbytMode = 0 And mbytInState = 0 Then
            If CreatePlugInOK(mlngModul) Then
                ...
                If Err <> 0 Then
                    Call zlPlugInErrH(Err, "PatiValiedCheck"): Err.Clear
                Else
                    If blnChecked = False Then Exit Sub
                End If
                On Error GoTo ErrGo
            End If
        End If
        ...
        ElseIf mbytMode <> 1 Then
            If mRegistFeeMode = EM_RG_记帐 Then
                blnNoPrint = True
            Else
                If Not gblnPrintFree Then blnNoPrint = (GetRegistMoney(True) = 0)
        ...
        If bln存为划价单 And GetRegistMoney <> 0 Then
            If chk病历费.Value = 1 Then
                '暂时不管:使用划价单到收费室缴费时不允许收取病历费
            End If
            '医生站挂号不允许划价单结算时的检查提醒
            If mblnStation And Not mblnStationPrice Then
                MsgBox "病人余额不足，不能进行挂号。", vbInformation, gstrSysName
                Exit Sub
            End If
        ...
        If Trim(txtSN.Text) <> "" And Val(txtSN.Tag) <> Val(txtSN.Text) Then
            mrsSNState.Filter = "序号=" & lngSN
            If mrsSNState.RecordCount > 0 Then
                If mrsSNState!状态 = 1 Or mrsSNState!状态 = 2 Or (mrsSNState!状态 = 3 And mrsSNState!操作员姓名 <> UserInfo.姓名) Then
...
'        End If
        ...
        If blnPati Then
            With mobjfrmPatiInfo
                ...
                If str联系电话 = "" And txt家庭电话.Visible And txt家庭电话.Text <> "" Then str联系电话 = Trim(txt家庭电话.Text)
                str身份证号 = Trim(.txt身份证号.Text)
                If str身份证号 = "" And txtIDCard.Text <> "" And txtIDCard.Visible Then str身份证号 = Trim(txtIDCard.Text)
                '问题号:51071
                '问题号:40005
                '73609:李南春，2014-8-1，病人信息保存
                strSQL = _
                ...
                For j = 1 To mrsInComes.RecordCount
                    ...
                    Else
                        ...
                        Else
                            ...
                            '72702：李南春，2014-06-09，门诊医生站挂号时开单部门ID以安排的科室为准
                            If (bln存为划价单) _
                                And mRegistFeeMode <> EM_RG_记帐 And GetRegistMoney <> 0 Then
                                strSQL = _
...
'        MsgBox "该预约挂号当前时段未安排，不能接收。", vbInformation, gstrSysName
...
Private Function ReadBill(strNO As String, Optional blnGetBooking As Boolean = False) As Boolean
   ...
   Else
        ...
        "          d.身份证号, d.家庭电话, d.家庭地址,D.户口地址, d.费别, a.急诊 As 加班标志, Nvl(A.附加标志,0) as 附加标志, a.号别, b.名称 As 项目, a.执行部门id, c.名称 As 科室, 0  As 应收, 0 As 实收, a.执行人," & _
        "          a.发生时间, a.操作员姓名, Null As 结帐ID, a.摘要, a.预约方式 As 结论, a.号序,a.退号审核人,a.退号审核时间, 0 as 收费细目ID,0 as 收入项目ID,D.病人类型," & _
        "          0 as 记帐费用,nvl(A.险类,0) as  险类,D.出生日期" & _
...
chkBooking:
    ...
    lbl合计.Caption = Format(curMoney, "0.00")
    Call Set连续挂号
    If txt门诊号.Text = "" And mbytMode = 2 Then
        txt门诊号.Text = zlGet门诊号
    End If
...
Private Function GetRegistMoney(Optional blnOnlyReg As Boolean = False) As Currency
    '功能：获取当前挂号单的合计金额
...
'功能：设置病人输入使能状态
    ...
    Else
        ...
        txt家庭电话.Enabled = gbln电话 Or blnUse
        txtIDCard.Enabled = mbln基本信息调整
    End If
...
Private Sub txt预交支付_Validate(Cancel As Boolean)
    ...
    If Val(txt预交支付.Text) > curMoney Then
        MsgBox "冲减的预交金额不能大于本次挂号金额：" & Format(curMoney, "0.00") & "。", vbInformation, gstrSysName
...
Public Function zlGet门诊号() As String
    ...
    If gbln自动门诊号 Or mblnStation Or mbln建病案 Or mbytMode = 2 Then    '要求根据参数来设置 好别要求建立病案的 必须产生门诊号 以便建立病案
...
'        txt门诊号.Enabled = (Val(txt门诊号.Text) = 0)
        ...
        .cbo职业.ListIndex = GetCboIndex(.cbo职业, Nvl(rsPatiInfor!职业), , True)
...
Private Sub Load支付方式()
    ...
    '74550,冉俊明,2014-7-2,在病人来院就诊,医生在门诊医生站挂号时能够选择结算方式(包含性质为7的一卡通结算)
    '78507,冉俊明,2014-10-11,医生站医保病人使用个人账户支付挂号费
    str性质 = IIf(mblnStation And Not mblnStationPrice, "(3)", "(1,2,3)")
    strSQL = _
        "Select B.编码,B.名称,Nvl(B.性质,1) as 性质,Nvl(A.缺省标志,0) as 缺省" & _
        " From 结算方式应用 A,结算方式 B" & _
...
Private Sub AddCardDataSQL(ByVal lng病人ID As Long, ByVal dtCurdate As Date, _
    ...
    End If
    '院外卡且不能发卡的,只能是绑定卡
    If bln发卡(strCard) = False Then blnInRange = False
    If blnInRange Then
        blnInRange = True
        byt操作类型 = 0: byt变动类型 = 1
    Else
...
Private Function IsCheckCancelValied(ByVal lng挂号结帐ID As Long, ByVal lng卡费结帐ID As Long, _
    ...
    Dim str验证卡号  As String, strXmlIn As String
    Dim str刷卡密码 As String
...
Private Function ShowBillFormat()
    ...
    If Not rsTmp.EOF Then
        lblTitle.ToolTipText = "票据:" & Nvl(rsTmp!说明)
...
Private Function InitTimePlan() As Boolean
    ...
    ElseIf (mbytMode = 1 Or (chkBooking.Value = 1 And chkBooking.Visible)) And Val(mshPlan.TextMatrix(mshPlan.Row, GetCol("限号"))) > 0 Then
       strNO = mshPlan.TextMatrix(mshPlan.Row, GetCol("号别"))
        ...
        strSQL = strSQL & vbNewLine & "             Nvl(E.失效时间, To_Date('3000-01-01', 'yyyy-mm-dd')))"
        ...
        strSQL = strSQL & vbNewLine & "             Nvl(A.失效时间, To_Date('3000-01-01', 'yyyy-mm-dd'))) D"
        ...
        strSQL = strSQL & vbNewLine & "      Nvl(B.失效时间, To_Date('3000-01-01', 'yyyy-mm-dd')) And"
        strSQL = strSQL & vbNewLine & "      Decode(To_Char([2], 'D'), '1', '周日', '2', '周一', '3', '周二', '4', '周三', '5', '周四', '6', '周五',"
        strSQL = strSQL & vbNewLine & "            '7', '周六', Null) = A.星期(+)"
        strSQL = strSQL & vbNewLine & " Order By 开始时间　"

'        strSQL = _
'        "      Select Distinct A.序号,to_char(a.开始时间,'hh24')||':00' as 时间点, to_char(A.开始时间,'hh24:mi') as 开始时间, to_char(A.结束时间,'hh24:mi') as 结束时间, A.限制数量, A.是否预约 " & vbNewLine & _
'        "      From 挂号安排时段 A, 挂号安排 B " & vbNewLine & _
'        "      Where A.安排id = B.ID And B.号码 = [1]   And  " & _
'        "             Decode(To_Char([2], 'D'), '1', '周日', '2', '周一', '3', '周二', '4', '周三', '5', '周四', '6', '周五', '7'," & _
'        "             '周六', Null) = A.星期(+) " & _
'        "             And Not Exists (Select 1 From 挂号安排计划 E Where E.安排id = B.ID) " & vbNewLine & _
'        "      Union All " & vbNewLine & _
'        "      Select Distinct A.序号, to_char(a.开始时间,'hh24')||':00' as 时间点,to_char(A.开始时间,'hh24:mi') as 开始时间, to_char(A.结束时间,'hh24:mi') as 结束时间, A.限制数量, A.是否预约 " & vbNewLine & _
'        "      From 挂号计划时段 A, 挂号安排计划 B, 挂号安排 C,(" & vbNewLine & _
'        "            SELECT MAX(a.生效时间 ) 生效 FROM 挂号安排计划 a,挂号安排 B  WHERE a.安排Id=b.ID AND b.号码=[1] AND a.审核时间 IS NOT NULL" & vbNewLine & _
'        "             And [2] Between nvl(a.生效时间,to_date('1900-01-01','yyyy-mm-dd')) And nvl(a.失效时间,to_date('3000-01-01','yyyy-mm-dd'))" & vbNewLine & _
'        "           ) D  " & vbNewLine & _
'        "      Where A.计划id = B.ID And B.安排id = C.ID And C.号码 = [1] And B.生效时间=d.生效    And" & _
'        "            [2] Between nvl(b.生效时间,to_date('1900-01-01','yyyy-mm-dd')) And nvl(b.失效时间,to_date('3000-01-01','yyyy-mm-dd')) " & vbNewLine & _
'        "             And Decode(To_Char([2], 'D'), '1', '周日', '2', '周一', '3', '周二', '4', '周三', '5', '周四', '6', '周五', '7', " & _
'        "             '周六', Null) = A.星期(+)" & vbNewLine & _
'        "      Order By 开始时间　"
   ...
   strTime = _
    ...
    If lng计划ID > 0 Then
        ...
        strSQL = "" & _
         ...
         "                 Nvl(p.失效时间, To_Date('3000-01-01', 'YYYY-MM-DD'))" & _
...
Public Function Get失约号(ByVal str号别 As String, ByVal datThis As Date) As Long
   '获取安排在某一天.预约失约数
    ...
    strSQL = strSQL & vbNewLine & " FROM 病人挂号记录 "
    strSQL = strSQL & vbNewLine & " WHERE 号别 = [1] AND 记录性质=2 And 记录状态=1 AND " & _
                                    "预约时间 < SYSDATE + " & mTy_Para.lng预约有效时间 & "/24/60 And 预约时间 > To_Date([2],'YYYY-MM-DD') "
    strDat = Format(datThis, "yyyy-MM-dd")
    On Error GoTo Hd
    Set rsTmp = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, str号别, strDat)
    If rsTmp.EOF Then
        Get失约号 = 0
        Set rsTmp = Nothing
        Exit Function
