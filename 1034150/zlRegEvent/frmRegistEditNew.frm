...
Begin VB.Form frmRegistEditNew 
   ...
   Begin VB.PictureBox picInfoFrame 
      ...
      Begin VB.PictureBox picInfo 
         ...
         Begin VB.CommandButton cmdMore 
            Height          =   330
            Left            =   5940
            Picture         =   "frmRegistEditNew.frx":014A
            Style           =   1  'Graphical
            TabIndex        =   69
            TabStop         =   0   'False
         ...
         Begin VB.CommandButton cmdLookup 
            Height          =   330
            Left            =   5220
            Picture         =   "frmRegistEditNew.frx":06D4
            Style           =   1  'Graphical
            TabIndex        =   68
            TabStop         =   0   'False
         ...
         Begin VB.CommandButton cmdCard 
            Height          =   330
            Left            =   5565
            Picture         =   "frmRegistEditNew.frx":081E
            Style           =   1  'Graphical
            TabIndex        =   67
            TabStop         =   0   'False
         ...
         Begin VB.CommandButton cmdComminuty 
            Height          =   330
            Left            =   6285
            Picture         =   "frmRegistEditNew.frx":0DA8
            Style           =   1  'Graphical
            TabIndex        =   66
            TabStop         =   0   'False
         ...
         Begin VB.CommandButton cmdPatiPic 
            Height          =   330
            Left            =   6585
            Picture         =   "frmRegistEditNew.frx":1332
            Style           =   1  'Graphical
            TabIndex        =   57
         ...
         Begin zlIDKind.IDKindNew IDKind 
            ...
            _ExtentY        =   635
            Appearance      =   2
            IDKindStr       =   $"frmRegistEditNew.frx":7B84
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsfMoney 
            ...
            FormatString    =   $"frmRegistEditNew.frx":7C31
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   1
   ...
   Begin MSComctlLib.StatusBar stbThis 
      ...
      _ExtentX        =   26194
      _ExtentY        =   635
      SimpleText      =   $"frmRegistEditNew.frx":7DC2
      _Version        =   393216
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   2619
            MinWidth        =   882
            Picture         =   "frmRegistEditNew.frx":7E09
            Text            =   "中联软件"
            TextSave        =   "中联软件"
            Key             =   "ZLFLAG"
   ...
   Begin VB.PictureBox picPlan 
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsfList 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"frmRegistEditNew.frx":869D
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin XtremeDockingPane.DockingPane dkpMain 
      Bindings        =   "frmRegistEditNew.frx":87A9
      Left            =   1095
      Top             =   570
      _Version        =   589884
      _ExtentX        =   450
   ...
   Begin VB.Image imgDel 
      Height          =   240
      Left            =   2670
      Picture         =   "frmRegistEditNew.frx":87BD
      Top             =   705
      Width           =   240
   End
End
...
Public mstrStationPrivs As String
...
Private mlng默认卡类别ID As Long, mbln退号原因 As Boolean
Private mblnPre连续 As Boolean, mstr原摘要 As String
...
Private mdbl个帐余额 As Double
Private mdbl原金额 As Double
Private mblnCancel As Boolean, mstrCardPrivs As String, mstrForceNote As String
...
Private mblnUnChange As Boolean, mblnManualInput As Boolean
...
Private mstr门诊号 As String, mblnReadBooking As Boolean
...
Private Function SelectMemo(ByVal strInput As String) As Boolean
    ...
    strSQL = "" & _
     ...
     "   Order by 缺省标志"
     vRect = GetControlRect(cbo备注.Hwnd)
     On Error GoTo Hd
...
Private Sub cmdComminuty_Click()
    ...
    If Not mobjCommunity Is Nothing Then
        If mobjCommunity.Identify(glngSys, mlngModul, mint社区, mstr社区号, colInfo, lng病人ID) Then
            ...
            If strTmp <> "" Then cbo性别.ListIndex = GetCboIndex(cbo性别, strTmp)
            ...
            With mobjfrmPatiInfo
                ...
                strTmp = GetColItem(colInfo, "年龄")
                If strTmp <> "" Then .cbo国籍.ListIndex = GetCboIndex(.cbo国籍, strTmp)
                strTmp = GetColItem(colInfo, "民族")
                If strTmp <> "" Then .cbo民族.ListIndex = GetCboIndex(.cbo民族, strTmp)
                strTmp = GetColItem(colInfo, "婚姻状况")
                If strTmp <> "" Then .cbo婚姻.ListIndex = GetCboIndex(.cbo婚姻, strTmp)
                strTmp = GetColItem(colInfo, "职业")
                If strTmp <> "" Then .cbo职业.ListIndex = GetCboIndex(.cbo职业, strTmp)
...
'        End With
'        '问题:51408
'        MsgBox "你预约的时间" & Format(dtpAppointmentDate.Value, "yyyy-MM-dd") & " " & Format(dtpAppointmentTime.Value, "hh:mm:ss") & " 没有进行挂号安排 请检查!", vbOKOnly + vbInformation, Me.Caption
...
Private Sub mobjIDCard_ShowIDCardInfo(ByVal strID As String, ByVal strName As String, ByVal strSex As String, _
    ...
    If txt号别.Text <> "" And Not txtPatient.Locked And txtPatient.Text = "" And Me.ActiveControl Is txtPatient Then
        ...
        '107049:李南春,2017/5/4,如果his有记录，将his信息传给接口
...
Private Sub SetPatiEnable(ByVal blnEnable As Boolean)
    ...
    If mblnStation Then
        cbo费别.Enabled = blnEnable And InStr(1, mstrStationPrivs, ";允许修改费别;") > 0
    Else
...
Private Function IsCheckBackExtra(Optional ByVal bln病历费 As Boolean) As Boolean
    ...
    mCurCardPay.dbl部分退差额 = Val(curDiff)
    Call Load结算信息(Val(curMoney), mCurCardPay.dbl部分退差额)
    Set连续挂号
        ...
        If dblTotal > 0 Then
            If dblTotal > Val(rsTemp!冲预交) Then
                ...
                If Val(rsTemp!性质) = 7 Or Val(rsTemp!性质) = 8 Then
                    ...
                    If rsTx.EOF Then
                        strSQL = "Select 编号,是否退现 From 卡消费接口目录 Where 结算方式=[1]"
                        Set rsTx = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, rsTemp!结算方式)
                        If rsTx.EOF Then
...
Private Sub HoldRegNo()
    ...
    If blnCan Then
        If picBookingDate.Visible Then
            ...
            Case Else
                strDate = Format(dtpAppointmentDate.Value, "yyyy-MM-dd") & " " & Format(dtpAppointmentTime.Value, "HH:mm:ss")
                datThis = CDate(strDate)
            End Select
        Else
            If mViewMode <> v_专家号分时段 Then
...
'返回:True-未建档,卡费和挂号费一起收,false-已建档,卡费存为划价单
    ...
    If Not blnBoundCard Then
        Unload mobjfrmPatiInfo    'Must Unload
        Call ClearmobjfrmPatiInfoFace
    End If
...
Private Sub SetmobjfrmPatiInfo()
    ...
    With mobjfrmPatiInfo
        ...
        .cbo婚姻.ListIndex = GetCboIndex(.cbo婚姻, Nvl(mrsInfo!婚姻状况))
        '76314,李南春，2014-08-06，病人信息正确获取
        .cbo职业.ListIndex = GetCboIndex(.cbo职业, Nvl(mrsInfo!职业))
        ...
        .txt其他关系.Text = ""
        .txt联系人关系.Text = Nvl(mrsInfo!联系人关系)
    ...
    If mbytMode = 2 And mbytInState = 0 Then
        ...
        If Not mrsInfo Is Nothing Then
            If CreatePlugInOK(mlngModul) Then
                ...
                blnChecked = gobjPlugIn.PatiValiedCheck(glngSys, mlngModul, 1, Val(Nvl(mrsInfo!病人ID)), 0, "<YSXM>" & NeedName(cbo医生.Text) & "</YSXM>")
                If Err <> 0 Then
...
Private Sub zl权限控制()
    ...
    End If
    mstrStationPrivs = GetPrivFunc(glngSys, 1260)
    If mblnStation Then
        cbo费别.Enabled = InStr(1, mstrStationPrivs, ";允许修改费别;") > 0 And gbln费别
    End If
...
Private Sub Form_Load()
   ...
   ' Call zlInitParaSet  '初始化本地参数
    ...
    Set mobjfrmPatiInfo.mfrmMain = Me
    mobjfrmPatiInfo.mstrPrivs = mstrPrivs
    mobjfrmPatiInfo.mlngModul = mlngModul
    mobjfrmPatiInfo.mblnStation = mblnStation
...
'    If lbl险类.Visible Then
'        lblPrompt.Left = lbl险类.Left - lblPrompt.Width - 180
'    Else
'        lblPrompt.Left = lbl急.Left - lblPrompt.Width - 180
'    End If
End Sub
...
Private Sub picInfo_Resize()
    ...
    If (mbytMode = 0 Or mbytMode = 1) And mbytInState = 0 Then
        With picInfo
            picBal.Top = .ScaleHeight - 2700
            vsfPay.Top = picBal.Top
            picTotal.Top = picBal.Top
            cbo备注.Top = picBal.Top - 525
            lbl摘要.Top = cbo备注.Top + 60
            txt发生时间.Top = cbo备注.Top - 435
            cbo预约方式.Top = txt发生时间.Top
            lbl预约方式.Top = txt发生时间.Top + 60
            lbl发生时间.Top = lbl预约方式.Top
            chk病历费.Top = txt发生时间.Top + 45
            vsfMoney.Height = txt发生时间.Top - vsfMoney.Top - 60
            lblPrompt.Top = vsfPay.Top + vsfPay.Height + 60
        End With
    End If
End Sub
...
Private Sub picInfoFrame_Resize()
    On Error Resume Next
    If picInfo.Height >= picInfoFrame.Height Then
        picInfo.Top = 15
        picInfo.Left = 15
        picInfo.Height = picInfoFrame.ScaleHeight - 30
        picInfo.Width = picInfoFrame.ScaleWidth - 30
    Else
        picInfo.Left = 15
        picInfo.Top = 15
        picInfo.Height = picInfoFrame.ScaleHeight - 30
...
'Private Sub picInfoOut_Resize()
'    With picInfoFrame
'        .Left = 0
'        .Top = 0
'        .Width = picInfoOut.Width
'        .Height = picInfoOut.Height
'    End With
'End Sub
...
Private Sub vsfPay_BeforeEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)
    If vsfPay.TextMatrix(Row, 0) = "" Then Cancel = True: Exit Sub
...
Private Sub vsfPlan_AfterSort(ByVal Col As Long, Order As Integer)
    ...
    With vsfPlan
        For j = 1 To .Rows - 1
            If j Mod 2 = 1 Then
                For i = 0 To .Cols - 1
                    If .Cell(flexcpBackColor, j, i, j, i) <> &HFF8080 Then .Cell(flexcpBackColor, j, i, j, i) = &H80000005
                Next i
            Else
                For i = 0 To .Cols - 1
                    If .Cell(flexcpBackColor, j, i, j, i) <> &HFF8080 Then .Cell(flexcpBackColor, j, i, j, i) = &HF6F6F6
                Next i
            End If
        Next j
        For i = 0 To .Cols - 1
    ...
    With vsfPlan
         ...
         If blnCurDate Then
             ...
             For i = 1 To .Rows - 1
                ...
                Else
                    .ColData(.ColIndex(strPrevKey)) = "1"      '昨天日期
...
Private Sub LoadTimePlan()
    ...
    Case V_普通号分时段:
        ...
        strSQL = "Select Count(1) As 预约数量, To_Char(开始时间, 'HH24:MI') As 日期" & vbNewLine & _
                ...
                "Where instr(',4,0,',','|| Nvl(挂号状态,0)||',')=0 And Nvl(是否预约,0) = 1 And 预约顺序号 Is Not Null And 记录id = [1]" & vbNewLine & _
                "Group By 开始时间"
                    ...
                    '挂号时不区分都填充
                     ...
                     If Nvl(!限制数量, 0) <> 0 Then
                        ...
                        If Format(Datsys, "yyyy-mm-dd") <= Format(dtpAppointmentDate + 1, "yyyy-mm-dd") Then
                              ...
                              End If
                        End If
                        If Format(!详细开始时间, "yyyy-mm-dd") <> Format(dtpAppointmentDate.Value, "yyyy-mm-dd") And dtpAppointmentDate.Visible Then
                            vsfList.Cell(flexcpForeColor, lngRows, lngCols) = vbGrayText
                        End If
                     End If
                 End If
    ...
    '***************************************
     If mViewMode = v_专家号分时段 Then
        ...
        End If
         ...
         If mTy_Para.lng预约有效时间 <> 0 And mTy_Para.bln失约用于挂号 Then
...
'        vsflist.HighLight = 0
'        vsflist.FocusRect = flexFocusNone
'    End If
End Sub
   ...
   '初始化状态变量信息
    ...
    If mTy_Para.bln失约用于挂号 = True And mTy_Para.lng预约有效时间 <> 0 Then
        ...
        strSQL = "Select 1" & vbNewLine & _
                ...
                "       a.出诊记录Id = b.记录Id And a.出诊记录Id = [1] And (a.号序 = b.序号 Or a.号序 = b.备注) And Nvl(b.挂号状态,0) = 2 And rownum < 2"
...
Private Sub vsfPlan_EnterCell()
    ...
    '125595:李南春，2019/1/7，预约接收出诊记录定位问题
    If mblnChangeByCode Then mlngRow = vsfPlan.Row: Exit Sub
    sngTime = Timer
    If Format(sngTime, "0.000") - Format(msngTime, "0.000") < 0.1 And mblnNotChange = False And mblnManualInput = False Then
...
'处理是否允许预留
    ...
    '普通号分时段 不允许预留
    '***************************************
    If mViewMode = V_普通号分时段 Or mViewMode = V_普通号分时段 Then
...
Private Sub txtIDCard_Validate(Cancel As Boolean)
    ...
    If txtIDCard.Text = "" Or txtIDCard.Tag = txtIDCard.Text Then
        If Not mobjfrmPatiInfo Is Nothing Then
            mobjfrmPatiInfo.txt身份证号.Text = txtIDCard.Text
            mobjfrmPatiInfo.txt身份证号.Tag = txtIDCard.Tag
        End If
        Exit Sub
    End If
...
Private Sub zlInusreIdentify()
    ...
    Set rsTmp = GetMoneyInfo(lng病人ID, , , 1)
...
Public Sub txtPatient_Validate(Cancel As Boolean)
    ...
    If Not (gbln缴款结束 And mbytMode <> 1) Then mcur合计 = 0: mcur应缴 = 0
    ...
    If txtPatient.Text <> "" Then
        ...
        If mblnNewCard Then
            ...
            ElseIf chk病历费.Enabled And chk病历费.Visible Then
                chk病历费.SetFocus
            ElseIf txt缴款.Enabled And txt缴款.Visible And gbln缴款结束 Then
                txt缴款.SetFocus
            Else
                cmdOK.SetFocus
            End If
...
Private Sub txt缴款_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 Then
        ...
        End If
        If gbln缴款结束 And txt缴款.Text = "" Then Exit Sub
'        If Val(txt缴款.Text) <> 0 Then
        ...
        If vsfPlan.Tag = "" Then
            ...
            For i = 1 To vsfPlan.Rows - 1
                If Trim(vsfPlan.TextMatrix(i, GetCol("号别"))) = Trim(txt号别.Text) Then
                    ...
                    vsfPlan.Col = 0: vsfPlan.ColSel = vsfPlan.Cols - 1
                    Call vsfPlan_EnterCell
                    SetGridTop i
                    Exit For
                End If
...
Private Sub GetPatient(objCard As zlIDKind.Card, ByVal strInput As String, ByVal blnCard As Boolean, Optional blnInputIDCard As Boolean = False, Optional ByRef Cancel As Boolean)
    ...
    Dim bln医保号 As Boolean, strRegist As String, rsRegist As ADODB.Recordset
    ...
    If blnCard And objCard.名称 Like "姓名*" And mstrYBPati = "" And InStr("-+*.", Left(strInput, 1)) = 0 Then     '刷卡
        ...
        ElseIf IDKind.GetCurCard.接口序号 > 0 Then
            lng卡类别ID = IDKind.GetCurCard.接口序号
        '75015,冉俊明,2014-7-17,有两种模糊查找性质的卡类别,发卡时卡号相同的不同病人在挂号刷卡后没有弹出卡类别选择，而是默认提取了某种类别的卡
'        ElseIf blnCard And Not IDKind.GetfaultCard Is Nothing Then
'            lng卡类别ID = IDKind.GetfaultCard.接口序号
        Else
                ...
                If Not blnSame Then
                    ...
                    Else
                        ...
                        strPati = strPati & " Union ALL " & _
                                "Select 0,0 as ID,-NULL,'[新病人]',NULL,NULL,-NULL,To_Date(NULL),NULL,NULL,NULL,NULL From Dual"
...
ReadPati:
    ...
    If Not mrsInfo.EOF Then
        ...
        cmdCard.Enabled = Val("" & mrsInfo!就诊状态) = 0 Or IsNull(mrsInfo!就诊卡号)
        cmdCard.Enabled = cmdCard.Enabled And Not (mblnStation And mTy_Para.bln挂号必须刷卡)
        mstrPassWord = strPassWord
        If Not blnHavePassWord Then mstrPassWord = Nvl(mrsInfo!卡验证码)
        cbo性别.ListIndex = GetCboIndex(cbo性别, Nvl(mrsInfo!性别)) '年龄在后面根据出生日期算
        ...
        '55766:文本框有一bug:如果先为密文显示,后设置成非密文显示后,不能输入五笔
        txtPatient.IMEMode = 0
        Call zlControl.CboSetIndex(cbo费别.Hwnd, GetCboIndex(cbo费别, "" & mrsInfo!费别))
        ...
        If Not IsNull(mrsInfo!医疗付款方式) Then
            cbo付款方式.ListIndex = GetCboIndex(cbo付款方式, mrsInfo!医疗付款方式)
        ElseIf mstrYBPati <> "" Then
            cbo付款方式.ListIndex = GetCboIndex(cbo付款方式, "1")
        End If
...
NewPati:
        ...
        If isCheckInputIDCard(strInput) Then
            ...
            txt出生日期.Text = zlCommFun.GetIDCardDate(strInputInfo)
            mobjfrmPatiInfo.txt出生日期.Text = txt出生日期.Text
            If txt年龄.Text = "" Then
...
'功能：显示/隐藏预交支付信息
    ...
    If mblnStation Then
        If mblnStationPrice Then blnShow = False
    Else
...
Private Sub InitFace()
    ...
    If mbytInState = 0 Then
        ...
        cbo医生.Enabled = False
        If mblnStation Then
            cbo费别.Enabled = gbln费别 And mbytMode <> 2 And InStr(1, mstrStationPrivs, ";允许修改费别;") > 0
        Else
            cbo费别.Enabled = gbln费别 And mbytMode <> 2
        End If
        cbo结算方式.Enabled = gbln结算方式 And mbytMode <> 1
        txt家庭电话.Enabled = gbln电话
        lblIDCard.Visible = True: txtIDCard.Visible = True
...
'            mcbrToolBar.Visible = False
    ...
    Else
        If mbytMode = 1 Then '查看预约单时无结算相关信息
            ...
            Call SetUndisplayBalance
            '89242:李南春,2015/12/7,读取病人地址信息
            lbl家庭地址.Visible = True: If mblnStructAdress Then cbo家庭地址.Visible = True
            lblIDCard.Visible = True: txtIDCard.Visible = True
            txt家庭电话.Visible = True: lbl家庭电话.Visible = True
            cmdCard.Visible = False: cmdYb.Visible = False
...
'--------------------------
   ...
   If mbytInState <= 0 Or (mbytInState = 1 And (mbytMode = 3 Or mbytMode = 4)) Then
        ...
        Me.cbo备注.Visible = True
   Else
        Me.cbo备注.Visible = True: Me.cbo备注.Enabled = True
   End If
   If mbytMode = 0 Then
   '挂号 时 移动摘要的位置
'        lbl摘要.Left = Me.lbl预约方式.Left
'        Me.cbo备注.Width = Me.cbo备注.Left + Me.cbo备注.Width - Me.lbl摘要.Left - Me.lbl摘要.Width - 5 * Screen.TwipsPerPixelX
'        Me.cbo备注.Left = Me.lbl摘要.Left + Me.lbl摘要.Width + 2 * Screen.TwipsPerPixelX
   End If
...
'        End If
    ...
    If mbytInState = 0 Then
        ...
        mbln病历费 = True
        If mbytMode <> 2 Then
            mbln病历费 = Not GetSpecialInfo("病历费") Is Nothing
...
'                Else
'                    MsgBox "挂号场合没有可用的结算方式，请先到结算方式管理中设置。", vbInformation, gstrSysName
...
Private Sub SetPlanGrid()
    ...
    '初始安排表
    If mbytMode = 1 Then
        strHead = "IDS,1,0|号类,1,500|号别,1,750|科室,1,1200|项目,1,1500|医生,1,700|替诊医生,1,1000|时段,1,750|已挂,1,500|限号,1,500|已约,1,500|限约,1,500" & _
           "|日,4,450|一,4,450|二,4,450|三,4,450|四,4,450|五,4,450|六,4,450" & _
           "|病案,4,500|分诊,4,500|序号控制,4,850|出诊日期,1,1100|记录ID,1,0|提前时间,1,0|挂号时间,1,0|号源ID,1,0|是否独占,1,0|替诊开始时间,1,0|替诊终止时间,1,0|替诊医生姓名,1,0|替诊医生ID,1,0|结束时间,1,0"
    Else
        strHead = "IDS,1,0|号类,1,500|号别,1,750|科室,1,1200|项目,1,1500|医生,1,700|替诊医生,1,1000|时段,1,750|已挂,1,500|限号,1,500|已约,1,500|限约,1,500" & _
           "|日,4,450|一,4,450|二,4,450|三,4,450|四,4,450|五,4,450|六,4,450" & _
           "|病案,4,500|分诊,4,500|序号控制,4,850|出诊日期,1,1100|记录ID,1,0|提前时间,1,0|挂号时间,1,0|号源ID,1,0|是否独占,1,0|替诊开始时间,1,0|替诊终止时间,1,0|替诊医生姓名,1,0|替诊医生ID,1,0|结束时间,1,0"
...
'blnCache:仅当输入号别未达到最大长度时才缓存,主要是考虑限号时刻在变
    ...
    Dim DateThis As Date, strZero As String, intGap As Integer
    ...
    Select Case mSortType
        Case by号别:
                str排序 = "号别,出诊日期 Desc"
        Case by科室:
                str排序 = "科室,项目,已挂,出诊日期 Desc"
        Case by科室and已挂数:
                str排序 = "科室,已挂,出诊日期 Desc"
        Case Else:
             str排序 = "号别,出诊日期 Desc"
    End Select
    ...
    If Not blnCache Then
        ...
        If chkShowAll.Value <> 1 Then
            If mblnStation Then
                '门诊医生站挂号的限定条件
                strStationSql = " And Exists (Select 1 From 部门人员 M,上机人员表 N Where M.人员ID=N.人员ID And N.用户名=User And M.部门ID=A.科室ID) "
                strStationSql = strStationSql & "   And (A.医生姓名 Is Null Or A.医生姓名=[1]) "
              '  strIF = strIF & " And Nvl(P.病案必须,0)=1 And (P.医生姓名 Is Null Or P.医生姓名=[1])"
            ElseIf gstr挂号科室ID <> "" Then
                '本地参数确定了的挂号科室
                strStationSql = " And Instr(','||[4]||',',','||A.科室ID||',')>0 "
            End If
        End If
        ...
        strSQL = "Select a.Id, b.号码 As 号别, a.出诊日期, b.号类, b.科室id, c.名称 As 科室, a.项目id, d.名称 As 项目, a.替诊医生id, a.医生id, a.替诊医生姓名, a.医生姓名 As 医生, Nvl(a.已挂数, 0) As 已挂," & vbNewLine & _
                ...
                "       a.是否序号控制 As 序号控制, a.上班时段 As 排班, a.号源id, a.提前挂号时间 As 提前时间, a.开始时间 As 挂号时间, a.终止时间 As 结束时间, Nvl(a.是否独占,0) As 是否独占, a.替诊开始时间 , a.替诊终止时间 " & vbNewLine & _
                ...
                "       And Nvl(a.是否发布,0) = 1 And a.开始时间 >= [10] " & strStationSql
        ...
        If mbytMode <> 1 Then
            If InStr(mstrPrivs, ";挂免费号;") = 0 And mbytMode = 0 Then
                strZero = "" & _
                "   And Not Exists ( Select 1 From 收费价目 Where 收费细目ID = a.项目ID And [5] Between 执行日期 And 终止日期 Group by 收费细目ID Having Nvl(Sum(现价),0)=0)"
            End If
        ...
        If mbytMode = 1 Or (mbytMode = 0 And chkBooking.Visible And chkBooking.Value = 1) Then
            ...
            strSQL = strSQL & " And Sysdate + zl_Fun_GetAppointmentDays + Decode(Nvl(B.预约天数," & gint预约天数 & "),0,15,Nvl(B.预约天数," & gint预约天数 & ")" & ") >= [6] "
        Else
            '挂号
            strSQL = strSQL & strTime
            If chkShowAll.Value = 1 Then
                ...
                strSQL = strSQL & vbNewLine & _
                    ...
                    "       Null As 是否独占, Null As 替诊开始时间, Null As 替诊终止时间" & vbNewLine & _
        ...
        Set mrsPlan = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, _
            ...
            datNow, CDate(Format(gdatRegistTime, "yyyy-MM-dd")))
    ...
    If txtPatientPrint.Visible Then
        ...
        If txtPatient.Text <> txtPatientPrint.Text Or mstr年龄 & mstr年龄单位 <> str年龄 Or mstr性别 <> str性别 Then
            If zlExistOperationData(Val(txtPatientPrint.Tag), cboNO.Tag) Then
                ...
                txt年龄.Text = mstr年龄
                If mstr年龄单位 <> "" Then cbo年龄单位.ListIndex = GetCboIndex(cbo年龄单位, mstr年龄单位): cbo年龄单位.Visible = True: txt年龄.Width = 600
                str年龄 = Trim(txt年龄.Text): str性别 = NeedName(cbo性别.Text)
                If IsNumeric(str年龄) Then str年龄 = str年龄 & cbo年龄单位.Text
                cbo性别.ListIndex = GetCboIndex(cbo性别, mstr性别)
...
Private Function zlExcuteDelRegistered() As Boolean
    ...
    Dim rsTmp As ADODB.Recordset
    Dim bln原样退 As Boolean, strTemp As String
    ...
    If Not bln记帐 Then
        '问题:51527
        Call zlReadRegThreeBalance(lng结帐ID, lngCard结帐ID, cllBillBalance, objCard, dblThreeMoney)
        dblCheckThreeMoney = dblThreeMoney
        bln原样退 = True
    ...
    Else
        ...
        If strDelCardNo <> "" Then
            '问题号:56599
            If str卡号 <> "" Then
                strSQL = "Select Nvl(是否自制,0) As 是否自制  From 病人医疗卡信息 A,医疗卡类别 B " & _
                "           Where A.卡号=[1] And A.卡类别ID =B.ID "
                Set rs医疗卡类别 = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, str卡号)
                If rs医疗卡类别.EOF = False Then
                    If rs医疗卡类别!是否自制 = 0 Then '院外卡
    ...
    '如果退费涉及预交款,则需要刷卡验证
    If gbln消费验证 And dbl预交支付 <> 0 Then
        If mrsBill.RecordCount <> 0 Then mrsBill.MoveFirst
        If Not zlDatabase.PatiIdentify(Me, glngSys, Nvl(mrsBill!病人ID, 0), dbl预交支付, _
                            mlngModul, 1, IDKind.GetCurCard.接口序号, True) Then Exit Function
    End If
...
ResumeExecute:
    ...
    If byt退费类型 <> 0 Then
        ...
        If gblnSharedInvoice Then
            blnStartFactUseType = zlStartFactUseType("1")
            If blnStartFactUseType Then
                strUseType = zl_GetInvoiceUserType(lng病人ID, 0, mintInsure)
            End If
        End If
        Call RePrintBill(Me, 2, strNO, lng结帐ID, mintInsure, MCPAR.医保接口打印票据, strUseType, bln退费重打 And Not bln记帐 And (byt退费类型 <> 0 Or blnCardReprint))
    End If
    Select Case gByt退号回单
        Case 0
            bln打印 = False
        Case 1
            bln打印 = True
        Case 2
            If MsgBox("要打印退号回单吗？", vbQuestion + vbYesNo + vbDefaultButton1, gstrSysName) = vbYes Then
                bln打印 = True
            End If
    End Select
    If bln打印 Then
        Call ReportOpen(gcnOracle, glngSys, "ZL" & glngSys \ 100 & "_BILL_1111_3", Me, "NO=" & strNO, 2)
    End If
...
Private Function CheckInputValied() As Boolean
    ...
    With mobjfrmPatiInfo
        If Not mrsInfo Is Nothing And .mlng病人ID > 0 And mbln基本信息调整 And (.mstr年龄 & .mstr年龄单位 <> IIf(IsNumeric(txt年龄.Text), txt年龄.Text & cbo年龄单位.Text, txt年龄.Text) Or .mstr性别 <> NeedName(cbo性别.Text) Or .mstr姓名 <> txtPatient.Text Or _
            ...
            If MsgBox("病人基本信息已发生改变，是否继续？", vbInformation + vbYesNo, gstrSysName) = vbNo Then
                '记录病人原始信息
                txtPatient.Text = .mstr姓名:  cbo性别.ListIndex = GetCboIndex(cbo性别, .mstr性别)
    ...
    Else
        ...
        If mblnStructAdress Then
            If Not CheckStructAddr(padd家庭地址, 100) Then Exit Function
            If Not CheckStructAddr(padd户口地址, 100) Then Exit Function
        Else
            If zlCommFun.ActualLen(cbo家庭地址.Text) > 100 Then
                MsgBox "家庭地址输入过长，只允许输入100个字符或50个汉字，请检查!", vbInformation, gstrSysName
                cbo家庭地址.SetFocus: Exit Function
            End If
            
            If zlCommFun.ActualLen(cbo户口地址.Text) > 100 Then
                MsgBox "户口地址输入过长，只允许输入100个字符或50个汉字，请检查!", vbInformation, gstrSysName
    ...
    If cbo医生.ListIndex = -1 And cbo医生.Enabled Then
        ...
        Exit Function
    End If
    '134429：李南春，2019/1/7，检查当前出诊记录ID信息是否一致
    ...
    If mbytMode <> 1 And (mblnStation And Not mblnStationPrice And cbo结算方式.Visible = True) Then
        If cbo结算方式.ListIndex = -1 And Not blnPrice And mdbl个帐余额 = 0 And mdbl预交余额 = 0 Then
...
'        Exit Function
    ...
    If Val(dbl预交支付) <> 0 Then
        If Not zlDatabase.PatiIdentify(Me, glngSys, Nvl(mrsInfo!病人ID, 0), Val(dbl预交支付), _
                                mlngModul, 1, IDKind.GetCurCard.接口序号, True) Then Exit Function
    End If
...
Private Function CheckPayStyleValied(ByRef lngRow As Long) As Boolean
    ...
    If cbo结算方式.Text = "" Then
        ...
        Else
            For i = 1 To vsfPay.Rows - 1
                If Val(vsfPay.TextMatrix(i, vsfPay.ColIndex("金额"))) <> 0 Then
                ...
                End If
            Next i
            MsgBox "本次支付金额不足,不能完成挂号!", vbInformation, gstrSysName
            Exit Function
        End If
    End If
    ...
    If rsTemp.EOF Then
        strSQL = "Select 8 As 性质 From 医疗卡类别 Where 名称=[1] Union Select 8 As 性质 From 卡消费接口目录 Where 名称=[1]"
        Set rsTemp = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, NeedName(cbo结算方式.Text))
        If rsTemp.EOF Then
...
Private Function Get性质(ByVal str支付方式 As String, ByRef str结算方式 As String) As Integer
    ...
    If Not rsTemp.EOF Then
        ...
        str结算方式 = str支付方式
    Else
        strSQL = "Select 结算方式 From 医疗卡类别 Where 名称=[1] Union Select 结算方式 From 卡消费接口目录 Where 名称=[1]"
        Set rsTemp = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, str支付方式)
        If Not rsTemp.EOF Then
            Get性质 = 8
...
Private Function PlugInPatiValiedCheck() As Boolean
    Dim blnChecked As Boolean
    Dim strPatiInforXML As String
    Dim str年龄 As String, str出生日期 As String, str身份证号 As String
    ...
    If mbytMode = 0 And mbytInState = 0 Then
        If CreatePlugInOK(mlngModul) Then
            ...
            If mrsInfo Is Nothing Then
                ...
                blnChecked = gobjPlugIn.PatiValiedCheck(glngSys, mlngModul, 1, 0, 0, strPatiInforXML)
            Else
                strPatiInforXML = "<YSXM>" & NeedName(cbo医生.Text) & "</YSXM>"
                blnChecked = gobjPlugIn.PatiValiedCheck(glngSys, mlngModul, 1, Val(Nvl(mrsInfo!病人ID)), 0, strPatiInforXML)
            End If
            If Err <> 0 Then
                Call zlPlugInErrH(Err, "PatiValiedCheck"): Err.Clear
            Else
                If blnChecked = False Then Exit Function
            End If
        End If
    End If
    PlugInPatiValiedCheck = True
End Function
...
'---------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Dim objICCard As Object, dblPaySum As Double, str结算方式
    Dim strStyle As String, rsCheck As ADODB.Recordset
    Dim dbl费用金额 As Double, dbl结帐金额 As Double
    ...
    Dim rsSNCheck As ADODB.Recordset
    ...
    Dim Datsys As Date, lngRow As Long
    ...
    Dim str时点 As String, int性质 As Integer
    Dim blnInsertHisBook As Boolean, blnEnterPrint As Boolean
    Dim bln达到限号数 As Boolean, str医生姓名 As String, lng医生ID As Long
    ...
    Dim lng就诊ID As Long, dat发生时间 As Date
    Dim dbl找补 As Double, curCard As Currency
    Dim strDebug As String, bln检查时段 As Boolean
    Dim cur连续 As Currency, strErrMsg As String
    Dim lng记录ID As Long
    ...
    Else
        ...
        If cbo结算方式.Visible Then
            ...
            If lngRow <> 0 Then
                If Val(txt缴款.Text) = 0 Then
                    ...
                    If gbln缴款结束 And int性质 <> 7 And int性质 <> 8 Then
                        With vsfPay
                ...
                Else
                    ...
                    Else
                        ...
                        If Val(txt本次应缴.Text) = Val(txt缴款.Text) Then
                            ...
                            txt缴款.Text = ""
                        Else
                            txt本次应缴.Text = Format(Val(txt本次应缴.Text) - Val(txt缴款.Text), "0.00")
                            txt缴款.Text = ""
        ...
        Else
            If mblnStation Then
                blnPrice = mblnStationPrice And txtPatient.Text <> "" And mbytMode = 0 And chkBooking.Value = 0 And mstrNoIn = "" And vsfPlan.TextMatrix(vsfPlan.Row, vsfPlan.ColIndex("病案")) <> ""
            Else
                blnPrice = gblnPrice And txtPatient.Text <> "" And mbytMode = 0 And chkBooking.Value = 0 And mstrNoIn = "" And vsfPlan.TextMatrix(vsfPlan.Row, vsfPlan.ColIndex("病案")) <> ""
            End If
        End If
        ...
        If txtSN.Visible Then
            ...
            lngSN = Val(txtSN.Text)
        End If
        '134429:李南春，2019/1/7，只能以选中行号进行判断
        ...
        '102230,调用外挂部件接口
        If PlugInPatiValiedCheck() = False Then Exit Sub
        ...
        If mcustomTime = t_时段 Then
            ...
            ElseIf mbytMode = 0 And mViewMode = v_专家号分时段 Then
                ...
                '挂号 检查 时间是否在工作时间内
                '-----------------------------------------------
                    If Format(CDate(Format(Datsys, "hh:mm:ss")), "hh:mm:ss") < Format(CDate(Get时段(vsfList.Row, vsfList.Col, True)), "hh:mm:ss") Then
                        If Check有效号别(vsfPlan.TextMatrix(vsfPlan.Row, _
        ...
        If mRegistFeeMode = EM_RG_记帐 Then
            bln存为划价单 = False
        Else
            bln存为划价单 = (mblnStation And mblnStationPrice And mbytMode <> 1 Or blnPrice)
        End If

        '挂号费用信息
        '各类金额
        If Not blnPrice And Not bln存为划价单 Then
            curCard = 0
            mstrCard结算方式 = ""
            If Not mrsItems Is Nothing Then
                mrsItems.Filter = "性质=4"
                    ...
                    If .TextMatrix(i, 0) <> "" Then
                        ...
                        Else
                            ...
                            Else
                                ...
                                End If
                                If curCard <> 0 Then
                                    If Val(.TextMatrix(i, 1)) >= curCard Then
            ...
            If mRegistFeeMode <> EM_RG_记帐 Then
                For i = 1 To vsfPay.Rows - 1
                    ...
                    If Not rsTemp.EOF Then
                        ...
                        Exit For
                    Else
                        strSQL = "Select 编号,名称,结算方式 From 卡消费接口目录 Where 名称= [1] "
                        Set rsTemp = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, vsfPay.TextMatrix(i, 0))
                        If Not rsTemp.EOF Then
        ...
        If mViewMode <> V_普通号 Then
            Set mrsSNState = GetSNState(Val(vsfPlan.TextMatrix(vsfPlan.Row, vsfPlan.ColIndex("记录ID"))), CDate(Format(IIf(picBookingDate.Visible, dtpAppointmentDate.Value, Datsys), "yyyy-MM-dd")))
        End If
        ...
        If Trim(txtSN.Text) <> "" And Val(txtSN.Tag) <> Val(txtSN.Text) And Not mrsSNState Is Nothing Then
            ...
            Set rsSNCheck = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, Val(vsfPlan.TextMatrix(vsfPlan.Row, vsfPlan.ColIndex("记录ID"))), lngSN)
            mrsSNState.Filter = "序号=" & lngSN
        ...
        If mcustomTime = t_时段 Then    '该时段代表只要所有安排中有一个安排设置了时段该mcustomTime的值都被设置为了t_时段（也就是说该条件成立）
            '接收将来的预约挂号时,发生时间不变-picBookingDate.Visible Or
            ...
            If dtpAppointmentTime.Visible = False And (mViewMode = v_专家号分时段 Or mViewMode = V_普通号分时段) And mbytMode <> 2 And mstrNoIn = "" Then
                mrs时间段.MoveLast
                With vsfPlan
        ...
        If mbytMode <> 2 And mstrNoIn = "" And (mViewMode <> v_专家号分时段 Or bln检查时段 = True) Then
            If vsfPlan.TextMatrix(vsfPlan.Row, vsfPlan.ColIndex("挂号时间")) <> "" Then
                If Not (CDate(Format(vsfPlan.TextMatrix(vsfPlan.Row, vsfPlan.ColIndex("挂号时间")), "yyyy-mm-dd hh:mm:ss")) > zlDatabase.Currentdate And CDate(Format(vsfPlan.TextMatrix(vsfPlan.Row, vsfPlan.ColIndex("提前时间")), "yyyy-mm-dd hh:mm:ss")) < zlDatabase.Currentdate) Then
                    If Check有效时间段(vsfPlan.TextMatrix(vsfPlan.Row, vsfPlan.ColIndex("记录ID")), dat发生时间) = False Then
                        If chkShowAll.Value = 1 Then
        ...
        With vsfPlan
            If .TextMatrix(.Row, .ColIndex("替诊开始时间")) <> "" Then
                If .TextMatrix(.Row, .ColIndex("替诊医生姓名")) <> "" And dat发生时间 >= CDate(.TextMatrix(.Row, .ColIndex("替诊开始时间"))) And dat发生时间 <= CDate(.TextMatrix(.Row, .ColIndex("替诊终止时间"))) Then
        ...
        If cbo预约方式.Visible And (mbytMode = 1 Or chkBooking.Value = 1) Then
            ...
            Set rsTemp = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, Val(vsfPlan.TextMatrix(vsfPlan.Row, vsfPlan.ColIndex("记录ID"))), dat发生时间, lngSN, NeedName(cbo预约方式.Text, , "."))
            If rsTemp.EOF Then
        ...
        If blnPati Then
            With mobjfrmPatiInfo
                ...
                "zl_挂号病人病案_INSERT(" & bytType & "," & lng病人ID & "," & IIf(str门诊号 = "", "NULL", str门诊号) & "," & _
                         ...
                         IIf(Trim(mobjfrmPatiInfo.txt联系人关系.Text) = "", "NULL,", "'" & Trim(mobjfrmPatiInfo.txt联系人关系.Text) & "',")
                ...
                End If
                'str其他关系
                If mobjfrmPatiInfo.txt联系人姓名.Text <> "" And NeedName(mobjfrmPatiInfo.txt联系人关系.Text) = "其他" Then
        ...
        '101170:李南春,2017/5/4,保存HIS数据要提交EMPI数据，失败后所有数据都要回退
        ...
        If (mbytMode = 2 Or mbytMode = 0 And mbytInState = 0 And mstrNoIn <> "") And mTy_Para.bln预约接收确定挂号费 = False Then
            ...
            If Not mrsBill Is Nothing And (mbytMode = 2 Or (mbytMode = 0 And mbytInState = 0 And mstrNoIn <> "")) And InStr(1, mstrPrivs, ";允许修改费别;") > 0 Then
                ...
                For j = 1 To mrsInComes.RecordCount
                    ...
                    Else
                        ...
                        Else
                            ...
                            '  退号重用_IN Number:=1,
                            strSQL = strSQL & IIf(mTy_Para.blnReuseCancelNO, 1, 0) & ",Null,0,0,Null,0,'"
                            ...
                            If Trim(IIf(txt号别.Text = "+", "", txt号别.Text)) <> "" And k = 1 Then
                                ...
                                strSQL = strSQL & "" & ZVal(vsfPlan.TextMatrix(vsfPlan.Row, vsfPlan.ColIndex("记录ID"))) & ")"
                            ...
                            '72702：李南春，2014-06-09，门诊医生站挂号时开单部门ID以安排的科室为准
                            If (bln存为划价单 Or blnPrice) _
                                And mRegistFeeMode <> EM_RG_记帐 Then
                                strSQL = _
        ...
        If (mbytMode = 2 Or mbytMode = 0 And mbytInState = 0 And mstrNoIn <> "") Then
            ...
            End If
            '--预约接收
            strSQL = "Zl_预约挂号接收_出诊_insert('" & strNO & "'," & _
...
OthersCommit:
            ...
            '问题号:56599
            '写卡操作
            If bln发卡 Then Call WriteCard(lng病人ID)
...
'        cmd结束挂号.Enabled = True
    ...
    '医生站挂完号之后直接退出
    If mblnStation Then Call ClearBill: Unload Me: Exit Sub
    ...
    If mintInsure <> 0 And mstrYBPati <> "" Then
        ...
        bln连续 = gbln缴款结束 And mbytMode <> 1 And Val(txt缴款.Text) = 0 And txtPatient.Text <> "" And bln连续
        ...
        End If
    Else
        bln连续 = gbln缴款结束 And mbytMode <> 1 And Val(txt缴款.Text) = 0 And mstrYBPati = "" And txtPatient.Text <> ""
    End If
    ...
    If mbytMode <> 1 And Not mblnStation And Not blnPrice Then
        If blnNoPrint = False Then
            '问题:47154
            Call RefreshFact(blnNew, strFact)
        End If
    End If
...
'参数：blnNew=是否新单保存时调用,这时对于非严格控制的票据是保存当前号
    ...
    Else
        ...
        If Not blnNew Then
            ...
            End If
            txtFact.Text = IncStr(strFact)
        Else
            If gblnSharedInvoice Then
                zlDatabase.SetPara "当前收费票据号", strFact, glngSys, 1121
            Else
                zlDatabase.SetPara "当前挂号票据号", strFact, glngSys, mlngModul
            End If
...
Private Sub SetReceiveState(Optional blnReceive As Boolean)
    ...
    If mblnStation Then
        If InStr(1, mstrPrivs, ";允许修改费别;") > 0 And mTy_Para.bln预约接收确定挂号费 = True Then
            cbo费别.Enabled = True And InStr(1, mstrStationPrivs, ";允许修改费别;") > 0
            chk病历费.Enabled = True
        Else
            cbo费别.Enabled = Not blnReceive And InStr(1, mstrStationPrivs, ";允许修改费别;") > 0 '可以选择结算方式
...
Private Function ReadBooking(ByVal strNO As String) As Boolean
    ...
    If ReadBill(mstrNoIn, True) = False Then Exit Function
...
'        mblnUnload = True: Exit Function
    ...
    End If
    txt发生时间.Text = Format(dtpAppointmentDate.Value, "yyyy-mm-dd hh:mm:ss")
    ReadBooking = True
End Function
...
Private Function ReadBill(strNO As String, Optional blnGetBooking As Boolean = False) As Boolean
    ...
    Dim curMoney As Currency
    Dim Datsys      As Date, lngCard结帐ID As Long
    Dim datTmp      As Date
    Dim blnChk      As Boolean
...
chkBooking:
    ...
    If mbytMode = 0 And mbytInState = 0 And mstrNoIn <> "" Then
        ...
        If CreatePlugInOK(mlngModul) Then
            ...
            ''      strReserve=保留参数,用于扩展使用
            Dim blnChecked As Boolean
            blnChecked = gobjPlugIn.PatiValiedCheck(glngSys, mlngModul, 1, Val(Nvl(mrsBill!病人ID)), 0, "<YSXM>" & NeedName(cbo医生.Text) & "</YSXM>")
            If Err <> 0 Then
                Call zlPlugInErrH(Err, "PatiValiedCheck"): Err.Clear
            Else
                If blnChecked = False Then
    ...
    cbo性别.ListIndex = GetCboIndex(cbo性别, Nvl(mrsBill!性别))
    ...
    '103974:李南春,2017/5/17，查看、接收、退号等操作时，不换算年龄
    '也不换算出生日期
    mblnChange = False
    ...
    If Not IsNull(mrsBill!医疗付款方式) Then
        cbo付款方式.ListIndex = GetCboIndex(cbo付款方式, mrsBill!医疗付款方式)
        If cbo付款方式.ListIndex = -1 Then
    ...
    cbo费别.ListIndex = GetCboIndex(cbo费别, Nvl(mrsBill!费别))
    ...
    If mlngOutModeMC > 0 Then
        cbo医疗类别.ListIndex = GetCboIndex(cbo医疗类别, "" & mrsBill!医疗类别)
    ...
    If mbytInState = 1 And mbytMode = 4 Or chkCancel.Value = 1 Then
        bln退号处理 = True
        '退号时,获取结算时相应的信息
         ExistCardFee strNO, lngCard结帐ID
         If Not zlReadRegThreeBalance(GetBill结帐ID(strNO, 4), lngCard结帐ID, cllBillBalance, mobjPayCard) Then
    ...
    If mbytInState = 1 And mbytMode = 0 Then
        Call zlReadRegThreeBalance(GetBill结帐ID(strNO, 4), lngCard结帐ID, cllBillBalance, mobjPayCard)
    End If
...
'    txt预交支付.Tag = ""
    ...
    strSQL = "Select Mod(A.记录性质,10) as 记录性质,B.性质,A.结算方式," & _
        ...
        " From " & IIf(mblnNOMoved, "H", "") & "病人预交记录 A,结算方式 B,医疗卡类别 C,卡消费接口目录 D" & _
    ...
    For i = 1 To mrsBillAdvance.RecordCount
        ...
        Else
            ...
            Case 3 '医保个人账户
                ...
                If bln退号处理 And mintCancel <> 0 Then
                    MsgBox "使用医保接口结算的挂号单据,不能将挂号费分开退!", vbInformation, gstrSysName
                    mblnUnload = True
                    Exit Function
                End If
            Case 7, 8    '一卡通相关
                If mobjPayCard Is Nothing Then
                    If bln退号处理 Then
                        ...
                        cbo结算方式.ListIndex = -1
                    Else
                        cbo结算方式.ListIndex = GetCboIndex(cbo结算方式, mrsBillAdvance!结算方式)
                    End If
                    If cbo结算方式.ListIndex = -1 Then
    ...
    Else
        ...
        Do While Not mrsItems.EOF
             For j = 1 To vsfMoney.Rows - 1
                If Trim(vsfMoney.TextMatrix(j, 0)) = mrsItems!项目名称 Then
                    cur合计 = cur合计 + Val(vsfMoney.TextMatrix(j, 2))
                    Exit For
                End If
             Next
            mrsItems.MoveNext
...
'功能：设置病人输入使能状态
    ...
    If mblnStation Then
        ...
        txt年龄.Enabled = blnEnabled And mbln基本信息调整 '问题号:58843
        cbo年龄单位.Enabled = blnEnabled And mbln基本信息调整 '问题号:58843
    ...
    Else
        ...
        txt年龄.Enabled = mbln基本信息调整 And (gbln年龄 Or blnUse)
        cbo年龄单位.Enabled = mbln基本信息调整 And (gbln年龄 Or blnUse)
...
Private Sub ReCalc预约接收发卡()
    ...
    '说明：31182
    '------------------------------------------------------------------------------------------------------------------------
    Dim blnExitLoop As Boolean, i As Long, j As Long, lngRow As Long
    ...
    mrsBill.MoveFirst
    Call ReadRegistPrice(mrsBill!收费细目ID, mbln包含病历费, mblnAddCardItem, str费别, rsItems, rsIncomes, 0, mintInsure, txt号别.Text, 10, mlng挂号科室ID)
    ...
    End If
    If mrsInfo Is Nothing Then
        Call ReadRegistPrice(0, False, mblnAddCardItem, str费别, mrsItems, mrsInComes, 0, mintInsure, txt号别.Text, mbytMode)
    Else
        If mrsInfo.RecordCount = 0 Then
            Call ReadRegistPrice(0, False, mblnAddCardItem, str费别, mrsItems, mrsInComes, 0, mintInsure, txt号别.Text, mbytMode)
        Else
            Call ReadRegistPrice(0, False, mblnAddCardItem, str费别, mrsItems, mrsInComes, Val(Nvl(mrsInfo!病人ID)), mintInsure, txt号别.Text, mbytMode)
        End If
    End If
    '显示卡费数据
     If Not mrsItems Is Nothing Then
...
'功能：根据当前界面输入的号别,读取挂号费用集,显示在表格中
    ...
    ElseIf txt号别.Text <> "" Then
        '134441:李南春，2019/1/7，不相等说明确定了号别后列表选择又发生了改变
        ...
        If lngRow = 0 Then
            mbln建病案 = False
            If Not (mbytMode = 2 Or mbytMode = 0 And mbytInState = 0 And mstrNoIn <> "") Then mlng挂号科室ID = 0
            mstr医生姓名 = ""
            mlng医生ID = 0
    ...
    Call ReadRegistPrice(lng项目id, bln病历, mblnAddCardItem, str费别, rsItems, rsIncomes, 0, mintInsure, txt号别.Text, 10, mlng挂号科室ID)
    ...
    If mrsInfo Is Nothing Then
        Call ReadRegistPrice(lng项目id, bln病历, mblnAddCardItem, str费别, mrsItems, mrsInComes, 0, mintInsure, txt号别.Text, mbytMode)
    Else
        If mrsInfo.RecordCount = 0 Then
            Call ReadRegistPrice(lng项目id, bln病历, mblnAddCardItem, str费别, mrsItems, mrsInComes, 0, mintInsure, txt号别.Text, mbytMode)
        Else
            Call ReadRegistPrice(lng项目id, bln病历, mblnAddCardItem, str费别, mrsItems, mrsInComes, Val(Nvl(mrsInfo!病人ID)), mintInsure, txt号别.Text, mbytMode)
        End If
    End If
...
'                        "Union" & vbNewLine & _
'                        "Select a.性质 From 结算方式 A, 卡消费接口目录 B Where b.名称 = [1] And a.名称 = b.结算方式 And Rownum < 2"
...
Private Sub SetRePrintPatiEnabled(ByVal blnEdit As Boolean)
    ...
    If mblnStation Then
        cbo费别.Enabled = Not blnEdit And InStr(1, mstrStationPrivs, ";允许修改费别;") > 0
    Else
...
Public Function zlReadPlugInPati(ByVal str卡号 As String, Optional blnHavePati As Boolean) As Boolean
    ...
    With mobjfrmPatiInfo
        ...
        cbo性别.ListIndex = GetCboIndex(cbo性别, Nvl(rsPatiInfor!性别)) '年龄在后面根据出生日期算
        '89242:李南春,2015/12/7,读取病人地址信息
        Call zlReadAddrInfo(padd家庭地址, Val(Nvl(rsPatiInfor!病人ID)), 0, 3, cbo家庭地址.Text)

        Call zlControl.CboSetIndex(cbo费别.Hwnd, GetCboIndex(cbo费别, "" & rsPatiInfor!费别))
...
'        txt门诊号.Enabled = (Val(txt门诊号.Text) = 0)
        ...
        If Not IsNull(rsPatiInfor!医疗付款方式) Then
            cbo付款方式.ListIndex = GetCboIndex(cbo付款方式, rsPatiInfor!医疗付款方式)
        ElseIf mstrYBPati <> "" Then
            cbo付款方式.ListIndex = GetCboIndex(cbo付款方式, "1")
        End If
        ...
        .cbo国籍.ListIndex = GetCboIndex(.cbo国籍, Nvl(rsPatiInfor!国籍))
        .cbo民族.ListIndex = GetCboIndex(.cbo民族, Nvl(rsPatiInfor!民族))
        .cbo婚姻.ListIndex = GetCboIndex(.cbo婚姻, Nvl(rsPatiInfor!婚姻状况))
        .cbo职业.ListIndex = GetCboIndex(.cbo职业, Nvl(rsPatiInfor!职业))
...
Private Function CheckBrushCard(ByVal dblMoney As Double) As Boolean
   ...
   If gobjSquare.objSquareCard.zlBrushCard(Me, mlngModul, rsMoney, mCurCardPay.lng医疗卡类别ID, mCurCardPay.bln消费卡, _
    ...
    False, True, False, True, Nothing, False, strXmlIn) = False Then Exit Function
    '保存前,一些数据检查
...
'    mCurCardPay.dbl帐户余额 = formatex(dbl帐户余额, 2)
    CheckBrushCard = True
    Exit Function
errHandle:
    If ErrCenter() = 1 Then
...
Private Sub AddCardDataSQL(ByVal lng病人ID As Long, ByVal dtCurdate As Date, _
    ...
    Else
        ...
        dtCurdate, mlng磁卡领用ID, mCurSendCard.rs卡费, strICCard, mCurCardPay.lng医疗卡类别ID, mCurCardPay.bln消费卡, mCurCardPay.str刷卡卡号, lng结帐ID)
        zlAddArray cllPro, strSQL
    End If
    Exit Sub
errHandle:
...
Private Function IsCheckCancelValied(ByVal lng挂号结帐ID As Long, ByVal lng卡费结帐ID As Long, _
    ...
    If bln退款验卡 Then
        ...
        If gobjSquare.objSquareCard.zlBrushCard(Me, mlngModul, mrsBill, lng卡类别ID, bln消费卡, _
...
Private Function ShowBillFormat()
    ...
    Dim rsTmp As ADODB.Recordset
    Dim strSQL As String, intFormat As Integer
    
     intFormat = mintInvoiceFormat
            
    If intFormat = 0 Then
        intFormat = Val(GetSetting("ZLSOFT", "私有模块\" & UserInfo.用户名 & "\zl9Report\LocalSet\ZL" & glngSys \ 100 & "_BILL_1121_1", "Format", 1))
        If intFormat = 0 Then
            intFormat = Val(zlDatabase.GetPara("普通发票格式", glngSys, 1121))
            '当有普通病人和医保病人收费权限时，如果设置了票据格式，则只显示普通病人票据格式
        End If
    End If
    strSQL = "Select B.说明 From zlReports A,zlRptFmts B" & _
        " Where A.ID=B.报表ID And A.编号='ZL" & glngSys \ 100 & "_BILL_1121_1' And B.序号=[1]"
...
Private Sub AddDeposit()
    ...
    If objFun.PlusDeposit(glngSys, gcnOracle, Me, gstrDBUser, 3, lng病人ID, 0, 0, 0) = False Then
        Set objFun = Nothing
        Exit Sub
    End If
    Set objFun = Nothing
...
Public Function CancelApp(ByVal frmMain As Object, _
    ByVal strNoIn As String, ByVal lngModul As Long, ByVal strPrivs As String, Optional blnCenter As Boolean = False) As Boolean
   '---------------------------------------------------------------------------------------------------------------------------------------------
    '功能:取消预约操作
    '入参:frmMain-调用的主窗体
    '返回:退费成功返回true,否则返回False
...
Public Sub zlQueryEMPIPatiInfo()
    ...
    With rsTmp
        ...
        !国籍 = NeedName(mobjfrmPatiInfo.cbo国籍.Text)
        !民族 = NeedName(mobjfrmPatiInfo.cbo民族.Text)
        !职业 = NeedName(mobjfrmPatiInfo.cbo职业.Text)
        !工作单位 = mobjfrmPatiInfo.txt单位名称.Text
        !婚姻状况 = NeedName(mobjfrmPatiInfo.cbo婚姻.Text)
        ...
        !联系人关系 = NeedName(mobjfrmPatiInfo.txt联系人关系.Text)
        .Update
    End With
    'EMPI没有找到病人信息,直接返回
    ...
    If mobjfrmPatiInfo.mrsEMPIOut.EOF Then Exit Sub
    On Error Resume Next
    With mobjfrmPatiInfo.mrsEMPIOut
        '104905:李南春,2017/5/4,根据EMPI传回的病人ID，查找病人
        '接收查阅退号肯定有病人ID
        ...
        If Nvl(!国籍) <> "" Then mobjfrmPatiInfo.cbo国籍.ListIndex = GetCboIndex(mobjfrmPatiInfo.cbo国籍, Nvl(!国籍))
        If Nvl(!民族) <> "" Then mobjfrmPatiInfo.cbo民族.ListIndex = GetCboIndex(mobjfrmPatiInfo.cbo民族, Nvl(!民族))
        If Nvl(!职业) <> "" Then mobjfrmPatiInfo.cbo职业.ListIndex = GetCboIndex(mobjfrmPatiInfo.cbo职业, Nvl(!职业), , True)
        If Nvl(!工作单位) <> "" Then mobjfrmPatiInfo.txt单位名称.Text = Nvl(!工作单位)
        If Nvl(!婚姻状况) <> "" Then mobjfrmPatiInfo.cbo婚姻.ListIndex = GetCboIndex(mobjfrmPatiInfo.cbo婚姻, Nvl(!婚姻状况), True)
        ...
        If Nvl(!联系人关系) <> "" Then mobjfrmPatiInfo.txt联系人关系.Text = Nvl(!联系人关系)
    End With
...
Private Function zlSaveEMPIPatiInfo(ByVal blnNewPati As Boolean, ByVal lngPatiID As Long, ByVal lngClinicID As Long, ByRef strErrMsg As String) As Boolean
    ...
    If gobjPlugIn Is Nothing Then zlSaveEMPIPatiInfo = True: Exit Function
    ...
    Else
        ...
        With mobjfrmPatiInfo.mrsEMPIOut
            ...
            If mobjfrmPatiInfo.cbo国籍.ListIndex <> GetCboIndex(mobjfrmPatiInfo.cbo国籍, Nvl(!国籍)) Then blnCharge = True: GoTo EMPIModify
            If mobjfrmPatiInfo.cbo民族.ListIndex <> GetCboIndex(mobjfrmPatiInfo.cbo民族, Nvl(!民族)) Then blnCharge = True: GoTo EMPIModify
            If mobjfrmPatiInfo.cbo职业.ListIndex <> GetCboIndex(mobjfrmPatiInfo.cbo职业, Nvl(!职业), , True) Then blnCharge = True: GoTo EMPIModify
            If mobjfrmPatiInfo.txt单位名称.Text <> Nvl(!工作单位) Then blnCharge = True: GoTo EMPIModify
            If mobjfrmPatiInfo.cbo婚姻.ListIndex <> GetCboIndex(mobjfrmPatiInfo.cbo婚姻, Nvl(!婚姻状况)) Then blnCharge = True: GoTo EMPIModify
            ...
            If mobjfrmPatiInfo.txt联系人关系.Text <> Nvl(!联系人关系) Then blnCharge = True: GoTo EMPIModify
        End With
    End If
EMPIModify:
    If blnCharge Then
