...
Begin VB.Form frmSetExpence 
   ...
   Begin TabDlg.SSTab stab 
      ...
      Tab(0).Control(0)=   "lbl结算方式"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "lbl费别"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).Control(2)=   "lblMax"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "lblDay"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).Control(4)=   "fra分离"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "chk住院按门诊收费"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "fraPrintBill"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "udDay"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).Control(8)=   "cbo结算方式"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "cbo费别"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "fra类别"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "chkPay"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "txtMax"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).Control(13)=   "txtDay"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).Control(14)=   "chk累计"
      Tab(0).Control(14).Enabled=   0   'False
      Tab(0).Control(15)=   "chk护士"
      Tab(0).Control(15).Enabled=   0   'False
      Tab(0).Control(16)=   "chkTime"
      Tab(0).Control(16).Enabled=   0   'False
      Tab(0).Control(17)=   "chkPrePayPriority"
      Tab(0).Control(17).Enabled=   0   'False
      Tab(0).Control(18)=   "cmdAddedItem"
      Tab(0).Control(18).Enabled=   0   'False
      Tab(0).Control(19)=   "txtAddedItem"
      Tab(0).Control(19).Enabled=   0   'False
      Tab(0).Control(20)=   "chkAddedItem"
      Tab(0).Control(20).Enabled=   0   'False
      Tab(0).Control(21)=   "fra库存显示"
      Tab(0).Control(21).Enabled=   0   'False
      Tab(0).Control(22)=   "chk划价立即缴款"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "chkPayKey"
      Tab(0).Control(23).Enabled=   0   'False
      Tab(0).Control(24)=   "fraDrugNotFee"
      Tab(0).Control(24).Enabled=   0   'False
      Tab(0).Control(25)=   "fra退费缺省选择方式"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "chk皮试"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "chkInsurePartFee"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "chk医保结算光标缺省定位"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "fra单位"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "fraSetMoneyMode"
      Tab(0).Control(30).Enabled=   0   'False
      Tab(0).Control(31)=   "chk抗生素"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "chk禁止取消挂号单"
...
Private Sub txtSeekDays_Validate(Cancel As Boolean)
    If Val(txtSeekDays.Text) < 1 Then
        txtSeekDays.Text = 1
    ElseIf Val(txtSeekDays.Text) > 99 Then
        txtSeekDays.Text = 99
    End If
End Sub
