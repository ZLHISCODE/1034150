...
Begin VB.Form frmChargeFilter 
   ...
   Begin TabDlg.SSTab sst1 
      ...
      Tab(2).Control(0)=   "lblApply"
      Tab(2).Control(1)=   "lblApplyDate"
      Tab(2).Control(2)=   "lblAudit"
      Tab(2).Control(3)=   "lblAuditDate"
      Tab(2).Control(4)=   "Label12"
      Tab(2).Control(5)=   "Label13"
      Tab(2).Control(6)=   "dtpAuditE"
      Tab(2).Control(7)=   "dtpApplyE"
      Tab(2).Control(8)=   "dtpAuditB"
      Tab(2).Control(9)=   "dtpApplyB"
      Tab(2).Control(10)=   "chkDate(0)"
      Tab(2).Control(11)=   "chkDate(1)"
      Tab(2).Control(12)=   "cboApply"
      Tab(2).Control(13)=   "cboAudit"
      Tab(2).Control(14)=   "frmAuditStatus"
...
Private Sub txtInput_KeyPress(Index As Integer, KeyAscii As Integer)
    ...
    If KeyAscii = vbKeyReturn Then
        ...
        On Error GoTo errH
        vRect = GetControlRect(txtInput(Index).hWnd)
...
Private Function GetDoctorName(ByVal strCode As String) As String
    ...
    vRect = GetControlRect(txt开单人.hWnd)
