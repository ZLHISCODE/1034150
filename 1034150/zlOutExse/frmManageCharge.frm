...
Begin VB.Form frmManageCharge 
   ...
   Begin MSComctlLib.ImageList imgColor 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManageCharge.frx":C36C
            Key             =   "Print"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManageCharge.frx":C586
            Key             =   "New"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManageCharge.frx":C7A0
            Key             =   "Del"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManageCharge.frx":C9BA
            Key             =   "View"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManageCharge.frx":D134
            Key             =   "Find"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManageCharge.frx":D34E
            Key             =   "Filter"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManageCharge.frx":D568
            Key             =   "Help"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManageCharge.frx":D782
            Key             =   "Quit"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManageCharge.frx":D99C
            Key             =   "Adjust"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManageCharge.frx":DBB6
            Key             =   "Modi"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManageCharge.frx":DDD0
            Key             =   "RollingCurtain"
            Object.Tag             =   "RollingCurtain"
         EndProperty
      EndProperty
   ...
   Begin MSComctlLib.StatusBar stbThis 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel5 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            Object.Width           =   3722
            MinWidth        =   3722
            Picture         =   "frmManageCharge.frx":ED5E
         EndProperty
      EndProperty
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "宋体"
   ...
   Begin MSHierarchicalFlexGridLib.MSHFlexGrid mshFact 
      ...
      SelectionMode   =   1
      AllowUserResizing=   1
      MouseIcon       =   "frmManageCharge.frx":EEF0
      _NumberOfBands  =   1
      _Band(0).Cols   =   2
   End
   Begin MSHierarchicalFlexGridLib.MSHFlexGrid mshList 
      ...
      SelectionMode   =   1
      AllowUserResizing=   1
      MouseIcon       =   "frmManageCharge.frx":F20A
      _NumberOfBands  =   1
      _Band(0).Cols   =   2
   End
...
Private Sub cboDate_Click()
    ...
    lblDateShow.Visible = cboDate.ListIndex <> 6
    ...
    If gblnOK Then
        With frmChargeFilter
            ...
            If gbln退费申请模式 And tbPage.Selected.Index = 1 Then
                ...
                SQLCondition.ApplyName = NeedName(.cboApply.Text)
                SQLCondition.ApplyDateB = .dtpApplyB.Value
                SQLCondition.ApplyDateE = .dtpApplyE.Value
                SQLCondition.AuditName = NeedName(.cboAudit.Text)
            ...
            Else
                ...
                SQLCondition.int门诊标志 = IIf(.opt病人(0).Value, 0, IIf(.opt病人(1).Value, 1, 2)) + 1
                If .cbo费别.ListIndex > 0 Then SQLCondition.ChargeKind = NeedName(.cbo费别.Text)
                If .cbo付款方式.ListIndex > 0 Then
                    SQLCondition.PayKind = NeedCode(.cbo付款方式.Text)
                    SQLCondition.PayKindName = NeedName(.cbo付款方式.Text)
                Else
...
Private Sub mshList_EnterCell()
    ...
    With mshList
        ...
        If tbPage.Selected.Index <> 1 Then
            strNo = .TextMatrix(.Row, GetColNum("结算序号"))
            blnDel = Val(.TextMatrix(.Row, GetColNum("退费符号"))) < 0
            If strNo = "" Then Exit Sub
            BytType = IIf(CheckBalance(Val(strNo)), 2, 1)
            bln红票已打印 = Val(.TextMatrix(.Row, GetColNum("红票已打印"))) = 1
        Else
            strNo = .TextMatrix(.Row, GetColNum("首张单据"))
            If strNo = "" Then Exit Sub
        End If
    ...
    If gbln退费申请模式 Then
        If tbPage.Selected.Index = 1 Then
            blnAudit = mshList.TextMatrix(mshList.Row, GetColNum("审核状态")) = "通过" Or mshList.TextMatrix(mshList.Row, GetColNum("审核状态")) = "拒绝"
            
            mnuEdit_UnApply.Enabled = Not blnAudit
            mnuEdit_Audit.Enabled = Not blnAudit
            mnuEdit_RefuseApply.Visible = Not blnAudit And Val(mshList.TextMatrix(mshList.Row, GetColNum("结算序号"))) > 0
            mnuEdit_RefuseApply.Enabled = Not blnAudit And Val(mshList.TextMatrix(mshList.Row, GetColNum("结算序号"))) > 0
            mnuEdit_UnAudit.Enabled = mshList.TextMatrix(mshList.Row, GetColNum("审核状态")) = "通过"
            mnuEditWriteCard.Enabled = False
        Else
            strDate = mshList.TextMatrix(mshList.Row, GetColNum("登记时间"))
            ...
            mnuEdit_Print.Enabled = Not blnDel And Trim(mshList.TextMatrix(mshList.Row, GetColNum("首张发票"))) <> ""
            mnuFeeDetial_Print.Enabled = mnuEdit_Print.Enabled
            mnuEdit_Print_Supplemental.Enabled = Not blnDel And Trim(mshList.TextMatrix(mshList.Row, GetColNum("首张发票"))) = ""
            mnuFeeDetial_Supplemental.Enabled = Not blnDel And Trim(mshList.TextMatrix(mshList.Row, GetColNum("首张发票"))) = ""
...
Private Function CheckErrBill() As Boolean
    ...
    Select Case cboDate.ListIndex
       ...
       Case 2 '前二天至今日
           ...
           dtEndDate = CDate(Format(dtpStartDate.MaxDate, "yyyy-mm-dd") & " 23:59:59")
       Case 3 '前三天至今日
           dtStartDate = CDate(Format(DateAdd("d", -3, dtpStartDate.MaxDate), "yyyy-mm-dd") & " 00:00:00")
           dtEndDate = CDate(Format(dtpStartDate.MaxDate, "yyyy-mm-dd") & " 23:59:59")
       Case 4  '前一周至今日
           dtStartDate = CDate(Format(DateAdd("d", -7, dtpStartDate.MaxDate), "yyyy-mm-dd") & " 00:00:00")
           dtEndDate = CDate(Format(dtpStartDate.MaxDate, "yyyy-mm-dd") & " 23:59:59")
       Case 5  '
           dtStartDate = CDate(Format(DateAdd("m", -1, dtpStartDate.MaxDate), "yyyy-mm-dd") & " 00:00:00")
           dtEndDate = CDate(Format(dtpStartDate.MaxDate, "yyyy-mm-dd") & " 23:59:59")
       Case Else
...
Private Sub mshFact_EnterCell()
    mshFact.ForeColorSel = mshFact.CellForeColor
End Sub
...
Private Sub tbPage_SelectedChanged(ByVal Item As XtremeSuiteControls.ITabControlItem)
    ...
    Else
        ...
        Call SaveFlexState(mshList, App.ProductName & "\" & Me.Name & 1)
    End If
...
'    mnuEdit_Del.Enabled = blnUsed And Not blnApply
    ...
    mnuEdit_RefuseApply.Enabled = blnUsed And blnApply
    ...
    For i = IIf(blnHead, 1, mlngGo) To mshList.Rows - 1
        ...
        With frmChargeGo
            ...
            If .cbo操作员.ListIndex > 0 Then
                blnFill = blnFill And mshList.TextMatrix(i, GetColNum("操作员")) = NeedName(.cbo操作员.Text)
            End If
            If .txt姓名.Text <> "" Then
...
'bytMode=0-重打,1-补打
    ...
    If RePrintCharge(IIf(bytMode = 0, 1, 2), strNos, Me, 0, strReclaimInvoice, , , _
        intInvoiceFormat, blnVirtualPrint, blnDel, lngShareUseID, strUseType, blnOnePatiPrint) Then
...
Private Sub mshList_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Button = 1 And mshList.MousePointer = 99 Then
        ...
        If mshList.TextMatrix(1, GetColNum("首张单据")) = "" Then Exit Sub
        If mrsList Is Nothing Then Exit Sub
...
Private Sub SetApplyHeader()
    ...
    With mshList
        ...
        For i = 0 To UBound(Split(strHead, "|"))
            ...
            If Not Visible Or tbPage.Tag = "Change" Then .ColWidth(i) = Split(Split(strHead, "|")(i), ",")(2)
            .ColAlignmentFixed(i) = 4
        Next
        
        If Not Visible Or tbPage.Tag = "Change" Then Call RestoreFlexState(mshList, App.ProductName & "\" & Me.Name & 1)
        .RowHeight(0) = 350
        For i = 1 To .Rows - 1
            .RowHeight(i) = 300
        Next i
...
Private Sub SetHeader()
    ...
    With mshList
        ...
        If Not Visible Or tbPage.Tag = "Change" Then Call RestoreFlexState(mshList, App.ProductName & "\" & Me.Name)
        ...
        i = GetColNum("符号"): .ColWidth(i) = 0
        i = GetColNum("结算序号"): .ColWidth(i) = 0
...
Private Sub ShowBalanceList(Optional ByVal strNo As String, Optional ByVal blnSort As Boolean)
    Dim strSql As String, i As Long, lngBalanceID As Long, blnDel As Boolean
...
Private Sub ShowFactList(Optional ByVal strNo As String, Optional ByVal blnSort As Boolean)
    ...
    Else
        strSql = _
            " Select Nvl(A.结算方式,'未退金额') As 结算方式,Sum(A.冲预交) As 冲预交,Decode(Nvl(A.校对标志,0),0,'√',2,'√','×') As 标志,Nvl(B.性质,0) As 性质 " & _
            " From 病人预交记录 A,结算方式 B " & _
            " Where A.结算序号 = [1] And A.结算方式=B.名称(+)" & _
            " Group By Nvl(A.结算方式,'未退金额'),Nvl(A.校对标志,0),Nvl(B.性质,0)" & _
            " Order By 性质"
    End If
...
Private Sub ShowExtendInfo()
    ...
    If CheckBalance(lngBalanceID) Then
        ...
        strSql = _
            ...
            " Where b.结帐id = [1] And a.交易id = b.Id And b.卡类别id = c.Id(+) Order By ID"
    Else
        strSql = _
            " Select a.交易id As ID, b.结算方式, c.名称, b.冲预交 As 金额, a.交易项目 As 项目, a.交易内容 As 内容" & vbNewLine & _
            " From " & IIf(mblnNOMoved, "H", "") & "三方结算交易 A, " & IIf(mblnNOMoved, "H", "") & "病人预交记录 B, 医疗卡类别 C" & vbNewLine & _
            " Where b.结算序号 = [1] And a.交易id = b.Id And b.卡类别id = c.Id(+) Order By ID"
    End If
...
Private Sub SetApplyFactList()
    ...
    End If
    strHead = "ID,1,0,0|票据号,1,850|使用原因,1,850|使用时间,1,1080|使用人,1,800"
    With mshFact
        .Redraw = False
        varData = Split(strHead, "|")
        .COLS = UBound(varData) + 1
        For i = 0 To UBound(varData)
            ...
            '78562,冉俊明,2014-10-13,显示应该显示而被隐藏的列
            If .ColWidth(i) = 0 And Val(Split(varData(i), ",")(2)) <> 0 Then
                .ColWidth(i) = Val(Split(varData(i), ",")(2))
            End If
            If .TextMatrix(0, i) = "ID" Then .ColWidth(i) = 0
            .ColAlignmentFixed(i) = 4
        Next
        
        If Not Visible Then Call RestoreFlexState(mshFact, App.ProductName & "\" & Me.Name)
...
Private Sub SetFactList()
    ...
    End If
    If tbPage.Selected.Index = 3 Then
        strHead = "结算方式,4,1000|收费金额,7,1000|退费状态,4,1200|性质,1,0"
    Else
        strHead = "结算方式,4,1000|收费金额,7,1000|收费状态,4,1200|性质,1,0"
    End If
    ...
    With mshFact
        ...
        For i = 0 To UBound(varData)
            ...
            End If
            '隐藏不显示的列
            If .TextMatrix(0, i) = "性质" Then .ColWidth(i) = 0
            .ColAlignmentFixed(i) = 4
        Next
        For i = 1 To .Rows - 1
...
Private Sub mshDetail_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
    Dim lngCol As Long, strDate As String, blnDel As Boolean
    ...
    If Button = 1 And mshDetail.MousePointer = 99 Then
        ...
        If mshDetail.TextMatrix(0, lngCol) = "发药药店" Then
            mrsDetail.Sort = "执行科室" & IIf(mshDetail.ColData(lngCol) = 0, "", " DESC")
        Else
...
Private Sub mshFact_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If mshFact.MouseRow = 0 Then
        mshFact.MousePointer = 99
    Else
        mshFact.MousePointer = 0
    End If
End Sub

Private Sub mshFact_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
    Dim lngCol As Long
    
    lngCol = mshFact.MouseCol
    
    If Button = 1 And mshFact.MousePointer = 99 Then
        If mshFact.TextMatrix(0, lngCol) = "" Then Exit Sub
        If mshFact.TextMatrix(1, 0) = "" Then Exit Sub
        If mrsFact Is Nothing Then Exit Sub
        
        Set mshFact.DataSource = Nothing

        'mrsFact.Sort = mshFact.TextMatrix(0, lngCol) & IIf(mshFact.ColData(lngCol) = 0, "", " DESC")
        mshFact.ColData(lngCol) = (mshFact.ColData(lngCol) + 1) Mod 2
        
        Call ShowFactList(, True)
    End If
End Sub
