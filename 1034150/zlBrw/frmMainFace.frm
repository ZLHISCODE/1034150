...
Begin VB.Form frmBrower 
   ...
   Begin MSComctlLib.ImageList imgToolsHot 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   10
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":9D1B
            Key             =   "Preview"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":9F35
            Key             =   "Print"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":A14F
            Key             =   "Forward"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":A369
            Key             =   "Back"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":A583
            Key             =   "UpGrade"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":A79D
            Key             =   "Font"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":A9B7
            Key             =   "Help"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":ABD1
            Key             =   "Exit"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":ADEB
            Key             =   "Tool2"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":BE7D
            Key             =   "Tool"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imgToolsStard 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   10
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":CF0F
            Key             =   "Preview"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":D129
            Key             =   "Print"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":D343
            Key             =   "Forward"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":D55D
            Key             =   "Back"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":D777
            Key             =   "UpGrade"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":D991
            Key             =   "Font"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":DBAB
            Key             =   "Help"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":DDC5
            Key             =   "Exit"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":DFDF
            Key             =   "Tool2"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainFace.frx":F071
            Key             =   "Tool"
         EndProperty
      EndProperty
   End
...
Private Sub Form_Activate()
    ...
    stbThis.Panels(3).Text = gobjRelogin.DBUser & IIf(gobjRelogin.ServerName = "", "", "@" & gobjRelogin.ServerName) & IIf(zlDatabase.CheckRAC(lngInstanceNo), "(RAC:" & lngInstanceNo & ")", "")
    If stbThis.Panels(4).Tag = "" Then stbThis.Panels(4).Tag = Sys.IP
    stbThis.Panels(4).Text = stbThis.Panels(4).Tag
    stbThis.Panels(5).Text = gstrUserName
    stbThis.Panels(6).Text = gstrDeptName
    Call SetMainForm(Me)
...
Private Sub Form_Load()
    ...
    glngkey_idHotKey = GlobalAddAtom("MyHotKey") - &HC000
'    'glngkey_idHotKey的合法取之范围是0x0000到0xBFFF之间，   GlobalAddAtom函数得到的值在0xC000到0xFFFF之间，所以减掉0xC000来满足调用要求。
    If Not OS.IsDesinMode Then
        glngkey_preWinProc = GetWindowLong(Me.hwnd, GWL_WNDPROC)
        ' 用自定义程序代替原来的window程序
        SetWindowLong Me.hwnd, GWL_WNDPROC, AddressOf keyWndproc
        'CTRL+ALT+L
        If RegisterHotKey(Me.hwnd, glngkey_idHotKey, MOD_CONTROL + MOD_ALT, vbKeyL) = 0 Then  '向窗口注册系统热键,注册失败则不在标题栏上现实
            mstrHotKey = ""
        Else
            mstrHotKey = "CTRL+ALT+L"
        End If
    End If
    Me.Caption = gstrUserName & "-" & mstrTitle & IIf(mstrHotKey <> "", "(锁屏：" & mstrHotKey & ")", "")
    Call CheckTools
    Call LoadInitIcon
    RestoreWinState Me
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    If mstrHotKey <> "" Then
        '删除该热键的绑定
        UnregisterHotKey Me.hwnd, glngkey_idHotKey '取消系统热键
        SetWindowLong Me.hwnd, GWL_WNDPROC, glngkey_preWinProc  '恢复窗口信息
    End If
...
Private Sub tvwMenu_NodeClick(ByVal Node As MSComctlLib.Node)
    ...
    Node.Bold = True
    Me.Caption = gstrUserName & "-" & mstrTitle & "-" & Node.Text & IIf(mstrHotKey <> "", "(锁屏：" & mstrHotKey & ")", "")
    '后退记录
    Err = 0
    On Error Resume Next
