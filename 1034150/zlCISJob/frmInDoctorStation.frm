...
Begin VB.Form frmInDoctorStation 
   ...
   Begin VB.PictureBox picPati 
      ...
      Begin VB.Frame fra审查 
         ...
         Begin VB.Label lbl审查 
            ...
            Height          =   180
            Left            =   450
            MouseIcon       =   "frmInDoctorStation.frx":870C
      ...
      Begin MSComctlLib.ImageList imgPati 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":885E
               Key             =   "Pati"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":8DF8
               Key             =   "Meet"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":9392
               Key             =   "MeetFinish"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":992C
               Key             =   "Notify"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":9EC6
               Key             =   "等待审查"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":A460
               Key             =   "拒绝审查"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":A9FA
               Key             =   "正在审查"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":AF94
               Key             =   "正在抽查"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":B9A6
               Key             =   "审查反馈"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":C3B8
               Key             =   "抽查反馈"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":C952
               Key             =   "审查整改"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":D364
               Key             =   "抽查整改"
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":DD76
               Key             =   "未导入"
            EndProperty
            BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":E310
               Key             =   "变异结束"
            EndProperty
            BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":E8AA
               Key             =   "正常结束"
            EndProperty
            BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":EE44
               Key             =   "不符合"
            EndProperty
            BeginProperty ListImage17 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":F856
               Key             =   "执行中"
            EndProperty
            BeginProperty ListImage18 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":FDF0
               Key             =   "Child"
            EndProperty
            BeginProperty ListImage19 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":1038A
               Key             =   "单病种"
            EndProperty
            BeginProperty ListImage20 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":16BEC
               Key             =   "Out"
            EndProperty
            BeginProperty ListImage21 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInDoctorStation.frx":17186
               Key             =   "Fbaby"
            EndProperty
         EndProperty
      End
      Begin zlIDKind.PatiIdentify PatiIdentify 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         IDKindStr       =   $"frmInDoctorStation.frx":17720
   ...
   Begin XtremeDockingPane.DockingPane dkpMain 
      Bindings        =   "frmInDoctorStation.frx":177D2
      Left            =   705
      Top             =   210
      _Version        =   589884
      _ExtentX        =   450
...
Private mobjKernel As zlPublicAdvice.clsPublicAdvice
...
Private mintDeptViewBed As Integer '0-显示病区或者科室，1-只显示有床位的病区或者科室
...
Private mblnIsNot As Boolean, mstrVirutalPrivs As String
    ...
    If Index = 1 Then
        ...
        If intDateCount = -1 Then
            If Not frmSelectTime.ShowMe(Me, mdtOutBegin, mdtOutEnd, cboSelectTime(1)) Then
                '取消时恢复原来的选择
                Call zlControl.CboSetIndex(cboSelectTime(Index).hWnd, mintOutPreTime)
                Exit Sub
            End If
        Else
            mdtOutEnd = datCurr
    ...
    ElseIf Index = 2 Then
        ...
        If intDateCount = -1 Then
            If Not frmSelectTime.ShowMe(Me, mdtMeetBegin, mdtMeetEnd, cboSelectTime(2)) Then
                '取消时恢复原来的选择
                Call zlControl.CboSetIndex(cboSelectTime(Index).hWnd, mintMeetPreTime)
                Exit Sub
            End If
        Else
            mdtMeetEnd = datCurr
...
Private Sub Form_Load()
    ...
    mstrCardKind = "住|住院号|0|0|0|0|0|0;床|床号|0|0|0|0|0|0;就|就诊卡|0|0|8|0|0|0;姓|姓名|0|0|0|0|0|0"
    ...
    Call zlControl.CboSetWidth(cbo过敏.hWnd, cbo过敏.Width * 2)
    Call zlControl.CboSetWidth(cboPages.hWnd, cboPages.Width * 2.5)
...
'功能：定位到指定的病人
    ...
    If lng病人ID <> 0 Then
        ...
        If lng部门ID <> 0 Then Call zlControl.CboLocate(cboDept, lng部门ID, True)   '如果是与之前的科室相同，不会触发click事件
...
Private Sub cbsMain_Execute(ByVal Control As XtremeCommandBars.ICommandBarControl)
    ...
    Case conMenu_Tool_KssAudit '抗菌用药审核
        Call frmKSSExamine.ShowMe(Me, mclsMipModule)
    Case conMenu_Tool_OPSAudit '手术审核管理
        Call frmOPSExamine.ShowMe(Me, mclsMipModule)
    ...
    Case conMenu_Tool_TransAudit '输血审核管理
        Call frmTransfuseExamine.ShowMe(Me, 2, mclsMipModule)
    ...
    Case conMenu_Edit_OpenArrangement
        Call gobjVitualExpense.zlOpenStopedPlanBySN(Me, p住院医生站, , , UserInfo.ID)
    ...
    Case conMenu_Tool_HealthCard  '居民健康卡
        If Not mobjSquareCard Is Nothing Then
            Call mobjSquareCard.zlHealthArchivesShow(Me, p门诊医生站, mPatiInfo.病人ID, "")
        End If
    Case conMenu_Tool_Positive '阳性结果查看
        i = GetOne阳性结果
        If i <> 0 Then Call mclsDisease.ShowDisRegist(Me, 1, i, mPatiInfo.病人ID, mPatiInfo.主页ID)
    ...
    Case Else
        ...
        Else
            ...
            Case Else
                If Not gobjPlugIn Is Nothing Then
                    On Error Resume Next
                    Call gobjPlugIn.ExeButtomClick(glngSys, p住院医生站, mcolSubForm("_" & tbcSub.Selected.Tag), tbcSub.Selected.Tag, Control.Caption, mPatiInfo.病人ID, mPatiInfo.主页ID, "")
        ...
        Else
            ...
            If rptPati.SelectedRows.Count > 0 Then
                If Not rptPati.SelectedRows(0).GroupRow And rptPati.SelectedRows(0).Childs.Count = 0 Then
                    blnEnabled = rptPati.SelectedRows(0).Record(col_类型).Value = pt会诊
                End If
            End If
            Control.Enabled = blnEnabled
        ...
        Else
            ...
            If rptPati.SelectedRows.Count > 0 Then
                With rptPati.SelectedRows(0)
                    If Not .GroupRow Then
                        If Int(Val(.Record(col_类型).Value)) = pt出院 Or Int(Val(.Record(col_类型).Value)) = pt死亡 Then
        ...
        With mPatiInfo
            ...
            Case "医嘱"
                ...
                Call mclsAdvices.zlRefresh(.病人ID, .主页ID, lng病区ID, lng科室ID, lngState, .数据转出, , , lng执行科室ID, lng路径状态, _
                    cboDept.ItemData(cboDept.ListIndex), mclsMipModule, .婴儿)
            Case "病历"
                blnEdit = True
                With rptPati.SelectedRows(0)
                ...
                '待入住的病人不允许编辑病历
                blnEdit = blnEdit And tbcPati.Selected.Tag <> "待入住" And mlng病人ID = .病人ID
            ...
            Case "监护"
                ...
                End If
            Case "新病历"
                Call mclsEMR.zlRefresh(.病人ID, .主页ID, IIf(mintDeptView = 0, cboDept.ItemData(cboDept.ListIndex), lng科室ID), lngState, 2)
            Case Else
                If Not gobjPlugIn Is Nothing Then
                    On Error Resume Next
    ...
    If Text = "" And rptPati.SelectedRows.Count > 0 Then
        With rptPati.SelectedRows(0)
            ...
            If intTmp = 1 Then
                ...
                lblFee(1).Caption = GetPati费用信息(mlng病人ID, mlng主页ID) & Get住院费用药占比(mlng病人ID, mlng主页ID)
                '出院病人不显示输液量
    ...
    If Not blnEditCancel Then
        If mPatiInfo.主页ID <> mlng主页ID Then Exit Sub
            If InStr(";" & GetPrivFunc(glngSys, p住院病历管理) & ";", ";病历书写;") > 0 Then
                Call OpenEPRDoc(mobjEPRDoc, Me, mPatiInfo.病人ID, mPatiInfo.主页ID, mPatiInfo.科室ID, str疾病ID, str诊断ID, 2, , False, , blnNo)
                If blnNo Then
                    Call mclsDisease.EditNotFillReason(Me, mPatiInfo.病人ID, mPatiInfo.主页ID, 2)
                End If
            End If
        Call LoadPatients
        '导入路径
        ...
        If lng路径状态 = -1 And mclsInOutMedRec.IsDiagChange _
            ...
            If HavePath(mPatiInfo.科室ID) Then
                Set rsTmp = Get病种ID(mPatiInfo.病人ID, mPatiInfo.主页ID, mPatiInfo.科室ID, bln中医)
                If bln中医 Then
                ...
                If rsPath.RecordCount = 0 Then
                    Set rsNext = Get病种ID(mPatiInfo.病人ID, mPatiInfo.主页ID, mPatiInfo.科室ID, , 1)
                    If rsNext.RecordCount = 0 Then Exit Sub
                End If
                Call mclsInOutMedRec.Hide '隐藏首页
                Call mclsPath.zlRefresh(mPatiInfo.病人ID, mPatiInfo.主页ID, mPatiInfo.病区ID, mPatiInfo.科室ID, mPatiInfo.状态, False, True)
        ...
        ElseIf lng路径状态 = 1 And mclsInOutMedRec.IsDiagChange And mPatiInfo.状态 = 0 And InStr(GetInsidePrivs(p临床路径应用), ";导入路径;") <> 0 Then
            If HavePath(mPatiInfo.科室ID) Then
                ...
                Set rsTmp = zlDatabase.OpenSQLRecord(strSql, Me.Caption, mPatiInfo.病人ID, mPatiInfo.主页ID, mPatiInfo.科室ID)
                '还没有导入路径的话就直接退出
                If rsTmp.RecordCount = 0 Then
                    Exit Sub
                Else
                ...
                Set rsTmp = Get病种ID(mPatiInfo.病人ID, mPatiInfo.主页ID, mPatiInfo.科室ID, , 2)
                If rsTmp.RecordCount = 0 Then Exit Sub
    ...
    If KeyCode = vbKeyReturn Then
        If rptNotify.SelectedRows.Count > 0 Then
            ...
            If blnFinded And strNO = "ZLHIS_CIS_032" Then
                Call mclsDisease.ShowDisRegist(Me, 1, Val(str业务), lng病人ID, lng主页ID)
            End If
...
'功能：选择某次住院记录时，读取相关的病人信息
    ...
    With rsTmp
        ...
        Else
            ...
            Call CheckDeath(mPatiInfo.病人ID, mPatiInfo.主页ID)
        End If
...
Private Sub cboDept_Validate(Cancel As Boolean)
    If mblnReturn Then
        mblnReturn = False
    Else
        Call zlControl.CboSetIndex(cboDept.hWnd, Val(cboDept.Tag))
    End If
End Sub
...
'说明：从该事件开始会不重复引发相关的数据读取
    ...
    Call Have部门性质(lng部门ID, IIf(mintDeptView = 0, "临床", "护理"), mblnOutDept)
...
Private Sub picPati_Resize()
    ...
    PatiIdentify.Width = cboDept.Width
...
Private Sub rptPati_SelectionChanged()
    ...
    With rptPati.SelectedRows(0)
        ...
        If Not .GroupRow And strCurPati <> "" Then
            ...
            If str病人IDs = "" Then
                strSql = "Select rownum as 序号,病人id,主页ID,NVL(病人性质,0) 病人性质,住院号 From 病案主页 Where 主页ID<>0 And 病人ID=[1] Order by 主页ID Desc"
                Set rsTmp = zlDatabase.OpenSQLRecord(strSql, Me.Caption, mlng病人ID)
            Else
                strSql = "Select rownum as 序号,a.病人id,a.主页ID,NVL(a.病人性质,0) 病人性质,a.住院号 From 病案主页 a" & _
                ...
                " order by a.病人id desc,a.主页id desc"
            ...
            Do While Not rsTmp.EOF
                If str病人IDs = "" Then
                    strTmp = "第 " & rsTmp!主页ID
                Else
                    strTmp = "第 " & rsTmp!主页ID & "_" & rsTmp!住院号
                End If
                strTmp = strTmp & " 次" & Decode(rsTmp!病人性质, 1, "(门诊留观)", 2, "(住院留观)", "")
...
'功能：读取病人列表
    ...
    Dim objRow As ReportRow, lngColor As Long, intBedLen As Integer
    ...
    If cboDept.ListIndex = -1 Then Call zlControl.CboSetIndex(cboDept.hWnd, Val(cboDept.Tag))
    '判断是否是查找住院号及住院号是否为空
    ...
    If cboDept.ListIndex <> -1 Then
        If tbcPati.Selected.Tag = "在院" Then
            str字段诊断 = ",first_value(decode(h.诊断类型,1,h.诊断描述,2,h.诊断描述,3,h.诊断描述,'')) " & _
                " Over(partition By h.病人id,H.主页ID Order By sign(h.诊断类型-10),decode(h.记录来源,4,0,h.记录来源) desc,h.诊断类型 DESC,h.诊断次序) As 西医诊断," & _
                " first_value(decode(h.诊断类型,11,h.诊断描述,12,h.诊断描述,13,h.诊断描述,'')) " & _
                " Over(partition By h.病人id,H.主页ID Order By sign(h.诊断类型-10) desc,decode(h.记录来源,4,0,h.记录来源) desc,h.诊断类型 DESC,h.诊断次序) As 中医诊断"
        Else
        ...
        If mintDeptView = 0 Then
            ...
            If tbcPati.Selected.Tag = "在院" Or tbcPati.Selected.Tag = "待入住" Then
                If blnTeam And tbcPati.Selected.Tag = "在院" Then    '按小组模式
                    strSql = _
                        "Select Distinct Decode(B.状态,1,0,3,3,Decode(G.ID,Null,2,1)) as 排序," & _
                        " Decode(Nvl(B.病案状态,0),0,999,B.病案状态) as 排序2,G.Id 组ID,G.名称 as 小组名," & _
                        " Decode(B.状态,1,'待入住病人',3,'预出院病人',Decode(G.名称,Null,'在院病人',G.名称)) as 类型," & _
                        " A.病人ID,B.主页ID,A.就诊卡号,A.门诊号,B.住院号,A.身份证号,NVL(B.姓名,A.姓名) 姓名 ,NVL(B.性别,A.性别) 性别,NVL(B.年龄, A.年龄) 年龄,NULL as 科室,B.住院医师," & _
                ...
                Else
                    strSql = _
                        "Select Distinct Decode(B.状态,1,0,3,3,Decode(B.住院医师,[2],1,2)) as 排序," & _
                ...
                strSQLBaby = "Select q.病人id, q.主页id, q.序号, q.婴儿姓名, q.婴儿性别,round(Sysdate - q.出生时间)||'天' As 年龄" & _
                    " From 病人信息 A,病案主页 B,病人新生儿记录 Q,在院病人 R" & _
                    " Where A.病人ID=B.病人ID And A.主页ID=B.主页ID  And b.病人id=q.病人ID And b.主页ID=q.主页ID" & _
                    " And (R.科室ID=[1] Or b.婴儿科室ID=[1]) And a.病人ID=R.病人ID And A.当前科室ID=R.科室ID " & _
                    IIf(InStr(mstrPrivs, "本科病人") > 0 Or InStr(mstrPrivs, "全院病人") > 0, "", " And B.住院医师=[2]") & _
                    strICUSQL & " And B.封存时间 is NULL" & strFilter & IIf(tbcPati.Selected.Tag = "待入住", " And B.状态=1", " And B.状态<>1")
            ElseIf tbcPati.Selected.Tag = "出院" Then
                '出院病人:出院病人可能已有多次住院
                If blnOutTeam Then
                    strSql = _
                        "Select Decode(B.出院方式,'死亡',Decode(B.住院医师,[2],5.1,5.2),Decode(B.住院医师,[2],4.1,4.2)) as 排序," & _
                        ...
                        " From 病人信息 A,病案主页 B,临床医疗小组 G,病人新生儿记录 Q" & _
                        " Where A.病人ID=B.病人ID And Nvl(B.主页ID,0)<>0 And B.出院科室ID+0=[1] And b.病人id=q.病人ID(+) And b.主页ID=q.主页ID(+) And (q.序号=1 Or q.序号 is Null) " & strTmpOut & _
                        IIf(InStr(mstrPrivs, "本科病人") > 0 Or InStr(mstrPrivs, "全院病人") > 0, "And (B.医疗小组ID is Null or b.医疗小组id in(select id from 临床医疗小组 where 科室id =[1]))", _
                            " And (B.医疗小组ID is Null And B.住院医师=[2] or B.医疗小组ID in(Select 小组id From 医疗小组人员 Where 人员id = [5]))") & _
                ...
                Else
                    strSql = _
                        ...
                        " -Null as 医嘱ID,-Null as 发送号,-Null as 执行状态,-Null as 执行科室ID,Null as 会诊内容,Nvl(b.路径状态,-1) 路径状态,trunc(B.出院日期)-trunc(Decode(b.入科时间,NULL,b.入院日期,b.入科时间)) as 住院天数," & _
                        " q.序号 As 新生儿序号,b.单病种,b.婴儿科室ID,B.婴儿病区ID,B.责任护士" & str字段诊断 & _
                        " From 病人信息 A,病案主页 B,病人新生儿记录 Q" & _
                        " Where A.病人ID=B.病人ID And Nvl(B.主页ID,0)<>0 And B.出院科室ID+0=[1] And b.病人id=q.病人ID(+) And b.主页ID=q.主页ID(+) And (q.序号=1 Or q.序号 is Null) " & strTmpOut & _
                        IIf(InStr(mstrPrivs, "本科病人") > 0 Or InStr(mstrPrivs, "全院病人") > 0, "", " And B.住院医师=[2]") & _
            ...
            ElseIf tbcPati.Selected.Tag = "会诊" Then
                ...
                If InStr(mstrPrivs, "会诊病人") > 0 And Not mblnICU Then
                    strSql = _
                        "Select 6 as 排序,Decode(D.执行状态,1,1,0) as 排序2,Null as 组ID,'会诊病人' as 类型," & _
                        " A.病人ID,B.主页ID,A.就诊卡号,A.门诊号,B.住院号,A.身份证号,NVL(B.姓名,A.姓名) 姓名 ,NVL(B.性别,A.性别) 性别,NVL(B.年龄, A.年龄) 年龄,NULL as 科室,B.住院医师," & _
                        ...
                        " D.医嘱ID,D.发送号,Decode(D.执行状态,1,1,0) As 执行状态,D.执行部门ID as 执行科室ID," & _
                        " G.名称||'病人,'||Decode(D.执行状态,1,'已完成'||E.医嘱内容,'请于'||To_Char(E.开始执行时间,'MM.DD HH24:MI')||'进行'||E.医嘱内容||Decode(E.医生嘱托,NULL,NULL,'('||E.医生嘱托||')')) As 会诊内容,Nvl(b.路径状态,-1) 路径状态,trunc(sysdate)-trunc(Decode(b.入科时间,NULL,b.入院日期,b.入科时间)) as 住院天数" & _
                        " From 病人信息 A,病案主页 B,病人医嘱发送 D,病人医嘱记录 E,诊疗项目目录 F,部门表 G,病人新生儿记录 Q" & _
                        " Where A.病人ID=B.病人ID And Nvl(B.主页ID,0)<>0 And E.病人科室ID=G.ID" & _
                        IIf(chkOut.Value = 1, "", " And B.出院日期 is NULL") & " And Nvl(B.状态,0)<>3  And b.病人id=q.病人ID(+) And b.主页ID=q.主页ID(+) And (q.序号=1 Or q.序号 is Null)" & _
            ...
            ElseIf tbcPati.Selected.Tag = "转出" Then
                ...
                strSql = _
                    ...
                    " A.病人ID,B.主页ID,A.就诊卡号,A.门诊号,B.住院号,A.身份证号,NVL(B.姓名,A.姓名) 姓名 ,NVL(B.性别,A.性别) 性别,NVL(B.年龄, A.年龄) 年龄,NULL as 科室,C.经治医师 as 住院医师," & _
                    " LPAD(C.床号," & intBedLen & ",' ') as 床号,B.费别,Decode(b.入科时间,NULL,b.入院日期,b.入科时间) As 入院日期,B.出院日期,B.病人类型,B.状态,B.险类,B.病案状态," & _
                    " -Null as 医嘱ID,-Null as 发送号,-Null as 执行状态,-Null as 执行科室ID,Null as 会诊内容,Nvl(b.路径状态,-1) 路径状态,trunc(sysdate)-trunc(Decode(b.入科时间,NULL,b.入院日期,b.入科时间)) as 住院天数,q.序号 As 新生儿序号,b.单病种,b.婴儿科室ID,B.婴儿病区ID" & str字段诊断 & _
        ...
        Else
            ...
            If tbcPati.Selected.Tag = "在院" Or tbcPati.Selected.Tag = "待入住" Then
                If blnTeam And tbcPati.Selected.Tag = "在院" Then
                    strSql = _
                        "Select Distinct Decode(B.状态,1,0,3,3,Decode(G.名称,Null,2,1)) as 排序," & _
                        " Decode(Nvl(B.病案状态,0),2,'正在转科',0,999,B.病案状态) as 排序2,G.Id 组ID,G.名称 as 小组名," & _
                        " Decode(B.状态,1,'待入住病人',3,'预出院病人',Decode(G.名称,Null,'在院病人',G.名称)) as 类型," & _
                        " A.病人ID,B.主页ID,A.就诊卡号,A.门诊号,B.住院号,A.身份证号,NVL(B.姓名,A.姓名) 姓名 ,NVL(B.性别,A.性别) 性别,NVL(B.年龄, A.年龄) 年龄,C.名称 as 科室,B.住院医师," & _
                        " LPAD(B.出院病床," & intBedLen & ",' ') as 床号,B.费别,Decode(b.入科时间,NULL,b.入院日期,b.入科时间) As 入院日期,B.出院日期,B.病人类型,B.状态,B.险类,B.病案状态," & _
                        " -Null as 医嘱ID,-Null as 发送号,-Null as 执行状态,-Null as 执行科室ID,Null as 会诊内容,Nvl(b.路径状态,-1) 路径状态,trunc(sysdate)-trunc(Decode(b.入科时间,NULL,b.入院日期,b.入科时间)) as 住院天数,q.序号 As 新生儿序号,b.单病种,b.婴儿科室ID,B.婴儿病区ID " & _
                        str字段诊断 & vbNewLine & _
            ...
            ElseIf tbcPati.Selected.Tag = "出院" Then
                ...
                If blnOutTeam Then
                    strSql = _
                        ...
                        str字段诊断 & _
                        " From 病人信息 A,病案主页 B,部门表 C,临床医疗小组 G,病人新生儿记录 Q" & _
                        " Where A.病人ID=B.病人ID And Nvl(B.主页ID,0)<>0 And b.病人id=q.病人ID(+) And b.主页ID=q.主页ID(+) And (q.序号=1 Or q.序号 is Null)" & _
                ...
                Else
                    strSql = _
                        ...
                        " -Null as 医嘱ID,-Null as 发送号,-Null as 执行状态,-Null as 执行科室ID,Null as 会诊内容,Nvl(b.路径状态,-1) 路径状态,trunc(B.出院日期)-trunc(Decode(b.入科时间,NULL,b.入院日期,b.入科时间)) as 住院天数,q.序号 As 新生儿序号,b.单病种,b.婴儿科室ID,B.婴儿病区ID,B.责任护士" & _
                        str字段诊断 & _
                        " From 病人信息 A,病案主页 B,部门表 C,病人新生儿记录 Q" & _
                        " Where A.病人ID=B.病人ID And Nvl(B.主页ID,0)<>0 And b.病人id=q.病人ID(+) And b.主页ID=q.主页ID(+) And (q.序号=1 Or q.序号 is Null)" & _
                        " And B.当前病区ID+0=[1] And B.出院科室ID=C.ID And (c.站点='" & gstrNodeNo & "' Or c.站点 is Null) " & strTmpOut & _
                        IIf(InStr(mstrPrivs, "本科病人") > 0 Or InStr(mstrPrivs, "全院病人") > 0, "", " And B.住院医师=[2]") & _
                        strICUSQL & " And B.封存时间 is NULL"
            ...
            ElseIf tbcPati.Selected.Tag = "会诊" Then
                ...
                If InStr(mstrPrivs, "会诊病人") > 0 And Not mblnICU Then
                    strSql = _
                        "Select 6 as 排序,Decode(D.执行状态,1,1,0) as 排序2,Null as 组ID,'会诊病人' as 类型," & _
                        " A.病人ID,B.主页ID,A.就诊卡号,A.门诊号,B.住院号,A.身份证号,NVL(B.姓名,A.姓名) 姓名 ,NVL(B.性别,A.性别) 性别,NVL(B.年龄, A.年龄) 年龄,G.名称 as 科室,B.住院医师," & _
                        " LPAD(B.出院病床," & intBedLen & ",' ') as 床号,B.费别,Decode(b.入科时间,NULL,b.入院日期,b.入科时间) As 入院日期,B.出院日期,B.病人类型,B.状态,B.险类,B.病案状态,q.序号 As 新生儿序号,b.单病种,b.婴儿科室ID ,B.婴儿病区ID" & str字段诊断 & "," & _
                        " D.医嘱ID,D.发送号,Decode(D.执行状态,1,1,0) As 执行状态,D.执行部门ID as 执行科室ID," & _
                        " G.名称||'病人,'||Decode(D.执行状态,1,'已完成'||E.医嘱内容,'请于'||To_Char(E.开始执行时间,'MM.DD HH24:MI')||'进行'||E.医嘱内容||Decode(E.医生嘱托,NULL,NULL,'('||E.医生嘱托||')')) As 会诊内容,Nvl(b.路径状态,-1) 路径状态,trunc(sysdate)-trunc(Decode(b.入科时间,NULL,b.入院日期,b.入科时间)) as 住院天数" & _
                        " From 病人信息 A,病案主页 B,病人医嘱发送 D,病人医嘱记录 E,诊疗项目目录 F,部门表 G,病人新生儿记录 Q" & _
                        " Where A.病人ID=B.病人ID And Nvl(B.主页ID,0)<>0 And E.病人科室ID=G.ID And b.病人id=q.病人ID(+) And b.主页ID=q.主页ID(+) And (q.序号=1 Or q.序号 is Null)" & _
            ...
            ElseIf tbcPati.Selected.Tag = "转出" Then
                ...
                strSql = _
                    "Select /*+ RULE */Distinct 7 as 排序,Decode(Nvl(B.病案状态,0),0,999,B.病案状态) as 排序2,Null as 组ID,'转出病人' as 类型," & _
                    " A.病人ID,B.主页ID,A.就诊卡号,A.门诊号,B.住院号,A.身份证号,NVL(B.姓名,A.姓名) 姓名 ,NVL(B.性别,A.性别) 性别,NVL(B.年龄, A.年龄) 年龄,D.名称 as 科室,C.经治医师 as 住院医师," & _
                    " LPAD(C.床号," & intBedLen & ",' ') as 床号,B.费别,Decode(b.入科时间,NULL,b.入院日期,b.入科时间) As 入院日期,B.出院日期,B.病人类型,B.状态,B.险类,B.病案状态," & _
                    " -Null as 医嘱ID,-Null as 发送号,-Null as 执行状态,-Null as 执行科室ID,Null as 会诊内容,Nvl(b.路径状态,-1) 路径状态,trunc(sysdate)-trunc(Decode(b.入科时间,NULL,b.入院日期,b.入科时间)) as 住院天数,q.序号 As 新生儿序号,b.单病种,b.婴儿科室ID,B.婴儿病区ID" & str字段诊断 & _
        ...
        If tbcPati.Selected.Tag = "在院" Then
            ...
            strSql = "select  m.病人id,m.主页id,max(m.记录) as 记录,max(m.填写) as 填写,max(m.状态) as 状态 from " & vbNewLine & _
                ...
                "Where exists( select 1 from  电子病历记录 C where c.病历种类 = 5 And a.病人id = c.病人id And a.主页id = c.主页id) " & vbNewLine & _
                "union all " & vbNewLine & _
    ...
    For i = 1 To rsPati.RecordCount
        ...
        '根据提交审查情况添加父行
        If Nvl(rsPati!病案状态, 0) <> 0 And rsPati!排序 <> pt会诊 Then
            blnVisible审查 = True
        ...
        Set objItem = objRecord.AddItem(LPAD(Nvl(rsPati!床号), 10, " ")) 'Value用于排序
        ...
        objRecord.Item(col_住院号).ForeColor = lngColor
        objRecord.Item(col_病人类型).ForeColor = lngColor
        
        '已完成的会诊病人用灰色显示
        If rsPati!排序 = pt会诊 Then
    ...
    If tbcPati.Selected.Tag = "在院" Then
        ...
        rptPati.Columns(col_中医诊断).Visible = Have部门性质(cboDept.ItemData(cboDept.ListIndex), "中医科")
        rptPati.Columns(COL_传染病).Visible = True
    Else
        rptPati.Columns(col_西医诊断).Visible = False
        rptPati.Columns(col_中医诊断).Visible = False
        rptPati.Columns(COL_传染病).Visible = False
    End If
    rptPati.Columns.Find(col_审查).Visible = blnVisible审查
...
'参数：blnEditable=是否允许编辑(有权限及签名允许的情况下)
    ...
    '病案编目之后不可以整理
    If Not (CheckMecRed(mPatiInfo.病人ID, mPatiInfo.主页ID, Me.Caption) Or blnEditable) Then
        blnReadOnly = True
    End If
    ...
    If Not mclsInOutMedRec.IsOpen Then
        If mclsInOutMedRec.ShowInMedRecEdit(Me, mPatiInfo.病人ID, mPatiInfo.主页ID, mPatiInfo.科室ID, rptPati.SelectedRows(0).Record(col_路径状态).Value, , mstrPrivs, IIf(blnReadOnly, 1, 0), False) Then
            mstrPrePati = ""
        End If
    End If
End Sub
...
Private Function LoadNotify() As Boolean
    ...
    If Mid(mstrNotify, m医嘱安排, 1) = "1" Then strTmp = strTmp & ",ZLHIS_OPER_001,ZLHIS_CIS_005,ZLHIS_CIS_015"
    ...
    If Mid(mstrNotify, m备血完成, 1) = "1" And gbln血库系统 Then strTmp = strTmp & ",ZLHIS_BLOOD_001"   '启用新血库流程才有此消息和参数
    If Mid(mstrNotify, m校对疑问, 1) = "1" Then strTmp = strTmp & ",ZLHIS_CIS_035"
    If Mid(mstrNotify, m用血审核, 1) = "1" And gbln血库系统 Then strTmp = strTmp & ",ZLHIS_BLOOD_004"   '启用新血库流程才有此消息和参数m用血审核
    ...
    strSql = "Select b.id,b.病人id, b.就诊id as 主页id,a.住院号,a.姓名,a.当前床号 As 床号, Nvl(b.就诊科室id, a.当前科室id) As 就诊科室id," & _
        ...
        " Where a.病人id = b.病人id And b.Id = c.消息id And b.Id = d.消息id(+) And b.登记时间 >=Trunc(Sysdate-" & (mintNotifyDay - 1) & ") and substr(b.提醒场合,[4],1)='1'" & _
...
'功能：结束打印事件，写入首页打印数据
    ...
    strSql = _
            "Zl_电子病历打印_Insert(Null,9," & mPatiInfo.病人ID & "," & mPatiInfo.主页ID & ",'" & UserInfo.姓名 & "')"
    On Error GoTo errH
    Call zlDatabase.ExecuteProcedure(strSql, Me.Caption)
    Exit Sub
errH:
...
'功能：病人列表和过滤条件的相关控件的位置与大小调整
    ...
    Call SetCtrlPosOnLine(False, 0, lbl病况条件, 10, chk病况条件(0), lngDistance, chk病况条件(1), lngDistance, chk病况条件(2), lngDistance, chkByTeam)
    Call SetCtrlPosOnLine(False, 0, lbl出院时间, 50, cboSelectTime(1))
    Call SetCtrlPosOnLine(False, 0, lbl开始时间, 50, cboSelectTime(2), 50, chkOut)
    Call SetCtrlPosOnLine(False, 0, lbl转出, 50, cmdRef)
...
'功能：病人的详细信息界面的控件位置调整－－－－picInfo中的控件
    ...
    Call SetCtrlPosOnLine(False, 0, lbl姓名(0), lngDistance1, lbl姓名(1), lngDistance2, lbl护理(0), lngDistance1, lbl护理(1), lngDistance2, lbl病室(0), lngDistance1, lbl病室(1), _
    ...
    Call SetCtrlPosOnLine(False, 0, lbl过敏, lngDistance1, cbo过敏, lngDistance2, lbl病况(0), lngDistance1, lbl病况(1), lngDistance2, lbl入院(0), lngDistance2, lblDiag(0), lngDistance1, lblDiag(1))
    lbl姓名(0).Left = lbl过敏.Left
    
    lblFee(0).Top = lbl过敏.Height + lbl过敏.Top + 90
    Call SetCtrlPosOnLine(False, 0, lblFee(0), lngDistance1, lblFee(1), lngDistance2, lblFluid(0), lngDistance1, lblFluid(0))
    ...
    Call SetCtrlPosOnLine(False, 0, lbl病室(0), lngDistance1, lbl病室(1), lngDistance2, lbl类型(0), lngDistance1, lbl类型(1), lngDistance2, lbl付款(0), lngDistance1, lbl付款(1), lngDistance2, lbl医保号(0), lngDistance1, lbl医保号(1))
    Call SetCtrlPosOnLine(False, 0, lbl病况(0), lngDistance1, lbl病况(1), lngDistance2, lbl入院(0), lngDistance2, lblDiag(0), lngDistance1, lblDiag(1))
    ...
    Call SetCtrlPosOnLine(False, 0, lbl类型(0), lngDistance1, lbl类型(1), lngDistance2, lbl付款(0), lngDistance1, lbl付款(1), lngDistance2, lbl医保号(0), lngDistance1, lbl医保号(1))
    Call SetCtrlPosOnLine(False, 0, lbl入院(0), lngDistance1, lbl入院(1), lngDistance2, lblDiag(0), lngDistance1, lblDiag(1))
    ...
    Call SetCtrlPosOnLine(False, 0, lbl付款(0), lngDistance1, lbl付款(1), lngDistance2, lbl医保号(0), lngDistance1, lbl医保号(1))
    Call SetCtrlPosOnLine(False, 0, lblDiag(0), lngDistance1, lblDiag(1))
    
    lblFluid(0).Left = lbl付款(0).Left
    Call SetCtrlPosOnLine(False, 0, lblFluid(0), lngDistance1, lblFluid(1), lngDistance2, lblPrint(0), lngDistance1, lblPrint(1))
...
'功能：获取一条指定的阳性结果
    ...
    strSql = "Select A.ID, '住院' As 来源, a.记录状态,a.病人id, c.姓名, c.性别, c.年龄, e.名称 As 科室, " & vbNewLine & _
            "c.住院号 As 标识号, a.送检时间, a.送检医生, f.名称 As 登记科室, a.标本名称, a.反馈结果, a.传染病名称 As 疑似疾病, a.登记人, a.登记时间, a.处理人, " & vbNewLine & _
            "a.处理时间, a.处理情况说明 " & vbNewLine & _
            "From 疾病阳性记录 A, 病案主页 C,  部门表 E, 部门表 F " & vbNewLine & _
            "Where a.病人id = c.病人id And a.主页id = c.主页id  And " & vbNewLine & _
            "a.登记科室ID = f.Id(+) and c.出院科室id = e.Id(+) And a.病人id=[1] and a.主页id=[2] order by a.送检时间 desc "
...
Private Sub mclsDisease_Closed(ByVal lngFunID As Long, ByVal strTag As String)
    ...
    If lng路径状态 = -1 And mPatiInfo.状态 = 0 And InStr(GetInsidePrivs(p临床路径应用), ";导入路径;") <> 0 Then
        If HavePath(mPatiInfo.科室ID) Then
            ...
            If rsPath.RecordCount = 0 Then
                ...
                If rsNext.RecordCount = 0 Then Exit Sub
            End If
            Call mclsDisease.HideFrm(0) '隐藏传染病阳性结果窗体
...
'功能：传染病报告反修改消息阅读
    ...
    '弹出来修改报告
    Call mclsDisDoc.ModifyDiseaseDoc(Me, lng文件ID, mlng病人ID, mlng主页ID, 2, mPatiInfo.科室ID)
...
Private Sub CheckDeath(ByVal str病人ID As String, ByVal str主页ID As String)
'功能：检查病人是否含有死亡医嘱
    Dim rsTmp As New ADODB.Recordset
    Dim strSql As String
    
    On Error GoTo errH
    strSql = "Select Count(1) as 结果 From 病人医嘱记录 A, 诊疗项目目录 B Where A.医嘱状态 In (3, 8) And a.诊疗项目id = b.Id And b.操作类型 = '11' And a.诊疗类别 = 'Z' And a.病人id = [1] And a.主页id = [2]"
    Set rsTmp = zlDatabase.OpenSQLRecord(strSql, Me.Caption, str病人ID, str主页ID)
