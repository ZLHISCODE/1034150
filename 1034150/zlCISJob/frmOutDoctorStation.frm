...
'功能：选择某次历史就诊记录时，读取相关的病人信息
    ...
    strSql = "Select E.号类,B.Id,B.NO,B.门诊号,B.姓名,B.性别,B.年龄,A.出生日期,B.医疗付款方式,A.职业," & _
        ...
        "   A.民族,A.国籍,A.区域,A.婚姻状况,A.家庭地址邮编,A.单位邮编,A.出生地点,B.传染病上传,A.其他证件,a.户口地址,a.户口地址邮编,a.籍贯,a.email,a.qq,A.病人类型,A.病人ID" & _
...
'功能：设置病人信息的字体
    ...
    Call SetCtrlPosOnLine(False, 0, lblEdit(lbl身份证), lngDistance1, txtEdit(txt身份证号), lngDistance2, lblEdit(lbl过敏), lngDistance1, cmdAller, -30, vsAller)
