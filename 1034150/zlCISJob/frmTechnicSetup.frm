...
Private Sub cmdOK_Click()
    ...
    Call zlDatabase.SetPara("自动刷新医嘱类型", "" & chkWarn(0).Value & chkWarn(1).Value, glngSys, p医技工作站, blnSetup)
...
Private Sub Form_Load()
    ...
    strPar = zlDatabase.GetPara("自动刷新医嘱类型", glngSys, p医技工作站, "00", Array(lblNotifyArea, chkWarn(0), chkWarn(1)), InStr(mstrPrivs, "参数设置") > 0)
