...
Private Sub Form_Load()
    ...
    Else
        ...
        chkDeptView.Top = fraMedRec.Top + fraMedRec.Height + 50
    ...
    If mbln护士站 Then
        ...
        strPar = zlDatabase.GetPara("自动刷新医嘱类型", glngSys, mlngModual, "000000000", Array(lbl提醒内容, chkWarn(0), chkWarn(1), chkWarn(2), chkWarn(3), chkWarn(4), chkWarn(5), chkWarn(6), chkWarn(7), chkWarn(8), chkWarn(9)), InStr(mstrPrivs, "参数设置") > 0)
    ...
    Else
        ...
        varTmp = Array(chkWarn(chkD病历审阅), chkWarn(chkD医嘱安排), chkWarn(chkD危急值), chkWarn(chkD报告撤消), chkWarn(chkD医嘱审核), chkWarn(chkD处方审查), chkWarn(chkD传染病), chkWarn(chkD病历质控), chkWarn(chkD备血完成), chkWarn(chkD校对疑问), chkWarn(chkD用血审核), lblArea)
