...
Private Sub Form_Load()
    ...
    strPar = zlDatabase.GetPara("自动刷新医嘱类型", glngSys, mlngModual, "0000000000", Array(lbl提醒内容, chkWarn(0), chkWarn(1), chkWarn(2), chkWarn(3), chkWarn(4), chkWarn(5), chkWarn(6), chkWarn(7), chkWarn(8), chkWarn(9)), InStr(mstrPrivs, "参数设置") > 0)
