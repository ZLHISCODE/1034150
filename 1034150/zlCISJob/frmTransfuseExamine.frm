...
Begin VB.Form frmTransfuseExamine 
   Caption         =   "输血审核管理"
   ClientHeight    =   10935
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   14805
   ForeColor       =   &H8000000D&
   Icon            =   "frmTransfuseExamine.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   10935
   ScaleWidth      =   14805
   ...
   Begin VB.PictureBox picUnAudited 
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsAudit 
         ...
         FormatString    =   $"frmTransfuseExamine.frx":6852
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin MSComctlLib.StatusBar stbThis 
      ...
      _ExtentX        =   26114
      _ExtentY        =   635
      SimpleText      =   $"frmTransfuseExamine.frx":68ED
      _Version        =   393216
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   2355
            MinWidth        =   882
            Picture         =   "frmTransfuseExamine.frx":6934
            Text            =   "中联软件"
            TextSave        =   "中联软件"
            Key             =   "ZLFLAG"
   ...
   Begin MSComctlLib.ImageList img16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTransfuseExamine.frx":71C8
            Key             =   "Male"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTransfuseExamine.frx":DA2A
            Key             =   "feMale"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTransfuseExamine.frx":1428C
            Key             =   "unCheck"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTransfuseExamine.frx":14826
            Key             =   "Check"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imgAdvice 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   3
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTransfuseExamine.frx":14DC0
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTransfuseExamine.frx":1535A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTransfuseExamine.frx":158F4
            Key             =   "签名"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmTransfuseExamine"
...
'参数：mint场合=1门诊，2住院
    ...
    Call frmTransfuseExamine.Show(0, frmParent)
End Function
...
'    blnIsRecursive:是否递归，默认为要递归
            ...
            If .Cell(flexcpChecked, i, 0) = vbChecked Then
                ...
                ElseIf tbcSub.Selected.Tag = "已审核" Then  '兼容处理，非三级审核回退至待审核或者取消拒绝
                    If .TextMatrix(i, col_审核状态) = 3 Then
                        ...
                        End If
                    ElseIf .TextMatrix(i, col_审核状态) = 4 Then
                        arrIDs(t_待审核) = arrIDs(t_待审核) & IIf(arrIDs(t_待审核) = "", "", ",") & .TextMatrix(i, col_医嘱ID)
                        arrExp(t_待审核) = arrExp(t_待审核) & IIf(arrExp(t_待审核) = "", "", ",") & .TextMatrix(i, col_审核说明)
                    End If
                ElseIf tbcSub.Selected.Tag = "已签发" And .TextMatrix(i, col_审核状态) = 4 Then
    ...
    Call CancleAuditOnePatiChild(arrIDs(t_已签发), strDate, arrExp(t_已签发), 4)
...
'参数：是否加载已审核医嘱,为空为加载待审核医嘱
    ...
    strSQL = "Select Decode(a.病人来源, 2, a.病人id || '_' || a.主页id || '_' || Nvl(a.婴儿, 0), 1, a.病人id || '_' || a.挂号单) Key,a.Id, a.相关id, Nvl(a.相关id, a.Id) As 组id, a.诊疗类别,  Null As 选择, Null As 输入, " & vbNewLine & _
            ...
            " Decode(Nvl(a.婴儿, 0), 0, a.年龄, (Round(Sysdate - q.出生时间) || '天')) As 年龄, p.当前床号 As 床号," & vbNewLine & _
            ...
            "      e.病人id(+) = a.病人id And e.主页id(+) = a.主页id and g.诊疗类别 = 'E' And a.id=g.相关id and g.诊疗项目id=h.id And (H.操作类型='8' and nvl(H.执行分类,0)=0  or H.操作类型='9')  and A.病人ID = Q.病人ID(+) and A.主页ID = Q.主页ID(+) and A.婴儿 = Q.序号(+) AND a.id=c.医嘱id(+)" & _
            IIf(InStr(1, tbcSub.Selected.Tag, "已") > 0, " And c.医嘱id = a.Id ", _
            " And A.开嘱时间 between [6] and [7] And a.医嘱状态 = 1 And a.审核状态 = [8] ") & vbNewLine & _
    ...
    If mbln启用输血三级审核 Then    '当启用了三级审核时，计算24小时输血量以及输血总量
        If Not rsTmp.BOF Then
            ...
            If optOccasion(0).Value Then
                strSQL = _
                    " Select Key, Id, 开嘱时间, 申请量, 输血时间, 诊疗项目id" & vbNewLine & _
                    ...
                    "       Select b.Key, b.Id, b.开嘱时间, b.申请量 * Decode(Upper(a.计算单位), 'ML', 1, Nvl(a.计算系数, 1)) 申请量, b.输血时间, b.诊疗项目id" & vbNewLine & _
            ...
            Do While Not rsTmp.EOF
                If mbln启用输血三级审核 Then
                    If Not rsTemp.BOF Then
                        rsTemp.MoveFirst
                        If Not gobjPublicBlood Is Nothing Then strNoSumBlood = gobjPublicBlood.zlGetBloodAuditState(2)
                        dbl输血总量 = 0
                        dbl24h量 = 0
                        rsTemp.Filter = "Key ='" & rsTmp!Key & "'"
                        Do While Not rsTemp.EOF
                            dbl输血总量 = dbl输血总量 + rsTemp("申请量")
                            If InStr(1, strNoSumBlood, "|" & rsTemp("诊疗项目id") & "|") = 0 Then
    ...
    With vsAudit
        ...
        If mbln启用输血三级审核 Then
            Select Case tbcSub.Selected.Tag
                ...
                Case "已签发"
                    For lngloop = 1 To .Rows - 1
                        If Val(.TextMatrix(lngloop, col_医嘱状态)) <> 1 Or (Val(.TextMatrix(lngloop, col_审核状态)) <> 4 And Val(.TextMatrix(lngloop, col_审核状态)) <> 3) Then
                            .Cell(flexcpChecked, lngloop, col_选择) = flexUnchecked
