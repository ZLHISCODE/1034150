...
Private Sub Form_Activate()
    ...
    Me.stbThis.Panels(3).Text = gobjRelogin.DBUser & IIf(gobjRelogin.ServerName = "", "", "@" & gobjRelogin.ServerName) & IIf(zlDatabase.CheckRAC(lngInstanceNo), "(RAC:" & lngInstanceNo & ")", "")
    Me.stbThis.Panels(4).Text = gstrUserName
    Me.stbThis.Panels(5).Text = gstrDeptName
    ...
    With grsMenus
        Do While Not .EOF
            ...
            If Err = 0 Then
                ...
                If !模块 <> 0 Then LngMenuID = LngMenuID + 1
            End If
            .MoveNext
        Loop
        .MoveFirst
