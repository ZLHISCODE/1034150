...
Begin VB.Form frmPreview 
   ...
   Begin VB.HScrollBar scrHsc 
      DragIcon        =   "frmPreview.frx":0B30
      Height          =   250
      LargeChange     =   20
      Left            =   0
      Max             =   100
      MouseIcon       =   "frmPreview.frx":0E3A
      SmallChange     =   10
      TabIndex        =   4
      TabStop         =   0   'False
      Top             =   5475
   ...
   Begin VB.VScrollBar scrVsc 
      DragIcon        =   "frmPreview.frx":0F8C
      Height          =   4755
      LargeChange     =   20
      Left            =   8775
      Max             =   100
      MouseIcon       =   "frmPreview.frx":1296
      SmallChange     =   10
      TabIndex        =   3
      TabStop         =   0   'False
      Top             =   735
   ...
   Begin MSComctlLib.ImageList imgGray 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPreview.frx":13E8
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPreview.frx":1602
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPreview.frx":181C
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPreview.frx":1A36
            Key             =   "Help"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPreview.frx":1C50
            Key             =   "Quit"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPreview.frx":1E6A
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPreview.frx":2084
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPreview.frx":229E
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPreview.frx":24B8
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imgColor 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPreview.frx":2B06
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPreview.frx":2D20
            Key             =   "Help"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPreview.frx":2F3A
            Key             =   "Quit"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPreview.frx":3154
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPreview.frx":336E
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPreview.frx":3588
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPreview.frx":37A2
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Public NeedPrintEmpty As Boolean                        '需要检查空表打印
Public FormatNo As Byte                                 '当前格式号
Public ReportDatas As LibDatas                          '报表的数据源集合
...
Private Sub mnuFile_Print_Click()
    ...
    '检查“空表打印”
    If NeedPrintEmpty Then
        If mdlPublic.IsReportEmpty(objReport, ReportDatas, FormatNo) Then
            '无数据记录的空表
            Exit Sub
        End If
    End If
...
Private Sub mnuView_ScaleValue_Click(Index As Integer)
    Call SetScaleMenu(mnuView_ScaleValue(Index).Caption)
    Call ShowPage
End Sub
...
Private Sub picPage_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    lngPreX = X: lngPreY = Y
    If Button = 1 Then Set picPage.MouseIcon = scrHsc.MouseIcon
    If Button = 2 Then PopupMenu mnuView, 2
End Sub
...
Private Sub picPage_GotFocus()
    Call SetPubHook(GWL_WNDPROC, picPage.hwnd, AddressOf FlexScroll)
End Sub
...
Private Sub picPage_LostFocus()
    Call SetPubUnHook(GWL_WNDPROC, picPage.hwnd)
End Sub
...
Private Sub tbr_ButtonMenuClick(ByVal ButtonMenu As MSComctlLib.ButtonMenu)
    Call SetScaleMenu(ButtonMenu.Text)
    Call ShowPage
End Sub
...
Public Sub LoadForm(Optional intMode As Integer)
    ...
    sta.Panels(3) = GetPaperName(mobjFmt.纸张, Printer.Width, Printer.Height)
...
'            picPage.Width = mobjFmt.W * sngScale
'            picPage.Height = mobjFmt.H * sngScale
'        Else
'            picPage.Width = mobjFmt.H * sngScale
'            picPage.Height = mobjFmt.W * sngScale
'        End If
'    End If
...
Private Function MoveScaleMenu()
    Dim i As Integer, j As Integer
    For i = 0 To mnuView_ScaleValue.UBound
        If mnuView_ScaleValue(i).Checked Then j = i
        mnuView_ScaleValue(i).Checked = False
    Next
    i = (j + 1) Mod (mnuView_ScaleValue.UBound + 1)
    If mnuView_ScaleValue(i).Caption = "-" Then i = (i + 1) Mod (mnuView_ScaleValue.UBound + 1)
    mnuView_ScaleValue(i).Checked = True
End Function
