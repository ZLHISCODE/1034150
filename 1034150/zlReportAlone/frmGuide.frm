...
Private Sub cmdOK_Click()
    ...
    If txtTitle.Text <> "" Then
        ...
        '产生缺省格式
        objGuide.Fmts.Add 1, txtTitle.Text, mobjFmt.W, mobjFmt.H, mobjFmt.纸张, mobjFmt.纸向, mobjFmt.动态纸张 _
            , mobjFmt.图样, mobjFmt.停用, mobjFmt.停用原因, "_" & 1
    Else
        
        '产生缺省格式
        objGuide.Fmts.Add 1, "缺省格式", mobjFmt.W, mobjFmt.H, mobjFmt.纸张, mobjFmt.纸向, mobjFmt.动态纸张 _
            , mobjFmt.图样, mobjFmt.停用, mobjFmt.停用原因, "_" & 1
    End If
