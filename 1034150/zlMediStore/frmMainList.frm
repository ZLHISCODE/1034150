...
Begin VB.Form frmMainList 
   ...
   Begin MSComctlLib.ImageList ilsHot 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainList.frx":ABA3
            Key             =   "Print"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainList.frx":ADC3
            Key             =   "Add"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainList.frx":AFDF
            Key             =   "Modify"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainList.frx":B1FF
            Key             =   "Delete"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainList.frx":B41F
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainList.frx":BB19
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainList.frx":C50B
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainList.frx":CEFD
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainList.frx":D117
            Key             =   "Verify"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainList.frx":D333
            Key             =   "Restore"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainList.frx":D54F
            Key             =   "Search"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainList.frx":D769
            Key             =   "Refresh"
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainList.frx":D8C3
            Key             =   "Help"
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainList.frx":DAE3
            Key             =   "Quit"
         EndProperty
         BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainList.frx":DD03
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin VSFlex8Ctl.VSFlexGrid vsfDetail 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"frmMainList.frx":14565
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
...
Public Sub SetMenu()
    ...
    If TabShow.Tab = 0 Then
        If mlngMode = 模块号.药品移库 Then
            If int移库处理流程 = 0 Then
                mnuEditPreparePhysic.Visible = False
                mnuEditVerify.Visible = IsHavePrivs(mstrPrivs, "审核")
'                mnuEditStrike.Visible = IsHavePrivs(mstrPrivs, "冲销")
                mnuEditWriteOff.Visible = False
                mnuEditStrike.Visible = False
            ...
            Else
                ...
                mnuEditPreparePhysic.Visible = IsHavePrivs(mstrPrivs, "发送")
            End If
            If mint冲销申请 = 1 Then
        ...
        Else
            If mlngMode = 模块号.药品领用 Then
                ...
                If mblnStock Then
                    mnuEditVerify.Visible = IsHavePrivs(mstrPrivs, "审核")
                    mnuEditStrike.Visible = IsHavePrivs(mstrPrivs, "冲销")
                    mnuEditWriteOff.Visible = IsHavePrivs(mstrPrivs, "冲销")
                End If
            Else
                mnuEditVerify.Visible = IsHavePrivs(mstrPrivs, "审核")
                mnuEditStrike.Visible = IsHavePrivs(mstrPrivs, "冲销")
            ...
            If mlngMode = 模块号.外购入库 Then
                mnuEditLine0.Visible = True
                If IsHavePrivs(mstrPrivs, "核查成本价") And mbln核查 Then
                ...
                If IsHavePrivs(mstrPrivs, "付款标记") And gtype_UserSysParms.P173_经过标记付款后才能进行付款管理 = 1 Then
...
Private Sub cboStock_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If cboStock.ListCount = 0 Then Call zlCtlSetFocus(vsfList): Exit Sub
    
    If cboStock.ListIndex >= 0 Then
        If Val(cboStock.Tag) = cboStock.ItemData(cboStock.ListIndex) Then
            Call zlCtlSetFocus(vsfList, True)
            Exit Sub
        End If
    End If
...
Public Sub ShowList(ByVal lngMode As Long, ByVal strTitle As String, ByVal FrmMain As Variant)
    ...
    If mlngMode = 模块号.药品领用 Then
        vsfList.ColWidth(vsfList.Cols - 3) = 0
        vsfList.ColWidth(vsfList.Cols - 2) = 1000
    End If
    ...
    If mblnViewCost = False Then
        ...
        With vsfDetail
            Select Case mlngMode
                Case 模块号.外购入库
                    .ColHidden(.ColIndex("结算价")) = True
                    .ColHidden(.ColIndex("结算金额")) = True
...
Private Function CheckDepend() As Boolean
    ...
    If mlngMode <> 模块号.药品领用 Then
        gstrSQL = "SELECT DISTINCT a.id, a.名称 " _
                ...
                & IIf(IsHavePrivs(gstrprivs, "所有库房"), "", " And a.ID IN (Select 部门ID From 部门人员 Where 人员ID=[1])")
...
Private Sub GetList(ByVal StrFind As String)
    ...
    On Error GoTo errHandle
    mlastRow = 0
    Call zlCommFun.ShowFlash("正在搜索药品记录,请稍候 ...", Me)
    DoEvents
    ...
    Select Case mlngMode
        Case 模块号.外购入库           '药品外购入库管理
            ...
            If SQLCondition.int填制审核一并查询 = 0 Then
                gstrSQL = "SELECT A.NO, C.名称 AS 供应商,LTRIM(TO_CHAR(SUM(A.成本金额)," & mstrMoneyFormat & ")) AS 结算金额," & _
                    ...
                    " TO_CHAR(MIN(A.填制日期), 'YYYY-MM-DD HH24:MI:SS') AS 填制日期,A.配药人 As 核查人,TO_CHAR(MIN(A.配药日期), 'YYYY-MM-DD HH24:MI:SS') As 核查日期,A.审核人," & _
                    ...
                    " GROUP BY A.NO,C.名称,Nvl(A.费用id, 0),A.填制人,A.配药人,A.配药日期,A.审核人,A.记录状态, A.发药方式,A.摘要 " & _
            ...
            Else
                gstrSQL = "SELECT A.NO, C.名称 AS 供应商,LTRIM(TO_CHAR(SUM(A.成本金额)," & mstrMoneyFormat & ")) AS 结算金额," & _
                    ...
                    " GROUP BY A.NO,C.名称,Nvl(A.费用id, 0),A.填制人,A.配药人,A.配药日期,A.审核人,A.记录状态,A.发药方式,A.摘要 " & _
                    " Union " & _
                    " SELECT A.NO, C.名称 AS 供应商,LTRIM(TO_CHAR(SUM(A.成本金额)," & mstrMoneyFormat & ")) AS 结算金额," & _
                    " LTRIM(TO_CHAR(SUM(A.零售金额)," & mstrMoneyFormat & " )) AS 售价金额, LTRIM(TO_CHAR(SUM(A.差价)," & mstrMoneyFormat & " )) AS 差价金额, " & _
                    " LTRIM(TO_CHAR(SUM(A.零售金额)," & mstrMoneyFormat & " )) AS 零售金额, LTRIM(TO_CHAR(SUM(A.零售金额 - A.成本金额)," & mstrMoneyFormat & " )) AS 零售差价, Nvl(A.费用id, 0) 冲销类型,A.填制人," & _
                    " TO_CHAR(MIN(A.填制日期), 'YYYY-MM-DD HH24:MI:SS') AS 填制日期,A.配药人 As 核查人,TO_CHAR(MIN(A.配药日期), 'YYYY-MM-DD HH24:MI:SS') As 核查日期,A.审核人," & _
                    " TO_CHAR(MIN(A.审核日期), 'YYYY-MM-DD HH24:MI:SS') AS 审核日期,A.记录状态,Decode(Nvl(A.发药方式, 0), 0, '入库单', '退库单') 单据说明,A.摘要 " & _
...
'                " ORDER BY NO DESC,填制日期 ASC "
        ...
        Case 模块号.药品移库           '药品移库管理（查我的出库，条件不限；查我的入库，则只能看到未备药或已发送的单据）
            gstrSQL = "SELECT A.NO," & IIf(TabShow.Tab = 0, "C.名称 As 移入库房,", "B.名称 AS 移出库房,") & " LTRIM(TO_CHAR (SUM (A.成本金额), " & mstrMoneyFormat & ")) AS 成本金额, " & _
                " LTRIM(TO_CHAR ( (SUM (A.零售金额)), " & mstrMoneyFormat & ")) AS 售价金额, LTRIM(TO_CHAR((SUM(A.零售金额 - A.成本金额))," & mstrMoneyFormat & " )) AS 差价金额,A.填制人, " & _
                " TO_CHAR (MIN(A.填制日期), 'YYYY-MM-DD HH24:MI:SS') AS 填制日期," & strTransfer & " ,A.记录状态, A.摘要 " & _
                ...
                strUserPart & StrFind & _
                " GROUP BY A.NO," & IIf(TabShow.Tab = 0, "C.名称", "B.名称") & ",A.填制人" & strTransfer_Order & ",A.记录状态,A.摘要 " & _
                " ORDER BY NO DESC, 填制日期 ASC "
        Case 模块号.药品领用           '药品领用管理
            gstrSQL = "SELECT A.NO, C.名称 AS 领用部门,LTRIM(TO_CHAR (SUM (A.成本金额), " & mstrMoneyFormat & ")) AS 成本金额, " & _
                " LTRIM(TO_CHAR ( (SUM (A.零售金额)), " & mstrMoneyFormat & ")) AS 售价金额, LTRIM(TO_CHAR((SUM(A.零售金额 - A.成本金额))," & mstrMoneyFormat & " )) AS 差价金额,A.填制人, " & _
                " TO_CHAR (MIN(A.填制日期), 'YYYY-MM-DD HH24:MI:SS') AS 填制日期, A.审核人, " & _
                " TO_CHAR (MIN(A.审核日期), 'YYYY-MM-DD HH24:MI:SS') AS 审核日期, A.记录状态, A.摘要,Decode(Nvl(A.发药方式,0),0,'向库房领药','向留存领药') 领药方式 " & _
                " FROM 药品收发记录 A, 部门表 B ,部门表 C  " & strSqlForm & _
                " WHERE A.库房ID = B.ID AND A.对方部门ID=C.ID AND A.单据 = 7  " & _
                strUserPart & StrFind & _
                " GROUP BY A.NO,C.名称,A.填制人,A.审核人,A.记录状态,A.摘要,Nvl(A.发药方式,0) " & _
                " ORDER BY NO DESC, 填制日期 ASC "
        Case 模块号.其他出库          '药品其他出库管理
            If SQLCondition.int填制审核一并查询 = 0 Then
                gstrSQL = "SELECT A.NO, C.名称 AS 入出类别,Decode(C.名称, '药品外调', D.名称, Decode(C.名称, '药品外销', E.名称, '')) AS 对方单位,LTRIM(TO_CHAR (SUM (A.成本金额), " & mstrMoneyFormat & ")) AS 成本金额, " & _
                    ...
                    strUserPart & StrFind & _
                    " GROUP BY A.NO,C.名称,D.名称,E.名称,A.填制人,A.审核人,A.记录状态,A.摘要 " & _
                    " ORDER BY NO DESC,填制日期 ASC "
            Else
                gstrSQL = "SELECT A.NO, C.名称 AS 入出类别,Decode(C.名称, '药品外调', D.名称, Decode(C.名称, '药品外销', E.名称, '')) AS 对方单位,LTRIM(TO_CHAR (SUM (A.成本金额), " & mstrMoneyFormat & ")) AS 成本金额, " & _
                    " LTRIM(TO_CHAR ( (SUM (A.零售金额)), " & mstrMoneyFormat & ")) AS 售价金额, LTRIM(TO_CHAR((SUM(A.零售金额 - A.成本金额))," & mstrMoneyFormat & " )) AS 差价金额,LTRIM(TO_CHAR((SUM(A.单量 * A.实际数量))," & mstrMoneyFormat & " )) AS 外调外销金额,A.填制人," & _
    ...
    If (Not rsList.EOF) And (Not rsList.BOF) Then
        ...
        Do While Not rsList.EOF
            Select Case mlngMode
                Case 模块号.外购入库
                    dbl1 = dbl1 + IIf(IsNull(rsList!结算金额), 0, rsList!结算金额)
        ...
        Select Case mlngMode
            Case 模块号.外购入库
                lbl1.Caption = "结算金额合计：" & Format(dbl1, StrFormat)
...
'            intStatus = .TextMatrix(intRow, IIf(mlngMode = 模块号.差价调整 Or mlngMode = 模块号.外购入库 Or mlngMode = 模块号.药品领用, .Cols - 3, .Cols - 2))
            ...
            If intStatus Mod 3 = 2 Then
                ...
                If mlngMode = 模块号.外购入库 Then
                    ...
                    .Cell(flexcpForeColor, intRow, 0, intRow, .Cols - 1) = IIf(Val(.TextMatrix(intRow, 外购主表.冲销类型)) = 1, &HC0C0FF, &HFF)
                ElseIf mlngMode = 模块号.药品移库 Then
                    '移库中申请冲销单据为浅红色，已冲销单据为红色
                    .Cell(flexcpForeColor, intRow, 0, intRow, .Cols - 1) = IIf(int冲销状态 = 0, &HC0C0FF, &HFF)
                Else
                    '其他单据已冲销单据为红色
...
Private Sub SetListColWidth()
    ...
    With vsfList
        Select Case mlngMode
            Case 模块号.外购入库
                .ColAlignment(外购主表.结算金额) = flexAlignRightCenter
    ...
    With vsfDetail
        Select Case mlngMode
            Case 模块号.外购入库
                ...
                .ColAlignment(.ColIndex("结算价")) = flexAlignRightCenter     '结算价
                .ColAlignment(.ColIndex("结算金额")) = flexAlignRightCenter     '结算金额
            ...
            Case 模块号.药品移库
                ...
                .ColAlignment(.ColIndex("单位")) = flexAlignCenterCenter    '单位
                .ColAlignment(.ColIndex("送货单位")) = flexAlignCenterCenter    '送货单位
                .ColAlignment(.ColIndex("成本价")) = flexAlignRightCenter     '成本价
                .ColAlignment(.ColIndex("成本金额")) = flexAlignRightCenter     '成本金额
                .ColAlignment(.ColIndex("售价")) = flexAlignRightCenter    '售价
                .ColAlignment(.ColIndex("售价金额")) = flexAlignRightCenter    '售价金额
...
Private Sub SetVisable()
    ...
    If IsHavePrivs(mstrPrivs, "付款标记") And gtype_UserSysParms.P173_经过标记付款后才能进行付款管理 = 1 And mlngMode = 模块号.外购入库 Then
        mnuEditMark.Visible = True
    Else
        mnuEditMark.Visible = False
    End If
    Select Case mlngMode
        Case 模块号.外购入库, 模块号.自制入库, 模块号.其他入库, 模块号.差价调整, 模块号.药品移库, 模块号.药品领用, 模块号.其他出库
            If Not IsHavePrivs(mstrPrivs, "登记") Then
            ...
            If Not IsHavePrivs(mstrPrivs, "修改") Then
                mnuEditModify.Visible = False
                tlbTool.Buttons("Modify").Visible = False
            End If
            
            If Not IsHavePrivs(mstrPrivs, "删除") Then
            ...
            If mlngMode = 模块号.药品领用 Then
                If Not mblnStock Or Not IsHavePrivs(mstrPrivs, "审核") Then
                    mnuEditVerify.Visible = False
    ...
    If mlngMode = 模块号.外购入库 Then
        ...
        If IsHavePrivs(mstrPrivs, "审核") Then
            mnuEditLine0.Visible = True
            mnuEditBill.Visible = True
        Else
            mnuEditLine0.Visible = False
        End If
        mnuEditRestore.Visible = IsHavePrivs(mstrPrivs, "退货")
        If IsHavePrivs(mstrPrivs, "财务审核") Then
            mnuEditLine0.Visible = True
        ...
        If IsHavePrivs(mstrPrivs, "药品退药计划") Then
            mnuEditHandBack.Visible = True
        Else
            mnuEditHandBack.Visible = False
        End If
        
        If IsHavePrivs(mstrPrivs, "药品计划单批量导入") Then
    ...
    ElseIf mlngMode = 模块号.药品移库 Then
        mnuEditRestore.Visible = False
        mnuEditLine2.Visible = False
        If IsHavePrivs(mstrPrivs, "发送") Then
            ...
            tlbTool.Buttons("PrepareSeparate").Visible = True
        End If
        If Not IsHavePrivs(mstrPrivs, "审核") And _
           Not IsHavePrivs(mstrPrivs, "冲销") Then
...
Private Sub Form_Load()
    '恢复设置
    Dim dateCurrentDate As Date
    mbln操作员限制 = Not IsHavePrivs(mstrPrivs, "所有库房")
...
Private Sub mnuEditVerify_Click()
    ...
    With vsfList
        ...
        Select Case mlngMode
            ...
            Case 模块号.药品领用
                frmDrawCard.ShowCard Me, strNo, 编辑.审核, mblnStock, .TextMatrix(.Row, .Cols - 3), 0, BlnSuccess
            Case 模块号.其他出库
...
'                        If Not IsHavePrivs(mstrPrivs, "允许修改申领单") Then
...
'                    End If
                ...
                Case 模块号.药品领用
                    gstrSQL = "zl_药品领用_Delete('" & strBillNo & "')"
                Case 模块号.其他出库
...
Private Sub mnuEditDisplay_Click()
    ...
    With vsfList
        ...
        Select Case mlngMode
            ...
            Case 模块号.药品领用
                frmDrawCard.ShowCard Me, strNo, 编辑.查阅, mblnStock, .TextMatrix(.Row, .Cols - 3), 0
            Case 模块号.其他出库
    ...
    With vsfList
        Select Case mlngMode
                ...
                If mint库存检查 <> 0 And .TextMatrix(.Row, 0) <> "" Then
                    For n = 1 To vsfDetail.rows - 1
                        If vsfDetail.TextMatrix(n, 0) <> "" Then
                            If CheckStrickUsable(单据号.自制入库, 0, 0, vsfDetail.TextMatrix(n, 1), _
            ...
            Case 模块号.药品移库
                ...
                Exit Function
            Case 模块号.药品领用
                frmDrawCard.ShowCard Me, .TextMatrix(.Row, 0), 编辑.冲销, mblnStock, vsfList.TextMatrix(vsfList.Row, vsfList.Cols - 3), 0, BlnSuccess
                StrikeSave = BlnSuccess
                Exit Function
            Case 模块号.其他出库
...
Private Sub mnuEditModify_Click()
    ...
    With vsfList
        ...
        Select Case mlngMode
            ...
            Case 模块号.药品领用
                frmDrawCard.ShowCard Me, strNo, 编辑.修改, mblnStock, vsfList.TextMatrix(vsfList.Row, vsfList.Cols - 3), 0, BlnSuccess
            Case 模块号.其他出库
...
Private Sub mnuFileBillPreview_Click()
    ...
    With vsfList
        ...
        Select Case mlngMode
            ...
            Case 模块号.药品领用
                ReportOpen gcnOracle, glngSys, IIf(glngSys \ 100 = 1, "zl1_bill_" & 模块号.药品领用, "zl8_bill_" & 模块号.药品领用), Me, "单据编号=" & .TextMatrix(.Row, 0), "记录状态=" & .TextMatrix(.Row, .Cols - 3), "单位系数=" & int单位系数, 1
            Case 模块号.其他出库
...
Private Sub mnuFileBillPrint_Click()
    ...
    With vsfList
        ...
        Select Case mlngMode
            ...
            Case 模块号.药品领用
                ReportOpen gcnOracle, glngSys, IIf(glngSys \ 100 = 1, "zl1_bill_" & 模块号.药品领用, "zl8_bill_" & 模块号.药品领用), Me, "单据编号=" & .TextMatrix(.Row, 0), "记录状态=" & .TextMatrix(.Row, .Cols - 3), "单位系数=" & int单位系数, 2
            Case 模块号.其他出库
...
Private Sub mnuFileParameter_Click()
    ...
    frm参数设置.设置参数 Me, mstrPrivs, mlngMode, Me.Tag
...
Private Sub mnuReportItem_Click(Index As Integer)
    ...
    If strReportName = "ZL1_INSIDE_模块号.药品领用_1" Then
        ReportOpen gcnOracle, glngSys, "ZL1_INSIDE_模块号.药品领用_1", Me, "期间=" & Format(zlDataBase.Currentdate, "YYYY"), "库房=" & cboStock.Text & "|" & cboStock.ItemData(cboStock.ListIndex), "单位=住院单位" & "|4"
    Else
...
Private Sub mnuViewColDefine_Click()
    ...
    Select Case mlngMode
    Case 模块号.外购入库           '药品外购入库管理
        strColumn_All = "药名,0|药品来源,1|基本药物,1|药价级别,1|规格,1|产地,0|批号,0|生产日期,1|效期,0|单位,1|数量,0|指导批发价,1|采购价,1|扣率,1|" & _
                        "结算价,0|结算金额,0|加成率,1|售价,0|售价金额,0|差价,0|零售价,1|零售单位,1|零售金额,1|零售差价,1|批准文号,1|外观,1|" & _
                        "产品合格证,1|随货单号,1|验收结论,1|发票号,0|发票代码,0|发票日期,0|发票金额,0"
        str可选列 = "药名|药品来源|基本药物|药价级别|规格|产地|批号|生产日期|效期|单位|数量|指导批发价|采购价|扣率|" & _
                        "结算价|结算金额|加成率|售价|售价金额|差价|零售价|零售单位|零售金额|零售差价|批准文号|外观|产品合格证|随货单号|验收结论|发票号|发票代码|发票日期|发票金额"
        str屏蔽列 = "零售价|零售单位|零售金额|零售差价"
    Case 模块号.自制入库           '药品自制入库管理
    Case 模块号.其他入库           '药品其他入库管理
        strColumn_All = "药名,0|药品来源,1|基本药物,1|规格,1|产地,0|批号,0|生产日期,1|效期,0|单位,1|数量,0|冲销数量,0|成本价,1|成本金额,1|" & _
                        "售价,0|售价金额,0|差价,0|零售价,1|零售单位,1|零售金额,1|零售差价,1|批准文号,1|外观,1"
        str可选列 = "药名|药品来源|基本药物|规格|产地|批号|生产日期|效期|单位|数量|冲销数量|成本价|成本金额|" & _
    ...
    If mlngMode = 模块号.外购入库 Or mlngMode = 模块号.其他入库 Then
        If strColumn_Select <> "" Then
            ...
            If UBound(arr总列) <> UBound(arr设置列) Or InStr(1, "|" & strColumn_Select & "|", "|产地|") = 0 Or InStr(1, "|" & strColumn_UnSelect & "|", "|产地|") <> 0 Or (mlngMode = 模块号.其他入库 And (InStr(1, "|" & strColumn_Select & "|", "|采购价|") <> 0 Or InStr(1, "|" & strColumn_UnSelect & "|", "|采购价|") <> 0)) Then
                Select Case mlngMode
                Case 模块号.外购入库
                    strColumn_Select = "药名|药品来源|基本药物|药价级别|规格|产地|批号|生产日期|效期|单位|数量|指导批发价|采购价|扣率|" & _
                ...
                Case 模块号.其他入库
                    strColumn_Select = "药名|药品来源|基本药物|规格|产地|批号|生产日期|效期|单位|数量|冲销数量|成本价|成本金额|" & _
                                                    "售价|售价金额|差价|批准文号|外观"
                    strColumn_UnSelect = "零售价|零售单位|零售金额|零售差价"
                    zlDataBase.SetPara "选择列", strColumn_Select, glngSys, mlngMode
                    zlDataBase.SetPara "屏蔽列", strColumn_UnSelect, glngSys, mlngMode
...
'                    strUnitQuantity & _
'                    " LTRIM(TO_CHAR(A.成本价*" & str包装系数 & "," & mstrCostFormat & ")) AS 结算价, LTRIM(TO_CHAR(A.成本金额," & mstrMoneyFormat & ")) AS 结算金额," & _
...
'                    " ) ORDER BY " & strSqlOrder
                gstrSQL = "SELECT * FROM (SELECT DISTINCT A.序号,decode(c.付款标志,Null,'未标记',0,'未标记','已标记') 付款标志 " & strSql药名 & ",B.药品来源,B.基本药物,F.规格, A.产地, A.批号, " & strSql效期 & " ," & _
                    ...
                    " LTRIM(TO_CHAR(Decode(C.发票号,Null,decode(c.发票代码,Null,0,c.发票金额),C.发票金额)," & mstrMoneyFormat & ")) AS 发票金额,B.招标药品,B.差价让利比,C.随货单号, " & _
                    " Decode(Nvl(F.是否变价, 0) * Nvl(A.批次, 0), 0, '',LTRIM(TO_CHAR(A.零售价," & mstrPriceFormat & "))) As 零售价," & _
                    " Decode(Nvl(F.是否变价, 0) * Nvl(A.批次, 0), 0, '',LTRIM(TO_CHAR(A.零售金额," & mstrMoneyFormat & ")))  AS 零售金额, " & _
                    " Decode(Nvl(F.是否变价, 0) * Nvl(A.批次, 0), 0, '',LTRIM(TO_CHAR(A.差价," & mstrMoneyFormat & "))) AS 零售差价 " & _
                    " FROM 药品收发记录 A, 药品规格 B,收费项目目录 F,收费项目别名 E ,应付记录 C " & _
...
'                    " ) ORDER BY " & strSqlOrder
            ...
            Case 模块号.差价调整
                intBill = 5
                gstrSQL = "SELECT * FROM (SELECT DISTINCT A.序号" & strSql药名 & ",B.药品来源,B.基本药物," & _
                    "F.规格, A.产地, A.批号, " & strSql效期 & "," & strUnit & _
            ...
            Case 模块号.药品移库       '药品移库管理
                ...
                Case 1
                    str送货单位 = "decode(b.送货单位,null,'',b.送货单位|| '(1'||b.送货单位||'='||b.送货包装/1|| f.计算单位 ||')') as 送货单位,"
                Case 2
                    str送货单位 = "decode(b.送货单位,null,'',b.送货单位||'(1'||b.送货单位||'='||b.送货包装/b.门诊包装|| b.门诊单位 ||')') as 送货单位,"
                Case 3
                    str送货单位 = "decode(b.送货单位,null,'',b.送货单位||'(1'||b.送货单位||'='||b.送货包装/b.住院包装|| b.住院单位 ||')') as 送货单位,"
                Case Else
                    str送货单位 = "decode(b.送货单位,null,'',b.送货单位||'(1'||b.送货单位||'='||b.送货包装/b.药库包装|| b.药库单位 ||')') as 送货单位,"
                End Select
                gstrSQL = " SELECT * FROM (SELECT DISTINCT A.序号" & strSql药名 & ",B.药品来源,B.基本药物,F.规格,A.产地, " & _
                    " A.批号, " & strSql效期 & ",LTRIM(TO_CHAR(A.填写数量 /" & str包装系数 & "," & mstrNumberFormat & ")) AS 填写数量," & _
                    " LTRIM(TO_CHAR(A.实际数量 /" & str包装系数 & "," & mstrNumberFormat & ")) AS 实际数量," & strUnit & " AS 单位," & str送货单位 & _
                    " LTRIM(TO_CHAR (A.成本价*" & str包装系数 & ", " & mstrCostFormat & ")) AS 成本价," & _
                    " LTRIM(TO_CHAR (A.成本金额, " & mstrMoneyFormat & ")) AS 成本金额," & _
                    " LTRIM(TO_CHAR (A.零售价*" & str包装系数 & ", " & mstrPriceFormat & ")) AS 售价," & _
                    " LTRIM(TO_CHAR (A.零售金额, " & mstrMoneyFormat & ")) AS 售价金额," & _
                    " LTRIM(TO_CHAR (A.差价, " & mstrMoneyFormat & ")) AS 差价 ,C.库房货位 " & _
            ...
            Case 模块号.药品领用
                ...
                gstrSQL = " SELECT * FROM (SELECT DISTINCT A.序号" & strSql药名 & ",B.药品来源,B.基本药物,F.规格,A.产地, " & _
                    ...
                    " LTRIM(TO_CHAR (A.零售价*" & str包装系数 & ", " & mstrPriceFormat & ")) AS 售价," & _
                    " LTRIM(TO_CHAR (A.零售金额, " & mstrMoneyFormat & ")) AS 售价金额," & _
                    " LTRIM(TO_CHAR (A.差价, " & mstrMoneyFormat & ")) AS 差价 ,C.库房货位 ,NVL(E.名称,F.名称) as 名称 " & _
                    " FROM 药品收发记录 A, 药品规格 B, 收费项目目录 F,收费项目别名 E ,药品储备限额 C " & _
                    " WHERE A.药品ID = B.药品ID AND B.药品ID=F.ID " & _
                    " AND B.药品ID = E.收费细目ID (+) AND E.性质(+)=3 " & _
                    " AND 记录状态 = [3] " & _
        ...
        Set rsDetail = zlDataBase.OpenSQLRecord(gstrSQL, Me.Caption, intBill, vsfList.TextMatrix(vsfList.Row, 0), Val(vsfList.TextMatrix(vsfList.Row, vsfList.Cols - IIf(mlngMode = 模块号.差价调整 Or mlngMode = 模块号.外购入库 Or mlngMode = 模块号.药品领用, 3, 2))))
        ...
        If rsDetail.RecordCount > 0 Then
            With vsfDetail
                ...
                Case 模块号.外购入库
                    For n = 1 To .rows - 1
                        .TextMatrix(n, .ColIndex("数量")) = GetFormat(.TextMatrix(n, .ColIndex("数量")), mintShowNumberDigit)
                    Next
                Case 模块号.自制入库
                    For n = 1 To .rows - 1
                        .TextMatrix(n, .ColIndex("数量")) = GetFormat(.TextMatrix(n, .ColIndex("数量")), mintShowNumberDigit)
                ...
                Case 模块号.药品移库
                    For n = 1 To .rows - 1
                        .TextMatrix(n, .ColIndex("填写数量")) = GetFormat(.TextMatrix(n, .ColIndex("填写数量")), mintShowNumberDigit)
                        .TextMatrix(n, .ColIndex("实际数量")) = GetFormat(.TextMatrix(n, .ColIndex("实际数量")), mintShowNumberDigit)
                    Next
                Case 模块号.药品领用
                    For n = 1 To .rows - 1
                        .TextMatrix(n, .ColIndex("填写数量")) = GetFormat(.TextMatrix(n, .ColIndex("填写数量")), mintShowNumberDigit)
        ...
        With vsfDetail
            ...
            Select Case mlngMode
                Case 模块号.外购入库
                    ...
                    .TextMatrix(0, intCol) = "结算价": intCol = intCol + 1
                    .TextMatrix(0, intCol) = "结算金额": intCol = intCol + 1
                ...
                Case 模块号.药品移库
                    ...
                    .TextMatrix(0, intCol) = "单位": intCol = intCol + 1
                    .TextMatrix(0, intCol) = "送货单位": intCol = intCol + 1
                    .TextMatrix(0, intCol) = "成本价": intCol = intCol + 1
                    .TextMatrix(0, intCol) = "成本金额": intCol = intCol + 1
                    .TextMatrix(0, intCol) = "售价": intCol = intCol + 1
                    .TextMatrix(0, intCol) = "售价金额": intCol = intCol + 1
         ...
         Else
            ...
            If strVerify = "" Then    '未审核单
                ...
                If mlngMode = 模块号.药品移库 Then
                    ...
                    End If
                End If
            ElseIf .TextMatrix(.Row, IIf(mlngMode = 模块号.差价调整 Or mlngMode = 模块号.外购入库 Or mlngMode = 模块号.药品领用, .Cols - 3, .Cols - 2)) = 1 Then '审核单
                If mnuEditModify.Visible = True Then
                    mnuEditModify.Enabled = False
                    tlbTool.Buttons("Modify").Enabled = False
                End If
            ...
            Else   '2,3 冲销单（已付款的单据不允许财务审核，同样，财务审核后的单据不允许冲销）
                If .TextMatrix(.Row, IIf(mlngMode = 模块号.差价调整 Or mlngMode = 模块号.外购入库 Or mlngMode = 模块号.药品领用, .Cols - 3, .Cols - 2)) Mod 3 = 0 Then
                    ...
                    If mnuEditBill.Visible = True Then
                        mnuEditBill.Enabled = True
                    End If
                ElseIf .TextMatrix(.Row, IIf(mlngMode = 模块号.差价调整 Or mlngMode = 模块号.外购入库 Or mlngMode = 模块号.药品领用, .Cols - 3, .Cols - 2)) Mod 3 = 2 Then
                    If mlngMode = 模块号.外购入库 Then
