...
Public Function GetCondition(FrmMain As Form, ByRef str用途ID, ByRef str剂型 As String, _
    ...
    ByRef bln数量方式 As Boolean, ByRef blnOnlyBaseMedi As Boolean, ByRef strToxicologyClass As String, _
    ByRef bln按销量产生计划 As Boolean, ByRef str来源药房 As String, ByRef str来源库房 As String, Optional ByRef strAll来源药房 As String) As Boolean
