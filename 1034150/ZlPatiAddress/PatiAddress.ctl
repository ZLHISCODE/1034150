...
'===控件方法
'==============================================================
Public Sub LoadAllAdress(ByVal strAdress As String)
    Call StructAdress(strAdress)
End Sub

Public Sub LoadStructAdress(ByVal str省 As String, ByVal str市 As String, ByVal str区县 As String, ByVal str乡镇 As String, ByVal str详细地址 As String)
   Call StructAdress(str省 & "," & str市 & "," & str区县 & "," & str乡镇 & "," & str详细地址)
End Sub
    ...
    If strInputCode = "" Then
        ...
        Else
            ...
            If strInput <> "" Then
                ...
                End If
            End If
            strSQL = "Select Rownum as ID,编码,名称,简码,上级编码,是否虚拟,是否不显示  From 区域 A " & _
...
Private Function StructAdress(ByVal strInput As String) As String
'功能：结构化地址，并读取结构化地址信息。
    ...
    ElseIf Not blnCopyStruct Then
        strSQL = "Select Zl_Adderss_Structure([1]) 地址分解 From dual"
        Set rsTmp = zlDatabase.OpenSQLRecord(strSQL, "地址结构分解", strInput)
        strInput = rsTmp!地址分解 & ""
    End If
    blnClare = True
