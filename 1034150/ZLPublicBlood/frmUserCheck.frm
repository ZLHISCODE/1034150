...
'    End If
    ...
    If blnSendUserCheck = True Then
        If Not OraDataOpen(mstrServer, arrUserName(0), IIf(UCase(arrUserName(0)) = "SYS" Or UCase(arrUserName(0)) = "SYSTEM", arrPassword(0), TranPasswd(arrPassword(0)))) Then
            TXT密码(0).Text = ""
    ...
    If Not OraDataOpen(mstrServer, arrUserName(1), IIf(UCase(arrUserName(1)) = "SYS" Or UCase(arrUserName(1)) = "SYSTEM", arrPassword(1), TranPasswd(arrPassword(1)))) Then
        TXT密码(1).Text = ""
