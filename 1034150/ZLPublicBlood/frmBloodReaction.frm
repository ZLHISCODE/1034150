...
Public Sub BloodReaction(frmMain As Object, lng阶段 As Long, lng病人ID As Long, lng主页id As Long, lng病人来源 As Long, ByVal lngSys As Long, lng模块号 As Long, Optional strPrivs As String, Optional lngisModul As Long = 0)
    '功能：输血反应主要的处理程序
    '参数：lng阶段-医生处理阶段还是输血科处理阶段，lng病人id-病人的id，lng主页id-病人的主页id，lng病人来源-1：门诊、2：住院，strPrivs-权限串
    ...
    If zlGetComLib = False Then MsgBox "获取对象失败！", vbInformation, gstrSysName: Exit Sub
    UCE.InitEdit
    UCE.showInfor mlng病人ID, mlng病人来源, mlng主页id, mlng阶段, gcnOracle, Me, mlng模块号
TOSHOW:
