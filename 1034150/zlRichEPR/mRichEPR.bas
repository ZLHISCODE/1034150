...
Public Function zlFileZip(ByVal strFile As String) As String
    ...
    Exit Function
errHand:
    Call WriteDebugLOG(Err.Description)
    If ErrCenter = 1 Then
        Resume
    End If
End Function
...
Foottxt:
    ...
    End With
End Sub
Public Sub ReadRTF(edtThis As Editor, ByVal lngFileID As Long, ByVal blnClearMode As Boolean, ByVal blnMoved As Boolean, Optional blnClearBColor As Boolean = True)
'读取RTF文件
