...
Public Const ID_EDIT_COPYSELF = 3231            '专用复制
Public Const ID_EDIT_COPYOUT = 3232             '复制到粘贴板
...
'Public Const ID_EDIT_EXPANDE = 335             '展开
'Public Const ID_EDIT_COLLAPSE = 336            '折叠
...
Public Const ID_VIEW_HISTORYREPORT = 3401       '本病人历史报告
Public Const ID_VIEW_Assistant = 3402        '助手窗格

'插入 "Insert"
Public Const ID_Main_INSERT = 50
...
'格式 "Format"
Public Const ID_Main_FORMAT = 60
...
Public Const ID_TABLE_SHOWGRID = 467            '显示虚框
Public Const ID_TABLE_INSERTINHERITROW = 468    '插入继承行
Public Const ID_TABLE_CELLPROTECTED = 469       '保护单元格
Public Const ID_TABLE_RETURNDOWN = 470          '回车键向下跳格
Public Const ID_TABLE_RETURNRIGHT = 471         '回车键横向跳格

'帮助 "Help"
Public Const ID_Main_HELP = 80
...
Public Const ID_HELP_Tip = 506                  '提示
...
'助手右键菜单
Public Const ID_ASSISTANT_HIDE = 700            '隐藏 ×
Public Const ID_ASSISTANT_VOICEINPUT = 701      '语音输入 ×
Public Const ID_ASSISTANT_ACTION = 702          '动作 ×
Public Const ID_ASSISTANT_SHOWONSTART = 703     '启动时显示 ×
...
Public Const ID_PATISIGN = 713                  '患者签名
...
'申请、报告接口
Public Const ID_Insert_YZSQXM = 800             '医嘱申请项目
Public Const ID_Insert_YZXMZ = 801              '医嘱项目组
Public Const ID_Insert_JYXMZ = 802              '检验项目组
Public Const ID_Insert_JCXMZ = 803              '检查项目组
Public Const ID_Insert_ZLXMZ = 804              '治疗项目组
Public Const ID_Insert_NXSSZ = 805              '拟行手术组

Public Const ID_Insert_ZXBGXM = 850             '执行报告项目
Public Const ID_Insert_JYJGZ = 851              '检验结果组

'医嘱提取窗口
Public Const ID_InsAdvice_CQYZ = 860            '长期医嘱
Public Const ID_InsAdvice_LSYZ = 861            '临时医嘱
Public Const ID_InsAdvice_XXD = 862             '新下达
Public Const ID_InsAdvice_YJD = 863             '已校对
Public Const ID_InsAdvice_YFZ = 864             '已废止
Public Const ID_InsAdvice_CZH = 865             '重整后
Public Const ID_InsAdvice_DRYZ = 866            '当日医嘱
Public Const ID_InsAdvice_ZDSJD = 867           '指定时间段
...
Public Const ID_COMMON_OK = 610                 '确定
Public Const ID_COMMON_CANCEL = 611             '取消

Public Const ID_BAR_NORMAL = 1000               '常用工具条
Public Const ID_BAR_FORMAT = 2000               '格式工具条
Public Const ID_FORMAT_SPACE = 2001             '间距
Public Const ID_BAR_SIGN = 3000                 '签名工具条
Public Const ID_BAR_TABLE = 4000                '表格工具条
