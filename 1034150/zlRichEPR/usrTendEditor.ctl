...
Private Sub ReadData()
    ...
    '检查是否归档
    gstrSQL = " Select 归档人 From 病人护理记录 Where 病人ID=" & mlng病人ID & " And 主页ID=" & mlng主页ID & " And 婴儿=" & cbo病人.ItemData(cbo病人.ListIndex) & " And Rownum<2"
