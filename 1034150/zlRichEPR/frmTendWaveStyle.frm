...
Begin VB.Form frmTendWaveStyle 
      ...
      Begin VB.PictureBox picCloumn 
         ...
         Begin VB.PictureBox picAlign 
            ...
            Begin VB.OptionButton optAlign 
               ...
               Index           =   2
               Left            =   660
               Picture         =   "frmTendWaveStyle.frx":255E
               Style           =   1  'Graphical
               TabIndex        =   164
               TabStop         =   0   'False
               Top             =   0
            ...
            Begin VB.OptionButton optAlign 
               ...
               Index           =   1
               Left            =   330
               Picture         =   "frmTendWaveStyle.frx":28B7
               Style           =   1  'Graphical
               TabIndex        =   163
               TabStop         =   0   'False
               Top             =   0
            ...
            Begin VB.OptionButton optAlign 
               ...
               Index           =   0
               Left            =   0
               Picture         =   "frmTendWaveStyle.frx":2C47
               Style           =   1  'Graphical
               TabIndex        =   162
               TabStop         =   0   'False
               Top             =   0
   ...
   Begin VB.PictureBox picOutput 
      ...
      Begin VB.PictureBox picPrint 
         ...
         Begin VB.Frame fraOrient 
            ...
            Begin VB.Image imgPortrait 
               Height          =   480
               Left            =   120
               Picture         =   "frmTendWaveStyle.frx":2FCD
               Top             =   330
               Width           =   480
            End
            Begin VB.Image imgCross 
               Height          =   480
               Left            =   120
               Picture         =   "frmTendWaveStyle.frx":3897
               Top             =   330
               Visible         =   0   'False
               Width           =   480
            End
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   120
            Picture         =   "frmTendWaveStyle.frx":4161
            Top             =   75
            Width           =   480
         End
      End
      ...
      Begin VB.PictureBox picFoot 
         ...
         Begin VB.CheckBox chkI 
            ...
            Height          =   350
            Left            =   5250
            Picture         =   "frmTendWaveStyle.frx":4A2B
            Style           =   1  'Graphical
            TabIndex        =   47
         ...
         Begin VB.CheckBox chkU 
            ...
            Height          =   350
            Left            =   4920
            Picture         =   "frmTendWaveStyle.frx":B27D
            Style           =   1  'Graphical
            TabIndex        =   46
         ...
         Begin VB.CheckBox chkB 
            ...
            Height          =   350
            Left            =   4590
            Picture         =   "frmTendWaveStyle.frx":11ACF
            Style           =   1  'Graphical
            TabIndex        =   45
         ...
         Begin RichTextLib.RichTextBox rtbHead 
            ...
            OLEDragMode     =   0
            OLEDropMode     =   0
            TextRTF         =   $"frmTendWaveStyle.frx":18321
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "宋体"
               Size            =   10.5
               Charset         =   134
         ...
         Begin RichTextLib.RichTextBox rtbFoot 
            ...
            OLEDragMode     =   0
            OLEDropMode     =   0
            TextRTF         =   $"frmTendWaveStyle.frx":183BE
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "宋体"
               Size            =   10.5
               Charset         =   134
   ...
   Begin XtremeDockingPane.DockingPane dkpMan 
      Bindings        =   "frmTendWaveStyle.frx":1845B
      Left            =   750
      Top             =   120
      _Version        =   589884
      _ExtentX        =   450
...
Private Sub cbsThis_Execute(ByVal Control As XtremeCommandBars.ICommandBarControl)
    ...
    Case conMenu__Curve_AddLeft
        ...
        Me.udBabyCol.Max = vfgThis.Cols - 1
...
Private Function zlRefreshData()
    ...
    gstrSQL = " SELECT DECODE(A.项目序号,-1,2,A.项目序号) 排列序号,A.项目序号,A.项目名称 as 项目名, B.记录名 项目名称, A.项目单位, B.记录法,DECODE(NVL(C.项目序号,''),'',A.项目表示,4) 项目表示" & vbNewLine & _
        ...
        " WHERE A.项目序号 = B.项目序号 And A.项目序号=C.项目序号(+) AND NOT (NVL(A.应用方式,0)=2 And A.项目序号=-1) And A.项目性质=1 And A.项目序号<>5" & vbNewLine & _
        " ORDER BY 项目序号"
...
Private Sub txtBabyCol_Change()
    txtColumnNo.Text = txtBabyCol.Text
    vfgThis.Col = txtBabyCol.Text
End Sub
...
Private Sub txtBabyLeft_GotFocus()
...
Private Sub txtBabyTitle_KeyPress(KeyAscii As Integer)
...
Private Sub txtBabyTitleText_GotFocus()
    Me.txtBabyTitleText.SelStart = 0: Me.txtBabyTitleText.SelLength = 4000
...
Private Sub txtColumnNo_Change()
    txtBabyCol.Text = txtColumnNo.Text
    vfgThis.Col = txtBabyCol.Text
End Sub
...
Private Sub vfgThis_Click()
    txtBabyCol.Text = vfgThis.Col
    udColumnNo.Value = txtBabyCol.Text
End Sub
