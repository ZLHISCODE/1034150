...
Dim cbp帮助 As CommandBarPopup      '帮助菜单
    ...
    With cbp视图.CommandBar.Controls
        ...
        Set objControl = .Add(xtpControlButton, ID_View_Mode_Orig, "原始状态(&O)"): objControl.BeginGroup = True
        Set objControl = .Add(xtpControlButton, ID_View_Mode_Clear, "最终状态(&C)")
    End With
    ...
    With BarMain.Controls
        Set objControl = .Add(xtpControlButton, ID_View_Mode_Orig, "原始状态(F5)"): objControl.BeginGroup = True
        Set objControl = .Add(xtpControlButton, ID_View_Mode_Clear, "最终状态(F6)")
        
        Set objControl = .Add(xtpControlButton, ID_HELP_CONTENT, "帮助")
        objControl.BeginGroup = True
