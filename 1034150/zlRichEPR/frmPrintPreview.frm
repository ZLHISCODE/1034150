...
Begin VB.Form frmPrintPreview 
   ...
   Begin MSComDlg.CommonDialog dlgThis 
      ...
      _Version        =   393216
   End
   Begin XtremeCommandBars.ImageManager immThis 
      Left            =   450
      Top             =   45
      _Version        =   589884
      _ExtentX        =   635
      _ExtentY        =   635
      _StockProps     =   0
      Icons           =   "frmPrintPreview.frx":187B
   End
...
Public Sub DoOnlyDocPreview(ByRef frmParent As Object, _
    ...
    With edtThis
        ...
        Doc.frmEditor.Editor1.DocHeadCopyWithFormat
...
'    strF = App.Path & "\TMP.rtf"
    ...
    With Me.edtThis
        ...
        .OpenDoc strF
        Editor1.DocHeadCopyWithFormat
        .DocHeadPasteWithFormat
        Editor1.DocFootCopyWithFormat
        .DocFootPasteWithFormat
        ...
        For intLoop = 1 To frmParent.Document.Elements.Count '要预览窗体控件上删除空要素，展开型要素重新刷新以去掉下波浪线
            If frmParent.Document.Elements(intLoop).内容文本 = "" Then
...
Dim cbp帮助 As CommandBarPopup          '帮助菜单
    ...
    With cbp文件.CommandBar.Controls
        .Add xtpControlButton, ID_File_SaveCopy, "保存副本(&A)..."
    ...
    With cbp视图.CommandBar.Controls
        ...
        Set objControl = cbpPopup.CommandBar.Controls.Add(xtpControlButton, ID_View_ZoomIn, "放大")
        objControl.BeginGroup = True
        cbpPopup.CommandBar.Controls.Add xtpControlButton, ID_View_ZoomOut, "缩小"
        
        Set objControl = .Add(xtpControlButton, ID_View_First, "第一页(&F)   ")
        objControl.BeginGroup = True
        .Add xtpControlButton, ID_View_Prev, "前一页(&P)   "
        .Add xtpControlButton, ID_View_Next, "后一页(&N)   "
        .Add xtpControlButton, ID_View_Last, "最后一页(&L) "
    End With
    ...
    With cbp帮助.CommandBar.Controls
        ...
        objControl.BeginGroup = True
        cbpPopupSub.CommandBar.Controls.Add xtpControlButton, ID_HELP_ONLINE, gstrProductName & "在线(&H)"
    ...
    With BarPreview.Controls
        ...
        objControl.BeginGroup = True
        Set objControl = .Add(xtpControlButton, ID_View_ZoomIn, "放大")
        objControl.BeginGroup = True
        ...
        Set objControl = .Add(xtpControlButton, ID_View_First, "第一页")
        objControl.BeginGroup = True
        .Add xtpControlButton, ID_View_Prev, "前一页"
        .Add xtpControlButton, ID_View_Next, "后一页"
        .Add xtpControlButton, ID_View_Last, "最后一页"
        ...
        Set objControl = .Add(xtpControlButton, ID_FILE_EXIT, "关闭(&Q)")
        objControl.BeginGroup = True
    End With
    '图标绑定
    cbsThis.Icons = immThis.Icons
    '显示扩展按钮
    cbsThis.Options.ShowExpandButtonAlways = True
    cbsThis.EnableCustomization (True)
    cbsThis.Options.UseDisabledIcons = True
    '是否显示所有菜单
    cbsThis.Options.AlwaysShowFullMenus = True
    ...
    'TAB控件的初始化
    tabThis.Icons = immThis.Icons
    tabThis.InsertItem 0, "页面缩略图 ", pic页面.hWnd, 401
