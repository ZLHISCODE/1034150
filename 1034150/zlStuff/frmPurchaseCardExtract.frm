...
Private Sub ExtractStockData()
    ...
    gstrSQL = "Select b.Id, '[' || b.编码 || ']' || b.名称 名称, b.规格, b.产地,a.批准文号, " & IIf(mintUnit = 0, "b.计算单位", "c.包装单位") & " 单位," & vbNewLine & _
              ...
              "From 药品库存 A, 收费项目目录 B, 材料特性 C, 收费价目 D" & vbNewLine & _
    ...
    With frmPurchaseCard
        ...
        For i = 1 To rsVal.RecordCount
            ...
            .SetColValue i, rsVal!Id, rsVal!名称, IIf(IsNull(rsVal!规格), "", rsVal!规格), IIf(IsNull(rsVal!产地), "", rsVal!产地) _
                ...
                , IIf(IsNull(rsVal!在用分批), 0, rsVal!在用分批), rsVal!指导差价率, rsVal!批准文号
