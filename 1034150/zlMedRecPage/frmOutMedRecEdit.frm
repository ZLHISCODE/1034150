...
Begin VB.Form frmOutMedRecEdit 
   ...
   Begin TabDlg.SSTab sstInfo 
      ...
      Begin VB.Frame fraMain 
         ...
         Begin VB.Frame fraDiag 
            ...
            Begin VB.CommandButton cmdMakeLog 
               Height          =   255
               Left            =   1560
               Picture         =   "frmOutMedRecEdit.frx":00F7
               Style           =   1  'Graphical
               TabIndex        =   74
               TabStop         =   0   'False
            ...
            Begin VSFlex8Ctl.VSFlexGrid vsDiagXY 
               ...
               FormatString    =   $"frmOutMedRecEdit.frx":0681
               ScrollTrack     =   -1  'True
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   115
            ...
            Begin VSFlex8Ctl.VSFlexGrid vsDiagZY 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   0   'False
               FormatString    =   $"frmOutMedRecEdit.frx":093D
               ScrollTrack     =   -1  'True
               ScrollBars      =   2
               ScrollTips      =   0   'False
               MergeCells      =   115
      ...
      Begin VB.Frame fraMain 
         ...
         Begin VB.ComboBox cboBaseInfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   61
            ItemData        =   "frmOutMedRecEdit.frx":0B2F
            Left            =   900
            List            =   "frmOutMedRecEdit.frx":0B31
            TabIndex        =   24
            Top             =   1875
            Width           =   2340
         End
   ...
   Begin VB.Image imgButtonNew 
      Height          =   240
      Left            =   7920
      Picture         =   "frmOutMedRecEdit.frx":0B33
      Top             =   6480
      Visible         =   0   'False
      Width           =   240
   End
   Begin VB.Image imgButtonDel 
      Height          =   240
      Left            =   7920
      Picture         =   "frmOutMedRecEdit.frx":10BD
      Top             =   6840
      Visible         =   0   'False
      Width           =   240
   End
