...
Begin VB.Form frmMediSpec 
   ...
   Begin TabDlg.SSTab stbSpec 
      ...
      Tab(2).Control(0)=   "lblTemperature"
      Tab(2).Control(1)=   "lblCondition"
      Tab(2).Control(2)=   "lblPrepareType"
      Tab(2).Control(3)=   "lblNotice"
      Tab(2).Control(4)=   "cboTemperature"
      Tab(2).Control(5)=   "cboPrepareType"
      Tab(2).Control(6)=   "chkCondition"
      Tab(2).Control(7)=   "chkDosage"
      Tab(2).Control(8)=   "txtNotice"
