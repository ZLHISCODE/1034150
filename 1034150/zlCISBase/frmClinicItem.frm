...
Begin VB.Form frmClinicItem 
   ...
   Begin TabDlg.SSTab stbInfo 
      ...
      Tab(0).Control(25)=   "lbl试管编码"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "cbo病理类别"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "fra标本部位"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "fra录入量"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "fra检查部位"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "fra标准编码"
      Tab(0).Control(30).Enabled=   0   'False
      Tab(0).Control(31)=   "chk检验组合"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "cmd参考"
      Tab(0).Control(32).Enabled=   0   'False
      Tab(0).Control(33)=   "txt参考"
      Tab(0).Control(33).Enabled=   0   'False
      Tab(0).Control(34)=   "cbo操作类型"
      Tab(0).Control(34).Enabled=   0   'False
      Tab(0).Control(35)=   "txt项目编码"
      Tab(0).Control(35).Enabled=   0   'False
      Tab(0).Control(36)=   "txt项目名称"
      Tab(0).Control(36).Enabled=   0   'False
      Tab(0).Control(37)=   "cbo适用性别"
      Tab(0).Control(37).Enabled=   0   'False
      Tab(0).Control(38)=   "cbo计算方式"
      Tab(0).Control(38).Enabled=   0   'False
      Tab(0).Control(39)=   "txt名称拼音"
      Tab(0).Control(39).Enabled=   0   'False
      Tab(0).Control(40)=   "txt名称五笔"
      Tab(0).Control(40).Enabled=   0   'False
      Tab(0).Control(41)=   "txt其他别名"
      Tab(0).Control(41).Enabled=   0   'False
      Tab(0).Control(42)=   "chk单独应用"
      Tab(0).Control(42).Enabled=   0   'False
      Tab(0).Control(43)=   "chk执行安排"
      Tab(0).Control(43).Enabled=   0   'False
      Tab(0).Control(44)=   "txt别名拼音"
      Tab(0).Control(44).Enabled=   0   'False
      Tab(0).Control(45)=   "txt别名五笔"
      Tab(0).Control(45).Enabled=   0   'False
      Tab(0).Control(46)=   "txt计算单位"
      Tab(0).Control(46).Enabled=   0   'False
      Tab(0).Control(47)=   "txt录入限量"
      Tab(0).Control(47).Enabled=   0   'False
      Tab(0).Control(48)=   "cbo录入限量范围"
      Tab(0).Control(48).Enabled=   0   'False
      Tab(0).Control(49)=   "txt英文"
      Tab(0).Control(49).Enabled=   0   'False
      Tab(0).Control(50)=   "cbo分类说明"
      Tab(0).Control(50).Enabled=   0   'False
      Tab(0).Control(51)=   "cbo执行分类"
      ...
      Tab(0).Control(60)=   "cboBloodType"
      Tab(0).Control(60).Enabled=   0   'False
      Tab(0).Control(61)=   "picTestTubeCode"
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsfBloodLis 
         ...
         FormatString    =   $"frmClinicItem.frx":0616
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsUseDept 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"frmClinicItem.frx":066E
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.ComboBox cbo操作类型 
         Height          =   300
         ItemData        =   "frmClinicItem.frx":081A
         Left            =   5085
         List            =   "frmClinicItem.frx":081C
         Style           =   2  'Dropdown List
         TabIndex        =   9
         Top             =   450
         Width           =   1815
      ...
      Begin VB.Image imgComment 
         Height          =   240
         Left            =   7305
         Picture         =   "frmClinicItem.frx":081E
         Top             =   1845
         Width           =   240
      End
      Begin VB.Label lblComment 
         Caption         =   $"frmClinicItem.frx":1660
         Height          =   1545
         Left            =   7305
         TabIndex        =   40
         Top             =   1905
   ...
   Begin VB.CommandButton cmdHelp 
      ...
      Height          =   350
      Left            =   105
      Picture         =   "frmClinicItem.frx":1704
      TabIndex        =   54
      TabStop         =   0   'False
      Top             =   7695
      Width           =   1100
   ...
   Begin VB.ComboBox cbo类别 
      Height          =   300
      ItemData        =   "frmClinicItem.frx":184E
      Left            =   8310
      List            =   "frmClinicItem.frx":1850
      Style           =   2  'Dropdown List
      TabIndex        =   4
      Top             =   60
      Width           =   1710
   ...
   Begin MSComctlLib.ImageList imgList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicItem.frx":1852
            Key             =   "close"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicItem.frx":1DEC
            Key             =   "expend"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicItem.frx":2386
            Key             =   "Dept"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicItem.frx":2920
            Key             =   "unCheck"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmClinicItem.frx":2EBA
            Key             =   "Check"
         EndProperty
      EndProperty
   End
...
Private Sub Load部门(ByVal intType As Integer, ByVal str工作性质 As String)
    ...
    Do Until rsData.EOF
        ...
        If Me.lvwItems.Tag = "执行" Then
            If InStr(Me.msf定向执行.TextMatrix(Me.msf定向执行.Row, col执行科室ID) & ",", rsData!ID & ",") > 0 Then
                objItem.Checked = True
            End If
        End If
...
Private Sub GetDefineSize()
    ...
    txt名称拼音.MaxLength = mint简码长度
    txt名称五笔.MaxLength = mint简码长度
    txt别名拼音.MaxLength = mint简码长度
    txt别名五笔.MaxLength = mint简码长度
...
'            Call SQLTest
    ...
    Case "E"        '处置
        ...
        Me.cbo操作类型.Clear: Me.cbo操作类型.Visible = True
        '增加输血采集方式的设置
        If isPiotBlood = True Then
            aryTemp = Split("0-普通;1-过敏试验;2-给药方法(西药);3-中药煎法;4-中药用(服)法;5-特殊治疗;6-标本采集;7-配血方法;8-输血途径;9-输血采集", ";")
        Else
            aryTemp = Split("0-普通;1-过敏试验;2-给药方法(西药);3-中药煎法;4-中药用(服)法;5-特殊治疗;6-标本采集;7-配血方法;8-输血途径", ";")
        End If
        For intCount = LBound(aryTemp) To UBound(aryTemp)
...
Private Sub cmdOK_Click()
    ...
    If txt项目名称.Text <> strTmp Then
        txt项目名称.Text = strTmp
        Me.txt名称拼音.Text = zlGetSymbol(strTmp, 0, mint简码长度)
        Me.txt名称五笔.Text = zlGetSymbol(strTmp, 1, mint简码长度)
    End If
    ...
    If txt其他别名.Text <> strTmp Then
        txt其他别名.Text = strTmp
        Me.txt别名拼音.Text = zlGetSymbol(strTmp, 0, mint简码长度)
        Me.txt别名五笔.Text = zlGetSymbol(strTmp, 1, mint简码长度)
    End If
...
'                    End If
    ...
    If OptAppUse(0).Enabled = True And OptAppUse(0).Value = False Then
        For i = 0 To Me.OptAppUse.Count - 1
            If OptAppUse(i).Value = True Then
...
'        If zlClinicCodeRepeat(Trim(Me.txt项目编码.Text)) = True Then Exit Sub
    ...
    Do While int循环 <> 0
        ...
        Case "D"
            ...
            '新的方式下,检查项目没有组合项目
                ...
                Dim str方法 As String, blnOne As Boolean
                ...
                For lngRow = .FixedRows To .Rows - 1
                    If .RowData(lngRow) = 1 Then
                        ...
                        If blnOne Then
                            blnOne = False
                        Else
                            lngCount = UBound(strModusSQL)
                        End If
                        ReDim Preserve strModusSQL(lngCount + UBound(arrItem)) As String
                        For lngItem = LBound(arrItem) To UBound(arrItem) - 1
                            strModusSQL(lngCount + lngItem + 1) = "zl_诊疗项目部位_insert(" & lngItemID & ",'" & Mid(cbo操作类型.Text, InStr(cbo操作类型, "-") + 1) & "','" & _
                                                    Trim(.Cell(flexcpText, lngRow, .ColIndex("名称"))) & "','" & Trim(arrItem(lngItem + 1)) & "'," & _
                                                    IIf(InStr(.Cell(flexcpText, lngRow, .ColIndex("默认")) & ",", Trim(arrItem(lngItem + 1)) & ",") > 0, 1, "null") & ")"
                        Next
                    End If
                Next
                End With
        ...
        For i = 0 To Me.OptApp.Count - 1
            If Me.OptApp(i).Value = True Then
                mAppType = i
                Exit For
            End If
        Next
        ...
        '使用科室范围
        For i = 0 To Me.OptAppUse.Count - 1
            If Me.OptAppUse(i).Value = True Then
                mAppType = i
                Exit For
            End If
        Next
        ...
        If Me.Tag = "复制增加" Then
            gstrSql = gstrSql & "," & mlngoldId
        ElseIf Me.Tag = "增加" Then
            gstrSql = gstrSql & ",Null"
        End If
        '治疗类的输血采集方式，保存对应的试管编码
        If Left(Me.cbo类别.Text, 1) = "E" And Me.cbo操作类型.ListIndex = 9 Then
            If cboTestTubeCode.ListIndex > 0 Then
                gstrSql = gstrSql & ",'" & Split(cboTestTubeCode.List(cboTestTubeCode.ListIndex), "-")(0) & "'"
            End If
        End If
        
        If Me.Tag = "增加" Or Me.Tag = "复制增加" Then
            gstrSql = "zl_诊疗项目_Insert(" & gstrSql & ")"
        Else
            gstrSql = "zl_诊疗项目_Update(" & gstrSql & ")"
        End If
    ...
    If Left(Me.cbo类别.Text, 1) = "D" Then
        ...
        If mblnPACSInterface = True Then
            If Not gobjRIS Is Nothing Then
                If gobjRIS.HISBasicDictTable(RISBaseItemType.ClinicItem, IIf(Me.Tag = "增加" Or Me.Tag = "复制增加", RISBaseItemOper.AddNew, RISBaseItemOper.Modify), lngItemID) <> 1 Then
    ...
    If Left(Me.cbo类别.Text, 1) = "C" Then
        ...
        If Not (lngVItemID0 = 0 And (Me.Tag <> "增加" And Me.Tag <> "复制增加")) Then   '导的演示数据有问题,加上判断,这种错误数据不处理.
...
ErrHand:
    ...
    If blnRisTrans = True And Not gobjRIS Is Nothing Then
        MsgBox "HIS" & IIf(Me.Tag = "增加" Or Me.Tag = "复制增加", "增加", "修改") & "诊疗项目错误，RIS接口和HIS数据不同步，请与系统管理员联系。", vbInformation, gstrSysName
        
        On Error Resume Next
        Call gobjRIS.WriteCommLog("frmClinicItem：cmdOK_Click", "HIS" & IIf(Me.Tag = "增加" Or Me.Tag = "复制增加", "增加", "修改") & "诊疗项目错误，RIS接口和HIS数据不同步", "诊疗项目ID=" & lngItemID, 0)
    End If
...
Private Sub cmd标本_Click()
    ...
    vPoint = GetCoordPos(txt标本部位.hWnd, txt标本部位.Left - 165, txt标本部位.Top - 30)
...
Private Sub Form_Activate()
    ...
    gstrSql = "select A.编码,A.名称,执行频率,单独应用,计算方式,计算单位,适用性别,执行安排,服务对象,执行科室,操作类型,组合项目,标本部位,A.试管编码," & _
            "        建档时间,nvl(撤档时间,to_date('3000-01-01','YYYY-MM-DD')) as 撤档时间,参考目录ID,B.名称 As 参考名称,A.录入限量,A.执行标记,A.执行分类,A.计算规则,A.站点,A.计算系数 " & _
...
'                Me.txt检验(5) = Nvl(!临床意义)
    ...
    If Me.Tag = "增加" Or Me.Tag = "复制增加" Then
        ...
        If Val(GetSysPara(61)) = 0 Then '诊疗项目编码递增模式
...
Private Sub txt其他别名_KeyPress(KeyAscii As Integer)
    If KeyAscii = vbKeyReturn Then
        ...
        Me.txt别名拼音.Text = zlGetSymbol(Me.txt其他别名.Text, 0, mint简码长度)
        Me.txt别名五笔.Text = zlGetSymbol(Me.txt其他别名.Text, 1, mint简码长度)
        Call zlCommFun.PressKey(vbKeyTab): Exit Sub
    End If
'    If InStr(" ~!@#$%^&*_+|=-`;'""/?", Chr(KeyAscii)) > 0 Then KeyAscii = 0
...
Private Sub txt项目名称_KeyPress(KeyAscii As Integer)
    If KeyAscii = vbKeyReturn Then
        ...
        Me.txt名称拼音.Text = zlGetSymbol(Me.txt项目名称.Text, 0, mint简码长度)
        Me.txt名称五笔.Text = zlGetSymbol(Me.txt项目名称.Text, 1, mint简码长度)
        Call zlCommFun.PressKey(vbKeyTab): Exit Sub
    End If
'    If InStr(" ~!@#$%^&*_+|=`;'""/?", Chr(KeyAscii)) > 0 Then KeyAscii = 0
    If InStr(GCST_INVALIDCHAR, Chr(KeyAscii)) > 0 Then KeyAscii = 0
...
'将检验项目计算公式转换为以ID标识的公式
    ...
    OpenRecordset rsTmp, Me.Caption, strSQL
    Exit Function
DBError:
    If ErrCenter() = 1 Then Resume
    TransFormula = ""
...
Private Sub initVfgList()
    ...
    With vfgList
        ...
        '更新已设置的方法
        strSQL = "Select A.项目id, A.类型, A.部位, A.方法, A.默认, Decode(Nvl(B.收费项目id, 0), 0, 0, 1) As 使用" & vbNewLine & _
                "From 诊疗项目部位 A, 诊疗收费关系 B" & vbNewLine & _
                "Where A.部位 = B.检查部位(+) And A.方法 = B.检查方法(+) And A.项目id = B.诊疗项目id(+)" & vbNewLine & _
                " And instr([2],A.类型)>0 And A.项目ID=[1]"
        ...
        Do Until rsTmp.EOF
            ...
            Do Until rsZlxm.EOF
                If "" & rsZlxm.Fields("默认") = 1 Then
                    If InStr(.TextMatrix(.Rows - 1, .ColIndex("方法")), "" & rsZlxm.Fields("方法")) > 0 Then
                        If Mid(.TextMatrix(.Rows - 1, .ColIndex("方法")), InStr(.TextMatrix(.Rows - 1, .ColIndex("方法")), "" & rsZlxm.Fields("方法")) - 1, 1) = "□" Then
                            .TextMatrix(.Rows - 1, .ColIndex("方法")) = Replace(.TextMatrix(.Rows - 1, .ColIndex("方法")) & " ", "□" & rsZlxm.Fields("方法") & " ", "■" & rsZlxm.Fields("方法") & " ")
                            .TextMatrix(.Rows - 1, .ColIndex("方法")) = Replace(.TextMatrix(.Rows - 1, .ColIndex("方法")) & " ", "□" & rsZlxm.Fields("方法") & "〈", "■" & rsZlxm.Fields("方法") & "〈")
                            .TextMatrix(.Rows - 1, .ColIndex("方法")) = Replace(.TextMatrix(.Rows - 1, .ColIndex("方法")) & " ", "□" & rsZlxm.Fields("方法") & "〉", "■" & rsZlxm.Fields("方法") & "〉")
                        ElseIf Mid(.TextMatrix(.Rows - 1, .ColIndex("方法")), InStr(.TextMatrix(.Rows - 1, .ColIndex("方法")), "" & rsZlxm.Fields("方法")) - 1, 1) = "○" Then
                            .TextMatrix(.Rows - 1, .ColIndex("方法")) = Replace(.TextMatrix(.Rows - 1, .ColIndex("方法")) & " ", "○" & rsZlxm.Fields("方法") & " ", "●" & rsZlxm.Fields("方法") & " ")
                            .TextMatrix(.Rows - 1, .ColIndex("方法")) = Replace(.TextMatrix(.Rows - 1, .ColIndex("方法")) & " ", "○" & rsZlxm.Fields("方法") & "〈", "●" & rsZlxm.Fields("方法") & "〈")
                        End If
                    End If
...
'    If UBound(Split(strMethod, vbTab)) >= 0 Then
'        aryItem() = Split(Split(strMethod, vbTab)(0), ";")
'        For lngCount = 0 To UBound(aryItem)
'            strTemp = Mid(aryItem(lngCount), 2)
'            If strTemp <> "" Then
'                If InStr(1, strTemp, ",") > 0 Then
...
'    End If
'    If UBound(Split(strMethod, vbTab)) > 0 Then
'        aryItem() = Split(Split(strMethod, vbTab)(1), ";")
'        For lngCount = 0 To UBound(aryItem)
'            strItems = strItems & " □" & Mid(aryItem(lngCount), 2)
'        Next
'    End If
            ...
            With vfgList
                If strDefault <> .TextMatrix(Row, .ColIndex("默认")) Then
                    ...
                    If .TextMatrix(Row, .ColIndex("默认")) <> "" Then
                        arrItem = Split(.TextMatrix(Row, .ColIndex("默认")), ",")
...
Private Sub vsfBloodLis_CellButtonClick(ByVal Row As Long, ByVal Col As Long)
    ...
    vRect = GetControlRect(vsfBloodLis.hWnd) '获取位置
...
Private Sub GetBloodLis(ByVal strInput As String)
    ...
    strInput = mstrFindStyle & strInput & "%"
    With vsfBloodLis
...
'是否启用血库相关设置
    Dim objPublicBlood As Object
    Dim rsTmp As New ADODB.Recordset
    Dim strSQL As String
    Dim blnPiot As Boolean
    On Error GoTo ErrHand
