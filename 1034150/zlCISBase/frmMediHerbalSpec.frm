...
Begin VB.Form frmMediHerbalSpec 
   ...
   Begin TabDlg.SSTab stbSpec 
      ...
      Tab(0).Control(31)=   "txt合同单位"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "cmbStationNo"
      Tab(0).Control(32).Enabled=   0   'False
      Tab(0).Control(33)=   "txt备选码"
      Tab(0).Control(33).Enabled=   0   'False
      Tab(0).Control(34)=   "cbo发药类型"
      Tab(0).Control(34).Enabled=   0   'False
      Tab(0).Control(35)=   "txt说明"
      Tab(0).Control(35).Enabled=   0   'False
      Tab(0).Control(36)=   "cmd合同单位"
      Tab(0).Control(36).Enabled=   0   'False
      Tab(0).Control(37)=   "cbo申领单位"
      Tab(0).Control(37).Enabled=   0   'False
      Tab(0).Control(38)=   "txt申领阀值"
      Tab(0).Control(38).Enabled=   0   'False
      Tab(0).Control(39)=   "txt注册商标"
      Tab(0).Control(39).Enabled=   0   'False
      Tab(0).Control(40)=   "txt批准文号"
      Tab(0).Control(40).Enabled=   0   'False
      Tab(0).Control(41)=   "cbo药品来源"
      Tab(0).Control(41).Enabled=   0   'False
      Tab(0).Control(42)=   "txt编码"
      Tab(0).Control(42).Enabled=   0   'False
      Tab(0).Control(43)=   "txt数字码"
      Tab(0).Control(43).Enabled=   0   'False
      Tab(0).Control(44)=   "txt售价单位"
      Tab(0).Control(44).Enabled=   0   'False
      Tab(0).Control(45)=   "txt药库包装"
      Tab(0).Control(45).Enabled=   0   'False
      Tab(0).Control(46)=   "txt药库单位"
      Tab(0).Control(46).Enabled=   0   'False
      Tab(0).Control(47)=   "txt药房包装"
      Tab(0).Control(47).Enabled=   0   'False
      Tab(0).Control(48)=   "txt药房单位"
      Tab(0).Control(48).Enabled=   0   'False
      Tab(0).Control(49)=   "txt剂量系数"
      Tab(0).Control(49).Enabled=   0   'False
      Tab(0).Control(50)=   "txt规格"
      Tab(0).Control(50).Enabled=   0   'False
      Tab(0).Control(51)=   "txt产地"
      Tab(0).Control(51).Enabled=   0   'False
      Tab(0).Control(52)=   "txt标识码"
      Tab(0).Control(52).Enabled=   0   'False
      Tab(0).Control(53)=   "opt中药形态(0)"
      Tab(0).Control(53).Enabled=   0   'False
      Tab(0).Control(54)=   "opt中药形态(1)"
      Tab(0).Control(54).Enabled=   0   'False
      Tab(0).Control(55)=   "opt中药形态(2)"
      Tab(0).Control(55).Enabled=   0   'False
      Tab(0).Control(56)=   "cmd产地"
      Tab(0).Control(56).Enabled=   0   'False
      Tab(0).Control(57)=   "txt送货包装"
      Tab(0).Control(57).Enabled=   0   'False
      Tab(0).Control(58)=   "txt送货单位"
      Tab(0).Control(58).Enabled=   0   'False
      Tab(0).Control(59)=   "txt本位码"
      Tab(0).Control(59).Enabled=   0   'False
      Tab(0).ControlCount=   60
      TabCaption(1)   =   "药价信息(&2)"
      TabPicture(1)   =   "frmMediHerbalSpec.frx":0A30
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "lbl批价单位(1)"
      Tab(1).Control(1)=   "lbl批价单位(0)"
      Tab(1).Control(2)=   "lblPercent(2)"
      Tab(1).Control(3)=   "Label2"
      Tab(1).Control(4)=   "lblPercent(1)"
      Tab(1).Control(5)=   "lbl管理费比例"
      Tab(1).Control(6)=   "lbl服务对象"
      Tab(1).Control(7)=   "lbl住院可否分零"
      Tab(1).Control(8)=   "lbl费用类型"
      Tab(1).Control(9)=   "lbl成本价格"
      Tab(1).Control(10)=   "lbl加成率"
      Tab(1).Control(11)=   "lbl收入记入"
      Tab(1).Control(12)=   "lbl当前售价"
      Tab(1).Control(13)=   "lbl药价级别"
      Tab(1).Control(14)=   "lbl药价属性"
      Tab(1).Control(15)=   "lbl结算价"
      Tab(1).Control(16)=   "lbl扣率"
      Tab(1).Control(17)=   "lblPercent(0)"
      Tab(1).Control(18)=   "lbl指导批价"
      Tab(1).Control(19)=   "lbl指导售价"
      Tab(1).Control(20)=   "lbl病案费目"
      Tab(1).Control(21)=   "lbl门诊可否分零"
      Tab(1).Control(22)=   "txt病案费目"
      Tab(1).Control(23)=   "txt增值税率"
      Tab(1).Control(24)=   "chk住院动态分零"
      Tab(1).Control(25)=   "txt管理费比例"
      Tab(1).Control(26)=   "txt成本价格"
      Tab(1).Control(27)=   "txt加成率"
      Tab(1).Control(28)=   "chkGMP认证"
      Tab(1).Control(29)=   "fra分批核算"
      Tab(1).Control(30)=   "cbo药价属性"
      Tab(1).Control(31)=   "txt结算价"
      Tab(1).Control(32)=   "txt扣率"
      Tab(1).Control(33)=   "cbo住院可否分零"
      Tab(1).Control(34)=   "cbo服务对象"
      Tab(1).Control(35)=   "cbo费用类型"
      Tab(1).Control(36)=   "txt当前售价"
      Tab(1).Control(37)=   "cbo收入记入"
      Tab(1).Control(38)=   "cbo药价级别"
      Tab(1).Control(39)=   "txt指导批价"
      Tab(1).Control(40)=   "txt指导售价"
      Tab(1).Control(41)=   "chk屏蔽费别"
      Tab(1).Control(42)=   "chk非常备药"
      Tab(1).Control(43)=   "cmd病案"
      Tab(1).Control(43).Enabled=   0   'False
      Tab(1).Control(44)=   "cbo门诊可否分零"
      ...
      Begin VB.Frame fraMedi 
         Caption         =   "设置该药品包装的外观图片(建议选择的图片不要超过100K，否则会影响读取性能)"
         Height          =   4260
         Index           =   3
         Left            =   -74880
         TabIndex        =   121
...
Private Sub cmdCancel_Click()
    ...
    If mblnOtherSave = False Then
        strTemp = txt编码.Text & "|" & txt本位码.Text & "|" & txt规格.Text & "|" & txt产地.Text & "|" & _
                        ...
                        txt指导售价.Text & "|" & txt加成率.Text & "|" & cbo收入记入.Text & "|" & txt病案费目.Text & "|" & txt管理费比例.Text & "|" & cbo药价级别.Text & "|" & _
                        chk屏蔽费别.Value & "|" & txt增值税率.Text & "|" & cbo费用类型.Text & "|" & cbo服务对象.Text & "|" & cbo住院可否分零.Text & "|" & chk住院动态分零.Value & "|" & _
...
'    End If
    ...
    End If
    gstrSql = gstrSql & "," & Val(Me.txt扣率.Text) & "," & dbl指导售价 & "," & Val(Me.txt加成率.Text) & "," & Val(Me.txt管理费比例.Text)
...
'        Call SQLTest
    With rsTemp
        ...
        With Me.msf合同单位
            ...
            .Top = Me.stbSpec.Top + Me.txt合同单位.Top + Me.txt合同单位.Height
            .Clear
            Set .DataSource = rsTemp
...
'        End If
    ...
    gstrSql = "select I.编码,S.本位码,I.规格,I.产地,S.标识码,S.药品来源,S.批准文号,S.注册商标,S.中药形态," & _
            ...
            "        I.是否变价,S.指导批发价,S.扣率,S.指导零售价,i.病案费目,S.加成率,S.管理费比例,S.差价让利比,S.成本价,S.招标药品,S.GMP认证,S.基本药物, " & _
...
'            Me.txt住院包装.Text = IIf(IsNull(!住院包装), 1, !住院包装)
            ...
            Me.txt加成率.Text = Format(IIf(IsNull(!加成率), 0, !加成率), "0.00000")
...
'    mblnLoad = True
    Me.stbSpec.Tab = 0
    mstr所有记录 = ""
    mstr所有记录 = txt编码.Text & "|" & txt本位码.Text & "|" & txt规格.Text & "|" & txt产地.Text & "|" & _
                    txt数字码.Text & "|" & txt标识码.Text & "|" & cbo药品来源.Text & "|" & txt合同单位.Text & "|" & txt说明.Text & "|" & cbo发药类型.Text & "|" & _
                    cmbStationNo.Text & "|" & txt批准文号.Text & "|" & txt注册商标.Text & "|" & txt售价单位.Text & "|" & txt剂量系数.Text & "|" & _
                    txt药房单位.Text & "|" & txt药房包装.Text & "|" & txt药库单位.Text & "|" & txt药库包装.Text & "|" & cbo申领单位.Text & "|" & txt申领阀值.Text & "|" & _
                    txt备选码.Text & "|" & cbo药价属性.Text & "|" & txt成本价格.Text & "|" & txt当前售价.Text & "|" & txt指导批价.Text & "|" & txt扣率.Text & "|" & txt结算价.Text & "|" & _
...
'    Dim dbl差价让利 As Double
    ...
    txt指导售价.Text = GetFormat(Val(txt当前售价), mintPriceDigit)
...
Private Sub txt指导批价_LostFocus()
    Me.txt指导批价.Text = GetFormat(Val(txt指导批价), mintCostDigit)
End Sub
