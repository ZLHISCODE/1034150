...
Private Sub Form_Deactivate()
    ...
    For lngRow = vfg方法.FixedRows To vfg方法.Rows - 1
        If vfg方法.Cell(flexcpChecked, lngRow, mCol.默认) = flexChecked Then
            strReturn = strReturn & vfg方法.Cell(flexcpText, lngRow, mCol.方法 + 1) & ","
        End If
    Next
