...
Private Sub Form_Load()
    ...
    '打印选项
    chkPrintTurnPage.value = Val(zlDatabase.GetPara("重整和术后医嘱换页打印", glngSys, p住院医嘱发送, 0))
...
Private Sub chkPrintTurnPage_Click()
    Call zlDatabase.SetPara("重整和术后医嘱换页打印", chkPrintTurnPage.value, glngSys, p住院医嘱发送, InStr(GetInsidePrivs(p住院医嘱发送), ";医嘱选项设置;") > 0)
