...
Public Const conMenu_Edit_AdvicePrice = 30136      '*对医嘱记帐
Public Const conMenu_Edit_AdvicePay = 30137      '*诊间支付
...
Public Const conMenu_Edit_CriticalAdvice = 3031 '危急值医嘱
Public Const conMenu_Edit_ViewDrugExplain = 30821 '查看药品说明书
...
Public Const conMenu_Edit_ApplyCustom = 30761 '自定义申请单
...
Public Const conMenu_Report_BloodInstant = 409    '输血执行单(&I)
...
Public Const conMenu_Edit_NewRis = 300103     'RIS菜单按钮
Public Const conMenu_Edit_NewRisSch = 300104   '*预约
Public Const conMenu_Edit_NewRisDel = 300105   '*取消预约
Public Const conMenu_Edit_NewRisModi = 300106   '*调整预约
