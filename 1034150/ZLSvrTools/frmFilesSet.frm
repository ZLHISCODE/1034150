...
'        Dim RetVal      As Long  '返回值
        ...
        If FindFile(str7zFile) = False Then
            ...
            Exit Function
        End If
        If Not obj7ZZIP.Init7zZip() Then
            Exit Function
        End If
        ...
        For lngRow = 1 To .Rows - 1
                strFilename = UCase(.TextMatrix(lngRow, HeadInfor.部件名))
...
'                End If
                ...
                Else
                    '7z进行压缩
                    '4个文件不需要压缩 特殊处理
                    If UCase(Nvl(strFilename, "")) = "GACUTIL.EXE.CONFIG" Or UCase(Nvl(strFilename, "")) = "ZL7Z.DLL" Or UCase(Nvl(strFilename, "")) = "GACUTIL.EXE" Or UCase(Nvl(strFilename, "")) = UCase("zlHisCrust.exe") Or UCase(Nvl(strFilename, "")) = UCase("7z.exe") Or UCase(Nvl(strFilename, "")) = UCase("7z.dll") Or UCase(Nvl(strFilename, "")) = UCase("aamd532.dll") Or UCase(Nvl(strFilename, "")) = UCase("zlRunas.exe") Or UCase(Nvl(strFilename, "")) = UCase("RegCom.dll") Then
...
Success:
                    ...
                    Else
                        If FindFile(strFullPath) Then
                            ...
                            Call obj7ZZIP.ZipFile(strSource, strDesc)
