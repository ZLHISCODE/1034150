...
Private Sub cmdSqlFile_Click()
    With Me.dlgMain
        ...
        Else
            ...
            Me.fltFile.Pattern = "zlRegist.plb"
...
Private Sub Form_Load()
    ...
    If Dir(App.Path & "\Tools\zlRegist.plb") <> "" And Dir(App.Path & "\Tools\zlServer.Sql") <> "" Then
...
Private Function svrCreate(strSqlFile As String) As Boolean
    ...
    strRegFunFile = Mid(strSqlFile, 1, Len(strSqlFile) - InStr(1, StrReverse(strSqlFile), "\") + 1) & "zlRegist.plb"
