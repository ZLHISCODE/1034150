...
Begin VB.Form frmRAInPatient 
   Caption         =   "住院药嘱审查"
   ClientHeight    =   8430
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   11760
   Icon            =   "frmRAInPatient.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   8430
   ScaleWidth      =   11760
   ...
   Begin VB.PictureBox picDetail 
      ...
      Begin VB.PictureBox picRecipe 
         ...
         Begin zl9RecipeAudit.SpeedButton sbnPASS 
            ...
            Enabled         =   -1  'True
            PictureAlign    =   0
            Picture         =   "frmRAInPatient.frx":0781
            ShowCaption     =   -1  'True
         End
      ...
      Begin VB.PictureBox picAudit 
         ...
         Begin VB.PictureBox picFunc 
            ...
            Begin VB.CommandButton cmdYes_Fixed 
               ...
               Height          =   1080
               Left            =   0
               Picture         =   "frmRAInPatient.frx":0AD3
               Style           =   1  'Graphical
               TabIndex        =   31
               Top             =   0
               Width           =   1335
            ...
            Begin VB.CommandButton cmdNo_Fixed 
               ...
               Height          =   1080
               Left            =   1350
               Picture         =   "frmRAInPatient.frx":179D
               Style           =   1  'Graphical
               TabIndex        =   32
               Top             =   0
               Width           =   1695
         ...
         Begin zl9RecipeAudit.SpeedButton sbnSelect 
            ...
            Enabled         =   -1  'True
            PictureAlign    =   1
            Picture         =   "frmRAInPatient.frx":2467
            ShowCaption     =   0   'False
         End
         ...
         Begin zl9RecipeAudit.SpeedButton sbnHouse 
            ...
            Enabled         =   -1  'True
            PictureAlign    =   1
            Picture         =   "frmRAInPatient.frx":27B9
            ShowCaption     =   0   'False
         End
   ...
   Begin VB.PictureBox picAuditYN 
      ...
      Index           =   0
      Left            =   9000
      Picture         =   "frmRAInPatient.frx":2B0B
      ScaleHeight     =   375
      ScaleWidth      =   375
      TabIndex        =   39
      TabStop         =   0   'False
   ...
   Begin VB.PictureBox picAuditYN 
      ...
      Index           =   1
      Left            =   9480
      Picture         =   "frmRAInPatient.frx":3095
      ScaleHeight     =   375
      ScaleWidth      =   375
      TabIndex        =   40
      TabStop         =   0   'False
   ...
   Begin VB.PictureBox picAuditDel 
      ...
      Height          =   375
      Left            =   9960
      Picture         =   "frmRAInPatient.frx":361F
      ScaleHeight     =   375
      ScaleWidth      =   375
      TabIndex        =   41
      TabStop         =   0   'False
   ...
   Begin MSComctlLib.ImageList imgPASSLight 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRAInPatient.frx":39A9
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRAInPatient.frx":449B
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRAInPatient.frx":4F8D
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRAInPatient.frx":5A7F
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRAInPatient.frx":6571
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.StatusBar stbThis 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   2355
            MinWidth        =   882
            Picture         =   "frmRAInPatient.frx":7063
            Text            =   "中联软件"
            TextSave        =   "中联软件"
            Key             =   "ZLFLAG"
         EndProperty
   ...
   Begin XtremeCommandBars.ImageManager imgMain 
      Bindings        =   "frmRAInPatient.frx":78F5
      Left            =   840
      Top             =   120
      _Version        =   589884
      _ExtentX        =   635
   ...
   End
End
Attribute VB_Name = "frmRAInPatient"
...
Private Const MSTR_PATIENT = "姓|姓名|0;住|住院号|0;身|身份证号|1"

Private Const MSTR_VSF_WAIT As String = _
        "病人,,3,1000|审方ID,,0,0|病人ID,,0,0|挂号单ID,,0,0|主页ID,,0,0|性别,,3,600|年龄,,3,600|住院号,,3,1000|提交时间,,3,1600" & _
        "|提交科室,,3,1500|提交人,,3,1000|发药药房,,3,1500"
        
Private Const MSTR_VSF_FINISH As String = _
        "审查结果,,3,1000|病人,,3,1000|审方ID,,0,0|病人ID,,0,0|挂号单ID,,0,0|主页ID,,0,0|性别,,3,600|年龄,,3,600|住院号,,3,1000|提交时间,,3,1600" & _
        "|提交科室,,3,1500|提交人,,3,1000|发药药房,,3,1500|审查时间,,3,1600|审查人,,3,1000"
        
Private Const MSTR_VSF_RECIPE As String = _
        "临床科室,,3,1500|审方ID,,0,0|医嘱ID,,0,0|超量说明,,3,1500|医生嘱托,,3,1500|新生儿,,3,800|期效,,3,600|组序号,,0,0|组数,,0,0|组,,3,300" & _
        "|PASS,,3,600|药品名称,,3,2000|商品名,,3,1500|规格,,0,0|单位,,3,600|数量,,0,0,n|单量,,3,800,n|相关ID,,0,0|用法,,3,800|频次,,3,800" & _
        "|不合格,,0,0|标志,,0,0"
...
'Private mobjArchiveMedRec As zlPublicAdvice.clsArchiveMedRec    '电子病案
Private mobjPubAdvice As zlPublicAdvice.clsPublicAdvice         '临床公共方法
...
Private mintParaPass As Integer
Private mbytDrugName As Byte
Private mintItem As Integer
Private mblnNeedAudit As Boolean
Private mblnAuditStart As Boolean
...
Private mblnReasonRefresh As Boolean
...
Private Sub cbsMain_Execute(ByVal Control As XtremeCommandBars.ICommandBarControl)
    ...
    Select Case Control.ID
        ...
        Case enuMenus.查看PASS结果
            Call PassResultView(mobjPASS, False, Val(vsfRecipe.TextMatrix(vsfRecipe.Row, vsfRecipe.ColIndex("医嘱ID"))))
        Case enuMenus.刷新
            If mblnLocking Then
...
Private Sub Form_Load()
    ...
    mblnEnter = False
    mblnExit = False
    mstrPCName = UCase(mdlDefine.ComputerName)
    
    '来源科室
    '检查部门管理有无服务于住院的临床科室
    strSQL = "Select Distinct a.Id 部门id, a.编码, a.名称 " & vbNewLine & _
             "From 部门表 A, 部门性质说明 B " & vbNewLine & _
             "Where a.Id = b.部门id And b.工作性质 In ('临床') And b.服务对象 In (2, 3) " & vbNewLine & _
             "    And (a.撤档时间 Is Null Or To_Char(a.撤档时间, 'yyyy') = '3000')" & vbNewLine & _
             "Order By a.名称"
    Set rsTemp = zlDatabase.OpenSQLRecord(strSQL, "获取住院药嘱审查的来源科室")
    
    If rsTemp.RecordCount <= 0 Then
        MsgBox "无“临床”属性，并服务于住院的科室（来源科室），请检查部门管理！", vbInformation, gstrSysName
        rsTemp.Close
'        mblnExit = True
'        Exit Sub
    End If
    ...
    strSQL = "Select Distinct a.部门id, c.编码, c.名称 " & vbNewLine & _
             ...
             "   And b.服务对象 In (2, 3) And (c.撤档时间 Is Null Or To_Char(c.撤档时间, 'yyyy') = '3000') " & vbNewLine & _
             "Order By c.名称 "
    Set rsTemp = zlDatabase.OpenSQLRecord(strSQL, "获取操作员的所属住院类药房", UserInfo.ID)
    If rsTemp.RecordCount <= 0 Then
        MsgBox "操作员无住院类药房部门的属性，请检查部门管理！", vbInformation, gstrSysName
        rsTemp.Close
        mblnExit = True
        Exit Sub
    End If
    ...
    mblnNeedAudit = (lngTmp = 2 Or lngTmp = 3)                              '2-住院启用审查；3-门诊和住院启用审查
    mblnAuditStart = False                                                  '进入窗体审查状态为禁止
    mblnLocking = False
    mlngModule = glngModule
    mstrPrivs = mdlDefine.FormatString(";[1];", GetPrivFunc(glngSys, mlngModule))
...
'        Else
'            Set mfrmAMR = mobjArchiveMedRec.zlGetForm(1)
'        End If
'    End If
'    Err.Clear: On Error GoTo errHandle
    ...
    If Not mobjPubAdvice Is Nothing Then
        If Not gfrmNavigation Is Nothing Then
            Call mobjPubAdvice.InitCommon(gcnOracle, glngSys, , , , , , gfrmNavigation.mobjEmr)
        Else
            MsgBox "导航台数据存在异常，新版病历将无法查看！", vbInformation, gstrSysName
    ...
    If mblnMemory Then
        ...
        '字体大小
        lngTmp = Val(GetSetting("ZLSOFT", mdlDefine.FormatString("私有模块\[1]\界面设置\[2]\[3]\Form", "ZLHIS", App.ProductName, Me.Name), "FontSize"))
        ...
        'DockingPane
        strPane = GetSetting("ZLSOFT", mdlDefine.FormatString("私有模块\[1]\界面设置\[2]\[3]\Form", "ZLHIS", App.ProductName, Me.Name), "布局")
        iknPatient.IDKind = Val(GetSetting("ZLSOFT", mdlDefine.FormatString("私有模块\[1]\界面设置\[2]\[3]\Form", "ZLHIS", App.ProductName, Me.Name), "iknPatient"))
...
Private Sub InitTBCTab()
    ...
    With tbcTab
        .InsertItem 0, "药嘱审查(&1)", picDetail.hwnd, 0
...
'  blnLock：True加锁；False解锁
    ...
    strSQL = mdlDefine.FormatString("Zl_处方审查记录_Lock([1], '[2]', 1, [3])", _
                    IIf(blnLock, 1, 0), _
                    mstrPCName, _
...
'  bytMode：1-病人审查数据；2-处方明细数据；3-审查项目数据
    ...
    Select Case bytMode
        Case 1      '1-病人审查数据
            ...
            If lngClinicID <= 0 Then
                strTmp = "Select Column_Value 来源科室 " & vbNewLine & _
                         "From Table(f_Num2list((Select 来源科室 From 处方审查参数 Where Upper(机器名) = [6] And 服务对象 = 1), ',')) "
            End If
            ...
            If Me.tbcRec.Item(0).Selected Then
                ...
                If chkPubPatient.Value = 1 And lngClinicID <= 0 Then
                    '岗位未设置的来源科室
                    strTmp = strTmp & vbNewLine & _
                             "Union All Select 科室ID From (" & vbNewLine & _
                             "Select a.ID 科室id From 部门表 A, 部门性质说明 B Where a.ID = b.部门ID And b.工作性质 in ('临床') " & vbNewLine & _
                             "    And b.服务对象 in (2, 3) " & vbNewLine & _
                             "Minus " & vbNewLine & _
                             ...
                             "                       Where 服务对象 = 1 And 最后操作时间 >= Sysdate - 60 And 来源科室 Is Not Null), ',')) ) "
                End If

                strSQL = "Select b.姓名 病人, b.病人id, b.主页id, b.性别, b.年龄, b.住院号, c.Id 审方id, c.挂号id, " & vbNewLine & _
                         "    To_Char(c.提交时间, 'yyyy-mm-dd hh24:mi') 提交时间, c.提交人, D1.名称 提交科室, D2.名称 发药药房 " & vbNewLine & _
                         "From " & IIf(lngClinicID <= 0, mdlDefine.FormatString("(Select 来源科室 From ([1])) A,", strTmp), "") & vbNewLine & _
                         ...
                         "    And c.审查时间 Is Null And c.状态 = 0 And c.提交时间 Between [1] And [2] And c.主页ID Is Not Null "
                ...
                Set rsTemp = zlDatabase.OpenSQLRecord(strSQL, "查询住院类待审查数据", _
                                        datBegin, datEnd, _
                                        lngClinicID, _
            ...
            Else
                ...
                strSQL = "Select b.姓名 病人, b.病人id, b.主页id, b.性别, b.年龄, b.住院号, c.Id 审方id, c.挂号id, " & vbNewLine & _
                         ...
                         IIf(lngClinicID <= 0, " And a.来源科室 = c.提交科室id ", "") & vbNewLine & _
                         IIf(lngDrugstoreID <= 0, " And c.发药药房id = e.Column_Value ", " And c.发药药房id = [4] ") & vbNewLine & _
                         "    And c.审查时间 Is Not Null And c.状态 = 1 And c.提交时间 Between [1] And [2] And c.主页ID Is Not Null "
                strSQL = strSQL & IIf(lngClinicID <= 0, "", " And c.提交科室id = [3] ")
                strSQL = strSQL & IIf(Trim(txtPatient) = "", "", strPatient)
                strSQL = strSQL & vbNewLine & "Order By c.提交时间 "

                Set rsTemp = zlDatabase.OpenSQLRecord(strSQL, "查询住院类已审查数据", _
                                        datBegin, datEnd, _
                                        lngClinicID, _
                                        IIf(lngDrugstoreID <= 0, cboDrugstore.Tag, CStr(lngDrugstoreID)), _
                                        IIf(blnReadID = False, txtPatient.Text, lngPatientID), _
        ...
        Case 2      '2-处方明细数据
            ...
            strSQL = "Select Null 标志, e.名称 临床科室, b.审方id, b.医嘱id, A1.超量说明, A1.医生嘱托, decode(A1.婴儿, 1, '是', null) 新生儿, " & vbNewLine & _
                     "    A1.相关id, A1.审查结果 PASS, d.名称 药品名称, f.名称 商品名, Null 规格, g.计算单位 单位, A1.总给予量 数量, " & vbNewLine & _
                     "    A1.单次用量 || Nvl(d.计算单位, '') 单量, A2.医嘱内容 用法, Decode(A1.医嘱期效, 0, '长嘱', '临嘱') 期效, A1.执行频次 频次, " & _
                     "    Row_Number() Over(Partition By A1.相关id Order By b.医嘱id) 组序号," & vbNewLine & _
                     "    Count(1) Over(Partition By A1.相关id) 组数 " & vbNewLine & _
                     "From 病人医嘱记录 A1, 病人医嘱记录 A2, 处方审查明细 B, 诊疗项目目录 D, 部门表 E, 收费项目别名 F, 收费项目目录 G " & vbNewLine & _
                     "Where A1.相关id = A2.Id And A1.Id = b.医嘱id And A1.诊疗项目id = d.Id And A1.开嘱科室id = e.Id And " & vbNewLine & _
                     "    A1.收费细目id = f.收费细目id(+) And b.审方id = [1] And f.性质(+) = 3 And f.码类(+) = 1 And A1.收费细目id = g.id(+) " & vbNewLine & _
                     "Order By A1.相关id, 组序号 "
            If chk24.Value = 1 And Me.chk24.Visible = True Then
                '24小时内的所有药嘱（有病人医嘱发送记录）
                strTmp = "Select 1 标志, e.名称 临床科室, Null 审方id, A1.Id 医嘱id, A1.超量说明, A1.医生嘱托, decode(A1.婴儿, 1, '是', null) 新生儿, " & vbNewLine & _
                         "    A1.相关id, A1.审查结果 PASS, d.名称 药品名称, f.名称 商品名, Null 规格, g.计算单位 单位, A1.总给予量 数量, " & vbNewLine & _
                         "    A1.单次用量 || Nvl(d.计算单位, '') 单量, A2.医嘱内容 用法, Decode(A1.医嘱期效, 0, '长嘱', '临嘱') 期效, A1.执行频次 频次, " & vbNewLine & _
                         "    Row_Number() Over(Partition By A1.相关id Order By A1.Id) 组序号, " & vbNewLine & _
                         "    Count(1) Over(Partition By A1.相关id) 组数 " & vbNewLine & _
                         "From 病人医嘱记录 A1, 病人医嘱记录 A2, 诊疗项目目录 D, 部门表 E, 收费项目别名 F, 收费项目目录 G " & vbNewLine & _
                         "Where A1.相关id = A2.Id And A1.诊疗项目id = d.Id And A1.开嘱科室id = e.Id " & vbNewLine & _
                         "    And A1.收费细目id = f.收费细目id(+) And f.性质(+) = 3 And f.码类(+) = 1 And A1.收费细目id = g.id(+) " & vbNewLine & _
                         "    And A1.病人id = [2] And A1.病人来源 = 2 " & vbNewLine & _
                         "    And Not A1.Id In (Select 医嘱id From W_A) And d.类别 in ('5','6','7') " & vbNewLine & _
                         "    And Exists(Select 1 From 病人医嘱发送 Where 医嘱ID = a1.id and 发送时间 Between Sysdate - 1 And Sysdate) " & vbNewLine & _
                         "Order By A1.相关id, 组序号 "
        ...
        Case 3      '3-审查项目数据
            ...
            If Me.tbcRec(1).Selected Or Val(vsfRecipe.TextMatrix(vsfRecipe.Row, vsfRecipe.ColIndex("标志"))) = 1 Then
                ...
                If rsTemp.EOF = False Then
                    txtReason.Text = zlCommFun.NVL(rsTemp!综合理由)
                End If
                rsTemp.Close
            Else
                txtReason.Text = ""
            ...
            strSQL = "Select Decode(b.药师审查, 2, '不合格', 1, '合格', Decode(b.自动审查, 2, '不合格', '合格')) 药师审查, " & vbNewLine & _
                     ...
                     "From 病人医嘱记录 A, 处方审查结果 B, 诊疗项目目录 C, 处方审查项目 D " & vbNewLine & _
                     "Where a.Id(+) = b.医嘱id And a.诊疗项目id = c.Id(+) And b.审查项目id(+) = d.Id And b.审方id(+) = [1] " & vbNewLine & _
                     "    And d.类别 in ([2], 3, 4) And d.是否住院启用 = 1 " & vbNewLine & _
                     "Order By d.类别, d.编码"
...
'功能：刷新审查锁定或非锁定状态的相关控件
    ...
    cmdYes_Fixed.Enabled = mblnLocking And mblnAuditStart
    cmdNo_Fixed.Enabled = mblnLocking And mblnAuditStart
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    If mblnExit = False Then
        ...
        SaveSetting "ZLSOFT", mdlDefine.FormatString("私有模块\[1]\界面设置\[2]\[3]\Form", "ZLHIS", App.ProductName, Me.Name), "布局", strPane
        SaveSetting "ZLSOFT", mdlDefine.FormatString("私有模块\[1]\界面设置\[2]\[3]\Form", "ZLHIS", App.ProductName, Me.Name), "iknPatient", iknPatient.IDKind
        SaveSetting "ZLSOFT", mdlDefine.FormatString("私有模块\[1]\界面设置\[2]\[3]\Form", "ZLHIS", App.ProductName, Me.Name), "FontSize", mbytFontSize
    End If
End Sub
...
'返回：True成功；False失败
    ...
    If bytFun = 1 Then
        '开启
        strSQL = mdlDefine.FormatString("ZL_处方审查参数_SAVE(2, '[1]', 1, 1, Null)", mstrPCName)
    ...
    Else
        ...
        '更新是否开启审方、最后操作时间
        strSQL = mdlDefine.FormatString("ZL_处方审查参数_SAVE(2, '[1]', 1, 0, Null)", mstrPCName)
...
Private Sub SetOtherText()
    Dim vsfTmp As VSFlexGrid
    Dim lngPatientID As Long, lngPageID As Long, lngMedicalID As Long
    ...
    txtOther.Text = mdlDefine.FormatString("诊断：[1]热量需要量：", vbCrLf)
    
    If vsfTmp.Rows <= 1 Then Exit Sub
    
    lngPatientID = Val(vsfTmp.TextMatrix(vsfTmp.Row, vsfTmp.ColIndex("病人ID")))
    lngPageID = Val(vsfTmp.TextMatrix(vsfTmp.Row, vsfTmp.ColIndex("主页ID")))
    ...
    If Not mobjPubAdvice Is Nothing Then
        ...
        strDiagnose = mdlRecipeAudit.GetDiagnose(lngPatientID, lngPageID)
    End If
    txtOther.Text = mdlDefine.FormatString("诊断：[1][2]", strDiagnose, vbCrLf)
    
    '热量需要量
    strTmp = GetCalorie(lngPatientID, 0, lngPageID)
    txtOther.Text = txtOther & mdlDefine.FormatString("热量需要量：[1]", strTmp)
End Sub
...
Private Sub SetStatusbar()
    ...
    Else
        stbThis.Panels(2).Text = mdlDefine.FormatString("当前[1]审记录数量：[2]条", IIf(tbcRec.Item(0).Selected, "待", "已"), vsfTmp.Rows - 1)
    End If
...
Private Sub sbnHouse_Click()
    ...
    strSQL = mdlDefine.FormatString("Zl_处方审查常用理由_Update(1, '[1]', '[2]')", _
                            UserInfo.用户名, _
                            txtReason.Text)
...
Private Sub sbnSelect_Click()
    ...
    If blnCancel = False Then
        With rsTemp
            ...
            Do While .EOF = False
                strSQL = strSQL & mdlDefine.FormatString("[1]、[2][3]", i, !内容, vbNewLine)
                i = i + 1
                .MoveNext
            Loop
            If strSQL <> "" Then
...
Private Sub vsfRecFinish_AfterRowColChange(ByVal OldRow As Long, ByVal OldCol As Long, ByVal NewRow As Long, ByVal NewCol As Long)
    If OldRow <> NewRow Then
        Dim lngPatientID As Long, lngPageID As Long
...
Private Sub vsfRecipe_AfterRowColChange(ByVal OldRow As Long, ByVal OldCol As Long, ByVal NewRow As Long, ByVal NewCol As Long)
    If OldRow <> NewRow Then
        If NewRow > 0 Then 'If Screen.MousePointer = vbDefault And NewRow > 0 Then
            ...
            Call RefreshLockControls
            If Not mobjPASS Is Nothing Then
                Call mobjPASS.zlPassSetDrug_YF(GetExpenseID(Val(vsfRecipe.TextMatrix(NewRow, vsfRecipe.ColIndex("医嘱ID")))), _
...
Private Function GetExpenseID(ByVal lngMedicalID As Long) As Long
'功能：获取收费项目ID
'参数：
'  lngMedicalID：医嘱ID
'返回：收费项目ID
    ...
    strSQL = "Select Min(药品id) 药品id " & vbNewLine & _
             "From 收费项目目录 A, 药品规格 B, 病人医嘱记录 C " & vbNewLine & _
             "Where a.Id = b.药品id And b.药名id = c.诊疗项目id And (a.撤档时间 Is Null Or To_Char(a.撤档时间, 'yyyy') = '3000') " & _
             "    And c.Id = [1] "
    Set rsTemp = zlDatabase.OpenSQLRecord(strSQL, "获取收费项目ID", lngMedicalID)
    If rsTemp.EOF = False Then
        GetExpenseID = zlCommFun.NVL(rsTemp!药品id, 0)
    End If
    rsTemp.Close
...
'  bytFun：1-合格；2-不合格
    ...
    With vsfAudit
        ...
        For l = 1 To .Rows - 1
            ...
            If strReason = "" And (Trim(.TextMatrix(l, .ColIndex("药师审查"))) = "不合格" Or Trim(.TextMatrix(l, .ColIndex("自动审查"))) = "不合格") Then
                MsgBox "请填写“综合审查”内容！", vbInformation, gstrSysName
                .Row = l
                .SetFocus
                Exit Sub
    ...
    strSQL = mdlDefine.FormatString("Zl_处方审查_Audit([1], [2], [3], [4])", _
                    lngAuditID, _
                    bytFun, _
                    "'" & UserInfo.姓名 & "'", _
    ...
    With vsfAudit
        For l = 1 To .Rows - 1
            If .TextMatrix(l, .ColIndex("药师审查")) = "不合格" Or .TextMatrix(l, .ColIndex("自动审查")) = "不合格" Then
                ...
                strSQL = mdlDefine.FormatString("Zl_处方审查_Audit_Detail([1], [2], [3], [4])", _
                                lngAuditID, _
...
'    vsfRecWait.RemoveItem vsfRecWait.Row
    ...
    '审查不合格，发送消息通知医生
    If bytFun = 2 Then
        SendMessage bytFun, lngAuditID, 2, mobjMipModule
    End If
...
Private Sub SetClinicItem()
    ...
    strSQL = "Select a.Id 部门id, a.编码, a.名称 " & vbNewLine & _
             "From 部门表 A, Table(f_Num2list((Select 来源科室 From 处方审查参数 Where 机器名 = [1] And 服务对象 = 1), ',')) B " & vbNewLine & _
             "Where a.Id = b.Column_Value " & vbNewLine & _
             "Order By a.名称 "
    Set rsTemp = zlDatabase.OpenSQLRecord(strSQL, "获取住院药嘱审查岗位设置的来源科室", mstrPCName)
    With rsTemp
        cboClinic.Clear
    ...
    If Me.Visible Then
        If vsfVal Is Nothing Then
            If Me.tbcRec.Item(0).Selected Then
                ...
                lngPageID = Val(vsfRecWait.TextMatrix(vsfRecWait.Row, vsfRecWait.ColIndex("主页ID")))
            Else
                lngPatientID = Val(vsfRecFinish.TextMatrix(vsfRecFinish.Row, vsfRecFinish.ColIndex("病人ID")))
                lngPageID = Val(vsfRecFinish.TextMatrix(vsfRecFinish.Row, vsfRecFinish.ColIndex("主页ID")))
            End If
        Else
            lngPatientID = Val(vsfVal.TextMatrix(vsfVal.Row, vsfVal.ColIndex("病人ID")))
            lngPageID = Val(vsfVal.TextMatrix(vsfVal.Row, vsfVal.ColIndex("主页ID")))
        End If
        
        On Error GoTo errHandle
        If Not mobjPubAdvice Is Nothing And Not mfrmAMR Is Nothing Then
            Call mobjPubAdvice.zlArchiveRefresh(lngPatientID, lngPageID)
        End If
    End If
    Exit Sub
